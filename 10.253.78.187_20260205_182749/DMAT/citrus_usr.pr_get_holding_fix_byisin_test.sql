-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_byisin_test
...
CREATE proc [citrus_usr].[pr_get_holding_fix_byisin_test](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
select *,@pa_to_dt dphmcd_holding_dt  from #tmp_dp_daily_hldg_cdsl     
where     
(dphmcd_curr_qty <> '0'                        
