-- Object: PROCEDURE citrus_usr.PR_MAK_ISIN_WITH_ADDR
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE PROCEDURE [citrus_usr].[PR_MAK_ISIN_WITH_ADDR](@pa_id           VARCHAR(8000)  
						   ...
						   , @pa_adr2         varchar(50)
						   , @pa_adr3         varchar(50)
						   , @pa_adrcity      varchar(50)
						   , @pa_adrstate     varchar(50)
						   , @pa_adrcountry   varchar(50)
						   , @pa_adrzip       varchar(50)
						   , @pa_contactperson varchar(100)
        ...
        BEGIN TRANSACTION
						  ...
						  UPDATE isin_mstr
								SET    isin_name        = @pa_isin_name   
									 ...
									 , isin_adr2        =  @pa_adr2
									 , isin_adr3        =  @pa_adr3
									 , isin_adrcity     =  @pa_adrcity
									 , isin_adrstate    =  @pa_adrstate
									 , isin_adrcountry  =  @pa_adrcountry
									 , isin_adrzip      =  @pa_adrzip
									 , isin_contactperson = @pa_contactperson
									 ,  isin_email     = @pa_email
									 , isin_TELE   = @pa_tele
									 , isin_FAX  = @pa_fax
						...
						--
						  ...
						  --
							...
							SET    isin_name              = isinm.isin_name         
                                        ...
                                        ,isin_adr1=isinm.isin_adr1
										,isin_adr2=isinm.isin_adr2
										,isin_adr3=isinm.isin_adr3
										,isin_adrcity=isinm.isin_adrcity
										,isin_adrstate=isinm.isin_adrstate
										,isin_adrcountry=isinm.isin_adrcountry
										,isin_adrzip=isinm.isin_adrzip
										,isin_contactperson=isinm.isin_contactperson
										,isin_email=isinm.isin_email
										,isin_TELE=isinm.isin_TELE
										,isin_FAX  =isinm.isin_FAX
