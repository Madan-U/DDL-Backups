-- Object: PROCEDURE citrus_usr.PR_select_login_TP_bak_20032017
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

create   Procedure [citrus_usr].[PR_select_login_TP_bak_20032017](@tab varchar(10),@logn_name  varchar(800))
as
