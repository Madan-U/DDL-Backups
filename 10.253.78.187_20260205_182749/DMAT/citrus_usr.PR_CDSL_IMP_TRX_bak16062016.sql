-- Object: PROCEDURE citrus_usr.PR_CDSL_IMP_TRX_bak16062016
...
create  PROCEDURE [citrus_usr].[PR_CDSL_IMP_TRX_bak16062016] (  
...
,'1',SLIIM_SERIES_TYPE,'U','HO',getdate(),'HO',getdate(),1 ,''
FROM #tmp_dptdc,TMP_DP_OFFM_DTLS_CDSL with (nolock), slip_issue_mstr_POA with (nolock),DP_ACCT_MSTR with (nolock),DP_POA_DTLS 
