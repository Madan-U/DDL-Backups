-- Object: PROCEDURE citrus_usr.pr_dp_select_mstr_Allegro250909
...
--exec pr_dp_select_mstr @pa_id='1|*~|3|*~|',@pa_action='VOUCHERREC_SEL',@pa_login_name='',@pa_cd='',@pa_desc='12/11/2008',@pa_rmks='203412',@pa_values='',@pa_roles='6*|~*',@pa_scr_id='217',@RowDelimiter='*|~*',@ColDelimiter='|*~|',@pa_ref_cur=''
 ...
 CREATE PROCEDURE  [citrus_usr].[pr_dp_select_mstr_Allegro250909]( @pa_id  VARCHAR(20)                  
...
WHERE setm.setm_deleted_ind   = 1                 
  ...
  --                
    select dpm_dpid                 DpId                
     ...
     ,SLIBM_TO_NO                
     ,slibm_book_type   
     ,convert(varchar(11),slibm_dt,103) slibm_dt
    FROM  slip_book_mstr                
         ,transaction_sub_type_mstr                
         ,dp_mstr                
    WHERE slibm_dpm_id = dpm_id                  
