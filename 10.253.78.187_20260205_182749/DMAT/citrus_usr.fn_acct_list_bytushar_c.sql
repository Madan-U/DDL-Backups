-- Object: FUNCTION citrus_usr.fn_acct_list_bytushar_c
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE Function [citrus_usr].[fn_acct_list_bytushar_c](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int,@PA_FROMACCID varchar(16),@PA_TOACCID varchar(16))   
...
and case when @l_entem_col_name = 'ENTR_HO' then  ENTR_HO    
             when @l_entem_col_name = 'ENTR_RE' then  ENTR_RE    
                 when @l_entem_col_name = 'ENTR_AR' then  ENTR_AR    
                 when @l_entem_col_name = 'ENTR_BR' then  ENTR_BR    
                 when @l_entem_col_name = 'ENTR_SB' then  ENTR_SB    
                 when @l_entem_col_name = 'ENTR_DL' then  ENTR_DL    
                 when @l_entem_col_name = 'ENTR_RM' then  ENTR_RM    
                 when @l_entem_col_name = 'ENTR_DUMMY1' then  ENTR_DUMMY1    
                 when @l_entem_col_name = 'ENTR_DUMMY2' then  ENTR_DUMMY2    
                 when @l_entem_col_name = 'ENTR_DUMMY3' then  ENTR_DUMMY3    
                 when @l_entem_col_name = 'ENTR_DUMMY4' then  ENTR_DUMMY4    
                 when @l_entem_col_name = 'ENTR_DUMMY5' then  ENTR_DUMMY5    
                 when @l_entem_col_name = 'ENTR_DUMMY6' then  ENTR_DUMMY6    
                 when @l_entem_col_name = 'ENTR_DUMMY7' then  ENTR_DUMMY7    
                 when @l_entem_col_name = 'ENTR_DUMMY8' then  ENTR_DUMMY8    
                 when @l_entem_col_name = 'ENTR_DUMMY9' then  ENTR_DUMMY9    
                 when @l_entem_col_name = 'ENTR_DUMMY10' then ENTR_DUMMY10     
            end  =    @pa_ent_id  
