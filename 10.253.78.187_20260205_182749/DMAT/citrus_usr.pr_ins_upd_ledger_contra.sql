-- Object: PROCEDURE citrus_usr.pr_ins_upd_ledger_contra
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

--pr_ins_upd_ledger_Contra	'0','INS','HO','2','4','01','0','7','10/07/2008','B|*~|1|*~|0|*~|540|*~|*|~*B|*~|1|*~|0|*~|540|*~|5|*~|vghf|*~|*|~*',1,'*|~*','|*~|',''	
--pr_ins_upd_ledger_Contra	'7|*~|10/07/2008|*~|4|*~|2|*~|01|*~|*|~*8|*~|10/07/2008|*~|4|*~|2|*~|01|*~|*|~*','APP','VISHAL','','0','0','0','','','0',1,'*|~*','|*~|',''	
--pr_ins_upd_ledger_Contra    '6|*~|10/07/2008|*~|4|*~|2|*~|01|*~|*|~*','REJ','VISHAL','','0','0','0','','','0',1,'*|~*','|*~|',''	

CREATE PROCEDURE [citrus_usr].[pr_ins_upd_ledger_contra](@pa_id              VARCHAR(8000)      
...
DECLARE @@l_acct_type    CHAR(1)    
	...
	BEGIN
		  ...
		  COMMIT TRANSACTION
				...
				SET @@l_amount    = convert(numeric(18,2),citrus_usr.fn_splitval(@@currstring_value,4))
				SET @@l_narration = citrus_usr.fn_splitval(@@currstring_value2,6)     
				...
				SET @@l_amount    = convert(numeric(18,2),citrus_usr.fn_splitval(@@currstring_value2,4)) * -1   
				SET @@l_cheque    = citrus_usr.fn_splitval(@@currstring_value2,5)       
