-- Object: PROCEDURE citrus_usr.pr_ins_upd_entr
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE  PROCEDURE [citrus_usr].[pr_ins_upd_entr](@pa_id             varchar(8000)  
 ...
 *********************************************************************************  
 system         : class  
 module name    : pr_ins_upd_entr  
 description    : this procedure will add new VALUES to  entity relations  
 copyright(c)   : enc software solutions pvt. ltd.  
 version history:  
 vers.  author          date         reason  
 -----  -------------   ----------   ----------------------------------------------  
 1.0    sukhi/tushar    13-jan-2007  initial version.  
 -----------------------------------------------------------------------------------  
 */  
 --  
...
--  
  ...
  --  
    CREATE  TABLE #t_entr  
    (entr_id          numeric(10)   
    ,entr_crn_no      numeric(10)  
    ,entr_acct_no     varchar(25)  
    ,entr_sba         varchar(25)  
    ,entr_ho          numeric(10)  
    ,entr_re          numeric(10)  
    ,entr_ar          numeric(10)  
    ...
    ,entr_dl          numeric(10)  
    ,entr_rm          numeric(10)  
    ,entr_dummy1      numeric(10)  
    ,entr_dummy2      numeric(10)  
    ,entr_dummy3      numeric(10)  
    ,entr_dummy4      numeric(10)  
    ,entr_dummy5      numeric(10)  
    ,entr_dummy6      numeric(10)  
    ,entr_dummy7      numeric(10)  
    ,entr_dummy8      numeric(10)  
    ,entr_dummy9      numeric(10)  
    ,entr_dummy10     numeric(10)
    ,entr_excpm_id    numeric(10,0)  
    ,entr_FROM_dt     datetime   
    ,entr_created_by  varchar(25)  
    ,entr_created_dt  datetime   
    ,entr_lst_upd_by  varchar(25)  
    ,entr_deleted_ind smallint  
    )  
    INSERT INTO #t_entr  
    ( entr_id           
    , entr_crn_no       
    ...
    SELECT entr_id             entr_id  
         , entr_crn_no         entr_crn_no  
         , entr_acct_no        entr_acct_no  
         , entr_sba            entr_sba  
         , entr_ho             entr_ho  
         , entr_re             entr_re  
         , entr_ar             entr_ar  
         ...
         , entr_dl             entr_dl  
         , entr_rm             entr_rm  
         , entr_dummy1         entr_dummy1  
         , entr_dummy2         entr_dummy2  
         , entr_dummy3         entr_dummy3  
         , entr_dummy4         entr_dummy4  
         , entr_dummy5         entr_dummy5  
         , entr_dummy6         entr_dummy6  
         , entr_dummy7         entr_dummy7  
         , entr_dummy8         entr_dummy8  
         , entr_dummy9         entr_dummy9  
         , entr_dummy10        entr_dummy10  
         , entr_FROM_dt        entr_FROM_dt  
         , entr_excpm_id       entr_excpm_id
         , entr_created_by     entr_created_by  
         , entr_created_dt     entr_created_dt  
         , entr_lst_upd_by     entr_lst_upd_by  
         , entr_deleted_ind    entr_deleted_ind  
   FROM    entity_relationship_mak   
   WHERE   entr_deleted_ind IN (0, 4, 8)  
   --AND     entr_created_by       <> @pa_login_name  
  --  
  END--temp_app  
  --    
      ...
      --  
        ...
        --**--  
          ...
          --  
            ...
            AND    PROM_CD         = right(@@l_subaccountno,2)  
...
BEGIN  
                      --  
                        SET @@t_errorstr = '#'+'Could NOT Be Inserted/Edited'+@ROWDELIMITER  
                        --  
                      ...
                      BEGIN  
                      --  
                        SET @@t_errorstr = 'Entity Relationship Ruccessfuly Inserted/Edited'+@ROWDELIMITER  
                        --  
                        COMMIT TRANSACTION  
                      --  
                      END  
 ...
 --  
   ...
   ,entr_acct_no  
                  ...
                  EXEC pr_ins_upd_list @pa_ent_id, @l_action,'ENTITY RELATIONSHIP', @pa_login_name, '*|~*', '|*~|', ''    
                --  
                END --null_1  
              --  
              END--@pa_chk_yn=1_2  
 ...
 --  
       ...
       --  
         ...
         BEGIN  
         --  
           --SET @@t_errorstr = CONVERT(VARCHAR(10), @l_error) = 'Could Not Be Inserted/Edited'+@ROWDELIMITER  
           --  
