-- Object: PROCEDURE citrus_usr.PR_IMPORT_CLIENT_CDSL_DPB9_bak_18102022
...
CREATE PROCEDURE  [citrus_usr].[PR_IMPORT_CLIENT_CDSL_DPB9_bak_18102022]
			(
			 @pa_exch          VARCHAR(20)    
...
update  f set fre_action ='U', fre_rmks = ''
--case when FreezeResCd ='1' then 'By BO'
--when FreezeResCd ='2' then ' ITO Attachement'
--when FreezeResCd ='3' then ' SEBI Directive'
--when FreezeResCd ='4' then ' Disinvestment / Pvt. Deal'
