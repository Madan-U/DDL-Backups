-- Object: PROCEDURE citrus_usr.pr_ins_upd_dppd_old14112008poaversion
...
create PROCEDURE [citrus_usr].[pr_ins_upd_dppd_old14112008poaversion](@pa_id                varchar(8000)  
                                ,@pa_crn_no            numeric  
                                ,@pa_action            char(3)  
  ...
  --  
    ...
    --  
      ...
      --  
            ...
            SET @l_id               = case when citrus_usr.fn_splitval(@currstring,14) = '' then 0 else citrus_usr.fn_splitval(@currstring,19) end
            SET @l_action_type      = citrus_usr.fn_splitval(@currstring,20)  
            SET @l_id               = CASE WHEN @l_action_type      ='D' THEN citrus_usr.fn_splitval(@currstring,19) ELSE @l_id END  
            --  
            --  
            IF @pa_chk_yn = 0  
            BEGIN  
      ...
      --  
            ...
            --  
              ...
              --  
				...
				AND    dppd_poa_id    IN( CONVERT(VARCHAR,@l_id),'')
				AND    dppd_deleted_ind =1 
              ...
              --  
              SET @l_dppd_id = CASE WHEN @l_action_type = 'D' THEN @L_ID ELSE @l_dppd_id END  
