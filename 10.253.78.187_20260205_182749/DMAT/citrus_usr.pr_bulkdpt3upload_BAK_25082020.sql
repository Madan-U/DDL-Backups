-- Object: PROCEDURE citrus_usr.pr_bulkdpt3upload_BAK_25082020
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------


CREATE  proc [citrus_usr].[pr_bulkdpt3upload_BAK_25082020](@pa_file_path varchar(200),@PA_LOGIN_NAME varchar(50),@pa_ref_cur varchar(8000) output)                      
as                      
begin                      
