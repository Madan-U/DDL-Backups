-- Object: FUNCTION citrus_usr.FN_UCCMAP_DETAILS_UCCDIS_bak_05042023
...
CREATE   FUNCTION [citrus_usr].[FN_UCCMAP_DETAILS_UCCDIS_bak_05042023] (@PA_BOID VARCHAR(16),@PA_MSN VARCHAR(18))
RETURNS VARCHAR(800)
AS
BEGIN
