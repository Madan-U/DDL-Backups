-- Object: PROCEDURE citrus_usr.pr_fill_and_upd_properties_obj_bak_05052015
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------


create  procedure [citrus_usr].[pr_fill_and_upd_properties_obj_bak_05052015]
(
...
--			and dpm_dpid = (select top 1 left(dpam_sba_no,8) from dp_acct_mstr)
	...
	begin
		...
		+isnull(convert(varchar,LEFT(dpam.dpam_sba_no,8)),'')+'|*~|'+isnull(dpam.dpam_sba_no,'')+'|*~|'
		+ISNULL(ltrim(rtrim('')),'')+'|*~|'+ DPPD_HLD  +'|*~|'
