-- Object: FUNCTION citrus_usr.fn_get_child_os
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

--select citrus_usr.[fn_get_child](1,'HO|*~|FRANCHISEE_AR|*~|RETAILKOLH_BA|*~|RKOLHPRAGA_ONW|*~|')  
--select * from entity_mstr order by  1 desc  
--select citrus_usr.[fn_get_child](0,'JMF HO_HO|*~|RG_RE|*~|')  
create function [citrus_usr].[fn_get_child_os](@pa_parent_id int ,@pa_values varchar(8000))    
returns int     
as    
BEGIN    
--    
