-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_acrh_bak_16032020
...
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_acrh_bak_16032020](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
SELECT CDSHM_DPAM_ID , CDSHM_ISIN , SUM(CDSHM_QTY) QTY into #locindata_cr
 FROM dmat_archival.citrus_usr.cdsl_holding_dtls with (nolock) WHERE 
