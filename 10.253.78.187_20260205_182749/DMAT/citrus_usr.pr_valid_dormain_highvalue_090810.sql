-- Object: PROCEDURE citrus_usr.pr_valid_dormain_highvalue_090810
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

---pr_valid_dormain_highvalue '4','DORMENT',640,'Formno'
Create procedure [citrus_usr].[pr_valid_dormain_highvalue_090810](@pa_id numeric,@pa_action varchar(100), @pa_dtls_id numeric,@pa_output varchar(8000) output)
as
begin
...
select @pa_output = citrus_usr.fn_get_high_val('',0,'DORMANT',@l_dpam_acct_no,convert(datetime,@l_req_dt,103))
