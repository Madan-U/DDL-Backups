-- Object: PROCEDURE citrus_usr.pr_ins_upd_dppd_mod
...
CREATE PROCEDURE [citrus_usr].[pr_ins_upd_dppd_mod](@pa_id                varchar(8000)  
                                ,@pa_crn_no            numeric  
                                ,@pa_action            char(3)  
      ...
      --  
            ...
            --  
              ...
              IF EXISTS(SELECT dppdm.dppd_dpam_id        dphd_id  
                        ...
                        and    dppdm.DPPD_HLD = @l_holder
                        and	   dppdm.dppd_master_id = @L_dppd_master_id
						and     dppdm.dppd_gpabpa_flg=@l_dppd_gpabpa_flg
                        )  
              BEGIN  
              --  
                --BEGIN TRANSACTION  
                --  
			select top 1 @l_int_dppd_id = DPPD_ID 
			from DP_POA_DTLS_MAK 
			...
			--print 'ppppp'
              ...
              ,CASE @l_action_type WHEN 'A' THEN 0  
                ...
                SELECT @pa_id = dpam_crn_no  FROM dp_acct_mstr WHERE dpam_crn_no = @pa_crn_no  
                --  
                EXEC pr_ins_upd_list @pa_id, 'I','dp poa dtls', 'MIG', '*|~*', '|*~|', '' 
