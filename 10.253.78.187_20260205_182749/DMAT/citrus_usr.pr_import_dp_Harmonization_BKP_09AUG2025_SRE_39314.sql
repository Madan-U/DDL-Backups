-- Object: PROCEDURE citrus_usr.pr_import_dp_Harmonization_BKP_09AUG2025_SRE_39314
...
CREATE  PROCeDURE [citrus_usr].[pr_import_dp_Harmonization_BKP_09AUG2025_SRE_39314]( @pa_crn_no      VARCHAR(8000)                  
                            , @pa_exch        VARCHAR(10)                  
...
select * ,  acct_no boidorder,'10' id  , (select top 1 Borequestdt from @line2 l2 where l2.acct_no = L9.acct_no  )  Borequestdt  into #tmp_line9 from @line9 L9
