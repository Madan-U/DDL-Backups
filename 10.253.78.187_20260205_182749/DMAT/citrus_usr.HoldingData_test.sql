-- Object: VIEW citrus_usr.HoldingData_test
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

 

 Create View HoldingData_test
...
SELECT HOLDINGDT AS HLD_HOLD_DATE,HLD_AC_CODE,'01' AS HLD_CAT,HLD_ISIN_CODE,'12' AS HLD_AC_TYPE ,PLEDGE_QTY,'' HLD_CCID,'' AS HLD_MARKET_TYPE,'' AS HLD_SETTLEMENT,
...
SELECT HOLDINGDT AS HLD_HOLD_DATE,HLD_AC_CODE,'01' AS HLD_CAT,HLD_ISIN_CODE,'61' AS HLD_AC_TYPE ,AVAIL_LEND_QTY,'' HLD_CCID,'' AS HLD_MARKET_TYPE,'' AS HLD_SETTLEMENT,
