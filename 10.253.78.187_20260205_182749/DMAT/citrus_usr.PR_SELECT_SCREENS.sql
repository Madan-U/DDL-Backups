-- Object: PROCEDURE citrus_usr.PR_SELECT_SCREENS
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE PROCEDURE [citrus_usr].[PR_SELECT_SCREENS](@pa_tab        VARCHAR(50)  
                                  ,@pa_scr_id     NUMERIC  
                                  ,@pa_rol_id     NUMERIC  
 ...
 --  
    ...
    --  
      ...
      SELECT '0' excsm_id,CONVERT(VARCHAR,0) +@coldelimiter + CONVERT(VARCHAR,scr.scr_id) +@coldelimiter + act.act_cd ScrValues  
      FROM   actions            act  
           , roles_actions           rola  
           , screens                 scr  
           , roles                   rol  
