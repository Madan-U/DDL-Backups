-- Object: PROCEDURE citrus_usr.pr_billing_main_cdsl
...
CREATE procedure [citrus_usr].[pr_billing_main_cdsl]
...
insert into billlog
select 'update CDSHM_CHARGE = 0 start', GETDATE () 
  ...
  insert into billlog
select 'update CDSHM_CHARGE = 0 end ', GETDATE () 
