-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_Class_arch
...
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_Class_arch](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
,convert(numeric(18,5),0) DPHMCD_LEND_QTY    
,convert(numeric(18,5),0) DPHMCD_BORROW_QTY    
from vw_holding_base_all a with (nolock) ,dp_acct_mstr  with (nolock) where dphmcd_holding_dt ='jul 31 2011'    
...
select dpam_sba_no ,h.* from #holdingall h ,dp_acct_mstr where DPHMCD_DPAM_ID=dPAM_ID 
