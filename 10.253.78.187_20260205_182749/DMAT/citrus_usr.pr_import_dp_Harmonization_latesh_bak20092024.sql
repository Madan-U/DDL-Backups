-- Object: PROCEDURE citrus_usr.pr_import_dp_Harmonization_latesh_bak20092024
...
create PROCeDURE [citrus_usr].[pr_import_dp_Harmonization_latesh_bak20092024]( @pa_crn_no      VARCHAR(8000)                  
                            , @pa_exch        VARCHAR(10)                  
...
--changed by tushar on jan 09 2015      
  ...
  --Select 'CntrlSctiesDpstryPtcpt' + ',' +'BrnchId' + ',' +'BtchId' + ',' +'SndrId' + ',' +'CntrlSctiesDpstryPtcptRole' + ',' +'SndrDt' + ',' +'RcvDt' + ',' +'RcrdNb' + ',' +'RcdSRNumber' + ',' +'BOTxnTyp' + ',' +'ClntId' + ',' +'PrdNb'
  --        + ',' +'BnfcrySubTp' + ',' +'Purpse' + ',' +'Titl' + ',' +'FrstNm' + ',' +'MddlNm' + ',' +'LastNm' + ',' +'FSfx' + ',' +'BnfcryShrtNm' + ',' +'ScndHldrNmOfFthr' + ',' +'BirthDt' + ',' +'Gndr' + ',' +'PAN' + ',' +'PANVrfyFlg' + ',' +'PANXmptnCd' + ',' +'UID' + ',' +'AdhrAuthntcnWthUID'
  --        + ',' +'RsnForNonUpdtdAdhr' + ',' +'VID' + ',' +'SMSFclty' + ',' +'PrmryISDCd' + ',' +'MobNb' + ',' +'FmlyFlgForMobNbOf' + ',' +'ScndryISDCd' + ',' +'PhneNb' + ',' +'EmailAdr' + ',' +'FmlyFlgForEmailAdr' + ',' +'AltrnEmailAdr' + ',' +'NoNmntnFlg' + ',' +'MdOfOpr'
  --        + ',' +'ClrMmbId' + ',' +'StgInstr' + ',' +'GrssAnlIncmRg' + ',' +'NetWrth' + ',' +'NetWrthAsOnDt' + ',' +'LEI' + ',' +'LEIExp' + ',' +'OneTmDclrtnFlgForGSECIDT' + ',' +'INIFSC' + ',' +'MICRCd' + ',' +'DvddCcy' + ',' +'DvddBkCcy' + ',' +'RBIApprvdDt' + ',' +'RBIRefNb'
  --        + ',' +'Mndt' + ',' +'SEBIRegNb' + ',' +'EdctnLvl' + ',' +'AnlRptFlg' + ',' +'BnfclOwnrSttlmCyclCd' + ',' +'ElctrncConf' + ',' +'EmailRTADwnldFlg' + ',' +'GeoCd' + ',' +'Xchg' + ',' +'MntlDsblty' + ',' +'Ntlty' + ',' +'CASMd' + ',' +'AncstrlFlg' + ',' +'PldgStgInstrFlg'
  --        + ',' +'BkAcctTp' + ',' +'BnfcryAcctCtgy' + ',' +'BnfcryBkAcctNb' + ',' +'BnfcryBkNm' + ',' +'BnfcryTaxDdctnSts' + ',' +'ClrSysId' + ',' +'BSDAFlg' + ',' +'Ocptn' + ',' +'PMSClntAcctFlg' + ',' +'PMSSEBIRegnNb' + ',' +'PostvConf'
  --        + ',' +'FrstClntOptnToRcvElctrncStmtFlg' + ',' +'ComToBeSentTo' + ',' +'DelFlg' + ',' +'RsnCdDeltn' + ',' +'DtOfDeath' + ',' +'AccntOpSrc' + ',' +'CustdPmsEmailId' + ',' +'POAOrDDPITp' + ',' +'TradgId' + ',' +'SndrRefNb1'
  --        + ',' +'SndrRefNb2' + ',' +'CtdnFlg' + ',' +'DmtrlstnGtwy' + ',' +'NmneeMnrInd' + ',' +'SrlNbr' + ',' +'NmneePctgOfShr' + ',' +'FlgForShrPctgEqlty' + ',' +'RsdlSecFlg' + ',' +'RltshWthBnfclOwnr' + ',' +'NbOfPOAMppng'
  --        + ',' +'POAId' + ',' +'POAToOprtAcct' + ',' +'POAOrDDPIId' + ',' +'SetUpDt' + ',' +'FrDt' + ',' +'ToDt' + ',' +'GPABPAFlg' + ',' +'POAMstrID' + ',' +'PoaLnkPurpCd' + ',' +'Rmk' + ',' +'BOUCCLkFlg' + ',' +'CnsntInd' + ',' +'UnqClntId' + ',' +'Brkr' + ',' +'Sgmt' + ',' +'MapUMapFlg'
  --        + ',' +'CmAcctToMap' + ',' +'PurpCd' + ',' +'AdrPrefFlg' + ',' +'Adr1' + ',' +'Adr2' + ',' +'Adr3' + ',' +'Adr4' + ',' +'Ctry' + ',' +'PstCd' + ',' +'CtrySubDvsnCd' + ',' +'CitySeqNb' + ',' +'FaxNb' + ',' +'ITCrcl' + ',' +'ProofOfRes' + ',' +'NbOfCoprcnrs' + ',' +'SgntryId' + ',' +'SgntrSz'
  --        + ',' +'BnfclOwnrAcctOfPMSFlg' + ',' +'CrspdngBPId' + ',' +'ClngMbrPAN' + ',' +'LclAddPrsnt' + ',' +'BnkAddPrsnt' + ',' +'NmnorGrdnAddPrsnt' + ',' +'MnrNmnGrdnAddPrsnt' + ',' +'FrgnOrCorrAddPrsnt' + ',' +'NbOfAuthSgnt'
  --        + ',' +'AuthFlg' + ',' +'CoprcnrOrMmbr' + ',' +'TypMod' + ',' +'SubTypMod' + ',' +'StsChgRsnOrClsrRsnCd' + ',' +'NmChgRsnCd' + ',' +'ExctDt' + ',' +'AddModDelInd' + ',' +'AppKrta' + ',' +'ChgKrtaRsn' + ',' +'DtIntmnBO' + ',' +'PrfDpstryFldFrCAS'
  --        + ',' +'CoprcnrsId' + ',' +'ClsrInitBy' + ',' +'RmngBal' + ',' +'CANm' + ',' +'CertNbr' + ',' +'CertXpryDt' + ',' +'NbrPOASgntryReqSign' + ',' +'DpstryInd' + ',' +'AcctTyp' + ',' +'SrcCMBPID' + ',' +'TrgtDPID' + ',' +'TrgtClntID' + ',' +'SrlFlg' + ',' +'UPIId' + ',' +'SignTyp'
  --        + ',' +'Dummy1' + ',' +'Dummy2' + ',' +'Dummy3' + ',' +'Dummy4' detailshr
----------		 union all
----------SELECT purpose_code ,SUBSTRING(DPM_DPID,4,5),'',@PA_LOGINNAME,'',CONVERT(VARCHAR(23), GETDATE(), 126)  ,CONVERT(VARCHAR(23), GETDATE(), 126) ,'1','1','BOSET','',left(dpam_subcm_cd,2)
----------,right(dpam_subcm_cd,2),case when purpose_code='212' then 'FH' when purpose_code='206' then 'NM' else '' end ,l2.bo_title,l2.bo_name,bo_middle_name,l2.cust_search_name,'', '','' -- shortname
----------,cust_dob,sex_cd,hldr_pan,case when isnull(hldr_pan,'')='' then 'N' else 'Y' end,'',HLDR_UID,'' -- 2 line completed
----------,'','','',Pri_mob_ISD,l2.cust_ph1,'',Sec_mob_ISD,l2.cust_ph2,l2.cust_email,'','','','' --3  line completed
----------,'','',ann_income_cd,'','','','','',benf_bank_code,benf_brnch_numb,benf_bank_ccy,benf_bank_acno,rbi_app_dt,rbi_ref_no -- 4 line c
----------,ecs,sebi_reg_no,edu,ANNUAL_REPORT,bo_settm_plan_fg,elec_confirm,EMAIL_RTA,geographical_cd,stoc_exch,MENTAL_DISABILITY,nat_cd,CAS_MODE,'',PLEDGE_STANDING -- 5 line c
----------,divnd_brnch_numb,bo_catg,benf_bank_acno,'',benef_tax_ded_sta,clr_member_id,BSDA_FLAG,occp,'','','' --6 line c
----------,EMAIL_STATEMENT_FLAG,'','','','','','','','','' --7 line
----------,'','','','',nom_serial_no,sharepercent,'',res_sec_flag,rel_withbo,'' -- 8 line c

----------,poa_id,poa_to_opr_ac,poa_id,setup_date,eff_frm_dt,eff_to_dt,gpa_bpa_fl,poa_id,'' PoaLnkPurpCd,'' Rmk,'' BOUCCLkFlg,'' CnsntInd,'' UnqClntId,'' Brkr,'' Sgmt,'' MapUMapFlg -- 9 line c
----------,'' CmAcctToMap,Purpose_code ,'' AdrPrefFlg,l2.cust_addr1,l2.cust_addr2 ,l2.cust_addr3 ,l2.cust_addr_city ,l2.cust_addr_cntry ,l2.cust_addr_zip ,'' CtrySubDvsnCd,city_seq_no,l2.cust_fax 
----------,l2.it_crl,'' ProofOfRes,'' NbOfCoprcnrs,'' SgntryId,'' SgntrSz -- 10 line c
----------,'' BnfclOwnrAcctOfPMSFlg,'' CrspdngBPId,'' ClngMbrPAN,'' LclAddPrsnt,''  BnkAddPrsnt,''  NmnorGrdnAddPrsnt,'' MnrNmnGrdnAddPrsnt,'' FrgnOrCorrAddPrsnt,''  NbOfAuthSgnt -- 11 line c
----------,'' AuthFlg,'' CoprcnrOrMmbr,'' TypMod,'' SubTypMod,'' StsChgRsnOrClsrRsnCd,'' NmChgRsnCd,''  ExctDt,''  AddModDelInd,''  AppKrta,'' ChgKrtaRsn,'' DtIntmnBO,'' PrfDpstryFldFrCAS
----------,'' CoprcnrsId,'' ClsrInitBy,'' RmngBal,'' CANm,'' CertNbr,'' CertXpryDt,'' NbrPOASgntryReqSign,'' DpstryInd,'' AcctTyp,'' SrcCMBPID,''  TrgtDPID,'' TrgtClntID,'' SrlFlg,'' UPIId,'' SignTyp
----------,'' Dummy1,'' Dummy2,'' Dummy3,'' Dummy4

------------FROM @LINE2 L2 left outer join @line5 L5 on ,DP_ACCT_MSTR M,DP_MSTR WHERE M.DPAM_ID=L2.DPAM_ID AND DPAM_DELETED_IND=1
------------AND DEFAULT_DP=DPM_EXCSM_ID AND DPM_ID=DPAM_DPM_ID
...
----------             left outer join   
----------             @line4 l4       on                  l2.acct_no = l4.acct_no       
----------             ,DP_ACCT_MSTR M,DP_MSTR
----------      where  NOT EXISTS (select CDSL_ACCT_ID FROM cdsl_dpm_response where CDSL_ACCT_ID = isnull(l2.acct_no,'0'))                
----------	  and M.DPAM_ID=L2.DPAM_ID AND DPAM_DELETED_IND=1
----------      AND DEFAULT_DP=DPM_EXCSM_ID AND DPM_ID=DPAM_DPM_ID
   --   order by l2.acct_no asc
	  ----, line_sixth_detail asc
	  --, l7.purpose_code desc,l7.nom_serial_no asc 
...
SELECT distinct purpose_code  + ',' + SUBSTRING(DPM_DPID,4,5) + ',' + '' + ',' + 'ali' + ',' + '' + ',' + CONVERT(VARCHAR(23), GETDATE(), 126)   + ',' + CONVERT(VARCHAR(23), GETDATE(), 126)  + ',' + '1' + ',' + '1' + ',' + 'BOSET' + ',' + '' + ',' + left(dpam_subcm_cd,2)
 ...
 + ',' + divnd_brnch_numb + ',' + bo_catg + ',' + benf_bank_acno + ',' + '' + ',' + benef_tax_ded_sta + ',' + clr_member_id + ',' + BSDA_FLAG + ',' + occp + ',' + '' + ',' + '' + ',' + '' --6 line c
 + ',' + EMAIL_STATEMENT_FLAG + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' + ''
 + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' + nom_serial_no + ',' + sharepercent + ',' + '' + ',' + res_sec_flag + ',' + rel_withbo + ',' + ''
 + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' + '' + ',' +  '''PoaLnkPurpCd''' + ',' +  '''Rmk''' + ',' +  '''BOUCCLkFlg''' + ',' +  '''CnsntInd''' + ',' +  '''UnqClntId''' + ',' + ''' Brkr''' + ',' +  '''Sgmt''' + ',' +  '''MapUMapFlg''' 
 + ',' +  '''CmAcctToMap''' + ',' + Purpose_code  + ',' +  '''AdrPrefFlg''' + ',' + l2.cust_addr1 + ',' + l2.cust_addr2  + ',' + l2.cust_addr3  + ',' + l2.cust_addr_city  + ',' + l2.cust_addr_cntry  + ',' + l2.cust_addr_zip  + ',' +  '''CtrySubDvsnCd''' + ',' + city_seq_no + ',' + l2.cust_fax 
 + ',' + l2.it_crl + ',' +  '''ProofOfRes''' + ',' +  '''NbOfCoprcnrs''' + ',' +  '''SgntryId''' + ',' +  '''SgntrSz''' -- 10 line c
 + ',' +  '''BnfclOwnrAcctOfPMSFlg''' + ',' +  '''CrspdngBPId''' + ',' +  '''ClngMbrPAN''' + ',' +  '''LclAddPrsnt''' + ',' +   '''BnkAddPrsnt''' + ',' +   '''NmnorGrdnAddPrsnt''' + ',' +  '''MnrNmnGrdnAddPrsnt''' + ',' +  '''FrgnOrCorrAddPrsnt''' + ',' +   '''NbOfAuthSgnt''' -- 11 line c
 + ',' +  '''AuthFlg''' + ',' +  '''CoprcnrOrMmbr''' + ',' +  '''TypMod''' + ',' +  '''SubTypMod''' + ',' +  '''StsChgRsnOrClsrRsnCd''' + ',' +  '''NmChgRsnCd''' + ',' +   '''ExctDt''' + ',' +   '''AddModDelInd''' + ',' +   '''AppKrta''' + ',' +  '''ChgKrtaRsn''' + ',' +  '''DtIntmnBO''' + ',' +  '''PrfDpstryFldFrCAS'''
