-- Object: PROCEDURE citrus_usr.pr_select_trxgen_cdsl_SP_BAK_06082019
...
--rollback
CREATE  PROCEDURE [citrus_usr].[pr_select_trxgen_cdsl_SP_BAK_06082019]  
(  
...
--																																																											END  
	...
	+ convert(char(8),isnull(replace(convert(varchar(11),DPTDC_DOI,103),'/','')  ,''))
