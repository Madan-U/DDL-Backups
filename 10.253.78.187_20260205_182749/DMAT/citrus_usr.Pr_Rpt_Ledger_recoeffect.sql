-- Object: PROCEDURE citrus_usr.Pr_Rpt_Ledger_recoeffect
...
CREATE Proc [citrus_usr].[Pr_Rpt_Ledger_recoeffect]        
@pa_dpmid int,        
@pa_finyearid int,        
...
(        
 ...
 set @@ssql = @@ssql + ' and LDG_BANK_CL_DATE <> ''1900-01-01 00:00:00.000''           '
...
and LDG_BANK_CL_DATE <> ''1900-01-01 00:00:00.000''
