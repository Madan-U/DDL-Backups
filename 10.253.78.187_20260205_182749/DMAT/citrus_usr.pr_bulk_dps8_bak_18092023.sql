-- Object: PROCEDURE citrus_usr.pr_bulk_dps8_bak_18092023
...
CREATE  proc [citrus_usr].[pr_bulk_dps8_bak_18092023](@pa_dbpath varchar(8000))  
as  
begin   
...
--if exists (select 1 from dps8_pc5 ,  dpb9_source1 where  left(value ,2) = '05'  and boid = citrus_usr.fn_splitval_by(value,	12	,'~'))
--begin 
