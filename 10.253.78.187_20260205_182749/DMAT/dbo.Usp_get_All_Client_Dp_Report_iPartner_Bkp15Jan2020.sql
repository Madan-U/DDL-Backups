-- Object: PROCEDURE dbo.Usp_get_All_Client_Dp_Report_iPartner_Bkp15Jan2020
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CREATE PROCEDURE [dbo].[Usp_get_All_Client_Dp_Report_iPartner_Bkp15Jan2020]
(
...
SELECT CL_CODE INTO #CLT FROM [196.1.115.132].RISK.dbo.Client_Details WHERE Sub_Broker = @Sub_Broker
...
SELECT 
	...
	,Nominee 
FROM #CLT c
	INNER JOIN Citrus_usr.NXT_DP_CLIENT_INFO ci ON c.cl_code = ci.CLIENT_ID
 
	--and (CLIENT_ID = @CLIENT_ID or @CLIENT_ID = '-1') ***/
