-- Object: PROCEDURE citrus_usr.pr_billing_main_nsdl_quant
...
--rollback
CREATE procedure [citrus_usr].[pr_billing_main_nsdl_quant]    
...
--    
  ...
  --    
    ...
    --     
	  ...
	  and clic_dpam_id	not in(select dpam_id from #account_properties_cl)
  ...
  -- CHARGES FOR DP    
    ...
    --    
      ...
      --    
		...
		set @l_sql          = @l_sql         + ' and    ldg_account_id not in(select dpam_id from #account_properties_cl)'     
