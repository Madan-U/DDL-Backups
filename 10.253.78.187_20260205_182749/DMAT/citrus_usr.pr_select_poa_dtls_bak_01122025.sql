-- Object: PROCEDURE citrus_usr.pr_select_poa_dtls_bak_01122025
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------


CREATE procedure [citrus_usr].[pr_select_poa_dtls_bak_01122025]
(
...
--END 
	...
	, citrus_usr.FN_POATYPE(BOID,DPAM_SBA_NO)  dppd_poa_type     
