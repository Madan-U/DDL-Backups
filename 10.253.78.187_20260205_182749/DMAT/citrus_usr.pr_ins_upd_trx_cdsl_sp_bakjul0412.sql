-- Object: PROCEDURE citrus_usr.pr_ins_upd_trx_cdsl_sp_bakjul0412
...
create PROCEDURE [citrus_usr].[pr_ins_upd_trx_cdsl_sp_bakjul0412](@pa_id              VARCHAR(8000)    
													 ,@pa_tab             VARCHAR(20)  
       ...
       , @pa_trdReasoncd               
            ...
            --  
              ...
              --  
                ...
                BEGIN  
                --  
                  delete used from dptdc_mak,dp_acct_mstr,used_slip used where dpam_id = dptdc_dpam_id and uses_dpam_acct_no = dpam_sba_no and dptdc_dtls_id = convert(numeric,@currstring)                    
...
print 'lateshkk'
            ...
            --  
              ...
              BEGIN TRANSACTION  
                ...
                delete used from dptdc_mak,dp_acct_mstr,used_slip used where dpam_id = dptdc_dpam_id and uses_dpam_acct_no = dpam_sba_no and dptdc_id          = convert(numeric,@c_dptd_id)   
...
print 'shilpa'
print ltrim(rtrim(@pa_slip_no))
update dptdc_mak set dptdc_deleted_ind = -1 where  dptdc_slip_no in(select dptdc_slip_no from dptdc_mak where dptdc_slip_no= ltrim(rtrim(@pa_slip_no)) and dptdc_deleted_ind = -1)
