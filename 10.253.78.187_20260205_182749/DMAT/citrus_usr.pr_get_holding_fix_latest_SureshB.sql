-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_SureshB
...
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_SureshB](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
select dphmcd_holding_dt,dpam_sba_no,sum(DPHMCD_FREE_QTY*CLOPM_CDSL_RT) valuation  from #holdingall,dp_acct_mstr 
where dphmcd_dpam_id = dpam_id 
group by dphmcd_holding_dt,dpam_sba_no 
