-- Object: FUNCTION citrus_usr.fn_cdsl_export_line_7_extract_newversion_Dec1616
...
CREATE function [citrus_usr].[fn_cdsl_export_line_7_extract_newversion_Dec1616](@pa_crn_no      VARCHAR(8000)  
...
RETURNS @l_table  TABLE (ln_no                   char(2)                  
                        ...
                        ,usr_fld4                char(4)                      
                        ,usr_fld5                numeric       
						,nom_serial_no numeric
,rel_withbo    numeric
,sharepercent numeric(15,2)
,res_sec_flag char(1)            
                        )                                        
AS  
BEGIN  
...
--          ,0000--''--usr_fld4 
          ...
          ,0000--''--usr_fld5       
		  ,'01'
		  , isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'1ST_NRELATN_BO',''),'')
		  , isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'1ST_NPER_SHR',''),'')
		  , isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'1ST_NRED_SEC_FLG','') ,'')                   
    FROM   dp_acct_mstr              dpam                  
         , dp_holder_dtls            dphd                   
         , client_mstr               clim                  
         , entity_type_mstr          enttm                  
