-- Object: PROCEDURE citrus_usr.pr_bulk_dpm345_converter
...
set uploadfilename =  replace(citrus_usr.fn_splitval_by(@PA_DB_SOURCE,citrus_usr.ufn_countstring(@PA_DB_SOURCE,'\')+1,'\') ,'*|~*','<BR>')  
WHERE  task_id = @pa_task_id
