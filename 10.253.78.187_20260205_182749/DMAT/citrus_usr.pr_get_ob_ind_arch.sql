-- Object: PROCEDURE citrus_usr.pr_get_ob_ind_arch
...
CREATE proc [citrus_usr].[pr_get_ob_ind_arch](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime              
...
and dphmcd_holding_dt = 'mar 31 2011'           
,#tempdata_cdsl b          
