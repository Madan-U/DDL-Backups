-- Object: PROCEDURE citrus_usr.Delete_Suresh_pr_ins_upd_reqdtls_220113
...
CREATE proc [citrus_usr].[Delete_Suresh_pr_ins_upd_reqdtls_220113](
  @pa_id numeric  
      ...
      END 
        ...
        begin  
          insert into Dis_req_Dtls_mak  
		   ...
		   , @pa_login_name   
		   , 0  
		   , @pa_rmks,@pa_imagepath,@pa_chk_rmks,@pa_slip_yn, @pa_imagepath1,@pa_imagepath2
    ...
    begin  
      ...
      BEGIN  
       ...
       select id,req_slip_no,req_date,Boid,Boname,sholder,tholder,created_dt,created_by,lst_upd_dt,lst_upd_by,deleted_ind,
				remarks,imagepath,chk_remarks,slip_yn,isnull(imagepath1,'') imagepath1,isnull(imagepath2,'') imagepath2,case when slip_yn = 'D' then 'DRF' else 'DIS' end  slip_type 
	   from Dis_req_Dtls_MAK  
...
,imagepath2
    ...
    begin  
      select dpam_sba_name fhname, DPHD_SH_FNAME + ' ' + DPHD_SH_MNAME + ' ' + DPHD_SH_LNAME  shname, DPHD_TH_FNAME + ' ' + DPHD_TH_MNAME + ' ' + DPHD_TH_LNAME thname  
