-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_mODIFIED
...
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_mODIFIED](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
WHERE CDSHM_TRATM_cD  in ( '2262','2261') --=case whenCDSHM_BEN_ACCT_NO between @pa_ben_acct_no_fr and @pa_ben_acct_no_to  CDSHM_CDAS_TRAS_TYPE IN ('21','22','23') then '2262' else '2277' end --2261 added by tushar on jun 03 2014
and CDSHM_TRAS_DT between  @l_min_trx_dt and @pa_to_dt
and CDSHM_BEN_ACCT_NO between @pa_ben_acct_no_fr and @pa_ben_acct_no_to 
--AND CDSHM_CDAS_TRAS_TYPE IN ('21','22','23','12')--12 added by tushar on jun 03 2014
and CDSHM_CDAS_TRAS_TYPE IN ('12','20','21','22','23','14'
