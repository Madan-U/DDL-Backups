-- Object: PROCEDURE citrus_usr.temp_test
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE procedure  [citrus_usr].[temp_test](@pa_string VARCHAR(8000),@pa_fix_len VARCHAR(50),@pa_modified VARCHAR(8000),@l_idd int = 1)      
AS      
BEGIN      
  if @pa_modified = ''
