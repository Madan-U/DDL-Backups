-- Object: PROCEDURE citrus_usr.PR_SELECT_TRXGEN_CDSL_SP_XML_mosl
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------



CREATE PROCEDURE [citrus_usr].[PR_SELECT_TRXGEN_CDSL_SP_XML_mosl]  
(  
...
create table #tempdata(cd varchar(100),details varchar(8000),qty numeric(19,3),TRXEFLG char(1) ,dptdc_slip_no varchar(16) , dptdc_created_by varchar(20) , dptdc_lst_upd_by varchar(20),verifier varchar(20))
...
--@COLDELIMITER ,
--@PA_OUTPUT   
insert into #tempdata (details,qty,TRXEFLG ,dptdc_slip_no , dptdc_created_by , dptdc_lst_upd_by,verifier )
exec PR_SELECT_TRXGEN_CDSL_SP_MOSL @l_TRX_TAB  ,  
@PA_FROM_DT ,  
@PA_TO_DT ,  
@PA_BATCH_NO ,  
@PA_BATCH_TYPE ,  
...
+'<Mkropid>'+ dptdc_created_by +'</Mkropid>'
