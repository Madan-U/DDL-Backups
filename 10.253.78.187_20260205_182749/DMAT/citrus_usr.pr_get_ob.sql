-- Object: PROCEDURE citrus_usr.pr_get_ob
...
CREATE proc [citrus_usr].[pr_get_ob](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                  
...
from cdsl_holding_dtls   a left outer join vw_holding_base_all                   
