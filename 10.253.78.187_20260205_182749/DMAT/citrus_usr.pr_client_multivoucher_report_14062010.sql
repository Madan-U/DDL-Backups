-- Object: PROCEDURE citrus_usr.pr_client_multivoucher_report_14062010
...
create proc [citrus_usr].[pr_client_multivoucher_report_14062010](@pa_id numeric  
   ...
   declare	@l_counter numeric  
	...
	print @l_sql1				  
							...
							set @l_sql2 = ' ,CASE WHEN LDG_VOUCHER_TYPE = 1 THEN ''Payment'' 
											 ...
											 END AS TYPE
								from dp_acct_mstr dpam,ledger3 ldg --, fin_account_mstr fina
