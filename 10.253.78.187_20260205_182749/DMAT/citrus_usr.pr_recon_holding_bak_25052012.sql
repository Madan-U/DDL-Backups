-- Object: PROCEDURE citrus_usr.pr_recon_holding_bak_25052012
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

--exec pr_recon_holding 3,'may 24 2012','ALL'
--exec pr_recon_holding 3,'may 24 2012','MATCH'
--exec pr_recon_holding 3,'may 24 2012','MISMATCH'
create  proc [citrus_usr].[pr_recon_holding_bak_25052012](@pa_dpm_id numeric
, @pa_date datetime
, @pa_flag char(15)
)
as
...
into #priviousholding_1 from DP_HLDG_MSTR_CDSL,dp_acct_mstr 
...
select DISTINCT dpam_sba_no client_hldg_ason,DPHMC_ISIN isin_hldg_ason,DPHMC_CURR_QTY qty_hldg_ason 
