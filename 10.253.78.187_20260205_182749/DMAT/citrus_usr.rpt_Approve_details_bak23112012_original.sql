-- Object: PROCEDURE citrus_usr.rpt_Approve_details_bak23112012_original
...
CREATE procedure [citrus_usr].[rpt_Approve_details_bak23112012_original]
(@pa_id  varchar(10),
 @pa_type varchar(4),
 @pa_tab varchar(20),
 @pa_from_dt datetime,
...
--					,''
                    ...
                    , isnull('' ,'') mkt_type , isnull('' ,'') other_mkt_type , isnull('','') [settlementno] , isnull('','') [othersettmno], isnull('','') [cmbp], isnull('','') counter_account ,'' counter_dpid
					--,''
					,case when ISNULL(d.DEMRM_TRANSACTION_NO,'') <> '' then 'RESPONSE FILE IMPORTED'  when ISNULL(d.DEMRM_BATCH_NO,'') <> '' then 'BATCH GENERATED' when d.demrm_deleted_ind = 1 then 'CHECKER DONE' ELSE '' END AS [STATUS1]
