-- Object: PROCEDURE citrus_usr.pr_checkslipno_BAK_06012015
...
CREATE  procedure [citrus_usr].[pr_checkslipno_BAK_06012015]          
(          
...
print @pa_errmsg  
   ...
   IF exists(select 1 from Sebioldslipdata where SLIIM_SERIES_TYPE = @@series  and @@sr_no between SLIIM_SLIP_NO_FR and SLIIM_SLIP_NO_TO)
begin 
