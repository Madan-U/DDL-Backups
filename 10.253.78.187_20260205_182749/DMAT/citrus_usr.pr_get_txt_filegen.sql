-- Object: PROCEDURE citrus_usr.pr_get_txt_filegen
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

--PR_GET_TXT_FILEGEN 'summary','12033200','1203320008431140','1203320008431140','jUL  1 2017','JUL 31 2017'
CREATE proc [citrus_usr].[pr_get_txt_filegen](@pa_action varchar(100),@pa_dpid varchar(100)    
,@pa_boid varchar(100)    
,@pa_isin varchar(100)    
...
WHEN  ISNULL(CLIC_CHARGE_NAME,'')='IGST @18%' THEN 'TRANSACTION CHARGES'
   ...
   ,#ACCOUNT_PROPERTIES_ECN  with(nolock)  ,dp_acct_mstr  
