-- Object: FUNCTION citrus_usr.fn_conc_value_DPAM_ID
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE function [citrus_usr].[fn_conc_value_DPAM_ID](@pa_crn_no   numeric        
                             ,@pa_cd       varchar(25)        
                             )        
...
SELECT @pa_crn_no = DPAM_CRN_NO  FROM DP_aCCT_MSTR WHERE DPAM_ID= @pa_crn_no  
AND DPAM_DELETED_IND = 1   
  ...
  --        
    ...
    IF @PA_CD IN ('OFF_PH1','OFF_PH2','OFF_PH3','OFF_PH4','FAX1','EMAIL1','FAX2','MOBILE1','EMAIL2')        
    BEGIN        
    --        
