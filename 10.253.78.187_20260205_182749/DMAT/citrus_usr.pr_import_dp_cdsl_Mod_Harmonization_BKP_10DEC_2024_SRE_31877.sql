-- Object: PROCEDURE citrus_usr.pr_import_dp_cdsl_Mod_Harmonization_BKP_10DEC_2024_SRE_31877
...
CREATE  PROCeDURE [citrus_usr].[pr_import_dp_cdsl_Mod_Harmonization_BKP_10DEC_2024_SRE_31877]( @pa_crn_no      varchar(8000)                 
                            , @pa_exch        VARCHAR(10)                  
...
--select * from #tmp_line7_gr_remove
