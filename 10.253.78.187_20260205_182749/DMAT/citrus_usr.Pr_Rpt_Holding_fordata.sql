-- Object: PROCEDURE citrus_usr.Pr_Rpt_Holding_fordata
...
CREATE  PROC [citrus_usr].[Pr_Rpt_Holding_fordata]  
			@PA_DPTYPE VARCHAR(4),                    
			@PA_EXCSMID INT,                    
			@PA_ASONDATE CHAR(1),                    
			@PA_FORDATE DATETIME,                    
...
,case when CONVERT(NUMERIC(18,3),sum(DPHMCD_EARMARK_QTY))<>'0' then 
						...
						then CONVERT(NUMERIC(18,3),sum(DPHMCD_SAFE_KEEPING_QTY)) + CONVERT(NUMERIC(18,3),sum(DPHMCD_LOCKIN_QTY)) 
						else CONVERT(NUMERIC(18,3),sum(DPHMCD_LOCKIN_QTY)) end end DPHMCD_EARMARK_SAFE_KEEPING_QTY
						
,isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_ELIMINATION_QTY)),0) DPHMCD_ELIMINATION_QTY
,isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_EARMARK_QTY)),0) DPHMCD_EARMARK_QTY11
...
--,isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_LOCKIN_QTY)),0)      
,case when CONVERT(NUMERIC(18,3),sum(DPHMCD_SAFE_KEEPING_QTY)) <> '0' then CONVERT(NUMERIC(18,3),sum(DPHMCD_SAFE_KEEPING_QTY)) + CONVERT(NUMERIC(18,3),sum(DPHMCD_LOCKIN_QTY)) else CONVERT(NUMERIC(18,3),sum(DPHMCD_LOCKIN_QTY)) end
		 ,isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_ELIMINATION_QTY)),0),isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_EARMARK_QTY)),0) DPHMCD_EARMARK_QTY22,isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_AVAIL_LEND_QTY)),0),isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_LEND_QTY)),0),isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_BORROW_QTY)),0),DPAM_ID, HOLDING_DT=CONVERT(VARCHAR(11),@PA_FORDATE,109),CMP=ISNULL(convert(numeric(18,3),CLOPM_CDSL_RT),0.000)  
		 ,CLOPM_DT ratedate
  ,tradingid
...
,case when CONVERT(NUMERIC(18,3),sum(DPHMCD_SAFE_KEEPING_QTY)) <> '0' then CONVERT(NUMERIC(18,3),sum(DPHMCD_SAFE_KEEPING_QTY)) + CONVERT(NUMERIC(18,3),sum(DPHMCD_LOCKIN_QTY)) else CONVERT(NUMERIC(18,3),sum(DPHMCD_LOCKIN_QTY)) end
		 ,isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_ELIMINATION_QTY)),0),isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_EARMARK_QTY)),0) DPHMCD_EARMARK_QTY33,isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_AVAIL_LEND_QTY)),0),isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_LEND_QTY)),0),isnull(CONVERT(NUMERIC(18,3),sum(DPHMCD_BORROW_QTY)),0),DPAM_ID, HOLDING_DT=CONVERT(VARCHAR(11),@PA_FORDATE,109),CMP=ISNULL(convert(numeric(18,3),CLOPM_CDSL_RT),0.000)    
		 ,CLOPM_DT ratedate
