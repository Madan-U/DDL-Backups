-- Object: PROCEDURE citrus_usr.pr_get_ob_fix
...
CREATE proc [citrus_usr].[pr_get_ob_fix](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                                  
...
and cdshm_tratm_cd in ('2246','2277','2201','3102','2270','2220','2205','2262','2280','2215','4466')   -- 2262 added by tushar on  08112912 for lock in transaction             
