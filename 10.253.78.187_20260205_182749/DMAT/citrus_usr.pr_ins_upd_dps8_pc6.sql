-- Object: PROCEDURE citrus_usr.pr_ins_upd_dps8_pc6
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

create  proc [citrus_usr].[pr_ins_upd_dps8_pc6]
as
begin 

update s8 
set s8.PurposeCode6=b9.PurposeCode6
...
,	Filler14
,	Filler15
from dpb9_pc6 b9 where not exists (select 1 from dps8_pc6 s8 
where s8.boid = b9.boid 
and s8.NOM_Sr_No = b9.NOM_Sr_No) 
