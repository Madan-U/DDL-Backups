-- Object: PROCEDURE citrus_usr.pr_ins_upd_accd_bak23122011
...
--
--begin tran
--EXEC pr_ins_upd_accd '26*|~*','APP','HO', 12,'','','0',1,'*|~*','|*~|','' 
--SELECT * FROM account_documents WHERE accd_clisba_id = 13
--rollback 
--pr_ins_upd_accd '','INS','HO','13','567','D','12|*~|1|*~||*~|../CCRSDocuments/13_567_12isin0510|*~|*|~*11|*~|1|*~||*~|../CCRSDocuments/13_567_11pujari.txt|*~|*|~*',2,'*|~*','|*~|',''	
create     PROCEDURE [citrus_usr].[pr_ins_upd_accd_bak23122011](@pa_id                varchar(8000)
