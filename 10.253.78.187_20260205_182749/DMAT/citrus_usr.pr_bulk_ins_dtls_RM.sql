-- Object: PROCEDURE citrus_usr.pr_bulk_ins_dtls_RM
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

--begin tran
--pr_bulk_ins_dtls_RM
--select * from entity_mstr --select 1561+69 --1630
...
CREATE PROC [citrus_usr].[pr_bulk_ins_dtls_RM]
AS
BEGIN
--
