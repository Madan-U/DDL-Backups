-- Object: TABLE dbo.tmp_branch_master
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE TABLE [dbo].[tmp_branch_master]
(
    [Branch] NVARCHAR(255) NULL,
    [Code Branch Name] NVARCHAR(255) NULL,
    ...
    [Dial Up      IP Address      Server] NVARCHAR(255) NULL,
    [Database] NVARCHAR(255) NULL,
    [DBO] NVARCHAR(255) NULL,
