-- Object: FUNCTION citrus_usr.fn_acct_list_bytushar_bybbo
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE Function [citrus_usr].[fn_acct_list_bytushar_bybbo](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int  
...
--        
  --set  @PA_FROMACCID = '0'   
  --set @PA_TOACCID = '9999999999999999'
