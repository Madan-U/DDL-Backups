-- Object: PROCEDURE citrus_usr.Pr_Rpt_ProvisionalHolding_bak06032012
...
create Proc [citrus_usr].[Pr_Rpt_ProvisionalHolding_bak06032012]
@pa_dptype varchar(4),                  
@pa_excsmid int,                  
@pa_asondate char(1),                  
@pa_fordate datetime,                  
...
begin                  
	...
	begin               
			...
			select top 1 @pa_fordate = DPDHM_HOLDING_DT from DP_HLDG_MSTR_NSDL where dpdhm_deleted_ind =1    and DPDHM_DPM_ID = @@dpmid
	...
	begin
			...
			select top 1 @pa_fordate = DPHMC_HOLDING_DT from DP_HLDG_MSTR_CDSL where dphmc_deleted_ind =1  and DPHMC_DPM_ID = @@dpmid
			...
			select DPHMC_dpam_id,DPHMC_ISIN,convert(numeric(18,3),DPHMC_CURR_QTY),convert(numeric(18,3),DPHMC_FREE_QTY),convert(numeric(18,3),DPHMC_FREEZE_QTY),convert(numeric(18,3),DPHMC_PLEDGE_QTY),convert(numeric(18,3),DPHMC_DEMAT_PND_VER_QTY)    
