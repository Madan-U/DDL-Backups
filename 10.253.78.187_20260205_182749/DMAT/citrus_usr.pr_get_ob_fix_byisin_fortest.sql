-- Object: PROCEDURE citrus_usr.pr_get_ob_fix_byisin_fortest
...
CREATE proc [citrus_usr].[pr_get_ob_fix_byisin_fortest](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                    
...
,sum(isnull(dphmcd_curr_qty,0)) holdingbal   
