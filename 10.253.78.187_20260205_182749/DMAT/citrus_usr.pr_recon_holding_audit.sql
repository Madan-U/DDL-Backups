-- Object: PROCEDURE citrus_usr.pr_recon_holding_audit
...
CREATE proc [citrus_usr].[pr_recon_holding_audit](@pa_excsm_id numeric
, @pa_date datetime
, @pa_flag char(15)
...
into #asonholding from dp_hldg_mstr_cdsl_audit,dp_acct_mstr 
