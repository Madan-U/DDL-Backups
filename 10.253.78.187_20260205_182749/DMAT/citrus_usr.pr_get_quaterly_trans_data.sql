-- Object: PROCEDURE citrus_usr.pr_get_quaterly_trans_data
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

--exec pr_get_quaterly_trans_data 'MAY 01 2013','MAY 31 2013'
CREATE proc [citrus_usr].[pr_get_quaterly_trans_data](@pa_from_dt datetime,@pa_to_dt datetime)
as
begin 
...
truncate table quaterlytransdetails
...
insert into quaterlytransdetails
