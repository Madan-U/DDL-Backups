-- Object: PROCEDURE citrus_usr.DIS_bring_Back_to_make_from_int_rejection
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE  PROCEDURE [citrus_usr].[DIS_bring_Back_to_make_from_int_rejection] 
...
SELECT @L_mid_chk = DPTDC_MID_CHK FROM DPTDC_MAK WHERE DPTDC_SLIP_NO = @pa_slip_no
...
print @L_mid_chk
 ...
 IF exists (select 1 from dptdc_mak   where dptdc_slip_no = @pa_slip_no AND Isnull(dptdc_res_desc,'')= '' and isnull(dptdc_res_cd,'') = '')    
 BEGIN  
