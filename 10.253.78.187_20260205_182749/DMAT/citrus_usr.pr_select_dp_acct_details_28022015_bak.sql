-- Object: PROCEDURE citrus_usr.pr_select_dp_acct_details_28022015_bak
...
create PROCEDURE [citrus_usr].[pr_select_dp_acct_details_28022015_bak](@pa_id             VARCHAR(20)
...
--
   ...
   --
	 ...
	 BEGIN
		...
		WHERE ACCP_ACCPM_PROP_CD IN ('RGESS_FLAG','BSDA','SMS_FLAG','ADHAARFLAG','ADHAARSECHLDR','ADHAARTHRDHLDR')
