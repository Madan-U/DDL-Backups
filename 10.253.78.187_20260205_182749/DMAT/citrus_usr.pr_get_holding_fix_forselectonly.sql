-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_forselectonly
...
CREATE proc [citrus_usr].[pr_get_holding_fix_forselectonly](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
select cdshm_dpam_id , cdshm_isin , sum(cdshm_qty  ) qty ,cdshm_trans_no into #trasdmtpenfing1  from cdsl_holding_dtls
