-- Object: PROCEDURE citrus_usr.pr_import_dp_Harmonization_XXXXX
...
create  PROCeDURE [citrus_usr].[pr_import_dp_Harmonization_XXXXX]( @pa_crn_no      VARCHAR(8000)                  
                            , @pa_exch        VARCHAR(10)                  
...
select * , acct_no boidorder ,'5' id  , (select top 1  Borequestdt from @line2 l2 where l2.acct_no = l7.acct_no  )  Borequestdt  into #tmp_line7_NOM from @line7 l7 where Purpose_code ='206'
select * ,  acct_no  boidorder ,'6' id , (select top 1  Borequestdt from @line2 l2 where l2.acct_no = l5.acct_no  )  Borequestdt   into #tmp_line5 from @line5 l5
select pc6.* ,  acct_no  boidorder, mSTRPOAFLG  ,'7' id , (select top 1  Borequestdt from @line2 l2 where l2.acct_no = pc6.acct_no  )  Borequestdt    into #tmp_line6 from @line6 pc6  , dps8_pc1   a  where boid = bo3_usr_txt1
select * ,  acct_no boidorder,'8' id , (select top 1  Borequestdt from @line2 l2 where l2.acct_no = l8.acct_no  )  Borequestdt   into #tmp_line8 from @line8 l8
...
union 
select boidorder from #tmp_line7_NOM ) a 
...
select  substring(a.acct_no,4,5)  + ',0,,'+@pa_loginname+','+''+','+substring(a.Borequestdt,5,4)+'-'+substring(a.Borequestdt,3,2)+'-'+substring(a.Borequestdt,1,2) +','+substring(a.Borequestdt,5,4)+'-'+substring(a.Borequestdt,3,2)+'-'+substring(a.Borequestdt,1,2)+'T00:00:00'+','+CONVERT(varchar(100),ord.orderId) +','+'@@@@@'+''+','+'BOSET'+','+'' +','+case when product_number <> '' then Citrus_usr.fn_get_standard_value_harm('PrdNb',case when isnumeric(product_number)=1 then convert(varchar(100),convert(numeric,product_number) ) else '' end ) else '' end +''+','+case when bo_sub_status  <> '' then Citrus_usr.fn_get_standard_value_harm('BnfcrySubTp',case when isnumeric(bo_sub_status)=1 then convert(varchar(100),convert(numeric,bo_sub_status) ) else '' end ) else '' end+''+''+','+'FH'+','+ltrim(rtrim(isnull(bo_title,'')))+','+case when a.bo_name <> '' then ltrim(rtrim(isnull(a.bo_name,''))) else '' end +','+case when a.bo_middle_name  <> '' then ltrim(rtrim(isnull(bo_middle_name,''))) else '' end +','+case when a.cust_search_name  <> '' then ltrim(rtrim(isnull(a.cust_search_name,''))) else '' end +','+ltrim(rtrim(isnull(bo_suffix,'')))+',,'+ltrim(rtrim(isnull(hldr_fth_hsd_nm,'')))+','+case when dob <> '' then convert(varchar(10),convert(datetime,dob,103),126) else '' end +''+','+Citrus_usr.fn_get_standard_value_harm('Gndr',b.sex_cd)+','+ltrim(rtrim(isnull(hldr_pan,'')))+','+Citrus_usr.fn_get_standard_value_harm('PANVrfyFlg',pan_vf)+''+','+Citrus_usr.fn_get_standard_value_harm('PANXmptnCd','XXXXXX')+','+ltrim(rtrim(isnull(hldr_UID,'')))+','+Citrus_usr.fn_get_standard_value_harm('AdhrAuthntcnWthUID','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnForNonUpdtdAdhr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SMSFclty',ltrim(rtrim(smart)))+''+','+case when isnumeric(Pri_mob_ISD)=1 then Citrus_usr.fn_get_standard_value_harm('PrmryISDCd',convert(varchar(100),convert(numeric,Pri_mob_ISD))) else '' end +','+ltrim(rtrim(ISNULL(cust_ph1,'')))+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForMobNbOf','XXXXXX')+''+','+case when isnumeric(Pri_mob_ISD)=1 then Citrus_usr.fn_get_standard_value_harm('ScndryISDCd',convert(varchar(100),convert(numeric,sec_mob_isd))) else '' end +','+ltrim(rtrim(isnull(sec_mobile,'')))+','+ltrim(rtrim(ISNULL(cust_email,'')))+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForEmailAdr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('NoNmntnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MdOfOpr',isnull(dummy1,''))+','+ltrim(rtrim(isnull(clr_member_id,'')))+','+Citrus_usr.fn_get_standard_value_harm('StgInstr',isnull(confir_waived,''))+''+','+Citrus_usr.fn_get_standard_value_harm('GrssAnlIncmRg',ann_income_cd )+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('OneTmDclrtnFlgForGSECIDT','XXXXXX')+','+ltrim(rtrim(isnull(CONVERT(varchar(100),voice_mail),'')))+','+ltrim(rtrim(isnull(CONVERT(varchar(100),divnd_bank_code),''))) +',,'+case when rbi_app_dt <> '00000000' then convert(varchar(10),convert(datetime,rbi_app_dt,103),126) else '' end +','+ltrim(rtrim(isnull(rbi_ref_no,'')))+','+','+Citrus_usr.fn_get_standard_value_harm('Mndt',isnull(ecs,''))+','+ltrim(rtrim(isnull(sebi_reg_no,'')))+','+Citrus_usr.fn_get_standard_value_harm('EdctnLvl',isnull(edu,''))+''+','+Citrus_usr.fn_get_standard_value_harm('AnlRptFlg',isnull(ANNUAL_REPORT ,''))+''+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrSttlmCyclCd',isnull(bo_statm_cycle_cd,''))+''+','+Citrus_usr.fn_get_standard_value_harm('ElctrncConf',isnull(elec_confirm,''))+''+','+Citrus_usr.fn_get_standard_value_harm('EmailRTADwnldFlg',isnull(EMAIL_RTA,''))+''+','+Citrus_usr.fn_get_standard_value_harm('GeoCd',isnull(geographical_cd,''))+''+','+Citrus_usr.fn_get_standard_value_harm('Xchg',isnull(stoc_exch,''))+''+','+Citrus_usr.fn_get_standard_value_harm('MntlDsblty',isnull(MENTAL_DISABILITY,''))+''+','+Citrus_usr.fn_get_standard_value_harm('Ntlty',ltrim(rtrim(isnull(nat_cd,''))))+''+','+Citrus_usr.fn_get_standard_value_harm('CASMd',ltrim(rtrim(isnull(CAS_MODE ,''))))+''+','+Citrus_usr.fn_get_standard_value_harm('AncstrlFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PldgStgInstrFlg',ltrim(rtrim(isnull(PLEDGE_STANDING,''))))+''+','+ltrim(rtrim(Citrus_usr.fn_get_standard_value_harm('BkAcctTp',isnull(divnd_brnch_numb,''))))+''+','+Citrus_usr.fn_get_standard_value_harm('BnfcryAcctCtgy','XXXXXX')+','+ltrim(rtrim(isnull(divnd_acct_numb,'')))+','+','+case when benef_tax_ded_sta <> '' then Citrus_usr.fn_get_standard_value_harm('BnfcryTaxDdctnSts',convert(numeric,ltrim(rtrim(isnull(benef_tax_ded_sta,''))))) else '' end +''+','+case when ltrim(rtrim(isnull(clr_corp_id,''))) <> '000000' then Citrus_usr.fn_get_standard_value_harm('ClrSysId','XXXXXX') else '' end +''+','+Citrus_usr.fn_get_standard_value_harm('BSDAFlg',isnull(ltrim(rtrim(bsda_flag)),''))+''+','+Citrus_usr.fn_get_standard_value_harm('Ocptn',isnull(occp,''))+''+','+Citrus_usr.fn_get_standard_value_harm('PMSClntAcctFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PostvConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrstClntOptnToRcvElctrncStmtFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ComToBeSentTo',isnull(dummy2,''))+''+','+Citrus_usr.fn_get_standard_value_harm('DelFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnCdDeltn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AccntOpSrc',ltrim(rtrim(isnull(bo_acop_src,''))))+','+','+Citrus_usr.fn_get_standard_value_harm('POAOrDDPITp','XXXXXX')+',,'+isnull(a.acct_no,'')+','+','+Citrus_usr.fn_get_standard_value_harm('CtdnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DmtrlstnGtwy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmneeMnrInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('FlgForShrPctgEqlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsdlSecFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RltshWthBnfclOwnr','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('POAToOprtAcct','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('GPABPAFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PoaLnkPurpCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('BOUCCLkFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CnsntInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('Sgmt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MapUMapFlg','XXXXXX')+','+','+Case when ltrim(rtrim(isnull(cust_addr1,''))) <> '' then 'CORAD' else '' end +''+','+Citrus_usr.fn_get_standard_value_harm('AdrPrefFlg','XXXXXX')+case when isnull(cust_addr1 ,'') <> '' then ',"' else ',' end +ltrim(rtrim(isnull(cust_addr1,''))) + case when isnull(cust_addr1 ,'') <> '' then '","' else ',' end  +ltrim(rtrim(isnull(cust_addr2,'')))+case when isnull(cust_addr1 ,'') <> '' then '","' else ',' end +ltrim(rtrim(isnull(cust_addr3,'')))+ case when isnull(cust_addr1 ,'') <> '' then '",' else ',' end ++','+Citrus_usr.fn_get_standard_value_harm('Ctry',cust_addr_cntry)+','+ltrim(rtrim(isnull(cust_addr_zip ,'')))+','+Citrus_usr.fn_get_standard_value_harm('CtrySubDvsnCd',cust_addr_state  )+','+ltrim(rtrim(isnull(city_seq_no ,'') ))+',,'+','+Citrus_usr.fn_get_standard_value_harm('ProofOfRes','XXXXXX')+',,,'+'#SIG#'+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrAcctOfPMSFlg','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('LclAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnkAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmnorGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MnrNmnGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrgnOrCorrAddPrsnt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AuthFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CoprcnrOrMmbr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('TypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('SubTypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('StsChgRsnOrClsrRsnCd','XXXXXX')+''+','+ Citrus_usr.fn_get_standard_value_harm('NmChgRsnCd','XXXXXX')+','+','+''+''+','+Citrus_usr.fn_get_standard_value_harm('AppKrta','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ChgKrtaRsn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PrfDpstryFldFrCAS','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ClsrInitBy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RmngBal','XXXXXX')+',,,,,'+','+Citrus_usr.fn_get_standard_value_harm('AcctTyp','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('SrlFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SignTyp','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ChrInstUnvFlg','XXXXXX')+',,,'   detailshr ,  ord.orderId, '1' id 
...
select  distinct substring(acct_no,4,5)  + ',0,,'+@pa_loginname+','+''+','+substring(a.Borequestdt,5,4)+'-'+substring(a.Borequestdt,3,2)+'-'+substring(a.Borequestdt,1,2)+','+substring(a.Borequestdt,5,4)+'-'+substring(a.Borequestdt,3,2)+'-'+substring(a.Borequestdt,1,2)+'T00:00:00'+','+CONVERT(varchar(100),ord.orderId) +','+CONVERT(varchar(100),'@@@@@')+''+','+''+','+'' +','+''+''+','+''+''+','+'FH'+',,,,,,,,'+','+Citrus_usr.fn_get_standard_value_harm('Gndr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PANVrfyFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PANXmptnCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AdhrAuthntcnWthUID','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnForNonUpdtdAdhr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SMSFclty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PrmryISDCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForMobNbOf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ScndryISDCd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForEmailAdr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('NoNmntnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MdOfOpr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('StgInstr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('GrssAnlIncmRg','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('OneTmDclrtnFlgForGSECIDT','XXXXXX')+',,,,,,'+','+Citrus_usr.fn_get_standard_value_harm('Mndt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('EdctnLvl','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AnlRptFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrSttlmCyclCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ElctrncConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('EmailRTADwnldFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('GeoCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Xchg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MntlDsblty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Ntlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CASMd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AncstrlFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PldgStgInstrFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BkAcctTp','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfcryAcctCtgy','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('BnfcryTaxDdctnSts','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ClrSysId','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BSDAFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Ocptn','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PMSClntAcctFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PostvConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrstClntOptnToRcvElctrncStmtFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ComToBeSentTo','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DelFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnCdDeltn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AccntOpSrc','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('POAOrDDPITp','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('CtdnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DmtrlstnGtwy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmneeMnrInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('FlgForShrPctgEqlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsdlSecFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RltshWthBnfclOwnr','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('POAToOprtAcct','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('GPABPAFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PoaLnkPurpCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('BOUCCLkFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CnsntInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('Sgmt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MapUMapFlg','XXXXXX')+','+','+'PERAD' +''+','+Citrus_usr.fn_get_standard_value_harm('AdrPrefFlg','XXXXXX')+',"'+ltrim(rtrim(isnull(cust_addr1,'')))+'","'+ltrim(rtrim(isnull(cust_addr2,'')))+'","'+ltrim(rtrim(isnull(cust_addr3,'')))+'",'++','+Citrus_usr.fn_get_standard_value_harm('Ctry',cust_cntry)+','+ltrim(rtrim(isnull(cust_zip ,'')))+','+Citrus_usr.fn_get_standard_value_harm('CtrySubDvsnCd',cust_state  )+','+ltrim(rtrim(isnull(ln7_city_seq_no ,'') ))+',,'+','+Citrus_usr.fn_get_standard_value_harm('ProofOfRes','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrAcctOfPMSFlg','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('LclAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnkAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmnorGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MnrNmnGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrgnOrCorrAddPrsnt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AuthFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CoprcnrOrMmbr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('TypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('SubTypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('StsChgRsnOrClsrRsnCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmChgRsnCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AddModDelInd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AppKrta','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ChgKrtaRsn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PrfDpstryFldFrCAS','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ClsrInitBy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RmngBal','XXXXXX')+',,,,,'+','+Citrus_usr.fn_get_standard_value_harm('AcctTyp','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('SrlFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SignTyp','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ChrInstUnvFlg','XXXXXX')+',,,', ord.orderId,'2' id 
from #tmp_order ord ,  #tmp_line7_PADr a   where  a.boidorder = ord.boidorder
union all
--select  substring(acct_no,4,5)  + ',0,,'+@pa_loginname+','+Citrus_usr.fn_get_standard_value_harm('CntrlSctiesDpstryPtcptRole','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('BOTxnTyp','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PrdNb','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfcrySubTp','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Purpse','XXXXXX')+',,,,,,,,'+','+Citrus_usr.fn_get_standard_value_harm('Gndr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PANVrfyFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PANXmptnCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AdhrAuthntcnWthUID','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnForNonUpdtdAdhr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SMSFclty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PrmryISDCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForMobNbOf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ScndryISDCd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForEmailAdr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('NoNmntnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MdOfOpr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('StgInstr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('GrssAnlIncmRg','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('OneTmDclrtnFlgForGSECIDT','XXXXXX')+',,,,,,'+','+Citrus_usr.fn_get_standard_value_harm('Mndt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('EdctnLvl','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AnlRptFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrSttlmCyclCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ElctrncConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('EmailRTADwnldFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('GeoCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Xchg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MntlDsblty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Ntlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CASMd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AncstrlFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PldgStgInstrFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BkAcctTp','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfcryAcctCtgy','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('BnfcryTaxDdctnSts','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ClrSysId','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BSDAFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Ocptn','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PMSClntAcctFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PostvConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrstClntOptnToRcvElctrncStmtFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ComToBeSentTo','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DelFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnCdDeltn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AccntOpSrc','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('POAOrDDPITp','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('CtdnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DmtrlstnGtwy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmneeMnrInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('FlgForShrPctgEqlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsdlSecFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RltshWthBnfclOwnr','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('POAToOprtAcct','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('GPABPAFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PoaLnkPurpCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('BOUCCLkFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CnsntInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('Sgmt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MapUMapFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PurpCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AdrPrefFlg','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('Ctry','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('CtrySubDvsnCd','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('ProofOfRes','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrAcctOfPMSFlg','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('LclAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnkAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmnorGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MnrNmnGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrgnOrCorrAddPrsnt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AuthFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CoprcnrOrMmbr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('TypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('SubTypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('StsChgRsnOrClsrRsnCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmChgRsnCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AddModDelInd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AppKrta','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ChgKrtaRsn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PrfDpstryFldFrCAS','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ClsrInitBy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RmngBal','XXXXXX')+',,,,,'+','+Citrus_usr.fn_get_standard_value_harm('AcctTyp','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('SrlFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SignTyp','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ChrInstUnvFlg','XXXXXX')+',,,Z'
select  distinct substring(acct_no,4,5)  + ',0,,'+@pa_loginname+','+''+','+substring(a.Borequestdt,5,4)+'-'+substring(a.Borequestdt,3,2)+'-'+substring(a.Borequestdt,1,2)+','+substring(a.Borequestdt,5,4)+'-'+substring(a.Borequestdt,3,2)+'-'+substring(a.Borequestdt,1,2)+'T00:00:00'+','+CONVERT(varchar(100),ord.orderId) +','+CONVERT(varchar(100),'@@@@@')+''+','+''+','+'' +','+''+''+','+''+''+','+'NM'+',,'+ltrim(rtrim(isnull(bo_name,'')))+','+ltrim(rtrim(isnull(bo_middle_nm,'')))+','+ltrim(rtrim(isnull(cust_search_name,'')))+',,,'+ltrim(rtrim(isnull(hldr_fth_hs_name,'')))+','+case when cust_dob<> '' then right(cust_dob,4)+'-'+substring(cust_dob,3,2)+'-'+left(cust_dob,2) else '' end +','+Citrus_usr.fn_get_standard_value_harm('Gndr','XXXXXX')+','+ltrim(rtrim(isnull(hldr_in_tax_pan,'')))+','+Citrus_usr.fn_get_standard_value_harm('PANVrfyFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PANXmptnCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AdhrAuthntcnWthUID','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnForNonUpdtdAdhr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SMSFclty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PrmryISDCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForMobNbOf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ScndryISDCd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForEmailAdr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('NoNmntnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MdOfOpr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('StgInstr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('GrssAnlIncmRg','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('OneTmDclrtnFlgForGSECIDT','XXXXXX')+',,,,,,'+','+Citrus_usr.fn_get_standard_value_harm('Mndt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('EdctnLvl','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AnlRptFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrSttlmCyclCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ElctrncConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('EmailRTADwnldFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('GeoCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Xchg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MntlDsblty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Ntlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CASMd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AncstrlFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PldgStgInstrFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BkAcctTp','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfcryAcctCtgy','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('BnfcryTaxDdctnSts','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ClrSysId','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BSDAFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Ocptn','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PMSClntAcctFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PostvConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrstClntOptnToRcvElctrncStmtFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ComToBeSentTo','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DelFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnCdDeltn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AccntOpSrc','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('POAOrDDPITp','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('CtdnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DmtrlstnGtwy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmneeMnrInd','XXXXXX')+','+case when nom_serial_no <> '' then convert(varchar(10),convert(numeric,nom_serial_no)) else '' end +','+case when sharepercent <> '' then convert(varchar(10),convert(numeric(5,2),sharepercent/100)) else '' end +','+Citrus_usr.fn_get_standard_value_harm('FlgForShrPctgEqlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsdlSecFlg',res_sec_flag)+''+','+case when rel_withbo <>'' then Citrus_usr.fn_get_standard_value_harm('RltshWthBnfclOwnr',isnull(convert(numeric,rel_withbo),'')) else '' end +',,'+','+Citrus_usr.fn_get_standard_value_harm('POAToOprtAcct','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('GPABPAFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PoaLnkPurpCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('BOUCCLkFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CnsntInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('Sgmt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MapUMapFlg','XXXXXX')+','+','+'NOMAD' +''+','+Citrus_usr.fn_get_standard_value_harm('AdrPrefFlg','XXXXXX')+',"'+ltrim(rtrim(isnull(cust_addr1,'')))+'","'+ltrim(rtrim(isnull(cust_addr2,'')))+'","'+ltrim(rtrim(isnull(cust_addr3,'')))+'",'++','+Citrus_usr.fn_get_standard_value_harm('Ctry',cust_cntry)+','+ltrim(rtrim(isnull(cust_zip ,'')))+','+Citrus_usr.fn_get_standard_value_harm('CtrySubDvsnCd',cust_state  )+','+ltrim(rtrim(isnull(ln7_city_seq_no ,'') ))+',,'+','+Citrus_usr.fn_get_standard_value_harm('ProofOfRes','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrAcctOfPMSFlg','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('LclAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnkAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmnorGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MnrNmnGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrgnOrCorrAddPrsnt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AuthFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CoprcnrOrMmbr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('TypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('SubTypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('StsChgRsnOrClsrRsnCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmChgRsnCd','XXXXXX')+','+','+''+''+','+Citrus_usr.fn_get_standard_value_harm('AppKrta','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ChgKrtaRsn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PrfDpstryFldFrCAS','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ClsrInitBy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RmngBal','XXXXXX')+',,,,,'+','+Citrus_usr.fn_get_standard_value_harm('AcctTyp','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('SrlFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SignTyp','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ChrInstUnvFlg','XXXXXX')+',,,', ord.orderId,'2' id 
from #tmp_order ord ,  #tmp_line7_NOM a   where  a.boidorder = ord.boidorder
union all
--select  substring(acct_no,4,5)  + ',0,,'+@pa_loginname+','+Citrus_usr.fn_get_standard_value_harm('CntrlSctiesDpstryPtcptRole','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('BOTxnTyp','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PrdNb','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfcrySubTp','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Purpse','XXXXXX')+',,,,,,,,'+','+Citrus_usr.fn_get_standard_value_harm('Gndr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PANVrfyFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PANXmptnCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AdhrAuthntcnWthUID','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnForNonUpdtdAdhr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SMSFclty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PrmryISDCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForMobNbOf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ScndryISDCd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForEmailAdr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('NoNmntnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MdOfOpr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('StgInstr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('GrssAnlIncmRg','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('OneTmDclrtnFlgForGSECIDT','XXXXXX')+',,,,,,'+','+Citrus_usr.fn_get_standard_value_harm('Mndt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('EdctnLvl','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AnlRptFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrSttlmCyclCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ElctrncConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('EmailRTADwnldFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('GeoCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Xchg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MntlDsblty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Ntlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CASMd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AncstrlFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PldgStgInstrFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BkAcctTp','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfcryAcctCtgy','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('BnfcryTaxDdctnSts','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ClrSysId','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BSDAFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Ocptn','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PMSClntAcctFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PostvConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrstClntOptnToRcvElctrncStmtFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ComToBeSentTo','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DelFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnCdDeltn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AccntOpSrc','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('POAOrDDPITp','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('CtdnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DmtrlstnGtwy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmneeMnrInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('FlgForShrPctgEqlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsdlSecFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RltshWthBnfclOwnr','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('POAToOprtAcct','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('GPABPAFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PoaLnkPurpCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('BOUCCLkFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CnsntInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('Sgmt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MapUMapFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PurpCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AdrPrefFlg','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('Ctry','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('CtrySubDvsnCd','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('ProofOfRes','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrAcctOfPMSFlg','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('LclAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnkAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmnorGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MnrNmnGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrgnOrCorrAddPrsnt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AuthFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CoprcnrOrMmbr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('TypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('SubTypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('StsChgRsnOrClsrRsnCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmChgRsnCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AddModDelInd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AppKrta','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ChgKrtaRsn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PrfDpstryFldFrCAS','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ClsrInitBy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RmngBal','XXXXXX')+',,,,,'+','+Citrus_usr.fn_get_standard_value_harm('AcctTyp','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('SrlFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SignTyp','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ChrInstUnvFlg','XXXXXX')+',,,Z'
select  distinct substring(acct_no,4,5)  + ',0,,'+@pa_loginname+','+''+','+substring(a.Borequestdt,5,4)+'-'+substring(a.Borequestdt,3,2)+'-'+substring(a.Borequestdt,1,2)+','+convert(varchar(10),setup_date,126)+'T00:00:00'+','+CONVERT(varchar(100),ord.orderId) +','+CONVERT(varchar(100),'@@@@@')+''+','+''+','+'' +','+''+''+','+''+''+','+'POALB'+',,,,,,,,'+','+Citrus_usr.fn_get_standard_value_harm('Gndr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PANVrfyFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PANXmptnCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AdhrAuthntcnWthUID','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnForNonUpdtdAdhr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SMSFclty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PrmryISDCd','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForMobNbOf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ScndryISDCd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('FmlyFlgForEmailAdr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('NoNmntnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MdOfOpr','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('StgInstr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('GrssAnlIncmRg','XXXXXX')+',,,,'+','+Citrus_usr.fn_get_standard_value_harm('OneTmDclrtnFlgForGSECIDT','XXXXXX')+',,,,,,'+','+Citrus_usr.fn_get_standard_value_harm('Mndt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('EdctnLvl','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AnlRptFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrSttlmCyclCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ElctrncConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('EmailRTADwnldFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('GeoCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Xchg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MntlDsblty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Ntlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CASMd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('AncstrlFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PldgStgInstrFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BkAcctTp','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnfcryAcctCtgy','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('BnfcryTaxDdctnSts','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ClrSysId','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BSDAFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('Ocptn','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('PMSClntAcctFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PostvConf','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrstClntOptnToRcvElctrncStmtFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ComToBeSentTo','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DelFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsnCdDeltn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AccntOpSrc','XXXXXX')+','+','+''+',,,'+','+Citrus_usr.fn_get_standard_value_harm('CtdnFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('DmtrlstnGtwy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmneeMnrInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('FlgForShrPctgEqlty','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RsdlSecFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RltshWthBnfclOwnr','XXXXXX')+',0,'+ltrim(rtrim(convert(varchar(100),poa_id)))+','+'Y'+','+''  +','+convert(varchar(10),setup_date,126)+','+convert(varchar(10),eff_frm_dt,126)+','+case when  convert(varchar(10),eff_to_dt,126) ='1900-01-01' then '' else convert(varchar(10),eff_to_dt,126) end +','+Citrus_usr.fn_get_standard_value_harm('GPABPAFlg',gpa_bpa_fl)+','+  ltrim(rtrim(isnull(bo3_usr_txt1,'')))+','+Citrus_usr.fn_get_standard_value_harm('PoaLnkPurpCd',isnull(bo3_usr_fld3,''))+','+','+Citrus_usr.fn_get_standard_value_harm('BOUCCLkFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CnsntInd','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('Sgmt','XXXXXX')+''+','+''+''+','+Citrus_usr.fn_get_standard_value_harm('AdrPrefFlg','XXXXXX')+',,,,'++','+Citrus_usr.fn_get_standard_value_harm('Ctry','')+','+ltrim(rtrim(isnull('' ,'')))+','+Citrus_usr.fn_get_standard_value_harm('CtrySubDvsnCd',''  )+','+ltrim(rtrim(isnull('' ,'') ))+',,'+','+Citrus_usr.fn_get_standard_value_harm('ProofOfRes','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('BnfclOwnrAcctOfPMSFlg','XXXXXX')+',,'+','+Citrus_usr.fn_get_standard_value_harm('LclAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('BnkAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmnorGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('MnrNmnGrdnAddPrsnt','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('FrgnOrCorrAddPrsnt','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('AuthFlg','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('CoprcnrOrMmbr','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('TypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('SubTypMod','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('StsChgRsnOrClsrRsnCd','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('NmChgRsnCd','XXXXXX')+','+','+''+''+','+Citrus_usr.fn_get_standard_value_harm('AppKrta','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('ChgKrtaRsn','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('PrfDpstryFldFrCAS','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ClsrInitBy','XXXXXX')+''+','+Citrus_usr.fn_get_standard_value_harm('RmngBal','XXXXXX')+',,,,0,'+','+Citrus_usr.fn_get_standard_value_harm('AcctTyp','XXXXXX')+',,,'+','+Citrus_usr.fn_get_standard_value_harm('SrlFlg','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('SignTyp','XXXXXX')+','+','+Citrus_usr.fn_get_standard_value_harm('ChrInstUnvFlg','XXXXXX')+',,,', ord.orderId, '3' id 
