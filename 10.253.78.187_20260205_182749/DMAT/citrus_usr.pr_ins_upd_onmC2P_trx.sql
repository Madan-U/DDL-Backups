-- Object: PROCEDURE citrus_usr.pr_ins_upd_onmC2P_trx
...
*/
CREATE PROCEDURE [citrus_usr].[pr_ins_upd_onmC2P_trx](@pa_id              VARCHAR(8000)  
												...
												--
													  ...
													  --
																...
																SET     dptd_dpam_id              = @l_dpam_id
																							...
																							,dptd_counter_cmbp_id      = @pa_tr_cmbpid
																							,dptd_rmks																	= @pa_rmks
