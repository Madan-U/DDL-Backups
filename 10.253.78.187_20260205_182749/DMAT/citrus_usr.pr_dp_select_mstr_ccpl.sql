-- Object: PROCEDURE citrus_usr.pr_dp_select_mstr_ccpl
...
--exec pr_dp_select_mstr @pa_id='1|*~|3|*~|',@pa_action='VOUCHERREC_SEL',@pa_login_name='',@pa_cd='',@pa_desc='12/11/2008',@pa_rmks='203412',@pa_values='',@pa_roles='6*|~*',@pa_scr_id='217',@RowDelimiter='*|~*',@ColDelimiter='|*~|',@pa_ref_cur=''
 ...
 create PROCEDURE  [citrus_usr].[pr_dp_select_mstr_ccpl]( @pa_id  VARCHAR(20)                  
...
,CASE WHEN DPTDC_DELETED_IND IN (0,6,-1)  THEN 'MAKER ENTERED'
		...
		WHEN DPTDC_DELETED_IND = 1 AND ISNULL(DPTDC_BATCH_NO,'') = '' AND ISNULL(DPTDC_TRANS_NO,'0') =  '0'  THEN 'CHECKER APPROVED' END  STATUS
