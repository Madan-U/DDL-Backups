-- Object: PROCEDURE citrus_usr.pr_billing_main_nsdl
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

--pr_billing_main_nsdl 'DEC 22 2008','DEC 22 2008','IN302148','Y','N','B','HO'  
CREATE procedure [citrus_usr].[pr_billing_main_nsdl]    
  ...
  -- CHARGES FOR DP    
    ...
    --    
      ...
      --    
        ...
        print @l_sql    
        print 'DELETE'+convert(varchar,@l_fin_id)+ convert(varchar,@l_ref_no)
        exec (@l_sql)    
      --    
      END    
