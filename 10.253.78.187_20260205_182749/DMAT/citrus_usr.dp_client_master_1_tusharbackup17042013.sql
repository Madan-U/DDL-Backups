-- Object: VIEW citrus_usr.dp_client_master_1_tusharbackup17042013
...
create view [citrus_usr].[dp_client_master_1_tusharbackup17042013]  
as
...
FROM dps8_pc6 with (nolock) , (select max(DateOfSetup) maxdt ,boid maxbo from dps8_pc6 group by boid ) maxnom
where maxbo = boid 
