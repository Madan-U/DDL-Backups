-- Object: PROCEDURE citrus_usr.PR_TRATM_INS13
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE    PROCEDURE [citrus_usr].[PR_TRATM_INS13]
                AS
                BEGIN
                  --
                    DECLARE
                      ...
                      DELETE FROM TRANSACTION_SUB_TYPE_MSTR WHERE TRASTM_TRATM_ID=(SELECT trantm_id FROM TRANSACTION_TYPE_MSTR WHERE TRANTM_CODE = 'TRX_TYPE_NSDL')
		      DELETE FROM TRANSACTION_TYPE_MSTR WHERE TRANTM_CODE = 'TRX_TYPE_NSDL'
