-- Object: PROCEDURE citrus_usr.CLASS_AUTO_PROCESS_LISNER
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE PROC [citrus_usr].[CLASS_AUTO_PROCESS_LISNER]  
AS  
...
AND (D.IS_DEPEND_ON LIKE '%#-1,%' OR PROCESS_STATUS in (100,98))  
...
/*For History Insert*/
   ...
   WHERE PROCESS_DATE = LEFT(GETDATE(),11) AND (IS_DEPEND_ON LIKE '%#-1,%' OR PROCESS_STATUS in (100,98))  
