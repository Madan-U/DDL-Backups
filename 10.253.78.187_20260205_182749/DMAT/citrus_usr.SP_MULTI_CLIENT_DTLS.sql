-- Object: PROCEDURE citrus_usr.SP_MULTI_CLIENT_DTLS
...
CREATE  PROCEDURE [citrus_usr].[SP_MULTI_CLIENT_DTLS]
( 
...
BEGIN -- MAIN
--
exec [citrus_usr].SP_MULTI_CLIENT_DTLS_DPS8 @PA_FROM_ACCTNO
,@PA_TO_ACCTNO
,@PA_EXCSMID
,@pa_login_pr_entm_id
...
,isnull(TMPBA_DP_BANK_ZIP,'') [BPIN CODE]
	...
	--	, ISNULL(CITRUS_USR.FN_UCC_ACCP(DPAM.DPAM_ID,'BILL_START_DT'),'') ACTDT
		...
		,ISNULL(convert(varchar(11),DPHD_SH_DOB,106),'') 
