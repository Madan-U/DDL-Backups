-- Object: FUNCTION citrus_usr.fn_acct_list_bytushar_bak_16082021
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

create  Function [citrus_usr].[fn_acct_list_bytushar_bak_16082021](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int,@PA_FROMACCID varchar(16),@PA_TOACCID varchar(16))       
