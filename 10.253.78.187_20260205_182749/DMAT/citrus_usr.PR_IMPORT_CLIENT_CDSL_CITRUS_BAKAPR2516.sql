-- Object: PROCEDURE citrus_usr.PR_IMPORT_CLIENT_CDSL_CITRUS_BAKAPR2516
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE PROCEDURE  [citrus_usr].[PR_IMPORT_CLIENT_CDSL_CITRUS_BAKAPR2516]
			(
			 @PA_EXCH          VARCHAR(20)    
...
--  
			...
			SELECT @L_REM= ISNULL(ENTM_SHORT_NAME,'') FROM ENTITY_MSTR , TMP_CLIENT_DTLS_MSTR_CDSL_citrus 
												    WHERE ENTM_SHORT_NAME = TMPCLI_SUB + '_SB' AND ENTM_DELETED_IND = 1 AND TMPCLI_BOID = @C_BEN_ACCT_NO  
