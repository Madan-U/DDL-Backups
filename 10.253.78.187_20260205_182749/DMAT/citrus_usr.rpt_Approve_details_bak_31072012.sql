-- Object: PROCEDURE citrus_usr.rpt_Approve_details_bak_31072012
...
CREATE procedure [citrus_usr].[rpt_Approve_details_bak_31072012]
(@pa_id  varchar(10),
 @pa_type varchar(4),
 @pa_tab varchar(20),
 @pa_from_dt datetime,
...
--convert(varchar(11),DPTDC_LST_UPD_dt,103) else '' end as checker2_dt
					...
					, case  when dptdc_reason_cd= '1' then 'Gift' 
							...
							when dptdc_reason_cd= '6' then 'Others' 
							when dptdc_reason_cd= '7' then 'Trnsfr between family members' else '' end reason
                    --  ,isnull(recon_datetime,'')  as recon_datetime    
					, '' batchno
