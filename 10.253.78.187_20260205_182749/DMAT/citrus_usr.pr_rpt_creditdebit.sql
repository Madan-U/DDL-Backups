-- Object: PROCEDURE citrus_usr.pr_rpt_creditdebit
...
--[pr_rpt_creditdebit] '3','','','apr 14 2009', 'Sep 14 2009','','','','',1,'ho|*~|*|~*',''
CREATE PROCEDURE [citrus_usr].[pr_rpt_creditdebit](@PA_ID  NUMERIC
...
print 'tt'
	...
	WHERE  ldg_created_by ='INWARDENTRY'  
 and    isnull(inwsr_trastm_cd,'') + '_'+ convert(varchar,isnull(INWSR_id,'0'))=  LDG_REF_NO
 and    INWSR_DPAM_ID     = DPAM.DPAM_ID  AND DPAM.DPAM_ID = ACCOUNT.DPAM_ID 
	AND    INWSR_DPM_ID      = DPAM.DPAM_DPM_ID 
	AND    DPAM.DPAM_DPM_ID       = DPM_ID 
	AND    DPM_EXCSM_ID      = DEFAULT_DP 
	AND    DPM_EXCSM_ID      = @PA_ID
