-- Object: FUNCTION citrus_usr.fn_acct_list_remat
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE Function [citrus_usr].[fn_acct_list_remat](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int)   
...
BEGIN  
INSERT INTO @temp    
SELECT distinct DPAM_ID, DPAM_CRN_NO , DPAM_SBA_NO , DPAM_SBA_NAME, ENTR_FROM_DT,isnull(ENTR_TO_DT,'DEC 31 2100'),'P',0,DPAM_STAM_CD  
FROM DP_ACCT_MSTR , ENTITY_RELATIONSHIP   , remrm_mak 
WHERE DPAM_DELETED_IND =1   and REMRM_DPAM_ID = dpam_id 
