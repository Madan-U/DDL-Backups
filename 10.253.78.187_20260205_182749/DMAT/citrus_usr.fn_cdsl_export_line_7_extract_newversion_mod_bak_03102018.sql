-- Object: FUNCTION citrus_usr.fn_cdsl_export_line_7_extract_newversion_mod_bak_03102018
...
create   function [citrus_usr].[fn_cdsl_export_line_7_extract_newversion_mod_bak_03102018](@pa_crn_no      VARCHAR(8000)    
...
--          ,0000--''--usr_fld4    
   ...
   ,CASE WHEN exists (select 1 from dps8_pc12 where BOId = DPAM_SBA_NO and PurposeCode12 = '12' and TypeOfTrans = '3') THEN 'S' WHEN not exists (select 1 from dps8_pc12 where BOId = dpam_sba_no  and PurposeCode12 = '12') then 'S' WHEN exists (select 1 from dps8_pc12 where BOId = DPAM_SBA_NO and PurposeCode12 = '12' and (TypeOfTrans = '1' or TypeOfTrans ='2' or TypeOfTrans ='')) THEN 'M' ELSE 'D' END  
		  ...
		  ,CASE WHEN lower(isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'PRIIC'),'')) <> '' THEN  lower(isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'PRIIC'),'')) else space(6) END -- pri mob isd                   
...
,max(CASE WHEN lower(isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'NOMIC'),'')) <> '' THEN  lower(isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'NOMIC'),'')) else space(6) END) -- pri mob isd                   
     ...
     AND (TypeOfTrans = '1' or TypeOfTrans = '2' or TypeOfTrans = '') ) THEN 'M' else 'D' 
      END
          ...
          ,'','','00000',''     
		  		  ...
		  		  ,isnull(citrus_usr.FN_TOGETCDSLCOUNTRYSTATECODE('Country',citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'GUARD_ADR'),''),6 )),'') -- cntry code
		  ,isnull(citrus_usr.FN_TOGETCDSLCOUNTRYSTATECODE('State',citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'GUARD_ADR'),''),5 )),'')  -- state code
		  ,isnull(citrus_usr.Fn_Toget_CitySeqno(citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'GUARD_ADR'),''),7) ,citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'GUARD_ADR'),''),4)),'' ) -- seqno
		  ,CASE WHEN lower(isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'GUAIC'),'')) <> '' THEN  lower(isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'GUAIC'),'')) else space(6) END -- pri mob isd                                    
      ...
      END
          ,0000--''--usr_fld5 
           ,'','','00000',''         
		   		  ...
		   		  ,isnull(citrus_usr.FN_TOGETCDSLCOUNTRYSTATECODE('Country',citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'GUARD_ADR'),''),6 )),'') -- cntry code
		  ,isnull(citrus_usr.FN_TOGETCDSLCOUNTRYSTATECODE('State',citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'GUARD_ADR'),''),5 )),'')  -- state code
		  ,isnull(citrus_usr.Fn_Toget_CitySeqno(citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'GUARD_ADR'),''),7) ,citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'Per_ADR1'),''),4)),'' ) -- seqno
		  ,CASE WHEN lower(isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'GUAIC'),'')) <> '' THEN  lower(isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'GUAIC'),'')) else space(6) END -- pri mob isd                   
