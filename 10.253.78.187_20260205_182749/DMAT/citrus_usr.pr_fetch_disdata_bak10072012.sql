-- Object: PROCEDURE citrus_usr.pr_fetch_disdata_bak10072012
...
--	           
create  proc [citrus_usr].[pr_fetch_disdata_bak10072012](@pa_Action varchar(100)
...
--        end     
		...
		begin 
			...
			begin						
				...
				,isnull(substring(replace(citrus_usr.fn_splitval(citrus_usr.fn_addr_value(DPAM_CRN_NO,'COR_ADR1'),2),',',''),2,len(replace(citrus_usr.fn_splitval(citrus_usr.fn_addr_value(DPAM_CRN_NO,'COR_ADR1'),2),',',''))),'') [ADDRESS2]
				--,isnull(replace(citrus_usr.fn_splitval(citrus_usr.fn_addr_value(DPAM_CRN_NO,'COR_ADR1'),3),',',''),'') [ADDRESS3]
                ,isnull(substring(replace(citrus_usr.fn_splitval(citrus_usr.fn_addr_value(DPAM_CRN_NO,'COR_ADR1'),3),',',''),2,len(replace(citrus_usr.fn_splitval(citrus_usr.fn_addr_value(DPAM_CRN_NO,'COR_ADR1'),3),',',''))),'') [ADDRESS3]
