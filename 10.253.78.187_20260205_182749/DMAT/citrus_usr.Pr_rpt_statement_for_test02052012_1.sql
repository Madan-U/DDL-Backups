-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_for_test02052012_1
...
CREATE Proc [citrus_usr].[Pr_rpt_statement_for_test02052012_1]                            
@pa_dptype varchar(4),                                    
@pa_excsmid int,                                    
...
order by dpam_acctno,dpam_sba_name,order_by,Isin_name,convert(datetime,trans_date),exedt,dpm_trans_no,c_d_flag,cdshm_trg_settm_no    		 
	 ...
	 --
	     ...
	     if @@l_grpmstr_cd='N' 
	     begin
select dpam_acctno,dpam_sba_name,order_by,convert(datetime,trans_date),exedt
,c_d_flag,dpm_trans_no ,cdshm_trg_settm_no    		 
 from #tempmaincdsl
order by dpam_acctno,dpam_sba_name,order_by,convert(datetime,trans_date),exedt,c_d_flag,dpm_trans_no ,cdshm_trg_settm_no    		 
		 ...
		 --order by dpam_acctno,dpam_sba_name,order_by,Isin_name,convert(datetime,trans_date),dpm_trans_no,line_no,cdshm_trg_settm_no    
			order by dpam_acctno,dpam_sba_name,order_by,Isin_name,convert(datetime,trans_date),exedt,c_d_flag,dpm_trans_no ,cdshm_trg_settm_no    		 
		 end
		 else if (@@l_grpmstr_cd='Y')
		 begin
		 select order_by,dpam_id,dpam_sba_name,dpam_acctno,                                    
