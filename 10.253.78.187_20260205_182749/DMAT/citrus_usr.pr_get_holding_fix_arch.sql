-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_arch
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------



CREATE proc [citrus_usr].[pr_get_holding_fix_arch](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                          
...
select cdshm_dpam_id , cdshm_isin , sum(case when cdshm_tratm_cd = '3108' then cdshm_qty* - 1 else cdshm_qty end ) qty ,cdshm_trans_no into #trasdmtpenfing1  from dmat_archival.citrus_usr.cdsl_holding_dtls  
