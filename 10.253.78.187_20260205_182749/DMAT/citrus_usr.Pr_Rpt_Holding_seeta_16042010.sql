-- Object: PROCEDURE citrus_usr.Pr_Rpt_Holding_seeta_16042010
...
EXEC PR_RPT_HOLDING	'CDSL','3','N','SEP 17 2009','','','','N',1,'HO|*~|','','','',''	
*/
 
create PROC [citrus_usr].[Pr_Rpt_Holding_seeta_16042010]  
			@PA_DPTYPE VARCHAR(4),                    
			@PA_EXCSMID INT,                    
			@PA_ASONDATE CHAR(1),                    
			@PA_FORDATE DATETIME,                    
...
,CONVERT(NUMERIC(18,3),DPHMCD_AVAIL_LEND_QTY),CONVERT(NUMERIC(18,3),DPHMCD_LEND_QTY),CONVERT(NUMERIC(18,3)
,DPHMCD_BORROW_QTY),DPAM_ID
,HOLDING_DT=CONVERT(VARCHAR(11),@PA_FORDATE,109)--CONVERT(VARCHAR(11),@@TMPHOLDING_DT,109)
,CMP=ISNULL(convert(numeric(18,2)
,CLOPM_CDSL_RT),0.00)                                     
