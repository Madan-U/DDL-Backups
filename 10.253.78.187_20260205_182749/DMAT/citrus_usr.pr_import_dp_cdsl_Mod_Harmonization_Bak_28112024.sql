-- Object: PROCEDURE citrus_usr.pr_import_dp_cdsl_Mod_Harmonization_Bak_28112024
...
CREATE  PROCeDURE [citrus_usr].[pr_import_dp_cdsl_Mod_Harmonization_Bak_28112024]( @pa_crn_no      varchar(8000)                 
                            , @pa_exch        VARCHAR(10)                  
...
select * , acct_no boidorder ,'4' id  into #tmp_line7_gr_remove from @line7 where Purpose_code ='107'
select * ,  acct_no  boidorder ,'5' id  into #tmp_line5 from @line5
select pc6.* ,  acct_no  boidorder, mSTRPOAFLG  ,'6' id   into #tmp_line6 from @line6 pc6 , dps8_pc1   a  where boid = bo3_usr_txt1
