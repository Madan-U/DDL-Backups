-- Object: PROCEDURE citrus_usr.pr_main_menu_Lock
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------


--pr_main_menu 'VISHAL','1','1*|~*6*|~*8*|~*','','*|~*','|*~|',''        
CREATE  PROCEDURE  [citrus_usr].[pr_main_menu_Lock] (@pa_login_name    VARCHAR(20)              
  ...
  **********************************************************************************/              
  ...
  --              
   ...
   begin         
      ...
      AND SCR.SCR_ID NOT IN (86,111,135,192,193,195,227,269,272,274,300,346,394,591,592,593,594,595,596,597,598)--AND   SCR.scr_parent_id NOT in (243,244,78) AND ACT.ACT_SCR_ID NOT IN (78)
	  UNION      
