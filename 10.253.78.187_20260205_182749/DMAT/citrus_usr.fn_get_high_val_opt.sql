-- Object: FUNCTION citrus_usr.fn_get_high_val_opt
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------



CREATE   function [citrus_usr].[fn_get_high_val_opt](@l_isin varchar(16),@l_qty numeric(18,3),@pa_validation varchar(50),@pa_acct_no varchar(16),@pa_request_date datetime)      
returns char(1)      
as      
begin      
--      
