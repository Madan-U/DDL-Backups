-- Object: PROCEDURE citrus_usr.pr_billing_cdsl_bak_01062016
...
--ROLLBACK
create procedure [citrus_usr].[pr_billing_cdsl_bak_01062016](@pa_billing_from_dt datetime,@pa_billing_to_dt datetime,@pa_dpm_id numeric,@pa_billing_status   char(1))
as
begin
--
...
,'ZEROWAIVE1_POAFIXED','VERSON 2.5 NORMAL_POA','VERSON 2.5 LIFETIME_POA','VERSION 2.5 LIFETIMEPOA')
					group by dpam_id ,trans_dt ) a 
					,servicetax_mstr 
