-- Object: PROCEDURE citrus_usr.pr_main_menu_vishal
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

--pr_main_menu_vishal 'SS','28','2','1*|~*42*|~*','*|~*','|*~|',''        
CREATE  PROCEDURE  [citrus_usr].[pr_main_menu_vishal] (@pa_login_name    VARCHAR(20)              
