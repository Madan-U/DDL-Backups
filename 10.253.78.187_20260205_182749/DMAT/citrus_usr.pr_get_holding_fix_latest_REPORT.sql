-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_REPORT
...
--exec [pr_get_holding_fix_latest_REPORT] 3,'oct  3 2020','oct  3 2020','0','9999999999999999',''      
...
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_REPORT](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                          
,@pa_ben_acct_no_fr varchar(16),@pa_ben_acct_no_to varchar(16)
...
and cdshm_ben_acct_no  IN (SELECT * FROM CLIENT_CODE_DND)
...
and dpam_sba_no IN (SELECT * FROM CLIENT_CODE_DND)          
