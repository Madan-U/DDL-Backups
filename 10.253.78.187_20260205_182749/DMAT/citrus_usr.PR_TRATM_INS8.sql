-- Object: PROCEDURE citrus_usr.PR_TRATM_INS8
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

CREATE PROCEDURE [citrus_usr].[PR_TRATM_INS8]
              AS
              BEGIN
                  --
                    DECLARE
                       ...
                       ,@l_sub_cd    VARCHAR(50)
                        ...
                        SET @l_code='DEMAT_LOCK_CD_CDSL'
                        SET @l_desc ='DEMAT LOCK IN CODES'
                        DELETE FROM TRANSACTION_SUB_TYPE_MSTR WHERE TRASTM_TRATM_ID=(SELECT TRANTM_ID FROM TRANSACTION_TYPE_MSTR WHERE TRANTM_CODE ='DEMAT_LOCK_CD_CDSL')
		        DELETE FROM TRANSACTION_TYPE_MSTR WHERE TRANTM_CODE = 'DEMAT_LOCK_CD_CDSL'
		  ...
		  END
		   ...
		   /* EXECUTE PR_TRATM_INS8 select * from transaction_type_mstr
