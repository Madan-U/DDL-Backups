-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_byisin_test_all
...
--exec [pr_get_holding_fix_byisin_test_all] 'jul 16 2012','jul 16 2012','1201090000004621','1201090000004621','',''        
--1201090000025122~INE083C01022        
        
        
        
CREATE proc [citrus_usr].[pr_get_holding_fix_byisin_test_all](@pa_from_dt datetime, @pa_to_dt datetime                            
,@pa_ben_acct_no_fr varchar(16),@pa_ben_acct_no_to varchar(16),@pa_isin varchar(20),@pa_out  varchar(8000) out)          
as          
begin           
      
if exists(select name from sysobjects where name ='holdingcalc31032012')      
DROP TABLE holdingcalc31032012      
...
into #tmp_dp_daily_hldg_cdsl from cdsl_holding_dtls          
...
,convert(numeric(18,5),0) DPHMCD_LEND_QTY        
,convert(numeric(18,5),0) DPHMCD_BORROW_QTY        
from dp_daily_hldg_cdsl a ,dp_acct_mstr  where dphmcd_holding_dt ='jul 31 2011'        
...
and not exists(select b.dphmcd_dpam_id,b.dphmcd_isin,b.dphmcd_dpm_id from #tmp_dp_daily_hldg_cdsl b where a.dphmcd_dpm_id = b.dphmcd_dpm_id        
...
from #tmp_dp_daily_hldg_cdsl   a , #finalholding f        
...
into #holdingdmtpenfing2 from  dp_daily_hldg_cdsl, DP_aCCT_MSTR     
...
and CDSHM_TRAS_DT between  'aug 01 2011' and @pa_to_dt
AND CDSHM_CDAS_TRAS_TYPE IN ('20','21','22','23') --20 added by tushar on 16 jul 2012
GROUP BY CDSHM_DPAM_ID ,  CDSHM_ISIN 
...
select *,@pa_to_dt dphmcd_holding_dt INTO holdingcalc31032012 from #tmp_dp_daily_hldg_cdsl         
where         
(dphmcd_curr_qty <> '0'                            
...
select * from holdingcalc31032012           
