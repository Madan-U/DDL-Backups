-- Object: PROCEDURE citrus_usr.pr_bulk_dp57_bak_22112019
...
create    proc [citrus_usr].[pr_bulk_dp57_bak_22112019]
(  
...
BEGIN 
		...
		WHERE PROCESS_FOR='DP57900' and PROCESS_DATE=convert(varchar(11),getdate(),109)
        return
		--
		END
