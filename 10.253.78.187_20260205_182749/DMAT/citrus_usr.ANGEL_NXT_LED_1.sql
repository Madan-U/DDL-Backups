-- Object: PROCEDURE citrus_usr.ANGEL_NXT_LED_1
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------



CREATE PROC [citrus_usr].[ANGEL_NXT_LED_1] 
...
IF (@LTYPE ='L' ) 
		BEGIN 
			...
			SET @STRSQL = @STRSQL + ' ,LDG_VOUCHER_DT  LD_DT ,CONVERT(NUMERIC(18,4),LDG_AMOUNT  ) LD_AMOUNT,CASE WHEN LDG_AMOUNT < 0 THEN LDG_AMOUNT END LD_AMOUNT_D,0 LD_AMOUNT_C '   
			...
			SET @STRSQL = @STRSQL + ' ELSE '''' END  '
			SET @STRSQL = @STRSQL + ' LD_CLIENTCD     '
			SET @STRSQL = @STRSQL + ' ,LDG_VOUCHER_DT  LD_DT ,CONVERT(NUMERIC(18,4),LDG_AMOUNT  ) LD_AMOUNT ,0 LD_AMOUNT_D,CASE WHEN LDG_AMOUNT > 0 THEN LDG_AMOUNT END LD_AMOUNT_C '   
