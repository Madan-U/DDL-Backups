-- Object: PROCEDURE citrus_usr.PR_IMPORT_CLIENT_CDSL_DPB9_bak_09042016
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------

create PROCEDURE  [citrus_usr].[PR_IMPORT_CLIENT_CDSL_DPB9_bak_09042016]
			(
			 @pa_exch          VARCHAR(20)    
...
--
--
update dpam set DPAM_STAM_CD = [mSTRPOAFLG] from dp_acct_mstr dpam , dpb9_pc1  where boid = dpam_sba_no
...
UPDATE DPAM SET dpam_stam_Cd ='05' FROM dps8_pc1 ,dp_acct_mstr DPAM
where boacctstatus ='3'
