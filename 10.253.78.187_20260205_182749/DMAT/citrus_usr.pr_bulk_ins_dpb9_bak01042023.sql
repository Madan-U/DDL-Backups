-- Object: PROCEDURE citrus_usr.pr_bulk_ins_dpb9_bak01042023
...
create proc [citrus_usr].[pr_bulk_ins_dpb9_bak01042023]    
 (    
    @pa_exch          VARCHAR(20)        
...
,AFILLER1,AFILLER6,AFILLER7,AFILLER8,AFILLER9,AFILLER10,AFILLER2,AFILLER3,AFILLER4,AFILLER5,BOId,TransSystemDate) VALUES(''' +replace( REPLACE(value,'''',''''''),'~',''',''') + ''') '     
from #dpb9_pc1     
where ID = @L_COUNTER    
