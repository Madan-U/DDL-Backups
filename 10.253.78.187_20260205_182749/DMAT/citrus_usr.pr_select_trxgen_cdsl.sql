-- Object: PROCEDURE citrus_usr.pr_select_trxgen_cdsl
...
--rollback
CREATE PROCEDURE [citrus_usr].[pr_select_trxgen_cdsl]  
(  
...
update CLOSURE_ACCT_CDSL set CLSR_RMKS = 'AS PER CLIENT REQUEST'    where   CLSR_RMKS like '%AS PER CLIENT REQUEST%'
and  CONVERT(DATETIME,CONVERT(VARCHAR(11),CLSR_DATE,109)) BETWEEN @PA_FROM_DT  AND @PA_TO_DT  
 ...
 SELECT CONVERT(VARCHAR(16),ISNULL(CLSR_BO_ID,''))AS CLSR_BO_ID ,
        ...
        ----and CLSR_BO_ID = 1203320021084471
