-- Object: PROCEDURE citrus_usr.pr_breakup_bak_03042020
-- Server: 10.253.78.187 | DB: DMAT
--------------------------------------------------


CREATE procedure [citrus_usr].[pr_breakup_bak_03042020](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
