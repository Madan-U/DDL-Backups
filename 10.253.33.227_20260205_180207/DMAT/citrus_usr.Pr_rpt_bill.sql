-- Object: PROCEDURE citrus_usr.Pr_rpt_bill
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--[Pr_rpt_bill] 'NSDL',4,'MAR  1 2009','MAR 31 2009 23:59:59','N','N','','','','N','Y',1,'ho|*~|',''	

CREATE procedure  [citrus_usr].[Pr_rpt_bill]              
@pa_dptype varchar(4),                      
@pa_excsmid int,                      
...
prev_bill_bal numeric(18,2)
 ...
 begin           
  insert into #tempmaincdsl(dpam_id,dpam_sba_name,dpam_acctno,trans_desc,dpm_trans_no,trans_date,isin_cd,opening_bal,qty,order_by,line_no,charge_val)           
  select clic_dpam_id,dpam_sba_name,dpam_sba_no,clic_charge_name,null,clic_trans_dt=@pa_todate,null,null,null,2,0,clic_charge_amt           
 ...
 begin  
  ...
  and (clic_TRANS_DT between eff_from and eff_to)            
   ...
   END 	
	...
	CDSHM_TRATM_DESC=ltrim(rtrim(trans_desc)),              
	dpm_trans_no,                      
 ...
 begin  
   ...
   left outer join settlement_type_mstr s with(nolock) on t.sett_type = s.settm_type and isnull(s.settm_type,'') <> ''           
