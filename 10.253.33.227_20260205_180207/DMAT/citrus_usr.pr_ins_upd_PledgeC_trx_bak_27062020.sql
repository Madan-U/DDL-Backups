-- Object: PROCEDURE citrus_usr.pr_ins_upd_PledgeC_trx_bak_27062020
...
create  PROCEDURE [citrus_usr].[pr_ins_upd_PledgeC_trx_bak_27062020]
             (@pa_id              VARCHAR(8000)      
...
--case when @l_val_yn = 'Y' then 'Y' else citrus_usr.fn_get_high_val(@l_isin,abs(@l_qty),'HIGH_VALUE','','') end    
