-- Object: PROCEDURE citrus_usr.SP_MULTI_CLIENT_DTLS_fortest
...
CREATE PROCEDURE [citrus_usr].[SP_MULTI_CLIENT_DTLS_fortest]
( 
...
print @@L_CHILD_ENTM_ID
		SELECT case when fre_action = 'F' then 'FREEZED' else STAM_DESC end [STATUS]
