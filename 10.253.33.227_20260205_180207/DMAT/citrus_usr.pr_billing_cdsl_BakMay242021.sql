-- Object: PROCEDURE citrus_usr.pr_billing_cdsl_BakMay242021
...
--ROLLBACK
Create procedure [citrus_usr].[pr_billing_cdsl_BakMay242021](@pa_billing_from_dt datetime,@pa_billing_to_dt datetime,@pa_dpm_id numeric,@pa_billing_status   char(1))
as
begin
--
...
and (
 ...
 or
  exists (select   1  from AMCDec2019Oct2020 where bdpam_id = dpam_id and @pa_billing_to_dt < clic_nextamcdt ) -- May 11 2021 for client cross 1 year for exceptional client
 )
