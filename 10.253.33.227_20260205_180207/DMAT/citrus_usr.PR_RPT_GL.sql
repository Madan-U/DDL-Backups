-- Object: PROCEDURE citrus_usr.PR_RPT_GL
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------


CREATE  PROCEDURE [citrus_usr].[PR_RPT_GL]
@PA_FROM_DT DATETIME
,@PA_TO_DT DATETIME
,@PA_VOUCHER_TYPE VARCHAR (20)
,@PA_GL_CODE VARCHAR (220)
...
select LDG_VOUCHER_NO INTO #TEMP from ledger12 ,FIN_ACCOUNT_MSTR
