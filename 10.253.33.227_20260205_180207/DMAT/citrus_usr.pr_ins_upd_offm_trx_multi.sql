-- Object: PROCEDURE citrus_usr.pr_ins_upd_offm_trx_multi
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE PROCEDURE [citrus_usr].[pr_ins_upd_offm_trx_multi](@pa_id              VARCHAR(8000)  
								...
								--
								  ...
								  IF @l_action = 'A' OR @l_action ='E'
										...
										--
										  ...
										  set @l_tr_dpid  	        = citrus_usr.fn_splitval(@currstring_value,4) 
										  set @l_tr_acct_no         = citrus_usr.fn_splitval(@currstring_value,5) 
					                      set @l_res_cd             = citrus_usr.fn_splitval(@currstring_value,6) 
