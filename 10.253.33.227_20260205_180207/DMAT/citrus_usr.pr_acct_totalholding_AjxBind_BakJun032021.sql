-- Object: PROCEDURE citrus_usr.pr_acct_totalholding_AjxBind_BakJun032021
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------


--pr_acct_totalholding '10054016',''  
Create procedure [citrus_usr].[pr_acct_totalholding_AjxBind_BakJun032021]( @pa_sba_no  varchar(20)  
