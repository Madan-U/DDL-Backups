-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_ang
...
CREATE Proc [citrus_usr].[Pr_rpt_statement_ang]                                
@pa_dptype varchar(4),                                        
@pa_excsmid int,                                        
...
begin     
 insert into #tmphldg    
 exec CITRUS_USR.[pr_get_holding_fix_latest]   @@DPMID,@pa_fromdate,@pa_todate,@PA_FROMACCID,@PA_TOACCID,''    
...
begin 
  ...
  begin     
	insert into #vw_fethob    
	exec CITRUS_USR.pr_get_ob_fix @@dpmid,@pa_fromdate,@pa_todate,@pa_fromaccid,@pa_toaccid,''    
  end 
  else 
  begin 
	insert into #vw_fethob    
	exec CITRUS_USR.pr_get_ob_fix_byisin @@dpmid,@pa_fromdate,@pa_todate,@pa_fromaccid,@pa_toaccid,@pa_isincd,''    
  end 	
end     
else     
begin  
...
begin     
  ...
  begin 
	...
	begin 
	insert into #vw_fethob    
	exec CITRUS_USR.pr_get_ob_fix @@dpmid,@pa_fromdate,@pa_todate,@l_acct_no,@l_acct_no,''    
	end 
	else 
	begin 
	insert into #vw_fethob    
	exec CITRUS_USR.pr_get_ob_fix_byisin @@dpmid,@pa_fromdate,@pa_todate,@l_acct_no,@l_acct_no,@pa_isincd,''    
	end 
  end 	
