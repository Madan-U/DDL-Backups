-- Object: PROCEDURE citrus_usr.pr_ins_upd_demrm_rejlogic_bak_06072022
...
CREATE PROCEDURE [citrus_usr].[pr_ins_upd_demrm_rejlogic_bak_06072022](@pa_id              VARCHAR(8000)  
                                            ...
                                            , @pa_tot_cer        numeric
											, @pa_chk_yn         INT 
											, @pa_rejcdintobj    varchar(25)
											, @pa_rejsescintobj  varchar(250)
											, @pa_rejcdcompobj   varchar(25)
											, @pa_rejsesccompobj varchar(250)
...
print @currstring
				      ...
				      --
				        ...
				        BEGIN TRANSACTION
												...
												order by demttd_created_dt desc	
...
print 'gggg'
				      ...
				      IF @l_deleted_ind = 6 
				        ...
				        SET    demrm_isin               = demrmm.demrm_isin               
																		...
																		,demrm_rmks               = demrmm.demrm_rmks + ' ' + @pa_rmks --demrmm.demrm_rmks               
				    ...
				    ELSE IF @pa_action = 'REJ'
								...
								--
								  BEGIN TRANSACTION
										...
										UPDATE demrm_mak
										SET    demrm_deleted_ind = 0
										,demrm_res_cd_intobj = @pa_rejcdintobj
										,demrm_res_desc_intobj = @pa_rejsescintobj
										,demrm_res_cd_compobj = @pa_rejcdcompobj
										,demrm_res_desc_compobj	= @pa_rejsesccompobj
										,DEMRM_RMKS =    @pa_rmks
										,DEMRM_LST_UPD_BY = @pa_login_name
										,demrm_lst_upd_dt = getdate()
										WHERE  demrm_deleted_ind in (0,4,6,-1)
										AND    demrm_id          = CONVERT(INT,@currstring) 
