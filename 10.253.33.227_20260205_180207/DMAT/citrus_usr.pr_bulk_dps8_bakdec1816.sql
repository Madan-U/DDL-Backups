-- Object: PROCEDURE citrus_usr.pr_bulk_dps8_bakdec1816
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

create proc [citrus_usr].[pr_bulk_dps8_bakdec1816](@pa_dbpath varchar(8000))  
as  
begin   
...
,	BOId	=	citrus_usr.fn_splitval_by(value,	6	,'~')
,	TransSystemDate	=	citrus_usr.fn_splitval_by(value,	7	,'~')
