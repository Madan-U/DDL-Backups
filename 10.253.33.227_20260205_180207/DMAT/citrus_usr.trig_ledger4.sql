-- Object: TRIGGER citrus_usr.trig_ledger4
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------


CREATE  TRIGGER [citrus_usr].[trig_ledger4]   
 ON [citrus_usr].[LEDGER4]  
 FOR INSERT,UPDATE  
 AS  
