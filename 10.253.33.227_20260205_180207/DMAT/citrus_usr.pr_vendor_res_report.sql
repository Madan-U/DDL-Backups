-- Object: PROCEDURE citrus_usr.pr_vendor_res_report
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE  procedure [citrus_usr].[pr_vendor_res_report]  (@pa_from_no varchar(50)
,@pa_to_no  varchar(50)
,@pa_from_dt datetime
,@pa_to_dt datetime
...
--0
	 INSERT INTO #ACLIST SELECT DPAM_ID,DPAM_SBA_NO,DPAM_SBA_NAME,EFF_FROM,EFF_TO FROM CITRUS_USR.FN_ACCT_LIST(@@DPMID ,@PA_LOGIN_PR_ENTM_ID,@@L_CHILD_ENTM_ID)    
		...
		--,convert(varchar(19),d.reco_datetime,120) AS "RECO DTTIME"
