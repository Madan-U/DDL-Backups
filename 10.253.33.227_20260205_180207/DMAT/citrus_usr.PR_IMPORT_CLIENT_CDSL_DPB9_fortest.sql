-- Object: PROCEDURE citrus_usr.PR_IMPORT_CLIENT_CDSL_DPB9_fortest
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--begin tran
--exec PR_IMPORT_CLIENT_CDSL_DPB9_fortest 'CDSL','HO','normal','','*|~*','|*~|',''  
...
CREATE  PROCEDURE  [citrus_usr].[PR_IMPORT_CLIENT_CDSL_DPB9_fortest]
			(
			 @pa_exch          VARCHAR(20)    
