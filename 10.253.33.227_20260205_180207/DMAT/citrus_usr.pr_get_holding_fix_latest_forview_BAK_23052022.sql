-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_forview_BAK_23052022
...
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_forview_BAK_23052022](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
from cdsl_holdING_DTLS a where  CDSHM_CDAS_TRAS_TYPE='4'   and cdshm_tratm_cd ='2277'
and exists 
(select 1 from cdsl_holdING_DTLS b 
where a.CDSHM_DPAM_ID = b.CDSHM_DPAM_ID 
and a.CDSHM_ISIN = b.CDSHM_ISIN 
and a.CDSHM_TRANS_NO = b.cdshm_trans_no
and ABS(a.CDSHM_QTY )= ABS(b.cdshm_qty)
and b.CDSHM_CDAS_SUB_TRAS_TYPE ='409'  and b.cdshm_tratm_cd ='2215') 
and CDSHM_TRAS_DT between  @pa_from_dt and @pa_to_dt
GROUP BY CDSHM_DPAM_ID ,  CDSHM_ISIN
