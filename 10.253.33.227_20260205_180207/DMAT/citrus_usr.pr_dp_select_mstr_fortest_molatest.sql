-- Object: PROCEDURE citrus_usr.pr_dp_select_mstr_fortest_molatest
...
CREATE PROCEDURE  [citrus_usr].[pr_dp_select_mstr_fortest_molatest]( @pa_id  VARCHAR(800)                          
...
PRINT @l_entm_id      
      SELECT distinct  @l_dpm_dpid                                DPID                         
            ...
            ,isnull(replace(convert(varchar,dptdc_execution_dt,103),'01/01/1900',''),'') EXECUTIONDATE                                               
