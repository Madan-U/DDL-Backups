-- Object: PROCEDURE citrus_usr.pr_ins_upd_clim
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE  PROCEDURE [citrus_usr].[pr_ins_upd_clim](@pa_id          VARCHAR(8000)        
...
ISNULL(CONVERT(VARCHAR,@l_enttm_id),'')+@coldelimiter+CONVERT(VARCHAR,@l_error)+@coldelimiter+@rowdelimiter         
            ...
            --        
              ...
              --        
                ...
                --            
                EXEC citrus_usr.pr_ins_upd_entp '1', 'EDT', @pa_login_name, @l_clim_crn_no, '', @l_values, @l_dtls_values , @pa_chk_yn, '*|~*','|*~|',''         
                --        
              END        
              --pan_gir_no changed by Tushar on 18/07/2007        
              --         
            ...
            --        
              ...
              --        
                ...
                --    
                  ...
                  --    
                  EXEC citrus_usr.pr_ins_upd_entp '1', 'EDT', @pa_login_name, @l_clim_crn_no, '', @l_values, @l_dtls_values, 1, '*|~*','|*~|',''     
                --    
                END     
                --pan_gir_no changed by tushar on 18/07/2007        
              --        
