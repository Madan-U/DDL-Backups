-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_BBOCODE_arch_bkp_09122021
...
Create PROCEDURE [citrus_usr].[pr_get_holding_fix_latest_BBOCODE_arch_bkp_09122021]
(
	@pa_dpm_id  NUMERIC,
	@pa_from_dt DATETIME, 
	@pa_to_dt   DATETIME  ,
...
SELECT A.* INTO #cdsl_holding_dtls_tmp 
         FROM dmat_archival.citrus_usr.cdsl_holding_dtls A WITH (NOLOCK)    
		      INNER JOIN #CLIENTLIST B On A.CDSHM_BEN_ACCT_NO = B.SBANO 
