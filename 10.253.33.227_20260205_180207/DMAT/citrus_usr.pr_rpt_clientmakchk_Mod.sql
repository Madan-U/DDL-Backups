-- Object: PROCEDURE citrus_usr.pr_rpt_clientmakchk_Mod
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--exec pr_rpt_clientmakchk '4','dec 01 2008','nov 19 2009'  
CREATE  procedure [citrus_usr].[pr_rpt_clientmakchk_Mod]  
(  
@pa_excsm_id numeric,  
@pa_from_dt datetime,  
@pa_to_dt datetime  
...
Select distinct convert(varchar(11),clic_mod_from_dt,109) ModDt,convert(varchar,clic_mod_dpam_sba_no) + '  & Batch no : ' + convert(varchar,clic_mod_batch_no) clic_mod_dpam_sba_no,citrus_usr.fn_ucc_accp(dpam_id,'BBO_CODE','') bbo_code
