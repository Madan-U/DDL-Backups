...
convert(numeric(5,2),(CASE WHEN SecAccCd='' THEN '0' ELSE SecAccCd END )) CM_SECURITYCODE,    ----CHANGE UNDER SRE-38564    
...
convert(numeric(5,2),(CASE WHEN StockExch='' THEN '0' ELSE StockExch END))CM_STOCKEXCHANGE,     ----CHANGE UNDER SRE-38564    
