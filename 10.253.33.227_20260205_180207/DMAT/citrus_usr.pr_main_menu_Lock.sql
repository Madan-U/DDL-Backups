  ...
  **********************************************************************************/              
  ...
  --              
   ...
   begin         
      ...
      AND SCR.SCR_ID NOT IN (86,111,135,192,193,195,227,269,272,274,300,346,394,591,592,593,594,595,596,597)--AND   SCR.scr_parent_id NOT in (243,244,78) AND ACT.ACT_SCR_ID NOT IN (78)
	  UNION      
