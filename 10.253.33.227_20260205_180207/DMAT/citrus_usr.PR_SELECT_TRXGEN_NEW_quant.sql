-- Object: PROCEDURE citrus_usr.PR_SELECT_TRXGEN_NEW_quant
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--USE [Dmat_nsdl]
--GO
--/****** Object:  StoredProcedure [citrus_usr].[PR_SELECT_TRXGEN_NEW]    Script Date: 12/08/2010 10:32:18 ******/
--SET ANSI_NULLS ON
--GO
...
create PROCEDURE [citrus_usr].[PR_SELECT_TRXGEN_NEW_quant]  
(  
      ...
      --
								...
								If @PA_BATCHTYPE = 'BN' -- START OF NEW BATCH  
										...
										--  
												...
												+ ISNULL(DPTD_ISIN,'')    
												+ ISNULL(citrus_usr.FN_FORMATSTR(convert(varchar(18),ABS(DPTD_QTY)),15,3,'L','0'),space(18))    
												+ space(2)  
												+ Space(8)   
												...
												+ space(2) --REPLICATE(0,2)   
												+ 'IN000026'--Isnull(dptd_counter_dp_id,SPACE(8))
                                                + space(17)   
												+ case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(35),ISNULL(DPTD_SLIP_NO,''))         else CONVERT(CHAR(35),ISNULL(dptd_internal_ref_no,'')) end --Isnull(dptd_internal_ref_no,space(20))     
						                        + case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(50),ISNULL(dptd_internal_ref_no,'')) else CONVERT(CHAR(50),ISNULL(DPTD_SLIP_NO,'')) end --convert(char(20),ISNULL(DPTD_SLIP_NO,''))
                                                + SPACE(50)
...
print '1'
												...
												+ SPACE(2)--Replicate(0,2)  
												+ SPACE(8)    
												+ Space(17)--ISNULL(D1.DPTD_other_SETTLEMENT_NO,SPACE(7))   
												+ case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(35),ISNULL(DPTD_SLIP_NO,''))         else CONVERT(CHAR(35),ISNULL(dptd_internal_ref_no,'')) end --Isnull(dptd_internal_ref_no,space(20))     
						                        + case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(50),ISNULL(dptd_internal_ref_no,'')) else CONVERT(CHAR(50),ISNULL(DPTD_SLIP_NO,'')) end --convert(char(20),ISNULL(DPTD_SLIP_NO,''))
                                                + SPACE(85) 
                                                + '0' -- Priority flag --space(1) 
                                                + Space(24) as DpmTrxDtls , @L_QTY  
												, @L_TRX_TAB  
												, DPTD_ID  
...
PRINT @l_slip_no_rmks_yn
												...
												+ case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(35),ISNULL(DPTD_SLIP_NO,''))         else CONVERT(CHAR(35),ISNULL(dptd_internal_ref_no,'')) end --Isnull(dptd_internal_ref_no,space(20))     
						                        + case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(50),ISNULL(dptd_internal_ref_no,'')) else CONVERT(CHAR(50),ISNULL(DPTD_SLIP_NO,'')) end --convert(char(20),ISNULL(DPTD_SLIP_NO,''))
                                                + SPACE(85) + '1' + SPACE(24) as DpmTrxDtls   
												, @L_QTY  
												, @L_TRX_TAB  
												, DPTD_ID  
							...
							--  
										...
										--            
                                                ...
                                                + ISNULL(convert(varchar,dptd_execution_dt,112),'')    
												+ Space(6)   
												--+ DPM_DPID--ISNULL(dptd_counter_dp_id,Space(8))--space(16)
												+ ISNULL(ENTM_NAME3,space(8))
												+ ISNULL(dptd_counter_demat_acct_no,Space(8))   
												+ Replicate(0,2)    
												+ ISNULL(dptd_counter_cmbp_id,space(8))           
												+ Space(17)--ISNULL(dptd_counter_cmbp_id,space(8)) --ISNULL(D1.DPTD_other_SETTLEMENT_NO,SPACE(7))   
												+ case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(35),ISNULL(DPTD_SLIP_NO,''))         else CONVERT(CHAR(35),ISNULL(dptd_internal_ref_no,'')) end --Isnull(dptd_internal_ref_no,space(20))     
						                        + case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(50),ISNULL(dptd_internal_ref_no,'')) else CONVERT(CHAR(50),ISNULL(DPTD_SLIP_NO,'')) end --convert(char(20),ISNULL(DPTD_SLIP_NO,''))
                                                + SPACE(85) + '1' + space(24) as DpmTrxDtls     
												, @L_QTY  
												, @L_TRX_TAB  
												, DPTD_ID  
												FROM DP_TRX_DTLS D1, DP_ACCT_MSTR D2 ,SETTLEMENT_TYPE_MSTR D4  , ENTITY_MSTR --,DP_MSTR
												WHERE D1.DPTD_DPAM_ID = D2.DPAM_ID AND DPAM_DPM_ID = @L_DPM_ID  --AND D2.DPAM_DPM_ID=DPM_ID AND DEFAULT_DP=DPM_EXCSM_ID AND DPM_DELETED_IND=1
							...
							--   
										...
										--  
												...
												+ Space(27)--ISNULL(D1.DPTD_SETTLEMENT_NO,SPACE(7))   
												+ case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(35),ISNULL(DPTD_SLIP_NO,''))         else CONVERT(CHAR(35),ISNULL(dptd_internal_ref_no,'')) end --Isnull(dptd_internal_ref_no,space(20))     
						                        + case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(50),ISNULL(dptd_internal_ref_no,'')) else CONVERT(CHAR(50),ISNULL(DPTD_SLIP_NO,'')) end --convert(char(20),ISNULL(DPTD_SLIP_NO,''))
                                                + SPACE(85) + '0' + space(24) as DpmTrxDtls   
												, @L_QTY  
												, @L_TRX_TAB  
																																										, DPTD_ID  
							...
							--   
										...
										IF LTRIM(RTRIM(@L_TRX_TAB)) = 'DMT'  
																...
																--  
																		...
																		+ ISNULL(citrus_usr.FN_FORMATSTR(ABS(demrM_QTY),12,3,'L','0'),space(15))    
																		+ Space(68)    
																		+ ISNULL(convert(char(20),DEMRM_SLIP_SERIAL_NO),space(20))   
																		+ Isnull(convert(char(35),demrm_id),space(35))   
                                                                        + Space(73) 
																		 as DpmTrxDtls   
																		, @L_QTY  
																		, @L_TRX_TAB  
																		, DEMRM_ID  
																		FROM demat_request_mstr D1 , DP_ACCT_MSTR D2   
																		WHERE D1.demrm_DPAM_ID = D2.DPAM_ID AND DPAM_DPM_ID = @L_DPM_ID  
              ...
              order by remrm_lst_upd_dt                                 
                               ...
                               order by dptd_lst_upd_dt 
                                ...
                                order by dptd_lst_upd_dt 
										...
										--  
												...
												+ CASE WHEN (LEN(ISNULL(D4.SETTM_TYPE_CDSL,'')) = 6 AND ISNULL(DPTD_OTHER_SETTLEMENT_NO,'') <> '') THEN  citrus_usr.FN_FORMATSTR(D4.SETTM_TYPE_CDSL+D1.DPTD_OTHER_SETTLEMENT_NO,13,0,'R','') ELSE REPLICATE(0,13) END 
												--+ ISNULL(D1.DPTD_SETTLEMENT_NO,SPACE(7))
                                                + SPACE(22) + '0' + space(24)  as DpmTrxDtls   
												, @L_QTY  
												, @L_TRX_TAB  
												, DPTD_ID  
												FROM DP_TRX_DTLS D1 LEFT OUTER JOIN SETTLEMENT_TYPE_MSTR D3 ON D1.DPTD_MKT_TYPE=CONVERT(VARCHAR,D3.SETTM_ID)  
							...
							--   
										...
										--  
												...
												+ case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(35),ISNULL(DPTD_SLIP_NO,''))         else CONVERT(CHAR(35),ISNULL(dptd_internal_ref_no,'')) end --Isnull(dptd_internal_ref_no,space(20))     
						                        + case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(50),ISNULL(dptd_internal_ref_no,'')) else CONVERT(CHAR(50),ISNULL(DPTD_SLIP_NO,'')) end --convert(char(20),ISNULL(DPTD_SLIP_NO,''))
                                                + SPACE(85) + '0' + space(24) as DpmTrxDtls 												, @L_QTY  
												, @L_TRX_TAB  
												, DPTD_ID  
												FROM DP_TRX_DTLS D1, DP_ACCT_MSTR D2 ,SETTLEMENT_TYPE_MSTR D5  
												WHERE D1.DPTD_DPAM_ID = D2.DPAM_ID AND DPAM_DPM_ID = @L_DPM_ID  
...
IF LTRIM(RTRIM(@L_TRX_TAB)) = 'REPRMT'  
	...
	IF LTRIM(RTRIM(@L_TRX_TAB)) = 'CPLDG'  
										BEGIN 
																...
																+ ISNULL(D2.DPAM_SBA_NO,'')   
																+ ISNULL(PLDT_ISIN,'')    
																+ ISNULL(citrus_usr.FN_FORMATSTR(convert(varchar(18),ABS(PLDT_QTY)),15,3,'L','0'),space(18))    
																...
																+ Space(17)   
                                                                + case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(35),ISNULL(PLDT_SLIP_NO,''))         else CONVERT(CHAR(35),ISNULL(PLDT_ID,'')) end --Isnull(dptd_internal_ref_no,space(20))     
						                                        + case when @l_slip_no_rmks_yn = '1' then CONVERT(CHAR(50),ISNULL(PLDT_ID,'')) else CONVERT(CHAR(50),ISNULL(PLDT_SLIP_NO,'')) end --convert(char(20),ISNULL(DPTD_SLIP_NO,''))
                                                				+ SPACE(50)
										...
										BEGIN 
																...
																SELECT    
																	ISNULL(PLDT_TRASTM_CD,'')   
																+ 'A'   
																+ ISNULL(citrus_usr.FN_FORMATSTR(convert(varchar(14),ABS(PLDT_SEQ_NO)),14,0,'L','0'),space(14))--Space(7) -- ORG ORDER REF NO
																+ ISNULL(D2.DPAM_SBA_NO,'')   
																+ ISNULL(PLDT_ISIN,'')    
																+ ISNULL(citrus_usr.FN_FORMATSTR(convert(varchar(18),ABS(PLDT_QTY)),15,3,'L','0'),space(18))    
																+ Space(26) -- FILLER  		
										...
										BEGIN 
																...
																'911'  
																+ 'A'   
																+ ISNULL(citrus_usr.FN_FORMATSTR(convert(varchar(14),ABS(PLDT_SEQ_NO)),14,0,'L','0'),space(14))  -- ORG ORDER REF NO
																+ ISNULL(D2.DPAM_SBA_NO,'')   
																+ ISNULL(PLDT_ISIN,'')    
																+ ISNULL(citrus_usr.FN_FORMATSTR(convert(varchar(18),ABS(PLDT_QTY)),15,3,'L','0'),space(18))    
										...
										BEGIN 
																...
																SELECT    
																	ISNULL(PLDT_TRASTM_CD,'')   
																+ 'A'   
																+ Space(14) -- PLEDGE TRANSACTION ID
																+ ISNULL(D2.DPAM_SBA_NO,'')   
																+ ISNULL(PLDT_ISIN,'')    
																+ ISNULL(citrus_usr.FN_FORMATSTR(convert(varchar(18),ABS(PLDT_QTY)),15,3,'L','0'),space(18))    
																+ ISNULL(PLDT_STATUS,'')
  ...
  --C2C*|~*P2C*|~*C2P*|~*IDD*|~*ATO*|~*IDO*|~*DO*|~* 
   ...
   SELECT @L_TOTQTY20 =QTY FROM @l_table  WHERE trans_desc = 'REPRMT' -- 919
      ...
      SELECT @L_TOT905QTY =  CONVERT(NUMERIC(18,3),ISNULL(@L_TOTQTY12,'0'))   
		...
		--new+ REPLICATE(0,18)
--new+ REPLICATE(0,18)
        + REPLICATE(0,18) -- 801 should come
		...
		+ ISNULL(CITRUS_USR.FN_FORMATSTR(substring(@L_TOTQTY8,1,len(convert(varchar(18),@L_TOTQTY8))-2),15,3,'L','0'),REPLICATE(0,18)) --934  
