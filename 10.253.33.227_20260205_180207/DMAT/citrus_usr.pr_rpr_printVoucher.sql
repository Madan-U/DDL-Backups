-- Object: PROCEDURE citrus_usr.pr_rpr_printVoucher
...
CREATE procedure [citrus_usr].[pr_rpr_printVoucher]    
 (@pa_id numeric    
...
set @l_sql = @l_sql + ' and ldg_deleted_ind=1 and ldg_voucher_no<>0  order by ldg_voucher_no  '    
  print @l_sql  
