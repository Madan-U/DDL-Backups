-- Object: PROCEDURE citrus_usr.pr_dp_select_mstr_crystalReport
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

/*
select * from LEDGER1 ORDER BY 1 DESC  
exec pr_dp_select_mstr '0','CLIENT_INFO','HO','107
 
*/

 --pr_dp_select_mstr '90123456','GETDORMANTCLTMSG','','0','','','01/09/2009','',0,'*|~*','|*~|','' 
 CREATE PROCEDURE  [citrus_usr].[pr_dp_select_mstr_crystalReport]
	( 
	@pa_id  VARCHAR(20)                  
