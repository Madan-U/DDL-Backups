-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_asondt
...
--exec [pr_get_holding_fix_latest] 485031,'jul 12 2012','jul 12 2012','1201090700150315','1201090700150315',''    
--1201090000025122~INE083C01022    
    
    
    
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_asondt](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
select * from #holdingall_ASON

drop table #holdingall_ASON 
