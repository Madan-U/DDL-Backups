-- Object: PROCEDURE citrus_usr.pr_get_invzero_zeroinv_bak_29122015
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--exec pr_get_invzero_zeroinv 'INVTOZERO'
--exec pr_get_invzero_zeroinv 'ZEROTOINV'
create proc [citrus_usr].[pr_get_invzero_zeroinv_bak_29122015](@pa_tab varchar(100))
as
begin 
...
insert into #final
exec pr_get_client_list 'Dec 29 2015'
