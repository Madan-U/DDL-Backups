-- Object: PROCEDURE citrus_usr.pr_get_txt_filegen_ForAngelID_bak
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--PR_GET_TXT_FILEGEN 'CLIENT','12033200','1203320000714231','1203320000714231','AUG 01 2015','AUG 31 2015'
create PROC [citrus_usr].[pr_get_txt_filegen_ForAngelID_bak](@PA_ACTION VARCHAR(100),@PA_DPID VARCHAR(100)    
,@PA_BOID VARCHAR(100)    
,@PA_ISIN VARCHAR(100)    
