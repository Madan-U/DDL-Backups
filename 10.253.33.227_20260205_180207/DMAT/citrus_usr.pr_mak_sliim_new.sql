-- Object: PROCEDURE citrus_usr.pr_mak_sliim_new
...
SLIIM_DPM_ID
*/
CREATE PROCEDURE [citrus_usr].[pr_mak_sliim_new](
								  @pa_id             VARCHAR(8000)  
		...
		--
          ...
          --
				    ...
				    --
				      ...
				      select @l_sliim_gen_id = ISNULL(MAX(sliim_gen_id),0) + 1 FROM slip_issue_mstr
				      ...
				      ,@pa_sliim_tratm_id
										...
										,@pa_login_name
										,getdate()
										,1,@pa_dt,@pa_book_name, @pa_rmks,@l_sliim_gen_id,getdate()
				      )
