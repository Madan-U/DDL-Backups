-- Object: PROCEDURE citrus_usr.pr_dp_select_mstr_bak_01082017
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

create  PROCEDURE  [citrus_usr].[pr_dp_select_mstr_bak_01082017]( @pa_id  VARCHAR(800)                          
...
UNION ALL
SELECT DPM_EXCSM_ID EXCM_ID,CASE WHEN LEFT(DPM_DPID,3)='IN6' THEN 'BSE' WHEN LEFT(DPM_DPID,3)='IN5' THEN 'NSE' ELSE '' END
