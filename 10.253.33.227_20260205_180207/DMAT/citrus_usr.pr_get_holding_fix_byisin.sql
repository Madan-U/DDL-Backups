-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_byisin
...
CREATE proc [citrus_usr].[pr_get_holding_fix_byisin](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
