-- Object: PROCEDURE citrus_usr.pr_ins_upd_onmP2C_trx
...
CREATE PROCEDURE [citrus_usr].[pr_ins_upd_onmP2C_trx](@pa_id              VARCHAR(8000)  
...
--
		...
		-- 
				...
				INSERT INTO #temp_id VALUES(citrus_usr.FN_SPLITVAL(@l_str2,3))
