-- Object: PROCEDURE citrus_usr.Pr_rpt_bill_profile_filter_Shilpa_arch
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--PR_RPT_BILL_PROFILE_FILTER 	'CDSL',3,'JAN 26 2009','JUN 26 2009','N','N','1234567890123456','','','N','Y','',1,'HO|*~|',''	

CREATE PROC [citrus_usr].[Pr_rpt_bill_profile_filter_Shilpa_arch]              
@PA_DPTYPE VARCHAR(4),                      
@PA_EXCSMID INT,                      
...
CREATE INDEX IC_OB ON #VW_FETHOB(V_CDSHM_DPM_ID,V_CDSHM_DPAM_ID,V_CDSHM_ISIN)
  ...
  EXEC PR_GET_OB_FIX_arch @@DPMID,@PA_FROMDATE,@PA_TODATE,@PA_FROMACCID,@PA_TOACCID,''


SELECT * ,CITRUS_USR.FN_SPLITVAL_BY(CDSHM_TRANS_CDAS_CODE,16,'~') EXEDT
,CITRUS_USR.FN_SPLITVAL_BY(CDSHM_TRANS_CDAS_CODE,9,'~') EXETIME INTO #TMP_CDSL_HOLDING_DTLS FROM dmat_archival.citrus_usr.CDSL_HOLDING_DTLS
