-- Object: PROCEDURE citrus_usr.pr_app_dp_client_bak_28022015
...
create PROCEDURE [citrus_usr].[pr_app_dp_client_bak_28022015](@pa_id                VARCHAR(200)  
...
print 'ssssssssssssssss'
          ...
          update clil set clim_deleted_ind = 2 from client_mstr clim, client_list clil where clil.clim_crn_no = clim.clim_crn_no and clim.clim_deleted_ind = 1 and clim.clim_crn_no = @l_crn_no
         --  
         END  
      --  
      END  
