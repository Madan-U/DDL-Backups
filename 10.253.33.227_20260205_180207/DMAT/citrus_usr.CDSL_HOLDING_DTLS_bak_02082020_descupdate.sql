-- Object: TABLE citrus_usr.CDSL_HOLDING_DTLS_bak_02082020_descupdate
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[CDSL_HOLDING_DTLS_bak_02082020_descupdate]
(
    [NEWDESCR] VARCHAR(8000) NULL,
