-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_quant18102010
...
CREATE  Proc [citrus_usr].[Pr_rpt_statement_quant18102010]                            
@pa_dptype varchar(4),                                    
@pa_excsmid int,                                    
...
insert into #tempmainnsdl_old                           
 ...
 CREATE INDEX IX_1 on #temprunning(dpam_id,Ben_ctgry,Ben_acct_type,isin_cd)                         
  ...
  TRANS_DESC = CASE WHEN ISNULL(CITRUS_USR.TOGETACADESC(dpm_trans_no,t.isin_cd),'')<>'' THEN ISNULL(CITRUS_USR.TOGETACADESC(dpm_trans_no,t.isin_cd),'') else Replace(Replace(ltrim(rtrim(isnull(TRANS_DESC,''))),'By cm - nsccl-cc','By Pay-In'),'To nsccl – cc','To Pay-In ') end,                            
