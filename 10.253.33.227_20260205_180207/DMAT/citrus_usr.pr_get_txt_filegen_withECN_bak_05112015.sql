-- Object: PROCEDURE citrus_usr.pr_get_txt_filegen_withECN_bak_05112015
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--pr_get_txt_filegen_withECN 'Client','12033200','1203320000714231','1203320000714231','aUG 01 2015','AUG 31 2015'
create proc [citrus_usr].[pr_get_txt_filegen_withECN_bak_05112015](@pa_action varchar(100),@pa_dpid varchar(100)    
,@pa_boid varchar(100)    
,@pa_isin varchar(100)    
