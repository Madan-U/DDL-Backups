-- Object: TABLE citrus_usr.DP_HOLDER_DTLS_HST
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[DP_HOLDER_DTLS_HST]
(
    [DPHD_DPAM_ID] NUMERIC(10, 0) NULL,
    [DPHD_DPAM_SBA_NO] VARCHAR(20) NULL,
