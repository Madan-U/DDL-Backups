-- Object: TABLE citrus_usr.TRANSACTION_TYPE_MSTR_bak24022022
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[TRANSACTION_TYPE_MSTR_bak24022022]
(
    [trantm_id] NUMERIC(10, 0) NOT NULL,
    [trantm_excm_id] NUMERIC(10, 0) NULL,
    [trantm_code] VARCHAR(50) NULL,
    [trantm_desc] VARCHAR(100) NULL,
