-- Object: PROCEDURE citrus_usr.pr_bulk_ins_dpb9
...
CREATE proc [citrus_usr].[pr_bulk_ins_dpb9]    
 (    
    @pa_exch          VARCHAR(20)        
...
,client_consent_dt,rsn_bsda_mod,dt_of_demise_to_dp,flg_for_nom_in_statement

,UsrTxt2,UsrFld3,BOAcctStatus,FrzSusFlg,BOCategory,BOCustType,BOSubStatus,ProdCode,ClCorpId,ClMemId
