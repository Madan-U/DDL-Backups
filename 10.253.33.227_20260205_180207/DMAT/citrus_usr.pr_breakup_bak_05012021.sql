-- Object: PROCEDURE citrus_usr.pr_breakup_bak_05012021
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

create  procedure [citrus_usr].[pr_breakup_bak_05012020](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
...
and (CDSHM_TRATM_CD ='2277'   or  CDSHM_CDAS_SUB_TRAS_TYPE in ('1002' ,'905','802','829','1012','838','816'))---,'810'
...
--select * into ytemp06112020 from #final
