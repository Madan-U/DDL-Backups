-- Object: PROCEDURE citrus_usr.pr_get_range_for_cancel
...
CREATE proc [citrus_usr].[pr_get_range_for_cancel](@pa_series varchar(100),@pa_from_slip numeric,@pa_to_slip numeric,@pa_acct_no varchar(16)
