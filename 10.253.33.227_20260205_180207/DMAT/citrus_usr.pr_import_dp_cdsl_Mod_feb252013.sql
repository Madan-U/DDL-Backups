-- Object: PROCEDURE citrus_usr.pr_import_dp_cdsl_Mod_feb252013
...
create PROCeDURE [citrus_usr].[pr_import_dp_cdsl_Mod_feb252013]( @pa_crn_no      VARCHAR(8000)                    
                            , @pa_exch        VARCHAR(10)                    
    ...
    --                    
      ...
      --        
        ...
        SELECT 0                    
             ...
             , case when convert(char(1),ISNULL(citrus_usr.fn_ucc_accp(dpam.dpam_id,'ADR_PREF_FLG',''),'')) = '1' then 'Y' else 'N' end    --convert(char(1),ISNULL(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'',''),''))                                        
          --address preference flag                     
             ...
             , 'Y'                                                                                                      --local addr???                    
             , case when ISNULL(citrus_usr.fn_addr_value(banm_id,'COR_ADR1'),'') <> '' OR ISNULL(citrus_usr.fn_addr_value(banm_id,'PER_ADR1'),'') <> ''  then 'Y'   else 'N' end                                                                              
                                        --bank addr???                      
            ...
            ,  CASE WHEN  convert(char(1),ISNULL(citrus_usr.fn_ucc_accp(dpam.dpam_id,'ADR_PREF_FLG',''),'')) <> '1' THEN 'Y'    
             ...
             , CASE WHEN convert(char(20),cliba_ac_type) IN( 'SAVINGS', 'SAVING')  THEN '10' WHEN convert(char(20),cliba_ac_type) IN('CURRENT') THEN '11' WHEN convert(char(20),cliba_ac_type) IN( 'OTHERS') THEN  '13' else '13' END   --'11'                 
                                                                         --bank acct type                    
...
--                                  else '' end  
--                                , case when dpam_clicm_cd in ('21' , '24' , '27') then isnull(CLIM_NAME3,'')--CITRUS_USR.inside_trim(LTRIM(RTRIM(DPAM_SBA_NAME)),'3')  
--                                  else '.' end  
                                ,''  
                                ,''  
                                ,''  
                               ...
                               , case when citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_acct_addr_value(DPAM.DPAM_ID,'AC_COR_ADR1'),''),1) <> ''   
                                ...
                                , CASE WHEN isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'ACCFAX1'),'') <> '' THEN isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'ACCFAX1'),'') ELSE isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'FAX1'),'')
 END --fax                    
                                , isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'PAN_GIR_NO',''),'')  --pan card                    
                                , ''    
                                , CASE WHEN lower(isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'ACCEMAIL1'),'')) <> '' THEN lower(isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'ACCEMAIL1'),'')) ELSE lower(isnull(citrus_usr.fn_dp_import_conc(clim.
clim_crn_no,'EMAIL1'),'')) END --email                    
                                , ''                    
                                , ''                    
                                , '0000'                    
                                , ''                    
                                , case when isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'PAN_GIR_NO',''),'') <> '' then '1' else '0' end + case when isnull(DPHD_SH_PAN_NO,'') <> '' then '1' else '0' end + case when  isnull(DPHD_TH_PAN_NO,'') <> '' then
 '1' else '0' end + '0'                  
              ...
              , ''                  
               ...
               insert into @line5( ln_no                     
                                  ...
                                  SELECT distinct '05'                    
                                       , clim_crn_no                    
                                       , dpam_sba_no                    
                                       --, case when isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'date_of_maturity',''),'00000000')= '' then '00000000' else isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'date_of_maturity',''),'00000000') end  --dt_of_maturit
y                    
                                       ,''  
            , left(dpam_acct_no,8)--isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'dp_int_ref_no',''),'')  --dp_int_ref_no                    
                                       , case when dpam_subcm_cd in ('2156','2155','2150','082104') then case when isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'INC_DOB',''),'') = '' then '00000000' else isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'I
NC_DOB',''),'00000000') end  else case when isnull(convert(varchar(11),clim.clim_dob,103),'00000000') = '01/01/1900' then '00000000' else   isnull(convert(varchar(11),clim.clim_dob,103),'00000000')  end                end  
                                       , isnull(clim.clim_gender,'')                    
                                       , CASE WHEN citrus_usr.fn_get_listing('occupation',isnull(citrus_usr.fn_ucc_entp(clim_crn_no,'occupation',''),'')) = '' THEN 'O' ELSE citrus_usr.fn_get_listing('occupation',isnull(citrus_usr.fn_ucc_entp(clim_crn_no,'
occupation',''),'')) END --occupation            
               , ''    
...
--                                       , '000000'--citrus_usr.fn_get_listing('BANKCCY',isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'BANKCCY',''),''))                 
            , '000000'  
                                       , case when cliba_ac_type='SAVINGS' THEN '10' WHEN  cliba_ac_type='CURRENT' THEN '11' WHEN cliba_ac_type='OTHERS' THEN '13' ELSE '13' END --''--case when cliba_ac_type='SAVINGS' THEN '10' WHEN  cliba_ac_type='CURRENT' THEN '11' WHEN cliba_ac_type='OTHERS' THEN '13' ELSE '13' END                 --convert(char(12),banm_branch)                                    
                                       , case when banm_micr in ('0','000000000')  then space(12)                                                 when  banm_micr not in ('0','000000000')   then banm_micr   
                                              else space(12) end                                    
             ...
             dp_holder_dtls            dphd                 on dpam.dpam_id            = dphd.dphd_dpam_id                        
             left outer join                         
             client_bank_accts         cliba                on dpam.dpam_id            = cliba.cliba_clisba_id    AND    isnull(cliba.cliba_deleted_ind,1)     = 1                    
             left outer join             
                                           bank_mstr                 banm                 on  convert(int,cliba.cliba_banm_id)     = convert(int,banm.banm_id)   AND isnull(cliba_flg,'0') IN ('1','3')          AND    isnull(banm.banm_deleted_ind,1)       =
 1           
                                       , client_mstr               clim                    
                                       , entity_type_mstr          enttm          
                                       , client_ctgry_mstr         clicm                    
...
--            ,case when ISNULL(citrus_usr.fn_ucc_doc(dpam_id,'SIGN_POA',''),'') = '' then 'N' else 'Y'   end  --signature file flag             
  ...
  ,Purpose_code                               
                                  ...
                                  FROM fn_cdsl_export_line_7_extract_newversion(@pa_crn_no, @pa_from_dt, @pa_to_dt), dp_acct_mstr , EXCH_SEG_MSTR esm    
           ...
           ,CASE WHEN CITRUS_USR.fn_acct_conc_value(DPAM_ID,'EMAIL1')<> '' THEN lower(CITRUS_USR.fn_acct_conc_value(DPAM_ID,'EMAIL1'))  
...
--                                       , isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'voice_mail',''),'')  --voice_mail                                 
            , ''  
                                       , CASE WHEN isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'rbi_ref_no',''),'') = '' THEN isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'rbi_ref_no',''),'') ELSE isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'rbi_ref_n
o',''),'') END  --rbi_ref_no                                 
                                       , CASE WHEN isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'rbi_ref_no',''),'') = '' THEN isnull(citrus_usr.fn_ucc_accpD(dpam.dpam_id,'rbi_ref_no','rbi_app_dt',''),'00000000') ELSE  isnull(citrus_usr.fn_ucc_entpD(clim.clim_crn_no,'rbi_ref_no','rbi_app_dt',''),'00000000') END  --rbi_app_dt                                 
                                       , isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'sebi_regn_no',''),'')  --sebi_reg_no                                
                                       , citrus_usr.fn_get_listing('TAX_DEDUCTION',isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'TAX_DEDUCTION',''),''))  --benef_tax_ded_sta                          
            ...
            , '000000'  
                                       ...
                                       , citrus_usr.fn_get_listing('BANKCCY',isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'BANKCCY',''),''))--''                                   
                                          FROM   dp_acct_mstr              dpam                    
                                                 ...
                                                 client_bank_accts         cliba                on dpam.dpam_id            = cliba.cliba_clisba_id      
                                                 left outer join             
                                                bank_mstr                 banm    on  convert(int,cliba.cliba_banm_id)     = convert(int,banm.banm_id)     AND isnull(cliba_flg,'0') IN ('1','3')             
                                               , client_mstr               clim                    
                                               ,@crn                       crn    
                                               , entity_type_mstr          enttm          
                                               , client_ctgry_mstr         clicm                    
