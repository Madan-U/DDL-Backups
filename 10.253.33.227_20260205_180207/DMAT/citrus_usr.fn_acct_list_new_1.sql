-- Object: FUNCTION citrus_usr.fn_acct_list_new_1
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--select * from [fn_acct_list_new_](3,1,0)  
create Function [citrus_usr].[fn_acct_list_new_1](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int)   
...
--  
--DECLARE @account_properties TABLE (accp_value DATETIME, accp_clisba_id NUMERIC PRIMARY KEY, accp_accpm_prop_cd VARCHAR(25))  
--  
--  
...
FROM DP_ACCT_MSTR , ENTITY_RELATIONSHIP  , (select distinct convert(datetime,accp_value,103) accp_value, accp_clisba_id , accp_accpm_prop_cd   
from account_properties   
where accp_accpm_prop_cd = 'BILL_START_DT'   
and accp_value not in ('') ) a    
...
,dpam_stam_cd  
  ...
  , product_mstr prom   , (select distinct convert(datetime,accp_value,103) accp_value, accp_clisba_id , accp_accpm_prop_cd   
from account_properties   
where accp_accpm_prop_cd = 'BILL_START_DT'   
and accp_value not in ('') ) a    
