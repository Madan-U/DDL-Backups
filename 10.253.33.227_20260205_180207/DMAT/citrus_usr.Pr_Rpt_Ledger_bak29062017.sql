-- Object: PROCEDURE citrus_usr.Pr_Rpt_Ledger_bak29062017
...
create Proc [citrus_usr].[Pr_Rpt_Ledger_bak29062017]        
@pa_dpmid int,        
@pa_finyearid int,        
...
CREATE TABLE #ACLIST(dpam_id BIGINT,dpam_sba_no VARCHAR(16),dpam_sba_name VARCHAR(500),eff_from DATETIME,eff_to DATETIME,acct_type varchar(2))
