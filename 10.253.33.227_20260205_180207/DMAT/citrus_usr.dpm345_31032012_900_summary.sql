-- Object: TABLE citrus_usr.dpm345_31032012_900_summary
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[dpm345_31032012_900_summary]
(
    [DPHMCD_DPM_ID] NUMERIC(18, 0) NOT NULL,
    [DPHMCD_DPAM_ID] NUMERIC(10, 0) NOT NULL,
    [DPHMCD_ISIN] VARCHAR(20) NOT NULL,
    [DPHMCD_CURR_QTY] NUMERIC(38, 3) NULL,
    [DPHMCD_FREE_QTY] NUMERIC(38, 3) NULL,
    [DPHMCD_FREEZE_QTY] NUMERIC(38, 3) NULL,
    [DPHMCD_PLEDGE_QTY] NUMERIC(38, 3) NULL,
    [DPHMCD_DEMAT_PND_VER_QTY] NUMERIC(38, 3) NULL,
