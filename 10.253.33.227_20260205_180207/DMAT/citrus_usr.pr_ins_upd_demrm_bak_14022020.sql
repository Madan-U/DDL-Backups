-- Object: PROCEDURE citrus_usr.pr_ins_upd_demrm_bak_14022020
...
CREATE PROCEDURE [citrus_usr].[pr_ins_upd_demrm_bak_14022020](@pa_id              VARCHAR(8000)  
...
print '23232323223'
  ...
  (not exists (select uses_slip_no from used_slip where uses_slip_no = @pa_slp_sr_no and uses_deleted_ind =1)))
