-- Object: PROCEDURE citrus_usr.pr_rpt_ageing_bak_14082017
...
CREATE  proc [citrus_usr].[pr_rpt_ageing_bak_14082017]  
(  
 @pa_fin_id numeric,  
    @pa_frmdt datetime,  
...
,morethan365days  = case when datediffe > 365 then amount else 0 end 
