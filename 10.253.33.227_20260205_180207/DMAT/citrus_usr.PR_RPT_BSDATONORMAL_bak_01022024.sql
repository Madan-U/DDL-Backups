-- Object: PROCEDURE citrus_usr.PR_RPT_BSDATONORMAL_bak_01022024
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------


--select dpm_excsm_id,* from dp_mstr where default_dp = dpm_id
--EXEC PR_RPT_BSDATONORMAL 'Feb  1 2016','Feb  1 2016','3'
CREATE   procedure [citrus_usr].[PR_RPT_BSDATONORMAL_bak_01022024]
(
--@PA_DPM_ID INT
