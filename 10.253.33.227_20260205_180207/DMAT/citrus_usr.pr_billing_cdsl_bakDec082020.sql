-- Object: PROCEDURE citrus_usr.pr_billing_cdsl_bakDec082020
...
--ROLLBACK
Create  procedure [citrus_usr].[pr_billing_cdsl_bakDec082020](@pa_billing_from_dt datetime,@pa_billing_to_dt datetime,@pa_dpm_id numeric,@pa_billing_status   char(1))
as
begin
--
...
--and not exists (select 2 from [172.31.16.94].dmat.citrus_usr.client_trade_month,dp_acct_mstr  b where Client_COde = dpam_sba_no and a.dpam_id = b.dpam_id and last_trade between  @pa_billing_from_dt and @pa_billing_to_dt )
...
-- --and clidb_eff_from_dt  between @pa_billing_from_dt and @pa_billing_to_dt
-- and @pa_billing_from_dt  between clidb_eff_from_dt and  ISNULL (clidb_eff_to_dt , 'Dec 31 2100')
--and BROM_DESC in (select [Scheme Name] from schemettobeadd where [Affect Yes / No] = 'Y') )
