-- Object: PROCEDURE citrus_usr.PR_RPT_EMPSUBWSREV
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--exec PR_RPT_EMPSUBWSREV '3','BR','A','aug 01 2010','aug 31 2010',''   

CREATE PROCEDURE [citrus_usr].[PR_RPT_EMPSUBWSREV](@PA_EXCSM_ID NUMERIC 
...
select * from client_Commission_summary where carry_date is null  and n_r = @PA_ACTION  
and amc_date BETWEEN @PA_FROM_DT AND @PA_TO_DT 
...
select sum(Commission_paid) REV_VALUE , ENTM_SHORT_NAME
