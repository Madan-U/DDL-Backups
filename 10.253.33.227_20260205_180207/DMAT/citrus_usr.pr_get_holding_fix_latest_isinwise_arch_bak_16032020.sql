-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_isinwise_arch_bak_16032020
...
create   proc [citrus_usr].[pr_get_holding_fix_latest_isinwise_arch_bak_16032020](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
