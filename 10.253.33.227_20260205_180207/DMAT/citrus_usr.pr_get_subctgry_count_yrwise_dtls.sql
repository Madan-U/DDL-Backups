-- Object: PROCEDURE citrus_usr.pr_get_subctgry_count_yrwise_dtls
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE  proc pr_get_subctgry_count_yrwise_dtls(@pa_sub_desc varchar(1000))
as
begin 
...
SELECT SUBCM_DESC,DPAM_SBA_NO,accp_value,accp_value_cl ,SUM(CASE WHEN DPAM_STAM_CD ='ACTIVE' THEN 1 ELSE 0 END ) ASONACTIVE 
...
and SUBCM_DESC = @pa_sub_desc
AND DPAM_DELETED_IND = 1 
AND SUBCM_DELETED_IND = 1
GROUP BY SUBCM_DESC,DPAM_SBA_NO,accp_value,accp_value_cl
