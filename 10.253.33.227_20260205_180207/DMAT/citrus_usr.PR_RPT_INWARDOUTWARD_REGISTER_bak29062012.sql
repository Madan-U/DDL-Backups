-- Object: PROCEDURE citrus_usr.PR_RPT_INWARDOUTWARD_REGISTER_bak29062012
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--[PR_RPT_INWARDOUTWARD_REGISTER] 'nsdl',4,'D','pr','jun 01 2009','jun 06 2009','ho',1,'',''
create PROC [citrus_usr].[PR_RPT_INWARDOUTWARD_REGISTER_bak29062012]
@PA_DPTYPE VARCHAR(4),
@PA_EXCSM_ID INT,
...
@@l_child_entm_id BIGINT
  ...
  INSERT INTO #ACLIST SELECT DPAM_ID,dpam_sba_no,dpam_sba_name,EFF_FROM,EFF_TO,'',@@L_DPM_ID FROM citrus_usr.fn_acct_list(@@L_DPM_ID ,@PA_LOGIN_PR_ENTM_ID,@@l_child_entm_id)		
...
SELECT d2.demrm_id,E.ENTM_NAME1,group_cd,DRF_NO=d2.DEMRM_SLIP_SERIAL_NO,DRN_NO=ISNULL(d1.DEMRM_TRANSACTION_NO,''),ACCT_NO=DPAM_SBA_NO,CLIENT_NAME=DPAM_SBA_NAME,
					...
					AND DPM_ID = @@L_DPM_ID
					AND d2.DEMRM_REQUEST_DT BETWEEN @PA_FROM_DT AND @PA_TO_DT 
					...
					and LTRIM(RTRIM(ISNULL(d2.demrm_res_desc_intobj,''))) = rej.cd
					AND group_cd = E.ENTM_ID
					AND E.ENTM_DELETED_IND = 1
