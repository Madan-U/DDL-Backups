-- Object: PROCEDURE citrus_usr.PR_BILLING_BO_CSV_bak20052025
...
create  PROCEDURE [citrus_usr].[PR_BILLING_BO_CSV_bak20052025]  
...
,case when FINA_ACC_NAME  = 'AMC CHARGES  LIFE SCHEME 1250' then 'Lifetime Account Maintenance Charges' else 'Demat account monthly maintenanace charges' + ' Dt : '    end +  convert(varchar(11),MAX(CLIC_TRANS_DT ),109) FINA_ACC_NAME--CASE DATEPART(QUARTER, MAX(CLIC_TRANS_DT ))WHEN 1 THEN'Q4'WHEN 2 THEN'Q1'WHEN 3 THEN'Q2'WHEN 4 THEN'Q3'END ,109)
 ,'1'						
