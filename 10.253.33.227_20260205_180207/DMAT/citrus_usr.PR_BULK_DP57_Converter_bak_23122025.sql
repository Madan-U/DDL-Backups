...
,case when  isnull(TxnsType,'')  in   ('2','3') then isnull(CnsdrtnAmt,'0') else isnull(ConfRejQty,'0') end ,isnull(EarmrkdQty,'') ,isnull(EFTSCd.CDSL_Old_Values,'') EFTSCd--,isnull(EFTSCd.cdsl_old_value,'') EFTSCd
