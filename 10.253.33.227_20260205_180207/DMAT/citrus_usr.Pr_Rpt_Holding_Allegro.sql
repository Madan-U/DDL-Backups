-- Object: PROCEDURE citrus_usr.Pr_Rpt_Holding_Allegro
...
create PROC [citrus_usr].[Pr_Rpt_Holding_Allegro]  
			@PA_DPTYPE VARCHAR(4),                    
			@PA_EXCSMID INT,                    
			@PA_ASONDATE CHAR(1),                    
			@PA_FORDATE DATETIME,                    
...
PRINT('F11')
  ...
  PRINT(@PA_FORDATE)
     ...
     SELECT DPAM_SBA_NAME,DPAM_SBA_NO,DPHMC_ISIN,ISIN_NAME,CONVERT(NUMERIC(18,3),DPHMC_CURR_QTY),VALUATION=CONVERT(NUMERIC(18,2),DPHMC_CURR_QTY*ISNULL(CLOPM_CDSL_RT,0)), CONVERT(NUMERIC(18,3),DPHMC_FREE_QTY),CONVERT(NUMERIC(18,3),DPHMC_FREEZE_QTY)      
   ...
   INSERT INTO #ACLIST SELECT DPAM_ID,DPAM_SBA_NO,DPAM_SBA_NAME,EFF_FROM,EFF_TO FROM CITRUS_USR.FN_ACCT_LIST(@@DPMID ,@PA_LOGIN_PR_ENTM_ID,@@L_CHILD_ENTM_ID)    
     ...
     SELECT DPAM_SBA_NAME,DPAM_SBA_NO,DPHMCD_ISIN,ISIN_NAME,CONVERT(NUMERIC(18,3),DPHMCD_CURR_QTY),VALUATION=CONVERT(NUMERIC(18,2),DPHMCD_CURR_QTY*ISNULL(CLOPM_CDSL_RT,0)),CONVERT(NUMERIC(18,0),DPHMCD_FREE_QTY),CONVERT(NUMERIC(18,3),DPHMCD_FREEZE_QTY),CONVERT(NUMERIC(18,3),DPHMCD_PLEDGE_QTY)      
     ...
     ,CONVERT(NUMERIC(18,3),DPHMCD_ELIMINATION_QTY),CONVERT(NUMERIC(18,3),DPHMCD_EARMARK_QTY),CONVERT(NUMERIC(18,3),DPHMCD_AVAIL_LEND_QTY),CONVERT(NUMERIC(18,3),DPHMCD_LEND_QTY),CONVERT(NUMERIC(18,3),DPHMCD_BORROW_QTY),DPAM_ID,HOLDING_DT=CONVERT(VARCHAR(11),@@TMPHOLDING_DT,109),CMP=ISNULL(convert(numeric(18,2),CLOPM_CDSL_RT),0.00)                                     
