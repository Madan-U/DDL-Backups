-- Object: PROCEDURE citrus_usr.PR_SEARCH_CLIM
...
CREATE PROCEDURE [citrus_usr].[PR_SEARCH_CLIM]
							 (
...
END          
 ...
 --          
	...
	union
	SELECT DISTINCT accpm.ACCPM_PROP_CD PROPERTY_CODE 
	, accpm.ACCPM_PROP_DESC PROPERTY_DESC 
	FROM account_PROPERTY_MSTR accpm WITH (NOLOCK)
	WHERE accpm.ACCPM_DELETED_IND = 1 
	and accpm.ACCPM_PROP_CD = 'BBO_CODE'     
 --          
 END          
