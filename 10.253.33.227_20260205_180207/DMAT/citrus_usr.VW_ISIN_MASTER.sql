-- Object: VIEW citrus_usr.VW_ISIN_MASTER
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--select * from [VW_ISIN_MASTER]  
CREATE view [citrus_usr].[VW_ISIN_MASTER]  
as  
...
left outer join entity_mstr on ENTM_ENTTM_CD ='rta' and ENTM_SHORT_NAME ='rta_'+CONVERT(varchar,ISIN_REG_CD )  
