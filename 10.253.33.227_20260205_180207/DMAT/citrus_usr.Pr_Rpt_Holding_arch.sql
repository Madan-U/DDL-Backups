-- Object: PROCEDURE citrus_usr.Pr_Rpt_Holding_arch
...
CREATE  PROC [citrus_usr].[Pr_Rpt_Holding_arch]  
			@PA_DPTYPE VARCHAR(4),                    
			@PA_EXCSMID INT,                    
			@PA_ASONDATE CHAR(1),                    
			@PA_FORDATE DATETIME,                    
...
if @pa_fordate< 'Apr 01 2017' 
begin 
declare @p14 varchar(1)
set @p14=NULL
exec Pr_rpt_Holding_Bulk_arch @pa_dptype,@pa_excsmid,@pa_asondate
,@pa_fordate,@pa_fromaccid,@pa_toaccid,@pa_isincd,@pa_withvalue
,@pa_login_pr_entm_id,@pa_login_entm_cd_chain,@PA_SETTM_TYPE,@PA_SETTM_NO_FR,@PA_SETTM_NO_TO
,@pa_output=@p14 output
return
end 
...
begin 
	...
	begin 
		insert into  #tmphldg
		exec  [pr_get_holding_fix_latest_BBOCODE_arch]   @@DPMID,@PA_FORDATE,@PA_FORDATE,@PA_FROMACCID,@PA_TOACCID,@l_bbo_code,''
	...
	begin 
		...
		begin 
			insert into  #tmphldg
			exec  [pr_get_holding_fix_latest_acrh]   @@DPMID,@PA_FORDATE,@PA_FORDATE,@PA_FROMACCID,@PA_TOACCID,''
		end 

		if @pa_isincd <>''
		begin 
			insert into  #tmphldg
			exec  [pr_get_holding_fix_latest_isinwise_arch]   @@DPMID,@PA_FORDATE,@PA_FORDATE,@PA_FROMACCID,@PA_TOACCID,@pa_isincd,''
		end 
