-- Object: PROCEDURE citrus_usr.pr_breakup_bak_fd
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

create  procedure [citrus_usr].[pr_breakup_bak_fd](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
