-- Object: PROCEDURE citrus_usr.pr_import_dp_18sep2008
...
--select * from dp_Acct_mstr  where dpam_excsm_id = 4
--pr_import_dp '','CDSL','02/02/2007','13/02/2008','ALL',''                     
--begin tran 
--rollback 
--UPDATE DP_ACCT_MSTR SET DPAM_BATCH_NO = NULL WHERE DPAM_ID = 120222
--pr_import_dp '218959|*~|59335*|~*','NSDL','12/06/2008','12/06/2008','N','112037',4,'HO',''   
--select * from dp_acct_mstr order by 1 desc  
--CDSL	01/05/2008	02/05/2008	N	45	3	HO	
  
create  PROCEDURE [citrus_usr].[pr_import_dp_18sep2008]( @pa_crn_no      VARCHAR(8000)                  
                            , @pa_exch        VARCHAR(10)                  
    ...
    --                  
      ...
      --      
        ...
        SELECT 0                  
             ...
             , 'Y'                                                                                                      --local addr???                  
             , case when ISNULL(citrus_usr.fn_addr_value(banm_id,'COR_ADR1'),'') <> '' then 'Y'   else 'N' end                                                                                                                      --bank addr???                    
             ...
             , case when dphd_nom_fname <> '' then dphd_nom_fname  when dphd_gau_fname <> '' then dphd_gau_fname else '' end    
...
,send_ref_no1            
 ...
 ,cust_fax                char(100)                   
      ...
      BEGIN                  
        ...
        insert into @line2( ln_no                  
                           ...
                           SELECT distinct '02'                  
                                ...
                                , isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'FAX1'),'')--fax                  
                                , isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'PAN_GIR_NO',''),'')  --pan card                  
                                , ''  
                                , isnull(citrus_usr.fn_dp_import_conc(clim.clim_crn_no,'EMAIL1'),'')--email                  
                                , ''                  
                                , ''                  
                                , '0000'                  
                                , ''                  
               ...
               insert into @line5( ln_no                   
                                  ...
                                  SELECT distinct '05'                  
                                      ...
                                      , case when dpam_clicm_cd in ('21' , '24' , '27') then  left(isnull(citrus_usr.fn_ucc_entp(clim_crn_no,'STAFF',''),''),1) else '' end              
                                       ...
                                       , ''--isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'',''),'')  --smart_crd_req                            
                                       , ''--isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'',''),'')  --smart_crd_no                             
                                       , '0000000000'--isnull(citrus_usr.fn_ucc_entp(clim.clim_crn_no,'',''),'')  --smart_crd_pin                            
  ...
  ,Purpose_code                             
                                  ...
                                  FROM fn_cdsl_export_line_7_extract(@pa_crn_no, @pa_from_dt, @pa_to_dt)  ORDER BY Purpose_code DESC 
      --                  
      END                  
      ELSE IF @pa_crn_no <> ''                  
      BEGIN                  
        ...
        ,bo_usr_txt1                          
                       ...
                       insert into @line5( ln_no                   
                            ...
                            ,group_cd                            
                                       ...
                                       , '00'--'' -- category4_cd                  
                                       , '00'--'' -- bank_option5                  
                                       , case when dpam_clicm_cd in ('21' , '24' , '27') then  left(isnull(citrus_usr.fn_ucc_entp(clim_crn_no,'STAFF',''),''),1) else '' end   --lang_cd                  
                                       , '' -- staff_cd                  
                                       , '' -- usr_txt1                  
                                       , '' -- usr_txt2                  
                                       , '0000'--'' -- dummy1                  
