-- Object: PROCEDURE citrus_usr.pr_breakup_bak_03062016
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

create procedure [citrus_usr].[pr_breakup_bak_03062016](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
...
and CLIC_CHARGE_NAME not in ('SERVICE TAX','SWACHH BHARAT CESS'
,'TRANSACTION CHARGES')
...
,  isnull(amt*case when charge_name  in ('POAFIXED','POA') then 0 else 0.005  end ,0.000000) sbt_amt
