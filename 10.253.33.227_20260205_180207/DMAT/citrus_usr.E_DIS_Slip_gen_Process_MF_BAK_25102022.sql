-- Object: PROCEDURE citrus_usr.E_DIS_Slip_gen_Process_MF_BAK_25102022
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE PROCEDURE [citrus_usr].[E_DIS_Slip_gen_Process_MF_BAK_25102022]        
--(        
--@DATE DATETIME        
--)        
AS        
...
INSERT INTO #DIY_POA_PROCESS_LOG_MF        
 ...
 --   GROUP BY  PARTYCODE,EXCHANGE,POASTATUS,SYMBOL,ISIN,DPID,CONVERT(VARCHAR(11),DATE_TIME_STAMP,120),SETT_NO    
  ...
  INSERT INTO MF_DATA
  SELECT * FROM [172.31.16.94].dmat.citrus_usr.E_DIS_TRXN_DATA T WITH(NOLOCK) where Request_date >=GETDATE()-10
  ...
  --- TRUNCATE TABLE E_DIS_PROCESS_DATA  
   ...
   INSERT INTO E_DIS_PROCESS_DATA  
     SELECT PARTYCODE,BOID,N.ISIN,(ADJ_QTY) AS QTY,(ANGEL_TRXN_ID) ANGEL_TRXN_ID, (CDSL_TRXN_ID) CDSL_TRXN_ID,   
