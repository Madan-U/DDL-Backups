-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_branchageing_arch
...
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_branchageing_arch](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
into #tmp_dp_daily_hldg_cdsl from dmatarc.citrus_usr.cdsl_holding_dtls      with (nolock)
