-- Object: PROCEDURE citrus_usr.pr_breakup_bak_angelaccount_BAK_03122015
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE  procedure [citrus_usr].[pr_breakup_bak_angelaccount_BAK_03122015](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
...
,	'Remat Charges'
,	'Settlement Charges'
) then 'CDSL CHARGE' else brom_desc end brom_desc ,charge_name,amt*-1 amt,service_tax_amt*-1 service_tax_amt ,dp_charge cdslcharge 
, LEFT(pc1.BOActDt ,2) + '/'+SUBSTRING(pc1.BOActDt ,3,2)+'/'+RIGHT(pc1.BOActDt ,4) activationdt
from #final f , dp_Acct_mstr dpam , dps8_pc1 pc1 where pc1.boid = dpam.dpam_sba_no and dpam.dpam_sba_no = f.dpam_sba_no and amt + service_tax_amt + dp_charge <> 0
