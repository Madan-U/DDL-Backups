-- Object: PROCEDURE citrus_usr.pr_billing_cdsl_baknov2615
...
--ROLLBACK
create procedure [citrus_usr].[pr_billing_cdsl_baknov2615](@pa_billing_from_dt datetime,@pa_billing_to_dt datetime,@pa_dpm_id numeric,@pa_billing_status   char(1))
as
begin
--
