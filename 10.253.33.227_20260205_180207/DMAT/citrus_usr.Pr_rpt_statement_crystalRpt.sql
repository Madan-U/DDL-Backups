-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_crystalRpt
...
set @p18=NULL
exec Pr_Rpt_Statement @pa_dptype='CDSL',@pa_excsmid=3,@pa_fromdate='JAN 24 2009',@pa_todate='SEP 24 2009',@pa_fromaccid='1234567890123456',@pa_toaccid='',@pa_bulk_printflag='N',@pa_stopbillclients_flag='N',@pa_isincd='',@pa_group_cd='',@pa_transclientsonly='N',@pa_Hldg_Yn='Y',@pa_login_pr_entm_id='1',@pa_login_entm_cd_chain='HO|*~|',@pa_settm_type='',@pa_settm_no_fr='',@pa_settm_no_to='',@pa_output=@p18 output
select @p18


exec Pr_rpt_statement 'CDSL','3','jan 01 2009','Aug 14 2009','N','N','90123456','','','','n','Y',1,'HO|*~|','','','',''
 
exec Pr_rpt_statement 'CDSL','3','sep 01 2009','sep 16 2009','N','N','','','','','Y','Y',1,'HO|*~|','','',''

exec Pr_rpt_statement 'cdsl',3,'Apr 14 2009','Jul  1 2009','N','N','','','','','N','y',1,'HO|*~|','','','',''
*/ 

CREATE Proc [citrus_usr].[Pr_rpt_statement_crystalRpt]                            
@pa_dptype varchar(4),                                    
@pa_excsmid int,                                    
