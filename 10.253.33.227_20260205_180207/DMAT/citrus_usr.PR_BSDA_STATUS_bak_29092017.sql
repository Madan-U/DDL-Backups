-- Object: PROCEDURE citrus_usr.PR_BSDA_STATUS_bak_29092017
...
create    procedure [citrus_usr].[PR_BSDA_STATUS_bak_29092017]
(
@PA_DPM_ID INT
...
when sum((isnull(RATE,0)*isnull(DPHMCD_FREE_QTY,0))) > '200001' then 'VERSION 2.5 NORMAL'
...
from dps8_pc1
,DP_ACCT_MSTR 
left outer join client_dp_brkg on CLIDB_DPAM_ID = DPAM_ID and GETDATE() between clidb_eff_from_dt and isnull(clidb_eff_to_dt ,'dec 31 2100') AND CLIDB_DELETED_IND = '1'
