-- Object: FUNCTION citrus_usr.getfixedchargedate_test
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE function [citrus_usr].[getfixedchargedate_test](@startdate datetime,@bill_fr_date datetime,@bill_to_date datetime,@billinterval char(1), @billperiod int,@excmid int ) returns datetime      
as      
begin      
