-- Object: PROCEDURE citrus_usr.pr_ins_financial_yr_24092012
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

create PROCEDURE [citrus_usr].[pr_ins_financial_yr_24092012]   
(@pa_id          VARCHAR(8000)     
...
--  
 ...
 BEGIN  
   INSERT INTO LEDGER_HST'+ convert(varchar,@l_fin_id)+'(LDG_ID,LDG_DPM_ID,LDG_VOUCHER_TYPE,LDG_BOOK_TYPE_CD,LDG_VOUCHER_NO,LDG_SR_NO,LDG_REF_NO,LDG_VOUCHER_DT,LDG_ACCOUNT_ID,LDG_ACCOUNT_TYPE,LDG_AMOUNT,LDG_NARRATION,LDG_BANK_ID,LDG_ACCOUNT_NO,LDG_INSTRUM
ENT_NO,LDG_BANK_CL_DATE,LDG_COST_CD_ID,LDG_BILL_BRKUP_ID,LDG_TRANS_TYPE,LDG_STATUS,LDG_CREATED_BY,LDG_CREATED_DT,LDG_LST_UPD_BY,LDG_LST_UPD_DT,LDG_DELETED_IND,LDG_BRANCH_ID,LDG_ACTION)  
   SELECT  inserted.LDG_ID,inserted.LDG_DPM_ID,inserted.LDG_VOUCHER_TYPE,inserted.LDG_BOOK_TYPE_CD,inserted.LDG_VOUCHER_NO,inserted.LDG_SR_NO,inserted.LDG_REF_NO,inserted.LDG_VOUCHER_DT,inserted.LDG_ACCOUNT_ID,inserted.LDG_ACCOUNT_TYPE,inserted.LDG_AMOUNT
,inserted.LDG_NARRATION,inserted.LDG_BANK_ID,inserted.LDG_ACCOUNT_NO,inserted.LDG_INSTRUMENT_NO,inserted.LDG_BANK_CL_DATE,inserted.LDG_COST_CD_ID,inserted.LDG_BILL_BRKUP_ID,inserted.LDG_TRANS_TYPE,inserted.LDG_STATUS,inserted.LDG_CREATED_BY,inserted.LDG_C
REATED_DT,inserted.LDG_LST_UPD_BY,inserted.LDG_LST_UPD_DT,inserted.LDG_DELETED_IND,inserted.LDG_BRANCH_ID,''I''  
   FROM   inserted  
 END  
 ELSE   
 BEGIN  
...
ENT_NO,LDG_BANK_CL_DATE,LDG_COST_CD_ID,LDG_BILL_BRKUP_ID,LDG_TRANS_TYPE,LDG_STATUS,LDG_CREATED_BY,LDG_CREATED_DT,LDG_LST_UPD_BY,LDG_LST_UPD_DT,LDG_DELETED_IND,LDG_BRANCH_ID,LDG_ACTION)  
   SELECT inserted.LDG_ID,inserted.LDG_DPM_ID,inserted.LDG_VOUCHER_TYPE,inserted.LDG_BOOK_TYPE_CD,inserted.LDG_VOUCHER_NO,inserted.LDG_SR_NO,inserted.LDG_REF_NO,inserted.LDG_VOUCHER_DT,inserted.LDG_ACCOUNT_ID,inserted.LDG_ACCOUNT_TYPE,inserted.LDG_AMOUNT,
inserted.LDG_NARRATION,inserted.LDG_BANK_ID,inserted.LDG_ACCOUNT_NO,inserted.LDG_INSTRUMENT_NO,inserted.LDG_BANK_CL_DATE,inserted.LDG_COST_CD_ID,inserted.LDG_BILL_BRKUP_ID,inserted.LDG_TRANS_TYPE,inserted.LDG_STATUS,inserted.LDG_CREATED_BY,inserted.LDG_CR
EATED_DT,inserted.LDG_LST_UPD_BY,inserted.LDG_LST_UPD_DT,inserted.LDG_DELETED_IND,inserted.LDG_BRANCH_ID,''E''  
   FROM   inserted  
