-- Object: PROCEDURE dbo.pr_dbversion_utility
...
*/
CREATE procedure [dbo].[pr_dbversion_utility](@pa_id numeric,@pa_server_name varchar(1000),@pa_owner varchar(500),@pa_SRC_db_name varchar(1000),@pa_trg_db_name varchar(1000),@pa_target_path varchar(8000))
as
begin
