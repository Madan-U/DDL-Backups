-- Object: PROCEDURE citrus_usr.pr_get_invzero_zeroinv_bak_06042016
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--exec pr_get_invzero_zeroinv 'INVTOZERO'
--exec pr_get_invzero_zeroinv 'ZEROTOINV'
create proc [citrus_usr].[pr_get_invzero_zeroinv_bak_06042016](@pa_tab varchar(100))
as
begin 
...
insert into #final
exec pr_get_client_list 'feb 29 2016'
		...
		print 'yogesh'
			select distinct convert(datetime,accp_value,103) accp_value, accp_clisba_id , accp_accpm_prop_cd 
				...
				select LDG_ACCOUNT_ID, SUM(ldg_amount) os  into #ledger from LEDGER2 where ldg_deleted_ind = 1 group by LDG_ACCOUNT_ID
