-- Object: PROCEDURE citrus_usr.pr_valid_hldg_Online_Bkup_29Apr20
...
CREATE proc [citrus_usr].[pr_valid_hldg_Online_Bkup_29Apr20](@pa_cd varchar(10),@pa_boid varchar(20),@pa_isin varchar(20),@pa_qty numeric(18,3),@pa_out varchar(125) output)      
as      
begin      
...
--if exists(Select valuation from tmp_clientwise_holval where CLIENT_ID=@pa_boid and ISIN=@pa_isin and valuation>200000)
--begin 
