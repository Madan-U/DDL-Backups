-- Object: PROCEDURE citrus_usr.Pr_rpt_bill_o3
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--[Pr_rpt_bill] 'CDSL',3,'JUN  1 2009','JUN 30 2009 23:59:59','n','N','','','','n','Y',1,'ho|*~|',''	

create Proc [citrus_usr].[Pr_rpt_bill_o3]              
@pa_dptype varchar(4),                      
@pa_excsmid int,                      
