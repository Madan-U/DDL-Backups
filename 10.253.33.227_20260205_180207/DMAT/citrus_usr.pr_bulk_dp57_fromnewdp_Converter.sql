-- Object: PROCEDURE citrus_usr.pr_bulk_dp57_fromnewdp_Converter
...
CREATE proc [citrus_usr].[pr_bulk_dp57_fromnewdp_Converter]
(  
...
select 'COD- FILE - CDSL-12033202 Auto Import From New DP',GETDATE(),'','RUNNING','AUTO',MAX(task_id)+1,'',null,null,null  
 from filetask 
 
 select top 1 @PA_TASK_ID = task_id from FileTask where task_name ='COD- FILE - CDSL-12033202 Auto Import From New DP'  and STATUS ='RUNNING' 
...
select @l_filecount = COUNT(1) from citrus_usr.tmp_dp57_o 
...
where task_name ='COD- FILE - CDSL-12033202 Auto Import From New DP'  and STATUS ='RUNNING' and task_id =@PA_TASK_ID  
