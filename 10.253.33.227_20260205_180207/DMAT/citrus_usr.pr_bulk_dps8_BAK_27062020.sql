-- Object: PROCEDURE citrus_usr.pr_bulk_dps8_BAK_27062020
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------



CREATE proc [citrus_usr].[pr_bulk_dps8_BAK_27062020](@pa_dbpath varchar(8000))  
as  
begin   
...
Remarks	=citrus_usr.fn_splitval_by(value,	5	,'~'),
namechange=citrus_usr.fn_splitval_by(value,	6	,'~'),
MOBILE_NO_ISD	=citrus_usr.fn_splitval_by(value,	7	,'~'),
MOBILE_NUMBER	=citrus_usr.fn_splitval_by(value,	8	,'~'),
EMAILID	=citrus_usr.fn_splitval_by(value,	9	,'~'),
uid	=citrus_usr.fn_splitval_by(value,	10	,'~'),
UID_FLAG	=citrus_usr.fn_splitval_by(value,	11	,'~'),
FILLER1	=citrus_usr.fn_splitval_by(value,	12	,'~'),
FILLER2	=citrus_usr.fn_splitval_by(value,	13	,'~'),
FILLER3	=citrus_usr.fn_splitval_by(value,	14	,'~'),
FILLER4	=citrus_usr.fn_splitval_by(value,	15	,'~'),
FILLER5	=citrus_usr.fn_splitval_by(value,	16	,'~'),
BOId	=citrus_usr.fn_splitval_by(value,	17	,'~'),
TransSystemDate	=citrus_usr.fn_splitval_by(value,	18	,'~')
from dps8_source1 main,DPS8_PC18 a  where left(main.value ,2) = '18'   
and a.boid = main.BOID
