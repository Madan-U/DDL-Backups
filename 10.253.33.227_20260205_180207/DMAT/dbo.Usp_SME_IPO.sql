-- Object: PROCEDURE dbo.Usp_SME_IPO
...
into #temp   
from(  
 select NISE_PARTY_CODE ,TD_ISIN_CODE,
 --(case when TD_QTY > lotsize then lotsize
 --              when TD_QTY = lotsize then lotsize
 --              when TD_QTY < lotsize then TD_QTY    end )
			   TD_QTY as qty,  
 ...
 union all  
 select NISE_PARTY_CODE ,TD_ISIN_CODE,netqty as qty,  
