-- Object: PROCEDURE citrus_usr.PR_SELECT_TRXGEN_CDSL_SP_XML_BAK_11102017
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------



CREATE  PROCEDURE [citrus_usr].[PR_SELECT_TRXGEN_CDSL_SP_XML_BAK_11102017]  
(  
...
+'<Rsn>'+ ltrim(rtrim(substring(details , 112 , 1))) +'</Rsn>'
+'<Txnelflg>'+ TRXEFLG +'</Txnelflg>'
