-- Object: PROCEDURE citrus_usr.pr_get_ob_fix_totest_isin
...
CREATE proc [citrus_usr].[pr_get_ob_fix_totest_isin](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                          
,@pa_ben_acct_no_fr varchar(16),@pa_ben_acct_no_to varchar(16),@pa_isin varchar(100),@pa_out  varchar(8000) out)        
as        
begin         
...
and cdshm_dpm_id = @pa_dpm_id    and cdshm_isin =@pa_isin    
...
create index ix_1 on #tmp_cdsl_holding_dtls(cdshm_isin,cdshm_dpam_id,cdshm_dpm_id)                      
...
where CDSHM_TRAS_DT < @pa_from_dt        
and cdshm_tras_dt >='aug 01 2011'  and cdshm_isin =@pa_isin        
...
where CDSHM_TRAS_DT < @pa_from_dt        
and cdshm_tras_dt >='aug 01 2011'        
and cdshm_tratm_cd in ('2201')     and cdshm_isin =@pa_isin 
...
and cdshm_tras_dt >='aug 01 2011'        
and cdshm_tratm_cd in ('2246')  and cdshm_isin =@pa_isin )         
