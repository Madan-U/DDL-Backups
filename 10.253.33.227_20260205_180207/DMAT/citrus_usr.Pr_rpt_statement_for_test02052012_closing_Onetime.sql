-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_for_test02052012_closing_Onetime
...
CREATE Proc [citrus_usr].[Pr_rpt_statement_for_test02052012_closing_Onetime]                                
@pa_dptype varchar(4),                                        
@pa_excsmid int,                                        
...
BEGIN                                        
 ...
 set transaction isolation level read uncommitted                               
    ...
    --SELECT * FROM BK_STATEMENT_14OCT2013 where dpam_sba_no=@pa_fromaccid
--RETURN
...
delete from #ACLIST where dpam_sba_no not in (select dpam_sba_no from tmpclosing)    
