-- Object: PROCEDURE citrus_usr.pr_bulk_dpb9_harm_BKP_26MAR2025_SRE_35282
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------



CREATE  proc [citrus_usr].[pr_bulk_dpb9_harm_BKP_26MAR2025_SRE_35282]
as
begin 
...
--------,replace(convert(varchar(11),convert(datetime,ClntActDtTm),103),'/','')
...
--------,''
--------,case when len(isnull(EdctnLvl.CDSL_Old_Values ,'0'))=1 then '0' + isnull(EdctnLvl.CDSL_Old_Values ,'') else isnull(EdctnLvl.CDSL_Old_Values ,'0') end  EdctnLvl
...
--------,replace(convert(varchar(11),convert(datetime,BnAccClsrDt),103),'/','') BnAccClsrDt
--------,replace(convert(varchar(11),convert(datetime,BnAccClsrDt),103),'/','') BnAccClsrDt
