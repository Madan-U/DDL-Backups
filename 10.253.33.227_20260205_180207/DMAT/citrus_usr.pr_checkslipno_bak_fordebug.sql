-- Object: PROCEDURE citrus_usr.pr_checkslipno_bak_fordebug
...
CREATE   procedure [citrus_usr].[pr_checkslipno_bak_fordebug]
(          
...
= convert(vARCHAR(11),GETDATE() ,109) AND HOLM_DELETED_IND = 1),'') + '|*~|1'          
 ...
 if ('Monday'=datename(dw,getdate()) )  
 begin
 SET @pa_errmsg =  'Today is sunday as holiday. DIS request not allowed.'+ '|*~|0'     
 return
 end
