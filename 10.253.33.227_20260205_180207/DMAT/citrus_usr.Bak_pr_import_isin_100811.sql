-- Object: PROCEDURE citrus_usr.Bak_pr_import_isin_100811
...
CREATE PROCEDURE [citrus_usr].[Bak_pr_import_isin_100811](@PA_EXCH          VARCHAR(20)                
...
,ISIN_FACE_VAL                    
   ...
   , TIM.ISIN_NS_CD                       
         ...
         , TIM.ISIN_STATUS                      
         , 1                        
         , TIM.ISIN_SEC_TYPE                               , TIM.ISIN_CREATED_BY                  
         , TIM.ISIN_CREATED_DT                  
         , TIM.ISIN_LST_UPD_BY                  
         , TIM.ISIN_LST_UPD_DT                  
         , 1                
...
,TMPISIN_RTA_STATE  
,TMPISIN_RTA_CTRY  
,TMPISIN_RTA_ZIP,TMPISIN_EMAIL,TMPISIN_PH1,TMPISIN_FAX  
   ...
   SET    ISIN_REG_CD         = TMPISIN_RTA_ID    
     , ISIN_NAME           = TMPISIN_SHRT_NM  
     , ISIN_COMP_NAME    = TMPISIN_SHRT_NM        
     , ISIN_CONV_DT        = TMPISIN_CONV_DT                 
     , ISIN_STATUS         = CASE WHEN TMPISIN_STAT='A' THEN '01' WHEN  TMPISIN_STAT='I' THEN '04' WHEN TMPISIN_STAT='P' THEN '05' WHEN TMPISIN_STAT='S' THEN '02' ELSE TMPISIN_STAT END                 
     --, ISIN_LST_UPD_BY     = @PA_LOGIN_NAME                
     , ISIN_LST_UPD_DT     = GETDATE()   
,isin_adr1 = TMPISIN_RTA_ADD1  
,isin_adr2 = TMPISIN_RTA_ADD2  
,isin_adr3 = TMPISIN_RTA_ADD3  
,isin_adrcity = TMPISIN_RTA_CITY  
,isin_adrstate = TMPISIN_RTA_STATE  
,isin_adrcountry = TMPISIN_RTA_CTRY  
,isin_adrzip = TMPISIN_RTA_ZIP  
