-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_MFLOCK
...
create proc [citrus_usr].[pr_get_holding_fix_latest_MFLOCK](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
and CDSHM_TRAS_DT between  @l_min_trx_dt and @pa_to_dt
AND CDSHM_CDAS_TRAS_TYPE IN ('12','20','21','22','23','2') --'12' -- 20 added by tushar on jul 16 2012
GROUP BY CDSHM_DPAM_ID ,  CDSHM_ISIN 
