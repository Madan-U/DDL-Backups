-- Object: FUNCTION citrus_usr.fn_acct_list_bytushar_bak_01082012
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

create Function [citrus_usr].[fn_acct_list_bytushar_bak_01082012](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int,@PA_FROMACCID varchar(16),@PA_TOACCID varchar(16))   
