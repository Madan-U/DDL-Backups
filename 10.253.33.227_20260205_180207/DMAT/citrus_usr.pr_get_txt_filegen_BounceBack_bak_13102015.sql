-- Object: PROCEDURE citrus_usr.pr_get_txt_filegen_BounceBack_bak_13102015
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--pr_get_txt_filegen_BounceBack 'Client','12033200','1203320000714231','1203320000714231','aUG 01 2015','AUG 31 2015'
create proc [citrus_usr].[pr_get_txt_filegen_BounceBack_bak_13102015](@pa_action varchar(100),@pa_dpid varchar(100)    
,@pa_boid varchar(100)    
,@pa_isin varchar(100)    
...
--and ACCP_ACCPM_PROP_CD ='ECN_FLAG')
  ...
  AND CLIC_CHARGE_NAME ='SERVICE TAX' GROUP BY DPAM_SBA_NO
    ...
    +'|'+EMailId      
    +'|'+case when isnull(citrus_usr.Fn_Ucc_Brom(dpam_id),'')='1' then 'INVESTOR' else isnull(citrus_usr.Fn_Ucc_Brom(dpam_id),'') end --LIFE INVESTOR    
