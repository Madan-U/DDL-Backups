-- Object: FUNCTION citrus_usr.fn_gl_acct_list_temp
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE  function [citrus_usr].[fn_gl_acct_list_temp](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int) returns @l_table  TABLE (dpam_id INT,dpam_crn_no numeric,dpam_sba_no varchar(20),dpam_sba_name varchar(100),eff_from datetime,eff_to datetime,acct_type char(2),child_id int,group_id int)         
as     
begin    
--    
...
declare @temp table (dpam_id INT,dpam_crn_no numeric,dpam_sba_no varchar(20),dpam_sba_name varchar(100),eff_from datetime,eff_to datetime,acct_type char(2),child_id int,group_id int)     
