-- Object: PROCEDURE citrus_usr.pr_get_ob_fix_for_drop
...
CREATE proc [citrus_usr].[pr_get_ob_fix_for_drop](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
