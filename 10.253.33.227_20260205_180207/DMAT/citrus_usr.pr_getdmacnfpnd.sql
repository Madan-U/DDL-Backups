-- Object: PROCEDURE citrus_usr.pr_getdmacnfpnd
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

--exec citrus_usr.pr_getdmacnfpnd 3,'mar 31 2012','mar 31 2012','0','9999999999999999','',''    
CREATE proc [citrus_usr].[pr_getdmacnfpnd](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
