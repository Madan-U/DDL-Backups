-- Object: PROCEDURE citrus_usr.pr_import_bpm_bak201220011
...
--pr_import_bpm 'nsdl','MIG','BULK','C:\BULKINSDBFOLDER\BP MASTER\BP.FLT','*|~*','|*~|',''  
--
--select * from entity_mstr where entm_enttm_cd = 'CLM'  
create PROCEDURE  [citrus_usr].[pr_import_bpm_bak201220011]( @pa_exch          VARCHAR(20)    
