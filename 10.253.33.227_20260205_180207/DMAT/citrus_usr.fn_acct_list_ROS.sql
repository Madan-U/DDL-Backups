-- Object: FUNCTION citrus_usr.fn_acct_list_ROS
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

CREATE Function [citrus_usr].[fn_acct_list_ROS](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int,@PA_FROMACCID varchar(16),@PA_TOACCID varchar(16))       
...
and DPAM_SBA_NO in (select toc_boid from TBL_OWN_ACCOUNT)
...
,dpam_stam_cd     
 ...
 AND ACCP_CLISBA_ID = DPAM_ID     and dpam.DPAM_SBA_NO in (select toc_boid from TBL_OWN_ACCOUNT)
