-- Object: PROCEDURE citrus_usr.pr_dp_ins_upd_addr
...
CREATE PROCEDURE [citrus_usr].[pr_dp_ins_upd_addr] (@pa_id           varchar(8000)  
                  ...
                  --
                    ...
                    --
                      ...
                      IF EXISTS(SELECT * FROM account_adr_conc WITH (NOLOCK)
                                ...
                                and      accac_adr_conc_id in (select entac_adr_conc_id from entity_adr_conc)
        ...
        --
          ...
          --
            ...
            SET    adr_1           = @l_adr_1
                  ...
                  ,adr_lst_upd_by  = @pa_login_name
                  ,adr_lst_upd_dt  = GETDATE()
            WHERE  adr_id          = @l_accac_adr_conc_id
            AND    adr_deleted_ind = 1
          --
          END--n_ext_1
        --
