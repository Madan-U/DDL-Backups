-- Object: PROCEDURE citrus_usr.Pr_rpt_Highvalue_bak_tusharsir_25082015
...
create Proc [citrus_usr].[Pr_rpt_Highvalue_bak_tusharsir_25082015]              
@pa_dptype varchar(4),              
@pa_excsmid int,              
...
,        
		   ...
		   FROM CLOSING_LAST_CDSL right outer join dp_trx_dtls_cdsl MSTR  on  clopm_isin_cd = dptdc_isin        
