-- Object: PROCEDURE citrus_usr.pr_ins_upd_dps8_pc7
-- Server: 10.253.33.227 | DB: DMAT
--------------------------------------------------

 
create proc [citrus_usr].[pr_ins_upd_dps8_pc7]
as
begin 

update s8 
set s8.PurposeCode7=b9.PurposeCode7
...
,	Filler14
,	Filler15
from dpb9_pc7 b9 where not exists (select 1 from dps8_pc7 s8 
where s8.boid = b9.boid 
and s8.NOM_Sr_No = b9.NOM_Sr_No) 
