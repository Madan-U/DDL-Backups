-- Object: PROCEDURE citrus_usr.PR_SELECT_TRXGEN_CDSL_SP_XML_bak_14092022
...
CREATE PROCEDURE [citrus_usr].[PR_SELECT_TRXGEN_CDSL_SP_XML_bak_14092022]  
(  
...
+'<PldgIdntfr>P</PldgIdntfr>'
+ isnull(citrus_usr.FN_UCCMAP_DETAILS('N' + ltrim(rtrim(substring(details , 28 , 16))),ltrim(rtrim(substring(details , 127 , 16)))),'')
...
--MARGIN PLEDGE
WHEN (cd = 'PLEDGEMP' AND verifier='CRTEMP') THEN  '<Tp>'+ '7' +'</Tp>'
+'<Usn>'+ convert(varchar,usn) +'</Usn>'
+'<Pldgtp>'+ ltrim(rtrim(substring(details , 1 , 1))) +'</Pldgtp>'
+'<Subtp>'+ ltrim(rtrim(substring(details , 2 , 1))) +'</Subtp>'
+'<Lcksts>'+ ltrim(rtrim(substring(details , 3 , 1))) +'</Lcksts>'
...
+'<Remk>'+ ltrim(rtrim(substring(details , 163 , 100))) +'</Remk>'
+'<Psn></Psn>'
--+'<ExecDt>31082020</ExecDt>'
+'<Rcvdt>' + request_dt + '</Rcvdt>'
+'<PldgIdntfr>MP</PldgIdntfr>'
+ citrus_usr.FN_UCCMAP_DETAILS(ltrim(rtrim(substring(details , 28 , 16))),ltrim(rtrim(substring(details , 127 , 16))))
--MARGIN PLEDGE

--MARGIN REPLEDGE
WHEN (cd = 'PLEDGEMP' AND verifier='CREATEMR') THEN  '<Tp>'+ '7' +'</Tp>'
+'<Usn>'+ convert(varchar,usn) +'</Usn>'
+'<Pldgtp>'+ ltrim(rtrim(substring(details , 1 , 1))) +'</Pldgtp>'
+'<Subtp>'+ ltrim(rtrim(substring(details , 2 , 1))) +'</Subtp>'
+'<Lcksts>'+ ltrim(rtrim(substring(details , 3 , 1))) +'</Lcksts>'
...
+'<Remk>'+ ltrim(rtrim(substring(details , 163 , 100))) +'</Remk>'
--+'<Psn></Psn>'
+'<ExecDt>' + ISNULL(TRXEFLG,'') + '</ExecDt>'
+'<Rcvdt>' + request_dt + '</Rcvdt>'
+'<PldgIdntfr>MR</PldgIdntfr>'
+ citrus_usr.FN_UCCMAP_DETAILS_MR(ltrim(rtrim(substring(details , 28 , 16))),ltrim(rtrim(substring(details , 127 , 16))))
--MARGIN REPLEDGE
