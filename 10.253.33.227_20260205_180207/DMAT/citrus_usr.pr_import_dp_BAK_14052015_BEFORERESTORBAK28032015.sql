-- Object: PROCEDURE citrus_usr.pr_import_dp_BAK_14052015_BEFORERESTORBAK28032015
...
CREATE  PROCeDURE [citrus_usr].[pr_import_dp_BAK_14052015_BEFORERESTORBAK28032015]( @pa_crn_no      VARCHAR(8000)                  
                            , @pa_exch        VARCHAR(10)                  
 ...
 , case when isnull(citrus_usr.fn_ucc_accp(dpam_id,'RGESS_FLAG',''),'00')  = 'YES'     then 'Y' else 'N' end
  ...
  ,Purpose_code                             
                                  ...
                                  FROM fn_cdsl_export_line_7_extract(@pa_crn_no, @pa_from_dt, @pa_to_dt), dp_acct_mstr , EXCH_SEG_MSTR esm  
											...
											,CASE WHEN CITRUS_USR.fn_acct_conc_value(DPAM_ID,'SMSEMAIL')<> '' THEN lower(CITRUS_USR.fn_acct_conc_value(DPAM_ID,'SMSEMAIL'))
											ELSE lower(CITRUS_USR.fn_conc_value(DPAM_CRN_NO,'SMSEMAIL')) END 
											,''
											,'P'
											FROM   dp_acct_mstr              dpam 
