-- Object: VIEW dbo.pre_Client_Master
-- Server: 10.253.33.227 | DB: inhouse
--------------------------------------------------


CREATE View [dbo].[pre_Client_Master]      
As      
Select      
CM_CD = Isnull(CM_CD, ''),      
...
CM_ADD1 = Isnull(CM_ADD1, ''),      
CM_ADD2 = Isnull(CM_ADD2, ''),      
CM_ADD3 = Isnull(CM_ADD3, ''),      
CM_CITY = Isnull(CM_CITY, ''),      
CM_STATE = Isnull(CM_STATE, ''),      
CM_COUNTRY = Isnull(CM_COUNTRY, ''),      
CM_PIN = Isnull(CM_PIN, ''),      
CM_PHONEINDICATOR = Isnull(CM_PHONEINDICATOR, ''),      
CM_TELE1 = Isnull(CM_TELE1, ''),      
CM_PHONEINDICATOR2 = Isnull(CM_PHONEINDICATOR2, ''),      
...
CM_DIVBRANCHNO = Isnull(CM_DIVBRANCHNO, ''),      
