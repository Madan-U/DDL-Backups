-- Object: PROCEDURE citrus_usr.PR_IMPORT_CLIENT_CDSL_DPB9_bak_02072019
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------


create  PROCEDURE  [citrus_usr].[PR_IMPORT_CLIENT_CDSL_DPB9_bak_02072019]
			(
			 @pa_exch          VARCHAR(20)    
