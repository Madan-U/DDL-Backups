-- Object: PROCEDURE citrus_usr.pr_ins_upd_cham_bak_02012026
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------


--0	INS	HO	CDSL	r	F	IN0019780025|*~|IN0019780074|*~|	M					A|*~||*~||*~|4|*~|*|~*		0	*|~*	|*~|	
create PROCEDURE [citrus_usr].[pr_ins_upd_cham_bak_02012026](@pa_id              VARCHAR(8000)  
...
--163	165	GGMM_T	AMCPROFIX	NORMAL	M	1	TQ	1.00	999999999999999.00	V	87			3		2	VISHAL	2011-03-18 12:41:24.123	VISHAL	2011-03-18 12:41:24.123	1	0	0
select @l_dtls_id
														,@l_cham_id 
														,@pa_slab_name
														,@pa_charge_type
