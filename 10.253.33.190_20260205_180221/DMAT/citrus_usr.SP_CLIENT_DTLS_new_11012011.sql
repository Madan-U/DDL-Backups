-- Object: PROCEDURE citrus_usr.SP_CLIENT_DTLS_new_11012011
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--select * from dp_acct_mstr where dpam_sba_no='1205810000007264'      
--SP_CLIENT_DTLS '357349'      
CREATE PROCEDURE [citrus_usr].[SP_CLIENT_DTLS_new_11012011]      
...
WHILE @@FETCH_STATUS = 0                                                  
    ...
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(DPAM_CRN_NO,'PER_ADR1'),3) [PCITY]      
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(DPAM_CRN_NO,'PER_ADR1'),4) [PSTATE]      
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(DPAM_CRN_NO,'PER_ADR1'),5) [PCOUNTRY]      
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(DPAM_CRN_NO,'PER_ADR1'),6) [PPIN CODE]      
    ,CITRUS_USR.FN_CONC_VALUE(DPAM_CRN_NO,'RES_PH1') [RESPHONENO]      
    ...
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(DPAM_CRN_NO,'COR_ADR1'),3) [CCITY]      
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(DPAM_CRN_NO,'COR_ADR1'),4) [CSTATE]      
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(DPAM_CRN_NO,'COR_ADR1'),5) [CCOUNTRY]      
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(DPAM_CRN_NO,'COR_ADR1'),6) [CPIN CODE]      
    ,CITRUS_USR.FN_CONC_VALUE(DPAM_CRN_NO,'OFF_PH1') [OFFPHONENO]      
    ...
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(BANM_ID,'PER_ADR1'),3) [BCITY]      
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(BANM_ID,'PER_ADR1'),4) [BSTATE]      
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(BANM_ID,'PER_ADR1'),5) [BCOUNTRY]      
    ,CITRUS_USR.FN_SPLITVAL(CITRUS_USR.FN_ADDR_VALUE(BANM_ID,'PER_ADR1'),6) [BPIN CODE]      
    ,BANM_NAME  
    ,CITRUS_USR.FN_CONC_VALUE(BANM_ID,'OFF_PH1') [OFFPHONENO]      
    ,CITRUS_USR.FN_CONC_VALUE(DPAM_CRN_NO,'MOBILE1') [MOBILE]      
    ,ISNULL(CITRUS_USR.FN_CONC_VALUE(DPAM_CRN_NO,'EMAIL'),'') [EMAIL]      
    ...
    ,CASE WHEN DPHD_SH_DOB ='1900-01-01 00:00:00.000' THEN '' ELSE ISNULL(DPHD_SH_DOB,'') END DPHD_SH_DOB      
    ...
    ,CASE WHEN DPHD_TH_DOB ='1900-01-01 00:00:00.000' THEN '' ELSE ISNULL(DPHD_TH_DOB,'') END DPHD_TH_DOB      
