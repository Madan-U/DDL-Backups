-- Object: TABLE citrus_usr.Pend_data_to_import_accp_entp_dps8_pc6
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[Pend_data_to_import_accp_entp_dps8_pc6]
(
    [PurposeCode6] VARCHAR(100) NULL,
    ...
    [filler_a] VARCHAR(100) NULL,
    [driving_licence] VARCHAR(100) NULL,
    [passport_oci] VARCHAR(100) NULL,
    [filler_b] VARCHAR(100) NULL
);
