-- Object: FUNCTION citrus_usr.fn_acct_list_disdrf
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE Function [citrus_usr].[fn_acct_list_disdrf](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int)   
...
and exists (select dpamid from  (select dptdc_dpam_id dpamid from dptdc_mak where dptdc_deleted_ind in (1,0,4,6,-1)
union all 
select demrm_dpam_id dpamid  from demrm_mak where demrm_deleted_ind in (1,0,4,6,-1)) a where a.dpamid = dpam_id 
)
