-- Object: TRIGGER citrus_usr.trig_ledger3
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------


CREATE  TRIGGER [citrus_usr].[trig_ledger3]   
 ON [citrus_usr].[LEDGER3]  
 FOR INSERT,UPDATE  
 AS  
