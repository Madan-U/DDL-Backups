-- Object: PROCEDURE citrus_usr.pr_billing_nsdl_quant
...
CREATE procedure [citrus_usr].[pr_billing_nsdl_quant](@pa_billing_from_dt datetime,@pa_billing_to_dt datetime,@pa_dpm_id numeric,@pa_billing_status char(1))  
as  
begin  
--  
...
*/
						...
						and   DPCH_dpam_id not in(select cl_dpam_id from #account_properties_cl)  
