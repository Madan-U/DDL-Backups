-- Object: PROCEDURE citrus_usr.PR_BULK_DP57_Converter_bak_31082024
...
insert into Dp57log
select GETDATE(),'delete start for 1203320186015090','start'

delete from #tmp_dp57_o  where column_3  = '1203320186015090'

insert into Dp57log
select GETDATE(),'delete start for 1203320186015090','end'
				

				insert into Dp57log
select GETDATE(),'into tmp_dp57_o from #tmp_dp57_o','start'

select *
into tmp_dp57_o from #tmp_dp57_o

				insert into Dp57log
select GETDATE(),'into tmp_dp57_o from #tmp_dp57_o','end'

				insert into Dp57log
select GETDATE(),'index on tmp_dp57_o','start'
