-- Object: PROCEDURE citrus_usr.ANNUAL_REPORT_bkp_20042017
...
CREATE PROC [citrus_usr].[ANNUAL_REPORT_bkp_20042017] 
...
IF  @TRANSTYPE='NTNH'
	BEGIN   
		...
		AND  NOT EXISTS (SELECT 1
						  FROM DP_HLDG_MSTR_CDSL_MONTHEND_HOLDING 
 ...
 IF @TRANSTYPE='NTYH'
	BEGIN 
			 ...
			 AND ISNULL(CLOPM_DT,'01/01/1900') = ( SELECT TOP 1 CLOPM_DT FROM CLOSING_PRICE_MSTR_CDSL
			  WHERE CLOPM_ISIN_CD = DPHMCD_ISIN AND CLOPM_DT <= '2016-03-31' AND CLOPM_DELETED_IND = 1  ORDER BY CLOPM_DT DESC)                                                             
