-- Object: FUNCTION citrus_usr.fn_get_high_val_bak_23112021
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------



CREATE  function [citrus_usr].[fn_get_high_val_bak_23112021](@l_isin varchar(16),@l_qty numeric(18,3),@pa_validation varchar(50),@pa_acct_no varchar(16),@pa_request_date datetime)      
returns char(1)      
as      
begin      
--      
