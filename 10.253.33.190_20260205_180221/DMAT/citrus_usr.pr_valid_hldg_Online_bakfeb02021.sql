-- Object: PROCEDURE citrus_usr.pr_valid_hldg_Online_bakfeb02021
...
Create proc [citrus_usr].[pr_valid_hldg_Online_bakfeb02021](@pa_cd varchar(10),@pa_boid varchar(20),@pa_isin varchar(20),@pa_qty numeric(18,3),@pa_out varchar(125) output)      
as      
begin      
