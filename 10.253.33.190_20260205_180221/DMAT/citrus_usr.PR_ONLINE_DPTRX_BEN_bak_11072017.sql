-- Object: PROCEDURE citrus_usr.PR_ONLINE_DPTRX_BEN_bak_11072017
...
--declare @PA_ONL_mobile_email VARCHAR(100)
--set @PA_ONL_mobile_email=''
...
BEGIN
IF NOT EXISTS(SELECT 1 FROM ONLINE_DPTRX_BEN_MSTR WHERE (ONL_TRXFEREE_DPID=@PA_ONL_TRXFEREE_DPID OR ONL_CMBPID =@PA_ONL_CMBPID) AND ONL_TRXFEREE_BONAME= @PA_ONL_TRXFEREE_BONAME AND ONL_TRXFEREE_BOID=@PA_ONL_TRXFEREE_BOID AND ONL_DELETED_IND=1 and ONL_TRX_BOID = @PA_ONL_TRX_BOID)
BEGIN
