-- Object: FUNCTION citrus_usr.Fn_ChildExists
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--select citrus_usr.Fn_ChildExists(30,42)    
--select citrus_usr.Fn_ChildExists(30,30)  
CREATE function [citrus_usr].[Fn_ChildExists]    
