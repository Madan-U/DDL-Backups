-- Object: PROCEDURE citrus_usr.Pr_Rpt_Holding_bak150409
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--[Pr_Rpt_Holding_changedbyTUSHAR280309] 'nsdl',4,'Y','mar 28 2009','10000037','10000037','','N',1,'HO|*~|',''
--[Pr_Rpt_Holding] 'nsdl',4,'Y','mar 28 2009','10000037','10000037','','N',1,'HO|*~|',''
--select * from dp_mstr
create Proc [citrus_usr].[Pr_Rpt_Holding_bak150409]
@pa_dptype varchar(4),                  
@pa_excsmid int,                  
@pa_asondate char(1),                  
@pa_fordate datetime,                  
...
DECLARE @@FOOTER_LINES         VARCHAR(8000)

select @@FOOTER_LINES = ISNULL(CITRUS_USR.FN_STRING_FOR_PRINT(page_footer_msg,158),'')
from report_message where report_name = 'HLDG_NSDL'
