-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_for
...
CREATE Proc [citrus_usr].[Pr_rpt_statement_for]                            
@pa_dptype varchar(4),                                    
@pa_excsmid int,                                    
...
set @pa_group_cd =  isnull(citrus_usr.fn_splitval(@pa_group_cd,1),'')  
 ...
 END                                    
  ...
  create table #vw_fethob(v_cdshm_tras_dt datetime, v_CDSHM_DPM_ID numeric 
  ...
  exec pr_get_ob_newlogic @@dpmid,@pa_fromdate,@pa_todate,@pa_fromaccid,@pa_toaccid,''
...
, '00:00:00', '23:59:59') end )
    ,case when cdshm_qty > 0 then 'C' else 'D' end 
      ...
      and v_cdshm_isin = cdshm_isin               
	   and cdshm_tras_dt = v_cdshm_tras_dt
And cdshm_trans_no = v_cdshm_trans_no 
      ,account_group_mapping g with(nolock)                        
      ,#ACLIST account                                      
      where   CDSHM_DPM_ID = @@dpmid  
	  and CDSHM_TRAS_DT >=@pa_fromdate AND CDSHM_TRAS_DT <=@pa_todate                                    
      and cdshm_tratm_cd in('2246','2277','2280','2201','3102','2270','2220','2262','2251','2202','2252','4456')     
...
where  
tratm_cd not in ('2246','2277','2280','3102','2201','2270','2220','2262','2251','2202','2252','4456') 
