-- Object: TABLE citrus_usr.Nominee_Multi
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[Nominee_Multi]
(
    ...
    [NOM_TRXPRINTFLAG] CHAR(3) NULL,
    [NOM_DRIVINGLIC] VARCHAR(100) NULL,
    [NOM_PASSUIC] VARCHAR(100) NULL,
    [NOM_ISDCODE] VARCHAR(10) NULL
);
