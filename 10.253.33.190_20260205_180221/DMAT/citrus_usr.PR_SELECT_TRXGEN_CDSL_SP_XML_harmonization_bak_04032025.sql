-- Object: PROCEDURE citrus_usr.PR_SELECT_TRXGEN_CDSL_SP_XML_harmonization_bak_04032025
...
CREATE  PROCEDURE [citrus_usr].[PR_SELECT_TRXGEN_CDSL_SP_XML_harmonization_bak_04032025]  
(  
...
then case when isnull(ltrim(rtrim(convert(varchar,xmlField.value('(Ranges)[1]', 'nvarchar(max)')))),'') = '' then '0' else  isnull(ltrim(rtrim(convert(varchar,xmlField.value('(Ranges)[1]', 'nvarchar(max)')))),'') end  else CONVERT(VARCHAR,ISNULL(DEMRM_TOTAL_CERTIFICATES,'0')) end end
...
+ ','+','+','+','+  + ','+ case when @PA_TRX_TAB='DESTAT*|~*' then '' else  SUBSTRING(isnull(convert(varchar,xmlField.value('(Dspchdt)[1]', 'nvarchar(max)')),''), 5, 4) + '-' + SUBSTRING(isnull(convert(varchar,xmlField.value('(Dspchdt)[1]', 'nvarchar(max)')),''), 3, 2) + '-' + SUBSTRING(isnull(convert(varchar,xmlField.value('(Dspchdt)[1]', 'nvarchar(max)')),''), 1, 2) end + ','+',' +','+  ','+case when  @PA_TRX_TAB='DESTAT*|~*' then '' else 'AC' end +','+ +','+ ','+','+isnull((SELECT top 1 ltrim(rtrim(Standard_Value)) FROM standard_value_list WHERE iso_tags ='LckInRsnCd' AND ISNULL(CDSL_Old_Values,'')<>'' and CDSL_Old_Values=isnull(convert(varchar,xmlField.value('(Lckcd)[1]', 'nvarchar(max)')),'')),'')	+',' + ',' + case when isnull(convert(varchar,xmlField.value('(Lckexpdt)[1]', 'nvarchar(max)')),'') <> '' then SUBSTRING(isnull(convert(varchar,xmlField.value('(Lckexpdt)[1]', 'nvarchar(max)')),''), 5, 4)  + '-' + SUBSTRING(isnull(convert(varchar,xmlField.value('(Lckexpdt)[1]', 'nvarchar(max)')),''), 3, 2) + '-' + SUBSTRING(isnull(convert(varchar,xmlField.value('(Lckexpdt)[1]', 'nvarchar(max)')),''), 1, 2) else '' end  + ','+convert(varchar(100),demrm_id)+','+ ','+ ','+ case when  isnull(ltrim(rtrim(convert(varchar,xmlField.value('(Lcksts)[1]', 'nvarchar(max)')))),'') = 'Y' then 'LCK' else 'FRE' end  +','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+ ',' +','+','+','++','+','+ ',' +'' + ','+','+','+','++','+','+','+','+','+ ','+','+','+','+','+','+','+','+','+','+','+',' 
