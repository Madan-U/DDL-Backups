-- Object: PROCEDURE citrus_usr.pr_acct_totalholding_AjxBind_bak_30092016
...
if len(@pa_sba_no) = 16
select distinct top 1 dphmc.dphmc_isin                   dptdc_isin, replace(convert(varchar,dphmc.DPHMC_CURR_QTY),'.000','')    dptdc_qty,
