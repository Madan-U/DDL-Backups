-- Object: PROCEDURE dbo.DP_HOLDING_ISINWISE_SAT
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--exec [DP_HOLDING_ISINWISE]

 CREATE PROCEDURE   [dbo].[DP_HOLDING_ISINWISE_SAT]
...
AND TD_CURDATE > DATEADD(DAY, -3, GETDATE()) and TD_CURDATE < DATEADD(DAY, -2, GETDATE())
and td_trxno = '2201' 
...
and B.CLOPM_DT > DATEADD(DAY, -3, GETDATE()) and B.CLOPM_DT < DATEADD(DAY, -2, GETDATE())
