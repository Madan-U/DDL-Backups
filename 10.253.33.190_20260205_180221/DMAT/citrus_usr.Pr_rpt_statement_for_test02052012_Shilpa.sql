-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_for_test02052012_Shilpa
...
CREATE Proc [citrus_usr].[Pr_rpt_statement_for_test02052012_Shilpa]                            
@pa_dptype varchar(4),                                    
@pa_excsmid int,                                    
...
--,valuation numeric                       
  ...
  begin  
      ...
      insert into #tempmaincdsl(dpam_id,dpam_sba_name,dpam_acctno,trans_desc,dpm_trans_no,trans_date,isin_cd ,sett_type ,sett_no  ,opening_bal,qty,order_by,line_no,cdshm_trg_settm_no,tratm_cd,exedt,c_d_flag)--,rate,valuation)                         
...
--      and cdshm_isin like '' + '%'        
  ...
  begin    
      ...
      ,isin_cd
      ,sett_type,sett_no
      ,opening_bal,qty,order_by,line_no,cdshm_trg_settm_no,tratm_cd,exedt,c_d_flag)--,rate,valuation)                         
      select CDSHM_DPAM_ID,                        
      DPAM_SBA_NAME,                        
      CDSHM_BEN_ACCT_NO,                                    
      CDSHM_TRATM_DESC=replace(CDSHM_TRATM_DESC,'        ',''),                            
