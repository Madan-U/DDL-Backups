-- Object: PROCEDURE citrus_usr.pr_bulk_dp57_bak_bakdatedfileimport
...
CREATE   proc [citrus_usr].[pr_bulk_dp57_bak_bakdatedfileimport]
(  
...
truncate table  CDSL_HOLDING_DTLS_08122023
insert into Dp57log
...
SELECT * INTO YT3101  FROM #tmp_dp57_o

 insert into Dp57log
select GETDATE(),'into CDSL_HOLDING_DTLS','start'

--INSERT INTO CDSL_HOLDING_DTLS_08122023(
