-- Object: PROCEDURE citrus_usr.pr_get_txt_filegen_client_wisetest
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--pr_get_txt_filegen 'client','12033200','1203320000714231','1203320000714231','aUG 01 2015','AUG 31 2015'
CREATE proc [citrus_usr].[pr_get_txt_filegen_client_wisetest](@pa_action varchar(100),@pa_dpid varchar(100)    
,@pa_boid varchar(100)    
,@pa_isin varchar(100)    
...
INTO #ACCOUNT_PROPERTIES_ECN FROM ACCOUNT_PROPERTIES,DP_ACCT_MSTR  
WHERE ACCP_ACCPM_PROP_CD = 'ECN_FLAG'  and ACCP_CLISBA_ID = DPAM_ID and DPAM_SBA_NO = @pa_boid 
...
--and ACCP_ACCPM_PROP_CD ='ECN_FLAG')
  ...
  exec [pr_get_ob_fix] 3,@pa_from_date,@pa_to_date,'0','9999999999999999',''
   ...
   and CDSHM_TRAS_DT between @pa_from_date and @pa_to_date   
    ...
    select *, ob+isnull((select SUM(cdshm_qty) from #tempdata t2 where t1.CDSHM_ISIN= t2.CDSHM_ISIN and t1.CDSHM_DPAM_ID = t2.CDSHM_DPAM_ID 
