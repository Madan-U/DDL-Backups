-- Object: PROCEDURE citrus_usr.pr_ins_upd_trx_cdsl_sp_for_debug
...
CREATE  PROCEDURE [citrus_usr].[pr_ins_upd_trx_cdsl_sp_for_debug](@pa_id              VARCHAR(8000)      
              ,@pa_tab             VARCHAR(20)    
...
select @l_val_yn  = citrus_usr.fn_get_high_val_opt('',0,'DORMANT',@pa_dpam_acct_no,convert(datetime,@pa_req_dt,103))  
