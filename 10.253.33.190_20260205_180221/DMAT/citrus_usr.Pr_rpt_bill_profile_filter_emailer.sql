-- Object: PROCEDURE citrus_usr.Pr_rpt_bill_profile_filter_emailer
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE Proc [citrus_usr].[Pr_rpt_bill_profile_filter_emailer]              
@pa_dptype varchar(4),                      
@pa_excsmid int,                      
...
m.line_no ,closing_qty=0.000   
   ...
   TRANS_DESC=UPPER(ltrim(rtrim(isnull(TRANS_DESC,'')))),              
