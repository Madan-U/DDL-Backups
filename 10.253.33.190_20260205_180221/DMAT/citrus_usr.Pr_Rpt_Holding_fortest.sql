-- Object: PROCEDURE citrus_usr.Pr_Rpt_Holding_fortest
...
CREATE  PROC [citrus_usr].[Pr_Rpt_Holding_fortest]  
			@PA_DPTYPE VARCHAR(4),                    
			@PA_EXCSMID INT,                    
			@PA_ASONDATE CHAR(1),                    
			@PA_FORDATE DATETIME,                    
...
BEGIN   
		 ...
		 AND DPHMCD_ISIN LIKE @PA_ISINCD + '%'      
		-- AND ISNULL(DPHMCD_CURR_QTY,0) <> 0  
group BY DPAM_SBA_NO,ISIN_NAME,DPHMCD_ISIN ,DPAM_SBA_NAME  ,CLOPM_CDSL_RT,dpam_id          
