-- Object: PROCEDURE citrus_usr.pr_get_txt_filegen_BounceBack_bak_13092017
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--PR_GET_TXT_FILEGEN_BOUNCEBACK 'summary','12033200','1203320008431140','1203320008431140','jUL  1 2017','JUL 31 2017'
create  proc [citrus_usr].[pr_get_txt_filegen_BounceBack_bak_13092017](@pa_action varchar(100),@pa_dpid varchar(100)    
,@pa_boid varchar(100)    
,@pa_isin varchar(100)    
...
WHEN  ISNULL(CLIC_CHARGE_NAME,'')='CGST @9%' THEN 'TRANSACTION CHARGES'
WHEN  ISNULL(CLIC_CHARGE_NAME,'')='SGST @9%' THEN 'TRANSACTION CHARGES'
WHEN  ISNULL(CLIC_CHARGE_NAME,'')='IGST @18%' THEN 'TRANSACTION CHARGES'
