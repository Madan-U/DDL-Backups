-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_byisin_allreco_arch
...
CREATE proc [citrus_usr].[pr_get_holding_fix_byisin_allreco_arch](@pa_from_dt datetime, @pa_to_dt datetime                            
