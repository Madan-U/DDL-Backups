-- Object: PROCEDURE citrus_usr.pr_ins_upd_ledger_JV
...
CREATE PROCEDURE [citrus_usr].[pr_ins_upd_ledger_JV](@pa_id  VARCHAR(8000)      
...
print '1111111'
					  ...
					  SET @@SSQL= 'Insert into #tmpvch(Acct_id,dpm_id,Vch_dt,Vch_no,Amt,clrg_dt)
									 ...
									 and ldg_deleted_ind = 1 and ldg_voucher_type = ' + @pa_voucher_type + ' and ldg_voucher_no   = ' + @pa_voucher_no + ' and ldg_dpm_id = ' + @pa_dpm_id 
print @@SSQL
					  EXEC(@@SSQL)
					  IF @@rowcount > 0
					  BEGIN    
