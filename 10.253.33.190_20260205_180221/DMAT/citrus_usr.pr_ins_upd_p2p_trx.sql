-- Object: PROCEDURE citrus_usr.pr_ins_upd_p2p_trx
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE PROCEDURE [citrus_usr].[pr_ins_upd_p2p_trx](@pa_id              VARCHAR(8000)      
...
--    
          ...
          --    
            ...
            --    
              ...
              ,dptd_internal_ref_no    
              ,dptd_dpam_id    
              ,dptd_request_dt                  ,dptd_execution_dt    
              ,dptd_slip_no    
              ,dptd_isin    
              ,dptd_line_no    
              ,dptd_qty    
            ...
            --    
              ...
              --          
                 ...
                 --    
                   ...
                   AND     dptd.dptd_id              = dptdM.dptd_id             
...
and left(dptd_trastm_Cd,3) = left(uses_trantm_id,3)
  ...
  BEGIN    
  --    
    exec pr_checkslipno '','P2P_DP_TRX_SEL', @pa_dpm_dpid,@pa_dpam_acct_no,@pa_slip_no,@pa_login_name,''    
  --    
  END    
--    
END
