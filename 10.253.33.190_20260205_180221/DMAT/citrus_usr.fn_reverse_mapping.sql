-- Object: FUNCTION citrus_usr.fn_reverse_mapping
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE function [citrus_usr].[fn_reverse_mapping](@pa_exchange varchar(25), @pa_prop_cd varchar(50), @pa_value varchar(50) )  
returns varchar(100)  
as  
begin  
--  
...
when @pa_value = '11' then '> 1 CRORE'               
  ...
  --                    
    set @L_VALUES = case when @pa_value = '01' then   'Indian'                   
                        ...
                        when @pa_value = '04' then		'MIDDLE EAST NATIONS'
						when @pa_value = '06' then		'FRANCE' 
						when @pa_value = '08' then		'SINGAPORE' 
						when @pa_value = '10' then		'OTHERS' 
						when @pa_value = '02' then		'US'                  
						when @pa_value = '19' then		'AUSTRALIA'    
                        else '' end                    
