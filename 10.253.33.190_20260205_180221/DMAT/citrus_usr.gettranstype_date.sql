-- Object: FUNCTION citrus_usr.gettranstype_date
...
CREATE function [citrus_usr].[gettranstype_date] (@pa_trans_no varchar(100),@pa_dpam_id numeric)          
...
set @l =''    
--    
select  top 1  @l  = isnull(convert(varchar(10),cdshm_tras_dt,103),'')  
from cdsl_holding_dtls , transaction_sub_type_mstr     
