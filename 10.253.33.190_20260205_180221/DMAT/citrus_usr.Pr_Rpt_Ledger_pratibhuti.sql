-- Object: PROCEDURE citrus_usr.Pr_Rpt_Ledger_pratibhuti
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

/****** Object:  StoredProcedure [citrus_usr].[Pr_Rpt_Ledger_pritibhuti]    Script Date: 10/22/2008 14:20:26 ******/

--[Pr_Rpt_Ledger] 3,2,'apr  1 2009','APR 30 2009','P','','','y',1,'HO|~*|',''       
create Proc [citrus_usr].[Pr_Rpt_Ledger_pratibhuti]        
@pa_dpmid int,        
@pa_finyearid int,        
...
set @@ssql = @@ssql + ' select trans_type='''',voucher_type=0,Voucher_no=0,refno='''',ldg_account_id,dpam_sba_no,dpam_sba_name,ldg_account_type,voucher_date= convert(varchar(11),ldg_voucher_dt,109) ,bank_cl_date= '''','        
