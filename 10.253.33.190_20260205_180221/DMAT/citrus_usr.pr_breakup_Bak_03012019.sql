-- Object: PROCEDURE citrus_usr.pr_breakup_Bak_03012019
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------


CREATE procedure [citrus_usr].[pr_breakup_Bak_03012019](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
