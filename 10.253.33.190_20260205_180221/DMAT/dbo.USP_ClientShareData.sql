...
CREATE PROCEDURE [dbo].[USP_ClientShareData]

AS
exec USP_ClientShareData;
BEGIN

--select * INTO #Tempdataa  from  AGMUBODPL3.dMAT.DBO.SYNERGY_TRXN_DETAILS as TD with(nolock) 
...
--select * into #TempData1 from AGMUBODPL3.dMAT.DBO.TBL_CLIENT_MASTER as CM with(nolock);
