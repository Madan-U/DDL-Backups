-- Object: PROCEDURE citrus_usr.pr_bulk_dp57
...
CREATE   proc [citrus_usr].[pr_bulk_dp57]
(  
...
citrus_usr.fn_splitval_by(value,	1	,'~') 	column_1	,
citrus_usr.fn_splitval_by(value,	2	,'~') 	column_2	,
citrus_usr.fn_splitval_by(value,	3	,'~') 	column_3	,
citrus_usr.fn_splitval_by(value,	4	,'~') 	column_4	,
citrus_usr.fn_splitval_by(value,	5	,'~') 	column_5	,
citrus_usr.fn_splitval_by(value,	6	,'~') 	column_6	,
citrus_usr.fn_splitval_by(value,	7	,'~') 	column_7	,
--citrus_usr.fn_splitval_by(value,	8	,'~') 	column_8	,
citrus_usr.fn_splitval_by(value,	9	,'~') 	column_9	,
citrus_usr.fn_splitval_by(value,	10	,'~') 	column_10	,
citrus_usr.fn_splitval_by(value,	11	,'~') 	column_11	,
citrus_usr.fn_splitval_by(value,	12	,'~') 	column_12	,
citrus_usr.fn_splitval_by(value,	13	,'~') 	column_13	,
citrus_usr.fn_splitval_by(value,	14	,'~') 	column_14	,
citrus_usr.fn_splitval_by(value,	15	,'~') 	column_15	,
--citrus_usr.fn_splitval_by(value,	16	,'~') 	column_16	,
--citrus_usr.fn_splitval_by(value,	17	,'~') 	column_17	,
citrus_usr.fn_splitval_by(value,	18	,'~') 	column_18	,
--citrus_usr.fn_splitval_by(value,	19	,'~') 	column_19	,
citrus_usr.fn_splitval_by(value,	20	,'~') 	column_20	,
--citrus_usr.fn_splitval_by(value,	21	,'~') 	column_21	,
--citrus_usr.fn_splitval_by(value,	22	,'~') 	column_22	,
--citrus_usr.fn_splitval_by(value,	23	,'~') 	column_23	,
citrus_usr.fn_splitval_by(value,	24	,'~') 	column_24	,
--citrus_usr.fn_splitval_by(value,	25	,'~') 	column_25	,
citrus_usr.fn_splitval_by(value,	26	,'~') 	column_26	,
citrus_usr.fn_splitval_by(value,	27	,'~') 	column_27	,
--citrus_usr.fn_splitval_by(value,	28	,'~') 	column_28	,
citrus_usr.fn_splitval_by(value,	29	,'~') 	column_29	,
citrus_usr.fn_splitval_by(value,	30	,'~') 	column_30	,
citrus_usr.fn_splitval_by(value,	31	,'~') 	column_31	,
citrus_usr.fn_splitval_by(value,	32	,'~') 	column_32	,
--citrus_usr.fn_splitval_by(value,	33	,'~') 	column_33	,
citrus_usr.fn_splitval_by(value,	34	,'~') 	column_34	,
citrus_usr.fn_splitval_by(value,	35	,'~') 	column_35	,
--citrus_usr.fn_splitval_by(value,	36	,'~') 	column_36	,
citrus_usr.fn_splitval_by(value,	37	,'~') 	column_37	
--citrus_usr.fn_splitval_by(value,	38	,'~') 	column_38	,
--citrus_usr.fn_splitval_by(value,	39	,'~') 	column_39	,
--citrus_usr.fn_splitval_by(value,	40	,'~') 	column_40	,
--citrus_usr.fn_splitval_by(value,	41	,'~') 	column_41	,
--citrus_usr.fn_splitval_by(value,	42	,'~') 	column_42	,
--citrus_usr.fn_splitval_by(value,	43	,'~') 	column_43	,
--citrus_usr.fn_splitval_by(value,	44	,'~') 	column_44	,
--citrus_usr.fn_splitval_by(value,	45	,'~') 	column_45	,
--citrus_usr.fn_splitval_by(value,	46	,'~') 	column_46	,
--citrus_usr.fn_splitval_by(value,	47	,'~') 	column_47	,
--citrus_usr.fn_splitval_by(value,	48	,'~') 	column_48	,
--citrus_usr.fn_splitval_by(value,	49	,'~') 	column_49	,
--citrus_usr.fn_splitval_by(value,	50	,'~') 	column_50	,
--citrus_usr.fn_splitval_by(value,	51	,'~') 	column_51	,
--citrus_usr.fn_splitval_by(value,	52	,'~') 	column_52	,
--citrus_usr.fn_splitval_by(value,	53	,'~') 	column_53	,
--citrus_usr.fn_splitval_by(value,	54	,'~') 	column_54	
...
insert into Dp57log
select GETDATE(),'Auto Insert 33200','Start'
...
delete from AGMUBODPL3.dmat.citrus_usr.tmp_dp57  

insert into AGMUBODPL3.dmat.citrus_usr.tmp_dp57 
select * from #tempdata_toolddp 

exec [AGMUBODPL3].dmat.citrus_usr.[pr_bulk_dp57_fromnewdp] 'MIG','12033200',0,'','','*|~*', '|*~|','0',''
...
insert into Dp57log
select GETDATE(),'Auto Insert 33200','End'
...
insert into Dp57log
select GETDATE(),'Auto Insert 33202','Start'

/*	cdsl issue cuspa account 13092023		*/
if exists(select 1 from tmp_dp57_o where left(column_3 ,8)='12033202' )
begin 

declare @l_old_dp_cnt_202 numeric
select @l_old_dp_cnt_202  = count(1) from tmp_dp57_o  where left(value ,1)='D' and left(column_3 ,8)='12033202'

select * into #tempdata_toolddp_202 from (
select replace(value ,'~33201~','~33202~') value from tmp_dp57_o  where left(value ,1)='H'
union all
select value from tmp_dp57_o  where left(value ,1)='D' and left(column_3 ,8)='12033202'
union all
select replace(value,'~'+citrus_usr.fn_splitval_by(value ,2,'~') +'~','~'+CONVERT(varchar,@l_old_dp_cnt_202)+'~') from tmp_dp57_o  where left(value ,1)='T'
) a
 

delete from [ATMUMBODPL03].dmat.citrus_usr.tmp_dp57  

insert into [ATMUMBODPL03].dmat.citrus_usr.tmp_dp57 
select * from #tempdata_toolddp_202 

exec [ATMUMBODPL03].dmat.citrus_usr.[pr_bulk_dp57_fromnewdp] 'MIG','12033202',0,'','','*|~*', '|*~|','0',''

drop table #tempdata_toolddp_202

end 

insert into Dp57log
select GETDATE(),'Auto Insert 33202','End'
/*cdsl issue cuspa account 13092023		*/

insert into Dp57log
select GETDATE(),'Auto Insert 33203','Start'
/*	cdsl issue cuspa account 07062024	for 203 dp	*/
if exists(select 1 from tmp_dp57_o where left(column_3 ,8)='12033203' )
begin 

declare @l_old_dp_cnt_203 numeric
select @l_old_dp_cnt_203  = count(1) from tmp_dp57_o  where left(value ,1)='D' and left(column_3 ,8)='12033203'

select * into #tempdata_toolddp_203 from (
select replace(value ,'~33201~','~33203~') value from tmp_dp57_o  where left(value ,1)='H'
union all
select value from tmp_dp57_o  where left(value ,1)='D' and left(column_3 ,8)='12033203'
union all
select replace(value,'~'+citrus_usr.fn_splitval_by(value ,2,'~') +'~','~'+CONVERT(varchar,@l_old_dp_cnt_203)+'~') from tmp_dp57_o  where left(value ,1)='T'
) a
 

delete from [ABVSDP203].dmat.citrus_usr.tmp_dp57  

insert into [ABVSDP203].dmat.citrus_usr.tmp_dp57 
select * from #tempdata_toolddp_203 

exec [ABVSDP203].dmat.citrus_usr.[pr_bulk_dp57_fromnewdp] 'MIG','12033203',0,'','','*|~*', '|*~|','0',''

drop table #tempdata_toolddp_203
...
insert into Dp57log
select GETDATE(),'Auto Insert 33203','End'

/*cdsl issue cuspa account 13092023		*/

--insert into Dp57log
--select GETDATE(),'Auto Insert 33204','Start'
--/*	cdsl issue cuspa account 07062024	for 203 dp	*/
--if exists(select 1 from tmp_dp57_o where left(column_3 ,8)='12033204' )
--begin 

--declare @l_old_dp_cnt_204 numeric
--select @l_old_dp_cnt_204  = count(1) from tmp_dp57_o  where left(value ,1)='D' and left(column_3 ,8)='12033204'

--select * into #tempdata_toolddp_204 from (
--select replace(value ,'~33201~','~33204~') value from tmp_dp57_o  where left(value ,1)='H'
--union all
--select value from tmp_dp57_o  where left(value ,1)='D' and left(column_3 ,8)='12033204'
--union all
--select replace(value,'~'+citrus_usr.fn_splitval_by(value ,2,'~') +'~','~'+CONVERT(varchar,@l_old_dp_cnt_204)+'~') from tmp_dp57_o  where left(value ,1)='T'
--) a
 

--delete from [ABVSDP204].dmat.citrus_usr.tmp_dp57  

--insert into [ABVSDP204].dmat.citrus_usr.tmp_dp57 
--select * from #tempdata_toolddp_204 

--exec [ABVSDP204].dmat.citrus_usr.[pr_bulk_dp57_fromnewdp] 'MIG','12033204',0,'','','*|~*', '|*~|','0',''

--drop table #tempdata_toolddp_204

--end 

--/*cdsl issue cuspa account 07062024 for 203 dp		*/
--insert into Dp57log
--select GETDATE(),'Auto Insert 33204','End'
...
--added above line as per mail from vishal dated 25012023
		...
		and column_3 =dpam_sba_no) and LEFT(column_3,8) not in ('12033200','16010100','12033202','12033203') ) 	
		...
		and LEFT(column_3,8) not in ('12033200','16010100','12033202','12033203') --- added apr 04 2023
...
,demrm_response_dt  = convert(datetime,substring(ltrim(rtrim(substring(column_9,0,9))),1,2)
+ '/' + substring(ltrim(rtrim(substring(column_9,0,9))),3,2)
+ '/' + substring(ltrim(rtrim(substring(column_9,0,9))),5,4)
,103)
...
,CDSHM_CDAS_TRAS_TYPE,CDSHM_CDAS_SUB_TRAS_TYPE
		...
		--,CITRUS_USR.fn_dp57_stuff('desc',column_2,'','') + '-'+ CITRUS_USR.fn_dp57_stuff('MAINDESC',column_7,'','')
        ,cdasdesc 
		,convert(datetime,left(column_9,2)+'/'+substring(column_9,3,2)+'/'+substring(column_9,5,4),103) 
		,column_4 
...
select @l_filecount = column_2 from #tmp_dp57_o where left(value,1)='T'
