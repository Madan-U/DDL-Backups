-- Object: PROCEDURE citrus_usr.pr_import_Issuer
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE PROCEDURE  [citrus_usr].[pr_import_Issuer]( @pa_exch          VARCHAR(20)  
...
--  
  ...
  IF @pa_mode = 'BULK'
		...
		--
							...
							SET @@ssql ='BULK INSERT tmp_issuer_mstr	 from ''' + @pa_db_source + ''' WITH 
							(
										FIELDTERMINATOR = ''~'',
										ROWTERMINATOR = ''\n''
							)'
