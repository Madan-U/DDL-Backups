-- Object: PROCEDURE citrus_usr.pr_upd_dp
...
CREATE PROCEDURE [citrus_usr].[pr_upd_dp](@pa_id           varchar(8000)  
    ...
    --  
      ...
      --      
				...
				BEGIN
							...
							and    isnull(citrus_usr.fn_splitval(@currstring_id,9),'' )=''
							...
							update a set client_code = dpam_sba_no,ENTITY='CDSL' from kyc.dbo.CDSLAPI_REJECTION a 
							, dp_acct_mstr 
							, client_mstr 
							where clim_crn_no = dpam_crn_no 
							and citrus_usr.fn_splitval_by( LEFT(clim_short_name,200)  ,citrus_usr.ufn_CountString (clim_short_name,'-')+1,'-')=kit_no
							and status ='A' and dpam_sba_no = convert(varchar(20), citrus_usr.fn_splitval(@currstring_id,4))  
