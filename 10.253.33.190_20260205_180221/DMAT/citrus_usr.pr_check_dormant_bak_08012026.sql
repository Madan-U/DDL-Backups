-- Object: PROCEDURE citrus_usr.pr_check_dormant_bak_08012026
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

---pr_check_dormant 4,'DORMANT','IN504316',''
create procedure [citrus_usr].[pr_check_dormant_bak_08012026](@pa_id numeric,@pa_action varchar(100), @pa_dtls_id VARCHAR(20),@pa_output varchar(8000) output)
as
begin
print @pa_dtls_id
