-- Object: PROCEDURE citrus_usr.Pr_rpt_bill_profile_filter_CLOSEACCOUNT_quant
...
*/
create Proc [citrus_usr].[Pr_rpt_bill_profile_filter_CLOSEACCOUNT_quant]              
@pa_dptype varchar(4),                      
@pa_excsmid int,                      
...
prev_bill_bal numeric(18,2)
 ...
 begin  
  ...
  insert into #tempmainnsdl        
   select distinct @pa_todate,dpam_id,dpam_sba_no,dpam_sba_name,null,null,null,null,null,null,null,null,null,null,4,0,null           
   FROM #ACLIST a
   WHERE NOT EXISTS(SELECT dpam_id FROM #tempmainnsdl b WHERE a.dpam_id = b.dpam_id)
   AND  isnumeric(dpam_sba_no)=1 --and eff_from BETWEEN  @pa_fromdate AND @pa_todate 
   and convert(numeric,DPAM_SBA_NO) between convert(numeric,@pa_fromaccid) and convert(numeric,@pa_toaccid)  
