-- Object: PROCEDURE citrus_usr.pr_ins_upd_logn_bk_09oct2013
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

create PROCEDURE [citrus_usr].[pr_ins_upd_logn_bk_09oct2013]( @pa_id          varchar(8000)  
