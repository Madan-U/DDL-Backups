-- Object: PROCEDURE citrus_usr.pr_get_txt_filegen_BounceBack_bak_06072017
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--PR_GET_TXT_FILEGEN_BOUNCEBACK 'HOLDING','12033200','1203320000255616','','JAN 01 2016','JAN 31 2016'
create  proc [citrus_usr].[pr_get_txt_filegen_BounceBack_bak_06072017](@pa_action varchar(100),@pa_dpid varchar(100)    
,@pa_boid varchar(100)    
,@pa_isin varchar(100)    
