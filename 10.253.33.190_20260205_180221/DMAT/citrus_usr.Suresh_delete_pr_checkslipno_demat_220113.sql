-- Object: PROCEDURE citrus_usr.Suresh_delete_pr_checkslipno_demat_220113
...
--ROLLBACK
CREATE procedure [citrus_usr].[Suresh_delete_pr_checkslipno_demat_220113]      
(      
...
begin
	set @pa_errmsg = 'Request not approved! Entry not allowed!'
end  

	if @validateonly ='N'
	begin 
		if not exists(select USES_ID from used_slip where uses_slip_no = @slipno and uses_trantm_id =@trans_code)
		begin 
