-- Object: PROCEDURE citrus_usr.PR_Transfer_Previous_Log_bak_07102020
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------



CREATE Procedure [citrus_usr].[PR_Transfer_Previous_Log_bak_07102020] 
(
@pa_boid varchar(16),
@pa_date varchar(25),
@to_date varchar(25),
...
'REJECTED' WHEN DPTDC_DELETED_IND='1' THEN 'APPROVED' ELSE '' END IP , OTP_LST_UPD_DT MSGLG
,dptdc_id
FROM OTP_MSTR, DPTDC_MAK,Onlinetbl_IP_Mstr onl WHERE DPTDC_SLIP_NO=convert (varchar,OTP_INTREFNO) and onl.Onip_slip_no = convert (varchar,OTP_INTREFNO)
