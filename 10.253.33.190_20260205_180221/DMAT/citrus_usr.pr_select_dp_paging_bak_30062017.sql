-- Object: PROCEDURE citrus_usr.pr_select_dp_paging_bak_30062017
...
create  PROCEDURE [citrus_usr].[pr_select_dp_paging_bak_30062017] (@pa_startRowIndex int,                                                      
                                    @pa_maximumRows int  ,                                                
...
END  ---CLIENT SEARCH TAG ENDS HERE                            
 ...
 --                        
    ...
    --                        
      ...
      DECLARE @TBLGLACCTLIST  TABLE (TID int identity primary key,dpam_id numeric,dpam_crn_no numeric,dpam_sba_no varchar(100),dpam_sba_name varchar(200),acct_type varchar(5))                    
                     declare @l_from numeric(16,0)
                     declare @l_to numeric(16,0)
                     select @l_from = case when @pa_code ='' then '0' else @pa_code end 
                     select @l_to  = case when @pa_code ='' then '9999999999999999' else @pa_code end 
