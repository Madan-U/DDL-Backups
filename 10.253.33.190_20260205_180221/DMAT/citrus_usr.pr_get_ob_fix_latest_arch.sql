-- Object: PROCEDURE citrus_usr.pr_get_ob_fix_latest_arch
...
CREATE proc [citrus_usr].[pr_get_ob_fix_latest_arch](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                  
...
and cdshm_tratm_cd in ('2246','2277','2270','2220')                 --,'2205' removed for restat / remat set up dtd 28042020
