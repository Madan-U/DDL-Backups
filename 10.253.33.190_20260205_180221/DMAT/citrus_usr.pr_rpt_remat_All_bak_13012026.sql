-- Object: PROCEDURE citrus_usr.pr_rpt_remat_All_bak_13012026
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------


CREATE PROCEDURE [citrus_usr].[pr_rpt_remat_All_bak_13012026]                                      
(
@PA_EXCSM_ID INT,
...
INSERT INTO #ACLIST SELECT DPAM_ID,dpam_sba_no,dpam_sba_name,EFF_FROM,EFF_TO,NULL FROM citrus_usr.fn_acct_list(@@L_DPM_ID ,@PA_LOGIN_PR_ENTM_ID,@@l_child_entm_id)		
