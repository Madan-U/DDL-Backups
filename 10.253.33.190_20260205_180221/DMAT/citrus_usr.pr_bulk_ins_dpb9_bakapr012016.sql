-- Object: PROCEDURE citrus_usr.pr_bulk_ins_dpb9_bakapr012016
...
create proc [citrus_usr].[pr_bulk_ins_dpb9_bakapr012016]    
 (    
    @pa_exch          VARCHAR(20)        
...
SET @@SSQL1 = ''    
SELECT @@SSQL1 = 'INSERT INTO DPB9_PC6 VALUES(''' +replace( REPLACE(value,'''',''''''),'~',''',''') + ''') '     
from #dpb9_pc6     
where ID = @L_COUNTER    
...
SET @@SSQL1 = ''    
SELECT @@SSQL1 = 'INSERT INTO DPB9_PC7 VALUES(''' +replace( REPLACE(value,'''',''''''),'~',''',''') + ''') '     
from #dpb9_pc7     
where ID = @L_COUNTER    
...
SET @@SSQL1 = ''    
SELECT @@SSQL1 = 'INSERT INTO DPB9_PC8 VALUES(''' +replace( REPLACE(value,'''',''''''),'~',''',''') + ''') '     
from #dpb9_pc8     
where ID = @L_COUNTER    
...
SET @@SSQL1 = ''    
SELECT @@SSQL1 = 'INSERT INTO DPB9_PC18 VALUES(''' +replace( REPLACE(value,'''',''''''),'~',''',''') + ''') '     
from #dpb9_pc18    
where ID = @L_COUNTER    
