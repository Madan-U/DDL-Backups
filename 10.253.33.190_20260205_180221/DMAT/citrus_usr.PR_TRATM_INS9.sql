-- Object: PROCEDURE citrus_usr.PR_TRATM_INS9
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE  PROCEDURE [citrus_usr].[PR_TRATM_INS9]
              AS
              BEGIN
                  --
                    DECLARE
                       ...
                       ,@l_sub_cd    VARCHAR(50)
                        ...
                        SET @l_code='SLIP_TYPE_CDSL' 
			SET @l_desc ='SLIP TYPES'
			DELETE FROM TRANSACTION_SUB_TYPE_MSTR WHERE TRASTM_TRATM_ID=(SELECT TRANTM_ID FROM TRANSACTION_TYPE_MSTR WHERE TRANTM_CODE ='SLIP_TYPE_CDSL')
		        DELETE FROM TRANSACTION_TYPE_MSTR WHERE TRANTM_CODE = 'SLIP_TYPE_CDSL'
