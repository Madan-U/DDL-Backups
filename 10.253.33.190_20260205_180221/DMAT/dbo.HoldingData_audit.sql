-- Object: VIEW dbo.HoldingData_audit
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------



CREATE View [dbo].[HoldingData_audit]
 as
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK)  WHERE FREE_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK) WHERE REMAT_PND_CONF_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK) WHERE PLEDGE_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK) WHERE DEMAT_PND_VER_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK) WHERE ELIMINATION_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK)  WHERE EARMARK_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK) WHERE LEND_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK)  WHERE BORROW_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK) WHERE FREEZE_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK) WHERE SAFE_KEEPING_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK) WHERE LOCKIN_QTY <> 0.00
UNION ALL
...
'' AS HLD_BLF,'' AS HLD_BLC,'' AS HLD_LRD,'' HLD_PENDINGDT FROM citrus_usr.Holding_audit  WITH(NOLOCK) WHERE AVAIL_LEND_QTY <> 0.00 )A
