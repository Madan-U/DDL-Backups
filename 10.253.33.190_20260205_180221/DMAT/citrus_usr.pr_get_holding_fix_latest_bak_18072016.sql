-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_bak_18072016
...
create proc [citrus_usr].[pr_get_holding_fix_latest_bak_18072016](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
set @l_min_trx_dt = 'jul 01 2010'
set @l_base_hldg_dt = 'jun 30 2010'
...
select  * into #tmp_dp_daily_hldg_cdsl from tmp_dp_daily_hldg_cdsl
...
create index ix_1 on #tmp_dp_daily_hldg_cdsl(dphmcd_dpam_id,dphmcd_dpm_id,dphmcd_isin)
create index ix_1 on #finalholding(dphmcd_dpam_id,dphmcd_dpm_id,dphmcd_isin)
