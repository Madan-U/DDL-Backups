-- Object: PROCEDURE citrus_usr.PR_GET_INFO_FOR_CLIENTLOGIN_bak_27052019
...
create  PROCEDURE [citrus_usr].[PR_GET_INFO_FOR_CLIENTLOGIN_bak_27052019]
(
@PA_ID NUMERIC,
...
BEGIN    
 ...
 BEGIN
    ...
    SELECT RIGHT(DPAM_SBA_NO,8)  DPAM_SBA_NO   
	 ...
	 , 'DEC 31 2100'     TO_DT 
	 --, 1 , 'MIG',GETDATE(),'MIG',GETDATE(), 1, 0, 0, 0, 'A' ,''   
	 ,(Select top 1 isnull(ltrim(rtrim(emailid)),'') from dps8_pc1 where boid=dpam_sba_no  ) EMAIL --ISNULL( CITRUS_USR.FN_CONC_VALUE(DPAM_CRN_NO , 'EMAIL1'),'') EMAIL 
	 ,'V'     PREF
	 INTO #TEMPCLIENTDATA 
