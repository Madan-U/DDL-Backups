-- Object: PROCEDURE citrus_usr.Pr_rpt_bill_profile_filter_Shilpa_angel
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--PR_RPT_BILL_PROFILE_FILTER 	'CDSL',3,'JAN 26 2009','JUN 26 2009','N','N','1234567890123456','','','N','Y','',1,'HO|*~|',''	

CREATE PROC [citrus_usr].[Pr_rpt_bill_profile_filter_Shilpa_angel]              
@PA_DPTYPE VARCHAR(4),                      
@PA_EXCSMID INT,                      
...
when  isnull(TRANS_DESC,'')='1_ACMAIN' then 'ANNUAL MAINTAINENCE CHARGES'
	...
	,RATE = ISNULL(CLOPM_CDSL_RT,0) INTO BILL_ANGEL_18082015_new1
