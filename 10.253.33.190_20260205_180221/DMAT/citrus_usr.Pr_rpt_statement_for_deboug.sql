-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_for_deboug
...
exec [citrus_usr].Pr_rpt_statement 'CDSL','3','Apr 14 2009','Aug 14 2009','N','N','','','','','Y','Y',1,'HO|*~|','','','','',@pa_output=@p19 output
...
create  Proc [citrus_usr].[Pr_rpt_statement_for_deboug]                            
	@pa_dptype varchar(4),                                    
	@pa_excsmid int,                                    
...
insert into statement_report_log
select GETDATE () , @pa_dptype ,@pa_excsmid ,@pa_fromdate ,@pa_todate , @pa_bulk_printflag , @pa_stopbillclients_flag , @pa_fromaccid ,@pa_toaccid ,@pa_isincd ,@pa_group_cd ,@pa_transclientsonly ,@pa_Hldg_Yn ,@pa_login_pr_entm_id , @pa_login_entm_cd_chain,@pa_settm_type ,@pa_settm_no_fr
, @pa_settm_no_to  ,@PA_WITHVALUE , @pa_output 
...
--exec Pr_rpt_statement_for_test02052012 @pa_dptype ,@pa_excsmid,@pa_fromdate,@pa_todate , @pa_bulk_printflag , --Y/N
--@pa_stopbillclients_flag , @pa_fromaccid ,@pa_toaccid ,@pa_isincd ,              
--@pa_group_cd ,@pa_transclientsonly ,@pa_Hldg_Yn ,@pa_login_pr_entm_id ,                                      
--@pa_login_entm_cd_chain  ,@pa_settm_type   ,@pa_settm_no_fr ,@pa_settm_no_to  
--,@PA_WITHVALUE ,@pa_output  out 


exec CITRUS_USR.Pr_rpt_statement_for_test02052012 @pa_dptype ,@pa_excsmid,@pa_fromdate,@pa_todate , @pa_bulk_printflag , --Y/N
@pa_stopbillclients_flag , @pa_fromaccid ,@pa_toaccid ,@pa_isincd ,              
@pa_group_cd ,@pa_transclientsonly ,@pa_Hldg_Yn ,@pa_login_pr_entm_id ,                                      
@pa_login_entm_cd_chain  ,@pa_settm_type   ,@pa_settm_no_fr ,@pa_settm_no_to  
,@PA_WITHVALUE ,@pa_output  out 
...
where  
tratm_cd not in ('2246','2277','2280','3102','2201','2270','2220','2262') 
...
and cdshm_tratm_cd in('2246','2277','2280','3102','2201','2270','2220','2262') ) 
---and cdshm_tratm_cd in ('2246','2277','2201','2205','2220','3102','2252','2270','2280','2262','2251','3202','2202','2212') )    
--changed by tushar sep 18 2009    
  ...
  begin
     ...
     --        
		 ...
		 closing_bal = case when opening_bal = 0 and QTY <= 0  then 0 else Replace(convert(varchar,(isnull(opening_bal,0) + isnull(QTY,0))),'.000','') end , 
		 --trans_date,
		 cdshm_trg_settm_no,
