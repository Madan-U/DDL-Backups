-- Object: PROCEDURE citrus_usr.pr_get_ob_fix_latest_bak_16032020
...
CREATE proc [citrus_usr].[pr_get_ob_fix_latest_bak_16032020](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                  
...
create clustered index ix_1 on #tmp_cdsl_holding_dtls(cdshm_dpm_id,cdshm_isin,cdshm_dpam_id)              
