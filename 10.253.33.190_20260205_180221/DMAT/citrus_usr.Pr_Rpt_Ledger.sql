-- Object: PROCEDURE citrus_usr.Pr_Rpt_Ledger
...
CREATE Proc [citrus_usr].[Pr_Rpt_Ledger]        
@pa_dpmid int,        
@pa_finyearid int,        
@pa_fromdate datetime,        
@pa_todate datetime,        
@pa_ledgertype varchar(2),        
@pa_fromaccid varchar(100),        
@pa_toaccid varchar(100),        
...
CREATE TABLE #ACLIST(dpam_id BIGINT,dpam_sba_no VARCHAR(100),dpam_sba_name VARCHAR(500),eff_from DATETIME,eff_to DATETIME,acct_type varchar(2))
...
if (@pa_ledgertype = 'G' or @pa_ledgertype = 'B')      
 ...
 begin
	...
	where 	dpam_sba_no between @pa_fromaccid and @pa_toaccid
