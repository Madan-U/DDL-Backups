-- Object: PROCEDURE citrus_usr.PR_GET_PLEDGE_HOLDING
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE PROC [citrus_usr].[PR_GET_PLEDGE_HOLDING](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
where  CDSHM_BEN_ACCT_NO  BETWEEN @pa_ben_acct_no_fr AND @pa_ben_acct_no_to  AND cdshm_tratm_cd in ('2246','2277','2201','2230','5101','2280')   
