-- Object: VIEW citrus_usr.trxdetail_test
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE view [citrus_usr].[trxdetail_test]  
as  
select CONVERT(VARCHAR(8), GETDATE(), 112) td_curdate   
...
,'1603','1604','1605','1606'  
,'1701','1702'  
,'1801','1802','3001','3207','2202','2203','2204','2205','2201') then '11'   
when cdshm_cdas_sub_tras_type in ('601','602','603','604','605','607','608','609','610') then '12'   
when cdshm_cdas_sub_tras_type in ('606','2001','2002','2101','2102','2103','2104','2301','2302','2303') then '51'   
...
--				 where CLOPM_DT <= (select top 1 CDSHM_TRAS_DT from cdsl_holding_dtls order by 1 desc) 
--								and CLOPM_CDSL_RT <> 0  group by CLOPM_ISIN_CD ) lastdt 
------left outer join closing_price_mstr_cdsl 
--on cdshm_isin  = isincd
