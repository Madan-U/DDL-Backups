-- Object: FUNCTION citrus_usr.fn_gl_acct_list_bytushar_Gl_CL_Filter
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE Function [citrus_usr].[fn_gl_acct_list_bytushar_Gl_CL_Filter](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int,@PA_FROMACCID varchar(16),@PA_TOACCID varchar(16),@pa_acc_type varchar(1))       
returns @temp  TABLE (dpam_id INT,dpam_crn_no numeric,dpam_sba_no varchar(100),dpam_sba_name varchar(100),eff_from datetime,eff_to datetime,acct_type char(2)
