-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_forclass
...
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_forclass](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
CDSHM_TRATM_cD IN ('2212','2211','2261') --,'2211'
and CDSHM_TRAS_DT between  @l_min_trx_dt and @pa_to_dt
AND CDSHM_CDAS_TRAS_TYPE IN ('12','20','21','22','23','2','3','6','32') --'12' -- 20 added by tushar on jul 16 2012
GROUP BY CDSHM_DPAM_ID ,  CDSHM_ISIN 
