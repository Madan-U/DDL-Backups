-- Object: PROCEDURE citrus_usr.pr_get_invzero_zeroinv_BAK_21102015
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--exec pr_get_invzero_zeroinv 'INVTOZERO'
--exec pr_get_invzero_zeroinv 'ZEROTOINV'
CREATE proc [citrus_usr].[pr_get_invzero_zeroinv_BAK_21102015](@pa_tab varchar(100))
as
begin 
...
insert into #final
exec pr_get_client_list 'SEP 30 2015'
