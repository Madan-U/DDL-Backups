-- Object: PROCEDURE citrus_usr.pr_ins_upd_trx_cdsl_sp_mosl
...
create PROCEDURE [citrus_usr].[pr_ins_upd_trx_cdsl_sp_mosl](@pa_id              VARCHAR(8000)    
													 ,@pa_tab             VARCHAR(20)  
...
--  
  ...
  --  
    ...
    --  
      ...
      SET @l_qty               = CONVERT(VARCHAR(25),CONVERT(NUMERIC(18,3),@l_qty)*-1)   
