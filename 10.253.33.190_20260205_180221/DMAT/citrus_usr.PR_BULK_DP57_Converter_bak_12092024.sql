-- Object: PROCEDURE citrus_usr.PR_BULK_DP57_Converter_bak_12092024
...
CREATE   proc [citrus_usr].[PR_BULK_DP57_Converter_bak_12092024]
(  
...
,isnull(CntrLckInId,''),isnull(AuthntcnRefNb,''),isnull(XferTyp.cdsl_old_value,'') XferTyp 
,isnull(TxnRsnCd.cdsl_old_value,'') TxnRsnCd,isnull(AccptdQty,''),isnull(ActlQty,'')
