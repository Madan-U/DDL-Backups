-- Object: PROCEDURE citrus_usr.pr_upd_nom_g_dpb9
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE proc [citrus_usr].[pr_upd_nom_g_dpb9]
as
begin
...
select @l_count = count(1) from #missingnom  
 ...
 SELECT @l_nom_id      = bitrm_bit_location  
		...
		select @l_nom_id + id, dpam_id , boid , NOM_Sr_No+3,  Name,MiddleName,SearchName,FthName,substring(dateofbirth,5,4)+'-'+substring(dateofbirth,3,2)+'-'+substring(dateofbirth,1,2)+' 00:00:00.000',Addr1,Addr2
,Addr3,City,State,Country,PinCode,PriPhInd,PriPhNum
,AltPhInd,AltPhNum,AddPhones,Fax,PANGIR,ItCircle
