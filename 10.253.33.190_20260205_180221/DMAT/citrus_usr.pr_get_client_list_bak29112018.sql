-- Object: PROCEDURE citrus_usr.pr_get_client_list_bak29112018
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

create proc [citrus_usr].[pr_get_client_list_bak29112018](@pa_dt datetime)  
as  
begin   
...
INTO #ledgerminusamcaug2015   
 ...
 select LDG_ACCOUNT_ID  from ledger5  
...
--select * from #holdwithclienttrxexclude where DPAM_ID=549912  
  ...
  and brom_id not in (18,19,69,73,74,46)
