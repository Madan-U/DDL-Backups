-- Object: VIEW citrus_usr.TBL_CLIENT_MASTER_FORDUMP_BKP
...
CREATE view [citrus_usr].[TBL_CLIENT_MASTER_FORDUMP_BKP]  
as  
...
left outer join Nominee pc6 with(nolock) on pc1.BOId = pc6.BOId  and pc6.TypeOfTrans in ('','1','2')  
