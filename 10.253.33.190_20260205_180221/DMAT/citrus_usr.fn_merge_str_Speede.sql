-- Object: FUNCTION citrus_usr.fn_merge_str_Speede
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE function [citrus_usr].[fn_merge_str_Speede](@pa_tab varchar(50),@pa_id numeric,@pa_yn VARCHAR(50))        
...
ELSE IF @pa_tab = 'CDSL_ISIN_EP'      
 ...
 ELSE IF @pa_tab = 'CDSL_ISIN_NP'      
  ...
  BEGIN      
  --      
       select   @res = coalesce(@res + ',', '') +  convert(varchar(16),TMPDPC7_BOID)    
