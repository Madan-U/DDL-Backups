-- Object: PROCEDURE citrus_usr.pr_get_ob_fix_Forall_arch
...
CREATE proc [citrus_usr].[pr_get_ob_fix_Forall_arch](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                      
...
, cdshm_dpam_id      
, cdshm_isin , convert(numeric(18,5),0) ob  into #tmp_cdsl_holding_dtls1 from dmat_archival.citrus_usr.cdsl_holding_dtls    with(nolock)
