-- Object: PROCEDURE citrus_usr.pr_fetch_disdata_bak_25032015
...
create proc [citrus_usr].[pr_fetch_disdata_bak_25032015](@pa_Action varchar(100)
...
fetchdisdata	
      ...
      , @l_sliimm_id     NUMERIC , @l_sliim_gen_id numeric,@l_dpm_id       NUMERIC,@dpam_id numeric
			...
			begin						
				...
				,CONVERT(VARCHAR(11),sliim_dt,112) [CM_OPENDATE]
				--, sliim_rmks
