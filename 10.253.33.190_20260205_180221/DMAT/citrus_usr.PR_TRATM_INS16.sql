-- Object: PROCEDURE citrus_usr.PR_TRATM_INS16
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE  PROCEDURE [citrus_usr].[PR_TRATM_INS16]
              AS
              BEGIN
                  --
                    DECLARE
                       ...
                       ,@l_sub_cd    VARCHAR(50)
                        ...
                        SET @l_code='CLOSURE_INI_BY_CDSL'
                        SET @l_desc ='CLOSURE INITIALIZED BY'
                        DELETE FROM TRANSACTION_SUB_TYPE_MSTR WHERE TRASTM_TRATM_ID=(SELECT trantm_id FROM TRANSACTION_TYPE_MSTR WHERE TRANTM_CODE = 'CLOSURE_INI_BY_CDSL')
		        DELETE FROM TRANSACTION_TYPE_MSTR WHERE TRANTM_CODE = 'CLOSURE_INI_BY_CDSL'
