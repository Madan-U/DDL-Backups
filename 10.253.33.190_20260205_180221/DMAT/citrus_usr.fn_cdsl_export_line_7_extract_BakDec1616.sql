-- Object: FUNCTION citrus_usr.fn_cdsl_export_line_7_extract_BakDec1616
...
CREATE function [citrus_usr].[fn_cdsl_export_line_7_extract_BakDec1616](@pa_crn_no      VARCHAR(8000)  
...
,isnull(dphd_nom_dob,'')
         , isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'NOMINEE_FAX1'),'')--fax
          ...
          ,0000--''--usr_fld5          
		  		  ,'01'
		  , citrus_usr.fn_get_cd_rel( isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'1ST_NRELATN_BO',''),''))
		  , citrus_usr.fn_get_perc(isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'1ST_NPER_SHR',''),''))
