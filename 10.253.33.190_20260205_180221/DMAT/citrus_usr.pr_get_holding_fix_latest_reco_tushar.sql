-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_reco_tushar
...
CREATE  proc [citrus_usr].[pr_get_holding_fix_latest_reco_tushar](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
AND CDSHM_CDAS_TRAS_TYPE IN ('12','20','21','22','23','14'
,'18','8','9','14','29','32','326','3','2') --'12' -- 20 added by tushar on jul 16 2012

GROUP BY CDSHM_DPAM_ID ,  CDSHM_ISIN 


insert into #locindata_dr
SELECT CDSHM_DPAM_ID , CDSHM_ISIN , SUM(CDSHM_QTY) QTY  FROM CDSL_HOLDING_DTLS with (nolock)
WHERE CDSHM_TRATM_cD  in ( '2252') --=case when CDSHM_CDAS_TRAS_TYPE IN ('21','22','23') then '2262' else '2277' end --2261 added by tushar on jun 03 2014
and CDSHM_TRAS_DT between  @l_min_trx_dt and @pa_to_dt
and cdshm_ben_acct_no between @pa_ben_acct_no_fr and @pa_ben_acct_no_to 

--AND CDSHM_CDAS_TRAS_TYPE IN ('21','22','23','12')--12 added by tushar on jun 03 2014
AND CDSHM_CDAS_TRAS_TYPE IN ('6')
and CDSHM_CDAS_SUB_TRAS_TYPE ='604' --'12' -- 20 added by tushar on jul 16 2012
