-- Object: PROCEDURE citrus_usr.pr_import_property_acct_new1_bak_03022016
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

  
create  PROCEDURE [citrus_usr].[pr_import_property_acct_new1_bak_03022016]
(
	@pa_cd VARCHAR(100),
...
--  
	SET @L_ACCP_VALUE = ''  
  --print 'pp'
	SELECT DISTINCT @L_ACCP_VALUE = CONVERT(VARCHAR,accpm_PROP_ID) + '|*~|' + CONVERT(VARCHAR(100),[TMP_BBO_CODE]) + '|*~|*|~*'   
	FROM [BBO_CODE] ,account_PROPERTY_MSTR    
	WHERE [TMP_BOID]  = @c_ben_acct_no1   
