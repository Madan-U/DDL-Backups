-- Object: PROCEDURE citrus_usr.PR_GET_ClientwiseBILL_Breakup_brwisefilter
...
CREATE PROC [citrus_usr].[PR_GET_ClientwiseBILL_Breakup_brwisefilter](@pa_from_dt DATETIME, @pa_to_dt DATETIME,@pa_login_name varchar(250)    
