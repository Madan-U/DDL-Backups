-- Object: PROCEDURE citrus_usr.pr_get_quaterly_holding
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--exec pr_get_quaterly_holding 'apr 01 2013','apr 30 2013'
CREATE proc [citrus_usr].[pr_get_quaterly_holding](@pa_from_dt datetime,@pa_to_dt datetime)
as
begin 
...
truncate  table quaterlyholingval

truncate table bal_q 
...
,DPHMCD_FREE_QTY  qty,holdingdt
 from bal_q, dp_acct_mstr , isin_mstr
