-- Object: PROCEDURE citrus_usr.Pr_rpt_bill_23032010
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--[Pr_rpt_bill] 'CDSL',3,'NOV  1 2008','NOV 30 2008 23:59:59','n','N','','','','Y',1,'ho|*~|',''	

Create Proc [citrus_usr].[Pr_rpt_bill_23032010]              
@pa_dptype varchar(4),                      
@pa_excsmid int,                      
 ...
 begin  
  ...
  group by clic_dpam_id,dpam_sba_no,dpam_sba_name,clic_charge_name                     
   ...
   END 	
	...
	CDSHM_TRATM_DESC= replace(lower(ltrim(rtrim(trans_desc))),dpm_trans_no,''),              
	dpm_trans_no,                      
