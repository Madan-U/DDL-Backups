-- Object: FUNCTION citrus_usr.fn_cdsl_export_line_7_extract_newversion_mod_31032015
...
--USE [DMAT]
--GO
--/****** Object:  UserDefinedFunction [citrus_usr].[fn_cdsl_export_line_7_extract_newversion_mod]    Script Date: 02/25/2013 14:21:48 ******/
--SET ANSI_NULLS ON
--GO
...
CREATE function [citrus_usr].[fn_cdsl_export_line_7_extract_newversion_mod_31032015](@pa_crn_no      VARCHAR(8000)  
...
--          ,0000--''--usr_fld4 
    ...
    and	isnull(climmod.clic_mod_batch_no,0) = 0
	AND	  climmod.clic_mod_action in ('N Address')  
...
--          ,0000--''--usr_fld4   
    ...
    and	isnull(climmod.clic_mod_batch_no,0) = 0
	AND	  climmod.clic_mod_action in ('G Address')  
...
--          ,0000--''--usr_fld4  
    ...
    and	isnull(climmod.clic_mod_batch_no,0) = 0
	AND	  climmod.clic_mod_action in ('NG Address')
