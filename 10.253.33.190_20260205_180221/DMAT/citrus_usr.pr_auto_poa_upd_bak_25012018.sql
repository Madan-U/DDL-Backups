-- Object: PROCEDURE citrus_usr.pr_auto_poa_upd_bak_25012018
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

create  proc [citrus_usr].[pr_auto_poa_upd_bak_25012018]
as
begin 
...
print @l_lst_mig
                 ...
                 SELECT distinct  BOID   from dps8_pc5_tp where convert(datetime,TransSystemDate)  >  @l_lst_mig
                 and boid in (select dpam_sba_no from dp_acct_mstr) AND VALID =0 
        ...
        --  
			...
			+'|*~|'+ltrim(rtrim(dpam_sba_no))+'|*~|'+'0'+'|*~|'+'0|*~|0|*~|0|*~|'+'A*|~*'    
			 ...
			 and main.dppd_gpabpa_flg= mig.GPABPAFlg
			  ...
			  UPDATE dps8_pc5_tp SET VALID =1 WHERE BOID = @c_ben_acct_no1
