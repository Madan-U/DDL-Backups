-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_SEP302010_PANKAJ
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--exec Pr_rpt_statement_pritibhuti @pa_dptype='CDSL',@pa_excsmid=3,@pa_fromdate='JUN 29 2009',@pa_todate='JUN 29 2010',@pa_bulk_printflag='N',@pa_stopbillclients_flag='N',@pa_fromaccid='',@pa_toaccid='',@pa_isincd='',@pa_group_cd='',@pa_transclientsonly='N',@pa_Hldg_Yn='Y',@pa_login_pr_entm_id='1',@pa_login_entm_cd_chain='0',@pa_output=NULL 
--declare @p15 varchar(1)
--set @p15=NULL
--exec Pr_rpt_statement_pratibhuti @pa_dptype='CDSL',@pa_excsmid=3,@pa_fromdate='JUN 29 2009',@pa_todate='JUN 29 2010',
--@pa_bulk_printflag='N',@pa_stopbillclients_flag='N',@pa_fromaccid='',@pa_toaccid='',@pa_isincd='',@pa_group_cd='',
--@pa_transclientsonly='N',@pa_Hldg_Yn='Y',@pa_login_pr_entm_id='1',@pa_login_entm_cd_chain='0',@pa_output=@p15 
--output
--select @p15
--Pr_rpt_statement_pritibhuti 'CDSL',3,'MAY 13 2008','MAY 14 2008','','','','','Y',1,'BASIS POINT|*~|',''                           
create Proc [citrus_usr].[Pr_rpt_statement_SEP302010_PANKAJ]                            
@pa_dptype varchar(4),                                    
@pa_excsmid int,                                    
...
BEGIN                                    
 ...
 BEGIN                              
  ...
  if @pa_group_cd <> ''              
  begin              
      insert into #tempmaincdsl(dpam_id,dpam_sba_name,dpam_acctno,trans_desc,dpm_trans_no,trans_date,isin_cd,opening_bal,qty,order_by,line_no)                         
      ...
      CDSHM_TRAS_DT,                                    
      CDSHM_ISIN,                                    
      isnull(cdshm_opn_bal,0), --cdshm_opn_bal=case when (cdshm_tratm_cd='2201') then (cdshm_opn_bal-CDSHM_QTY) else  isnull(cdshm_opn_bal,0) end , --isnull(cdshm_opn_bal,0),                          
      CDSHM_QTY,                        
      0,                                  
      CDSHM_ID        
      ...
      and cdshm_tratm_cd in('2246','2277','2201')     
  ...
  begin              
      ...
      CDSHM_TRAS_DT,                                    
      CDSHM_ISIN,                                    
      isnull(cdshm_opn_bal,0),--cdshm_opn_bal=case when (cdshm_tratm_cd='2201') then (cdshm_opn_bal-CDSHM_QTY) else  isnull(cdshm_opn_bal,0) end ,                          
      CDSHM_QTY,                        
      0,                                  
      CDSHM_ID                                    
      FROM CDSL_HOLDING_DTLS with(nolock),                        
  ...
  begin
		  ...
		  begin                        
			...
			if @pa_group_cd <> ''              
			begin              
				insert into #tempmaincdsl(dpam_id,dpam_sba_name,dpam_acctno,trans_desc,dpm_trans_no,trans_date,isin_cd,opening_bal,qty,order_by)                         
     ...
     order by dpam_acctno,dpam_sba_name,order_by,Isin_name,14,line_no               
 ...
 CREATE INDEX IX_1 on #temprunning(dpam_id,Ben_ctgry,Ben_acct_type,isin_cd)                         
  ...
  order by dpam_acctno,final_trans,Isin_name,Runningid,15                        
