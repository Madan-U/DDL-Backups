-- Object: VIEW citrus_usr.vw_fetchclientholding_Mapp_test
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--select * from [vw_fetchclientholding_Mapp_test] where dphmcd_holding_dt = 'may 05 2012'
create view [citrus_usr].[vw_fetchclientholding_Mapp_test]                       
as    
