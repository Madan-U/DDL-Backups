-- Object: PROCEDURE citrus_usr.PR_SELECT_TRXGEN_CDSL_SP_XML_harmonization_Bak_03022025
...
CREATE  PROCEDURE [citrus_usr].[PR_SELECT_TRXGEN_CDSL_SP_XML_harmonization_Bak_03022025]  
(  
...
+ ','+','+','+','+  + ','+ case when @PA_TRX_TAB='DESTAT*|~*' then '' else  SUBSTRING(isnull(convert(varchar,xmlField.value('(Dspchdt)[1]', 'nvarchar(max)')),''), 5, 4) + '-' + SUBSTRING(isnull(convert(varchar,xmlField.value('(Dspchdt)[1]', 'nvarchar(max)')),''), 3, 2) + '-' + SUBSTRING(isnull(convert(varchar,xmlField.value('(Dspchdt)[1]', 'nvarchar(max)')),''), 1, 2) end + ','+',' +','+  ','+case when  @PA_TRX_TAB='DESTAT*|~*' then '' else 'AC' end +','+ +','+ ','+','+',' + ',' + ','+convert(varchar(100),demrm_id)+','+ ','+ ','+'FRE' +','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+ ',' +','+','+','++','+','+ ',' +'' + ','+','+','+','++','+','+','+','+','+ ','+','+','+','+','+','+','+','+','+','+','+',' 
