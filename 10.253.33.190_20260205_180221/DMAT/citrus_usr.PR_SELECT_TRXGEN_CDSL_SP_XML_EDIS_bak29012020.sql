-- Object: PROCEDURE citrus_usr.PR_SELECT_TRXGEN_CDSL_SP_XML_EDIS_bak29012020
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------



create PROCEDURE [citrus_usr].[PR_SELECT_TRXGEN_CDSL_SP_XML_EDIS_bak29012020]  
(  
...
from #tempdata where dptdc_created_by in (select dpam_sba_no from DP_ACCT_MSTR where DPAM_DELETED_IND=1)
...
select  @L_TOT_REC = count(*) from #tempdata where dptdc_created_by in (select dpam_sba_no from DP_ACCT_MSTR where DPAM_DELETED_IND=1)
