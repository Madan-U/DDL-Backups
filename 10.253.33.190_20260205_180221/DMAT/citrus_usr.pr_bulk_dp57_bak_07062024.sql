-- Object: PROCEDURE citrus_usr.pr_bulk_dp57_bak_07062024
...
CREATE   proc [citrus_usr].[pr_bulk_dp57_bak_07062024]
(  
...
--added above line as per mail from vishal dated 25012023
		...
		and column_3 =dpam_sba_no) and LEFT(column_3,8) not in ('12033200','16010100','12033202') ) 	
		...
		and LEFT(column_3,8) not in ('12033200','16010100','12033202') --- added apr 04 2023
