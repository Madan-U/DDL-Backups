-- Object: PROCEDURE citrus_usr.Bak_pr_ins_upd_trx_cdsl_011011
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

/*CREATE TABLE DP_TRX_DTLS_CDSL(DPTDC_ID                              numeric(10,0)  
,DPTDC_DPAM_ID                         numeric(10,0)  
,DPTDC_REQUEST_DT                      dateime  
...
CREATE procedure  [citrus_usr].[Bak_pr_ins_upd_trx_cdsl_011011](@pa_id              VARCHAR(8000)    
                                    ,@pa_tab             VARCHAR(20)  
