-- Object: PROCEDURE citrus_usr.vw_get_next_amcdt_new_cli
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

Create  PROC [citrus_usr].[vw_get_next_amcdt_new_cli]   
(@code VARCHAR(11))  
AS  
  
SELECT distinct *,RIGHT(CONVERT(VARCHAR(11),[NEXT AMC DT],113),9) AS MONTH_YEAR FROM (  
