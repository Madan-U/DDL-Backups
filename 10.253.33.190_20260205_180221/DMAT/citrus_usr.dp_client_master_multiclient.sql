-- Object: VIEW citrus_usr.dp_client_master_multiclient
...
CREATE view [citrus_usr].[dp_client_master_multiclient]  
as
...
, dpam_sba_no  cm_cd  
, isnull(brom_desc,'') cm_chgsscheme  
...
, isnull(dps8_pc1.pri_email,'') cm_email  
