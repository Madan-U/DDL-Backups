-- Object: PROCEDURE citrus_usr.PR_ONLINE_DPTRX_BEN_BAK_16122016
...
BEGIN
IF EXISTS(SELECT 1 FROM ONLINE_DPTRX_BEN_MSTR WHERE (ONL_TRXFEREE_DPID=@PA_ONL_TRXFEREE_DPID OR ONL_CMBPID =@PA_ONL_CMBPID) AND ONL_TRX_BOID =@PA_ONL_TRX_BOID  AND ONL_TRXFEREE_BOID=@PA_ONL_TRXFEREE_BOID AND ONL_DELETED_IND=1)
BEGIN
select 'AlReady Exists' result
