-- Object: PROCEDURE citrus_usr.pr_bulk_ins_dtls_br
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--begin tran      
--[pr_bulk_ins_dtls_br]      
--select * from entity_mstr where entm_enttm_cd='br' --984 --989      
...
CREATE PROC [citrus_usr].[pr_bulk_ins_dtls_br]      
AS      
BEGIN      
--      
...
--select distinct branch_code,branch from moslnew_br    
  
--select distinct b.branch_code,b.branch,entm_id from moslnew_AREA  a, moslnew_br b , entity_mstr C   
--where b.branch_Code=a.Branch_code  
--and entm_short_name=a.Areacode  

select distinct b.branch_code + '_BR',a.branch,entm_id from mosl_Branch_May032012 a,mosl_area_May032012 b, entity_mstr c
where ltrim(rtrim(a.branch_Code)) + '_br' not in (
select  ltrim(rtrim(Code))   from mosl_Branch)
and b.branch_Code + '_BR' =a.Branch_code   + '_BR'
and entm_short_name=b.Areacode  + '_AR'
