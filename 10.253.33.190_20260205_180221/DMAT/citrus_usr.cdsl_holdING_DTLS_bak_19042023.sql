-- Object: TABLE citrus_usr.cdsl_holdING_DTLS_bak_19042023
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[cdsl_holdING_DTLS_bak_19042023]
(
    [existqty] NUMERIC(18, 5) NULL,
    [tobeupdateqty] NUMERIC(20, 5) NULL,
