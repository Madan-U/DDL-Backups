-- Object: PROCEDURE citrus_usr.PR_rpt_maker_checker_daily
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE  PROC [citrus_usr].[PR_rpt_maker_checker_daily](@pa_from_dt DATETIME, @pa_to_dt DATETIME    
...
when dptd.dptdC_trastm_cd = 'TNT' and  dptd.dptdc_reason_cd= '7' then 'Shifting of Account within DP'
					...
					--and dptd.DPTDC_SLIP_NO ='0311202535646765'
