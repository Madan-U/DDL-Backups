-- Object: PROCEDURE citrus_usr.pr_ins_upd_trx_cdsl_sp_bak_15112021
...
CREATE  PROCEDURE [citrus_usr].[pr_ins_upd_trx_cdsl_sp_bak_15112021](@pa_id              VARCHAR(8000)      
              ,@pa_tab             VARCHAR(20)    
...
set @l_val_yn_byslip =''  
select @l_val_yn_byslip = citrus_usr.fn_get_high_val_byslip_fordebug(@pa_values)       
