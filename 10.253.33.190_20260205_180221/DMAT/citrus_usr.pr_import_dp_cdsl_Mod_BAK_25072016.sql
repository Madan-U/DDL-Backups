-- Object: PROCEDURE citrus_usr.pr_import_dp_cdsl_Mod_BAK_25072016
...
CREATE  PROCeDURE [citrus_usr].[pr_import_dp_cdsl_Mod_BAK_25072016]( @pa_crn_no      varchar(8000)                 
                            , @pa_exch        VARCHAR(10)                  
        ...
        insert into @line2( ln_no                  
                           ...
                           SELECT distinct '02'                  
								...
								--, MAX(case when clic_mod_action = 'SIGNATURE' then replace(ISNULL(citrus_usr.fn_ucc_doc_old(dpam_id,'SIGN_BO',''),'') ,'B'+dpam_sba_no,'') else '' end)
								 ,MAX(case when clic_mod_action = 'SIGNATURE' then '../CCRSDocuments/SIGN.bmp' END )
