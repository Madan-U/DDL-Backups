-- Object: PROCEDURE citrus_usr.pr_import_dp_bak_09012017
...
create  PROCeDURE [citrus_usr].[pr_import_dp_bak_09012017]( @pa_crn_no      VARCHAR(8000)                  
                            , @pa_exch        VARCHAR(10)                  
...
,sh_email
                                     ...
                                     SELECT distinct '03'                  
                                                  ...
                                                  ,'' --lower(isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'ACCEMAIL1'),''))
,'' --lower(isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'ACCEMAIL1'),''))
                                      FROM   dp_acct_mstr              dpam                  
                                             left outer join   
                                             dp_holder_dtls            dphd                 on dpam.dpam_id            = dphd.dphd_dpam_id                      
...
,  case when isnull(citrus_usr.fn_ucc_accp(dpam_id,'RGESS_FLAG',''),'00')  = 'YES'     then 'Y' else 'N' end
      ...
      select distinct l2.sign_bo                  
            ...
            +CONVERT(char(10),l3.sh_mob)
+CONVERT(char(50),l3.sh_email),'') 
            line_three_detail                  
            ...
            +CONVERT(char(10),l4.th_mob)
+CONVERT(char(50),l4.th_email),'') 
            line_four_detail                  
