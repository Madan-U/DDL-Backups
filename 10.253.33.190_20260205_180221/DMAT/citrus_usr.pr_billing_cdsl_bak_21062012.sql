-- Object: PROCEDURE citrus_usr.pr_billing_cdsl_bak_21062012
...
create procedure [citrus_usr].[pr_billing_cdsl_bak_21062012](@pa_billing_from_dt datetime,@pa_billing_to_dt datetime,@pa_dpm_id numeric,@pa_billing_status   char(1))
as
begin
--
...
create index ix_2 on #account_properties_close(accp_clisba_id_cl , accp_value_cl )
  ...
  and   ( DPAM_STAM_CD not in('05','04','08','02_BILLSTOP','CI') or @pa_billing_to_dt between  accp_value and isnull(accp_value_cl,'jan 31 2100'))
	and dpam_stam_cd not in ('CI','04','CLOS')
