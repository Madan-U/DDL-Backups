-- Object: PROCEDURE citrus_usr.pr_breakup_foroneclient
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

CREATE     procedure [citrus_usr].[pr_breakup_foroneclient](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100) , @pa_boid varchar (16))
as
begin 
...
insert into cdsl_holding_dtls_bak_forreve  
 select *  from cdsl_holding_Dtls where cdshm_ben_acct_no = '1203320186015090' 
 and  CDSHM_TRAS_DT between @pa_from_dt and @pa_to_dt 
-- and CDSHM_COUNTER_BOID = '1203320045957996'
 --and CDSHM_TRATM_CD ='2277'  
  and CDSHM_CDAS_SUB_TRAS_TYPE  in(  1006,821)
...
set @l_amount = 4.00-- added as per mail from vishal dated 29/12/2023
--set @l_amount = 4.25
--set @l_amount = 4.50
...
and cdshm_isin not in ('INF732E01037','IN0020120062')
UNION ALL
SELECT CDSHM_BEN_ACCT_NO, '5' act_AMT ,'UnPledge' dsc FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_CDAS_SUB_TRAS_TYPE in ('1006')
and cdshm_isin not in ('INF732E01037','IN0020120062') and  cdshm_ben_acct_no = '1203320186015090' 
UNION ALL
SELECT CDSHM_BEN_ACCT_NO, '5' act_AMT ,'Pledge' dsc FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_CDAS_SUB_TRAS_TYPE in ('821')
and cdshm_isin not in ('INF732E01037','IN0020120062') and  cdshm_ben_acct_no = '1203320186015090' 
UNION ALL
