-- Object: PROCEDURE citrus_usr.pr_recon_holding_acct
...
CREATE  proc [citrus_usr].[pr_recon_holding_acct](@pa_excsm_id numeric
, @pa_date datetime
, @pa_flag char(15)
,@pa_acctno varchar(100)
...
exec [pr_get_holding_fix_latest_reco] @pa_dpm_id,@l_dt,@l_dt,@pa_acctno,@pa_acctno,''    
...
and CDSHM_BEN_ACCT_NO = @pa_acctno
...
union all
select cdshm_ben_acct_no client, cdshm_isin isin, cdshm_qty qty from cdsl_holding_dtls a 
where  convert(varchar(11),CDSHM_TRAS_DT,109) = convert(varchar(11),@pa_date,109) 
and cdshm_tratm_cd ='2215' 
and cdshm_ben_acct_no = @pa_acctno
and not exists (select 1 from cdsl_holding_dtls b where b.cdshm_tras_dt =a.cdshm_tras_dt 
...
and exists (select 1 from cdsl_holding_dtls b where b.cdshm_tras_dt =a.cdshm_tras_dt 
and b.cdshm_tratm_cd ='2277' 
and a.CDSHM_DPAM_ID = b.CDSHM_DPAM_ID 
and a.CDSHM_ISIN = b.cdshm_isin 
and a.cdshm_qty = b.cdshm_qty*-1
and b.CDSHM_CDAS_TRAS_TYPE ='11'
and b.CDSHM_CDAS_SUB_TRAS_TYPE ='1103')
and not exists (select 1 from cdsl_holding_dtls b where b.cdshm_tras_dt =a.cdshm_tras_dt 
and b.cdshm_tratm_cd ='2280' 
and a.CDSHM_DPAM_ID = b.CDSHM_DPAM_ID 
and a.CDSHM_ISIN = b.cdshm_isin 
and a.cdshm_qty = b.cdshm_qty*-1
and b.CDSHM_CDAS_TRAS_TYPE ='10'
and b.CDSHM_CDAS_SUB_TRAS_TYPE in ('1012','1002'))




select * from #priviousholding_1  where isin_hldg ='INE536A01023'
...
if @pa_flag ='MISMATCH'
begin
		--IF NOT EXISTS (select TOP 1 * from #finalholding where edmat_hldg <> cdas_hldg)
		--BEGIN
