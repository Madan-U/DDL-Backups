-- Object: PROCEDURE citrus_usr.pr_dp_ins_upd_conc
-- Server: 10.253.33.190 | DB: DMAT
--------------------------------------------------

--SELECT * FROM CLIENT_MSTR ORDER BY 1 DESC
--SELECT * FROM DP_aCCT_MSTR WHERE DPAM_CRN_NO = 54892
--SELECT * FROM CONC_ACCT_MAK WHERE CONC_CLISBA_ID = 59777 ORDER BY 1 DESC
--SELECT * FROM ADDR_ACCT_MAK WHERE ADR_CLISBA_ID = 59775 ORDER BY 1 DESC
CREATE PROCEDURE [citrus_usr].[pr_dp_ins_upd_conc](@pa_id            varchar(8000)  
...
*********************************************************************************
 system         : Citrus
 module name    : pr_dp_ins_upd_conc
          ...
          --
            ...
            --
              ...
              IF EXISTS(SELECT conc_clisba_id    
                        ...
                        AND    conc_clisba_id    = @l_dpam_id--@pa_clisba_id
