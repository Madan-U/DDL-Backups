-- Object: PROCEDURE dbo.RECDATA_UNRECO_VK
...
--------------------------------------------------
 ...
 --EXEC RECDATA_UNRECO_VK 'APR  1 2019','JUL  1 2019'
                
CREATE PROC [dbo].[RECDATA_UNRECO_VK] 
		--@FROMDATE VARCHAR(11), 
		--@TODATE   VARCHAR(11)
...
SELECT * 
      ...
      FROM   (SELECT [CLTCODE]=cltcode, 
              ...
              WHERE  L.vno = L1.vno 
                    ...
                    AND L.vtyp in  ('2', '3') 
					 --AND L1.RELDT=''
                     AND L.vdt >= 'JAN 25 2020' 
                     AND L.vdt < = 'FEB 13 2020' 
