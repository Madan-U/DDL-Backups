-- Object: PROCEDURE dbo.VIRTUAL_MIS_LEDGER_CONVERTER_bkp_20220623
...
*/     
CREATE  PROCEDURE [dbo].[VIRTUAL_MIS_LEDGER_CONVERTER_bkp_20220623] @FILENAME VARCHAR(1000),     
                                                     @UNAME    VARCHAR(50)     
														WITH RECOMPILE
AS     
...
@DATASERVER + CHAR(34) + "'"                                     
    ...
    /** Changes Done By Ahsan May 9 2022**/
   /* Start Comments
