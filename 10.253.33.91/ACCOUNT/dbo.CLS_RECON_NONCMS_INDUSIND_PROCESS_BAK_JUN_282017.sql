-- Object: PROCEDURE dbo.CLS_RECON_NONCMS_INDUSIND_PROCESS_BAK_JUN_282017
...
CREATE PROCEDURE [dbo].[CLS_RECON_NONCMS_INDUSIND_PROCESS_BAK_282017]
...
PRINT @SQL
	...
	--		SELECT * FROM #XLImport3  WHERE F2<>''
	--		AND F1 NOT IN ('CustomerName','Bank Reference')
	--		AND F4 NOT IN('ToDate')
	...
	--SELECT .dbo.piece(DBO.PIECE(FILE_DATA,'æ',4),':',2) FROM MSAJAG..FILEDATA WHERE PROGID=@UPLOADID  and DBO.PIECE(FILE_DATA,'æ',4) like '%Account No :%'
				...
				,CAST(DBO.PIECE(FILE_DATA,'Æ',2) AS DATETIME)AS VALUEDATE
