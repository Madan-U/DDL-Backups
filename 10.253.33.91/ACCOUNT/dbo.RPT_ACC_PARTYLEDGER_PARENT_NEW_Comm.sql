-- Object: PROCEDURE dbo.RPT_ACC_PARTYLEDGER_PARENT_NEW_Comm
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


    
--Exec RPT_ACC_PARTYLEDGER_PARENT_NEW_Comm 'Apr  1 2011','nov  7 2011','H25314','H25314','ACCODE','vdt','broker','broker',''    
...
CREATE PROCEDURE [dbo].[RPT_ACC_PARTYLEDGER_PARENT_NEW_Comm]    
(    
...
SUB_BROKER,TRADER,CL_TYPE, BANK_NAME,CLTDPID,LNO,PDT    
 ...
 and  CLTCODE IN (SELECT CLTCODE FROM OLDNEWCL)         
  ORDER BY L.CLTCODE,    
  VOUDT, PDT    
 END    
 ELSE    
