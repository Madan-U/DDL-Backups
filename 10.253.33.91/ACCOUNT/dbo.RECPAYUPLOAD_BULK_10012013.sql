-- Object: PROCEDURE dbo.RECPAYUPLOAD_BULK_10012013
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


CREATE  PROC [dbo].[RECPAYUPLOAD_BULK_10012013]              
 @FNAME VARCHAR(100),              
 @UNAME VARCHAR(25),              
 @USERCAT SMALLINT              
...
CREATE TABLE [#RECPAY_TABLE]              
 (              
  SERIAL_NO INT,              
  EDATE VARCHAR(20),          VOUCHER_DATE VARCHAR(20),              
  CLIENT_CODE VARCHAR(50),              
  AMOUNT MONEY,              
  DRCR VARCHAR(1),              
  NARRATION VARCHAR(234),              
...
SELECT TOP 1              
 @@VDT = CONVERT(VARCHAR(11), VDT, 109)           FROM              
 #RECPAY_TABLE              
