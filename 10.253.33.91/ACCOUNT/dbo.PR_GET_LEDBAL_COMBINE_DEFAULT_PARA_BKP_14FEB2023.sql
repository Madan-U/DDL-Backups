-- Object: PROCEDURE dbo.PR_GET_LEDBAL_COMBINE_DEFAULT_PARA_BKP_14FEB2023
...
CREATE PROCEDURE [dbo].[PR_GET_LEDBAL_COMBINE_DEFAULT_PARA_BKP_14FEB2023]     
(    
...
(
	...
	WHERE    
	CONVERT(VARCHAR(11), VDT, 109) = @MARGINDATE AND VTYP = 3 AND DRCR = 'D'
	GROUP BY CLTCODE
) A
GROUP BY CLTCODE
...
SELECT 
	...
	FROM ACCOUNT.DBO.LEDGER A (NOLOCK)
	WHERE    
	CONVERT(VARCHAR(11), VDT, 109) = @MARGINDATE AND VTYP = 8
	GROUP BY CLTCODE
END
