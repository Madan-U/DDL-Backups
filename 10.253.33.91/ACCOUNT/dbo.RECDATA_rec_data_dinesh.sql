-- Object: PROCEDURE dbo.RECDATA_rec_data_dinesh
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

--- EXEC RECDATA_rec_data_dinesh '01/04/2007','31/03/2017'

                

CREATE PROC [dbo].[RECDATA_rec_data_dinesh] (@FROMDATE VARCHAR(11), 
  ...
  BEGIN 
   ...
   AND L.vdt >= @FROMDATE 
      ...
      SELECT [CLTCODE]=Replace(Ltrim(Rtrim(A.cltcode)), ' ', ''), 
			 ...
			 [b.branch_name]=ISNULL(Replace(Ltrim(Rtrim(B.branch_name)), ' ', ''),'') 
			  INTO #FINAL
