-- Object: PROCEDURE dbo.PAYOUTDATA_REPORT_NSE_BKP_08042023
...
CREATE proc [dbo].[PAYOUTDATA_REPORT_NSE_BKP_08042023] (                              
...
--msajag.dbo.client_details B on a.cltcode = b.cl_code ORDER BY EXCHANGE                            
  ...
  SELECT * into Snehal1_08042023 FROM   #FINAL   ORDER  BY CLTCODE            
