-- Object: PROCEDURE dbo.VIRTUAL_MIS_LEDGER_CONVERTER
...
set xact_abort on 
 ...
 INSERT INTO #VIRTUAL_MIS_LEDGER_tmp     
    ...
    REPLACE(REPLACE(VA_Number,'á',''),' ',''),Channel,Transaction_Amount,Transaction_Details1,Transaction_Details2,Transaction_Details3,Transaction_Details4,
    Transaction_Details5,Transaction_Details6,
	REPLACE(REPLACE(REPLACE(Transaction_Details7,'á','') ,',',''),',','')Transaction_Details7,
...
SELECT  DISTINCT 
 CONVERT(datetime, BUSINESS_DATE),     
           CONVERT(datetime, BUSINESS_DATE),     
           RIGHT(VA_NUMBER, LEN(REPLACE(REPLACE(VA_NUMBER,'á',''),' ','')) - 7),     
			TRANSACTION_AMOUNT,     
           'C',     
