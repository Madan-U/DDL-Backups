-- Object: PROCEDURE dbo.CLS_Recon_NONCMS_SCB_Process_05022018
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------



 CREATE PROCEDURE [dbo].[CLS_Recon_NONCMS_SCB_Process_05022018] (@UPLOADID nvarchar(50), @UPLOAD_FLAG CHAR(1),@BANKCODE NVARCHAR(50) ) 
AS
BEGIN
