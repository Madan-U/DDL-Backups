-- Object: PROCEDURE dbo.CLS_RECON_MATCH_UNMATCH_REPORT_WRAPPER_OLD
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


CREATE PROCEDURE [dbo].[CLS_RECON_MATCH_UNMATCH_REPORT_WRAPPER_OLD]
(
...
GROUP BY	FILEUPLOADID
			...
			BEGIN
					...
					UPDATE T
					SET	BANKSTATEMENTAMOUNT = L.BANKSTATEMENTAMOUNT
...
WHILE (SELECT	COUNT(*)	FROM @TEMP_SEGMENT) > 0 
	...
	END
			...
			--select * from #TEMP_REPORT_WRAPPER
			--return
