-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_BAKTODAY
...
#LEDGER_TO_MAP_NON  WHERE NARRATION LIKE'%PAYOUT THROUGH RTGS/NEFT REVERSED%'
...
AND NARRATION LIKE'%PAYOUT THROUGH RTGS/NEFT REVERSED%'
AND L.RELAMT = CONVERT(MONEY, N.AMT)
AND N.DRCR = L.DRCR
AND CONVERT (DATETIME,CONVERT (VARCHAR(11) ,L.VDT,109))<=CONVERT (DATETIME ,N.VALUEDATE,103)
