-- Object: PROCEDURE dbo.RECEIPT_DATA_NEW1
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


CREATE PROC [dbo].[RECEIPT_DATA_NEW1]                
(                  
  @FROMDATE VARCHAR(11),                  
  @TODATE VARCHAR(11)                  
 )                           
...
INTO  #NIK1                    
 FROM                  
(  
SELECT L.CLTCODE,L.VDT, L.EDT, L.VNO,L.NARRATION,L.VAMT,L.DRCR,L1.DDNO,L.VTYP,L1.RELDT,L.BOOKTYPE  
...
MSAJAG.DBO.CLIENT_DETAILS B ON A.CLTCODE = B.CL_CODE           
 ...
 --EXEC RECEIPT_DATA_NEW 'JAN 13 2020','JAN 13 2020'
