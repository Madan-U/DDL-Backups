-- Object: PROCEDURE dbo.acc_PrintReconcile_bkup_06APR2022_vk
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

    
create PROCEDURE  [dbo].[acc_PrintReconcile_bkup_06APR2022_vk]                      
@code varchar(10),                    
...
ON [PRIMARY]    
  ...
  SELECT VNO, VTYP, BOOKTYPE FROM LEDGER L (NOLOCK) WHERE CLTCODE = @code AND VDT <= @tdate
...
WHERE     
 ...
 AND (RELDT ='1900-01-01 00:00:00.000' OR RELDT >  @tdate )  AND L1.vtyp <> 16
  --and L.vno in ('202104268075', '202104289454') and L.Vtyp=3 and L.booktype='01' 
ORDER BY     
