-- Object: PROCEDURE dbo.V2_OFFLINE_JVDRCRUPLOAD_RND
...
/*                
begin tran                
exec V2_OFFLINE_JVDRCRUPLOAD_RND 'OFFLINE',1,'NSE','CAPITAL','AUG 20 2021','N',8                
rollback                
...
*/                 
 ...
 AND SEGMENT = @SEGMENT ORDER BY EXCHANGE                     
  ...
  CREATE TABLE [#RECPAY_TABLE] (                    
    ...
    BANKCOST     SMALLINT   NULL,                  LNO          INT   NOT NULL   DEFAULT (0),                    
