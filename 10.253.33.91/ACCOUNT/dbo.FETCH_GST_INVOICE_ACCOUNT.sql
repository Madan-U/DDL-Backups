-- Object: PROCEDURE dbo.FETCH_GST_INVOICE_ACCOUNT
...
--EXEC ACCOUNT.DBO.FETCH_GST_INVOICE_ACCOUNT 'Apr  1 2018','NSE','CAPITAL'
...
CREATE  CLUSTERED INDEX IX_1 on #GSTLED_TEMP (VNO, VTYP, BOOKTYPE,VDT)
...
UPDATE #GSTACCFINAL SET Narration = left(G.Narration,200)
FROM #NARR G
...
TOTCHRG = CONVERT(NUMERIC(18,4),0)
FROM #GSTACCFINAL
