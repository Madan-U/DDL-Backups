-- Object: PROCEDURE dbo.Bryearend_vin
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

CREATE Procedure [dbo].[Bryearend_vin]   
@sdtcur varchar(11),  
@ldtcur varchar(11),  
@vtyp   smallint,  
@vno varchar(12),  
...
truncate table branchwiseclbal_vin  
  
insert into branchwiseclbal_vin  
...
delete from branchwiseclbal_vin where cltcode in (select brcontrolac from branchaccounts)  
delete from branchwiseclbal_vin where cltcode = '99999'  
...
begin  
  if @@costcode <> @@maincc  
/*     begin  
        insert into branchwiseclbal_vin values( '99999', @@placname, @@costcode, -(@@amt) )  
     end  
  else */  
     begin  
        insert into branchwiseclbal_vin values( @@mainctrlac, @@mainacname, @@costcode, -(@@amt) )  
        insert into branchwiseclbal_vin values( @@ctrlac, @@ctrlname, @@maincc, (@@amt) )  
     end  
...
insert into branchwiseclbal_vin values( '99999', @@placname, @@maincc, -(@@plamt) )  
  
insert into ledger2_vin  
