-- Object: PROCEDURE dbo.VIRTUAL_MIS_LEDGER_CONVERTER_13092013
...
*/                    
CREATE PROCEDURE [dbo].[VIRTUAL_MIS_LEDGER_CONVERTER_13092013]                    
...
(                    
 ...
 AMOUNT MONEY,                    
 DRCR CHAR(1),                    
 NARRATION VARCHAR(500),                 BANK_CODE VARCHAR(10),                    
 BANK_NAME VARCHAR(100),                    
 REF_NO VARCHAR(20),                    
 BRANCHCODE VARCHAR(10),                    
 BRANCH_NAME VARCHAR(100),                    
...
OPEN @@MAINREC                  
 ...
 SELECT EDATE,VDATE,CLTCODE,AMOUNT,DRCR,NARRATION,BANK_CODE,BANK_NAME,REF_NO,BRANCHCODE,BRANCH_NAME,CHQ_MODE,CHQ_DATE,CHQ_NAME,CL_MODE,ACCOUNTNO,SEGMENT FROM #VIRTUAL_MIS WHERE SEGMENT = @@SEGMENT    
