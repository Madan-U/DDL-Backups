-- Object: PROCEDURE dbo.USP_VIRTUAL_MIS_LEDGER_CONVERTER_NEW
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

CREATE  PROCEDURE [dbo].[USP_VIRTUAL_MIS_LEDGER_CONVERTER_NEW] @FILENAME VARCHAR(1000),     
                                                    @UNAME    VARCHAR(50)     
WITH RECOMPILE
AS     
...
/*This Code is commented By Ahsan Farooqui 2022-07-23*/
 ...
 /*End 2022-07-23*/
   ...
   /*  ADDED FOR DUPLICATION  REMOVAL */ 
      ...
      SELECT DDNO,CLTCODE FROM AngelBSECM.ACCOUNT_AB.DBO.V2_OFFLINE_LEDGER_ENTRIES V  
