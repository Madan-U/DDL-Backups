...
BEGIN
SET @@SQL = "EXEC " + @@ACCOUNTSVR + "." + @@ACCOUNTDB + ".dbo.CLS_TRIALBALANCE_WITHOUTEXCHANGE '" + @FR_DATE + "','" + @VDT + "','" + @VIEWOPTION + "','" + @STATUSID + "','" + @STATUSNAME + "','" + @SORTBYDATE + "','" + @SHOWZEROBAL + "','" + @GRPCODE + "','" + @@SHAREDB + "','" + @@EXCHANGE + "','" + @@SEGMENT + "','" + @TABLE_NAME + "','" + @BRANCHCODE + "'," + CONVERT(VARCHAR, @WITHOPENING) + ",'" + @SORT_BY + "'"
PRINT @@SQL
EXEC (@@SQL)
