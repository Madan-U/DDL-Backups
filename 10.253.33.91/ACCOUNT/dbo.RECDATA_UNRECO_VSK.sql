-- Object: PROCEDURE dbo.RECDATA_UNRECO_VSK
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


 --EXEC RECDATA_UNRECO_VISHAL 'OCT 26 2020','OCT 26 2020'



                
CREATE PROC [dbo].[RECDATA_UNRECO_VSK] (
		@FROMDATE VARCHAR(11), 
		@TODATE   VARCHAR(11)
...
SELECT * 
 ...
 select distinct party_code,Req_datetime,PO_ApprovedAmt as amount,Req_PayBankId,Req_RefNo into #ncms from  INTRANET.cms.dbo.ncms_po_request_hist with(nolock) where  po_statusid in (2,4)
...
where Req_RefNo in (select Req_RefNo from #aa)
  ...
  SELECT a.*,b.Req_PayBankId FROM  #FINAL a left join #ab b on a.CLTCODE=b.party_code ORDER  BY exchange 
