-- Object: PROCEDURE dbo.LEDGER_GL_MFSS_NXT_1
...
EXEC usp_get_Financial_Ledger_OneTime '48GRW','Apr 1 2016','mar 31 2017'
		 ...
		 EXEC LEDGER_GL_MFSS_NXT_1 'Apr 1 2016','mar 31 2017', 'Apr 1 2016','mar 31 2017','48BAJA', '48BAJA'
		 EXEC LEDGER_GL_MFSS_NXT 'Apr 1 2016','mar 31 2017', 'Apr 1 2016','mar 31 2017','48BAJA', '48BAJA'
		 EXEC LEDGER_GL_MFSS_NXT 'Apr 1 2016','mar 31 2017','Apr 1 2016','mar 31 2017', '48ROK', '48ROK'
*/


	CREATE  PROC LEDGER_GL_MFSS_NXT_1
		...
		--AND ACCAT = '4'
		  ...
		  Select '222',
		   ...
		   From 
			...
			Where 
			(Particulars not in ('Opening Balance') or isnull(Particulars,'')='')
		and 
		VrNo=913
