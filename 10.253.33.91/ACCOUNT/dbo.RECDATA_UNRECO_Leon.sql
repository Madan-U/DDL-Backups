-- Object: PROCEDURE dbo.RECDATA_UNRECO_Leon
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

--EXEC RECDATA_UNRECO_Leon 'oct 26 2020','oct 26 2020'  
                  
CREATE PROC [dbo].[RECDATA_UNRECO_Leon] (  
  @FROMDATE VARCHAR(11),   
  @TODATE   VARCHAR(11)  
...
AS   
 --declare @FROMDATE as varchar(11)='OCT 26 2020'  
 --declare @TODATE as varchar(11)='OCT 26 2020'  
    IF Len(@FROMDATE) = 10   
...
,'.', ''),  
  ...
  select distinct CltCode,AccNO,AMT,'3' as vtyp into #ncms from (     
  ...
  union all  
  select Party_code,AccNum,Amount from MIS.sccs.dbo.sccs_INGV_BankFile_hist with(nolock)  where updated_on between @frmdate and @TODATE + ' 23:50:50'  
  union all  
  ...
  SELECT a.*,b.AccNO FROM  #FINAL a left join #ncms b on a.CLTCODE=b.CltCode and a.VAMT=b.amt and a.vTYP=b.vtyp ORDER  BY exchange   
    
  --select distinct party_code,Req_PayBankId into #ncms from  INTRANET.cms.dbo.ncms_po_request_hist with(nolock) where  po_statusid in (2,4)  
 -- SELECT a.*,b.Req_PayBankId FROM  #FINAL a left join #ncms b on a.CLTCODE=b.party_code ORDER  BY exchange   
