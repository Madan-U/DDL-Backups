-- Object: PROCEDURE dbo.CLS_RECON_BANK_FILEUPLOAD_LOGS_BAK_JAN_02_2017
...
CREATE PROCEDURE [dbo].[CLS_RECON_BANK_FILEUPLOAD_LOGS_BAK_JAN_02_2017] (
...
IF (CHARINDEX(@BANKACCOUNT, @UPLOADFILENAME) = 1) BEGIN
