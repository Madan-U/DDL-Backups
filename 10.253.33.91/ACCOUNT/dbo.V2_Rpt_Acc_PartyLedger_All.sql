-- Object: PROCEDURE dbo.V2_Rpt_Acc_PartyLedger_All
...
EXEC (@@SQL)            
  ...
  WHERE  SEGMENT IS NULL             
 END            
--- NEW MTF MTR CHANGE START
IF @@ACCOUNTDB = 'MTFTRADE'
 BEGIN
	 SET @@SQL = " INSERT INTO #TMPLEDGERNEW "        
	 SET @@SQL = @@SQL + " (BOOKTYPE, "        
	 SET @@SQL = @@SQL +" VOUDT, "        
	...
	--SET @@SQL = @@SQL +" PAN_GIR_NO) "    
	 --IF @@SERVERNAME <> @@ACCOUNTSVR        
	 --SET @@SQL = @@SQL +" EXEC "+@@ACCOUNTSVR+"."+@@ACCOUNTDB+"..CLS_CLIENTLEDGER_SEG_DETAILS "        
	 --ELSE        
	 SET @@SQL = @@SQL +" EXEC "+@@ACCOUNTDB+"..CLS_CLIENTLEDGER_SEG_DETAILS_CASH_COLL "        
	 SET @@SQL = @@SQL +"'" +@FDATE +"', "        
	 SET @@SQL = @@SQL +"'" +@TDATE +"', "        
	 SET @@SQL = @@SQL +"'" +@FCODE +"', "        
	 SET @@SQL = @@SQL +"'" +@TCODE +"', "        
	...
	--print 222
	  ...
	  ELSE         
	   ...
	   UPDATE #TMPLEDGERNEW         
		  SET  EXCHANGE = @@EXCHANGE,        
		   SEGMENT =@@SEGMENT,        
		   ENTITY = CASE WHEN @ENTITY_TYPE = 'ENTITY' THEN @@SEGMENT  +"-"+  @@EXCHANGE +"-"+  ' - CASH COLL' ELSE @@GROUPID + ' - CASH COLL' END,        
		   ORDERSEG = @@ORDERSEG + 1         
		WHERE  SEGMENT IS NULL         
	 END 
 ...
 SET @@SQL = @@SQL +" PDT) "        
	...
	--SET @@SQL = @@SQL +" MOBILE_PAGER, "        
	 ...
	 --SET @@SQL = @@SQL +" EXEC "+@@ACCOUNTSVR+"."+@@ACCOUNTDB+"..CLS_CLIENTLEDGER_SEG_DETAILS "        
	 --ELSE        
	 SET @@SQL = @@SQL +" EXEC "+@@ACCOUNTDB+"..CLS_CLIENTLEDGER_SEG_DETAILS_CASH_PAYIN "        
	 SET @@SQL = @@SQL +"'" +@FDATE +"', "        
	 SET @@SQL = @@SQL +"'" +@TDATE +"', "        
	 SET @@SQL = @@SQL +"'" +@FCODE +"', "        
	 SET @@SQL = @@SQL +"'" +@TCODE +"', "        
	...
	--print 222
	  ...
	  ELSE         
	   ...
	   UPDATE #TMPLEDGERNEW         
		  SET  EXCHANGE = @@EXCHANGE,        
		   SEGMENT =@@SEGMENT,        
		   ENTITY = CASE WHEN @ENTITY_TYPE = 'ENTITY' THEN @@SEGMENT  +"-"+  @@EXCHANGE + ' - CASH PAYIN' ELSE @@GROUPID + ' - CASH PAYIN' END,        
		   ORDERSEG = @@ORDERSEG  + 2       
		WHERE  SEGMENT IS NULL         
	 END 
	...
	-- SET @@SQL = @@SQL +" PAN_GIR_NO) "    
	 ...
	 --SET @@SQL = @@SQL +" EXEC "+@@ACCOUNTSVR+"."+@@ACCOUNTDB+"..CLS_CLIENTLEDGER_SEG_DETAILS "        
	 --ELSE        
	 SET @@SQL = @@SQL +" EXEC "+@@ACCOUNTDB+"..CLS_CLIENTLEDGER_SEG_DETAILS_MTOM "        
	 SET @@SQL = @@SQL +"'" +@FDATE +"', "        
	 SET @@SQL = @@SQL +"'" +@TDATE +"', "        
	 SET @@SQL = @@SQL +"'" +@FCODE +"', "        
	 SET @@SQL = @@SQL +"'" +@TCODE +"', "        
	...
	--print 222
	  ...
	  ELSE         
	   ...
	   UPDATE #TMPLEDGERNEW         
		  SET  EXCHANGE = @@EXCHANGE,        
		   SEGMENT =@@SEGMENT,        
		   ENTITY = CASE WHEN @ENTITY_TYPE = 'ENTITY' THEN @@SEGMENT  +"-"+  @@EXCHANGE + ' - MTOM' ELSE @@GROUPID + ' - MTOM' END,        
		   ORDERSEG = @@ORDERSEG   + 3      
		WHERE  SEGMENT IS NULL         
	 END 
...
--	 SET @@SQL = @@SQL +" PAN_GIR_NO) "    
	 ...
	 --SET @@SQL = @@SQL +" EXEC "+@@ACCOUNTSVR+"."+@@ACCOUNTDB+"..CLS_CLIENTLEDGER_SEG_DETAILS "        
	 --ELSE        
	 SET @@SQL = @@SQL +" EXEC "+@@ACCOUNTDB+"..CLS_CLIENTLEDGER_SEG_DETAILS_MTF_BILL "        
	 SET @@SQL = @@SQL +"'" +@FDATE +"', "        
	 SET @@SQL = @@SQL +"'" +@TDATE +"', "        
	 SET @@SQL = @@SQL +"'" +@FCODE +"', "        
	 SET @@SQL = @@SQL +"'" +@TCODE +"', "        
	...
	--print 222
	  ...
	  ELSE         
	   ...
	   UPDATE #TMPLEDGERNEW         
		  SET  EXCHANGE = @@EXCHANGE,        
		   SEGMENT =@@SEGMENT,        
		   ENTITY = CASE WHEN @ENTITY_TYPE = 'ENTITY' THEN @@SEGMENT  +"-"+  @@EXCHANGE + ' - BILL' ELSE @@GROUPID + ' - BILL' END,        
		   ORDERSEG = @@ORDERSEG   + 4      
		WHERE  SEGMENT IS NULL         
	 END 
	...
	-- SET @@SQL = @@SQL +" PAN_GIR_NO) "    
	 ...
	 --SET @@SQL = @@SQL +" EXEC "+@@ACCOUNTSVR+"."+@@ACCOUNTDB+"..CLS_CLIENTLEDGER_SEG_DETAILS "        
	 --ELSE        
	 SET @@SQL = @@SQL +" EXEC "+@@ACCOUNTDB+"..CLS_CLIENTLEDGER_SEG_DETAILS_MTF_JV "        
	 SET @@SQL = @@SQL +"'" +@FDATE +"', "        
	 SET @@SQL = @@SQL +"'" +@TDATE +"', "        
	 SET @@SQL = @@SQL +"'" +@FCODE +"', "        
	 SET @@SQL = @@SQL +"'" +@TCODE +"', "        
	...
	--print 222
	  ...
	  ELSE         
	   ...
	   UPDATE #TMPLEDGERNEW         
		  SET  EXCHANGE = @@EXCHANGE,        
		   SEGMENT =@@SEGMENT,        
		   ENTITY = CASE WHEN @ENTITY_TYPE = 'ENTITY' THEN @@SEGMENT  +"-"+  @@EXCHANGE + ' - JV' ELSE @@GROUPID + ' - JV' END,        
		   ORDERSEG = @@ORDERSEG   + 5      
		WHERE  SEGMENT IS NULL         
	 END 

	 --- NEW MTF MTR CHANGE END             
 END           
FETCH NEXT FROM @@MAINREC INTO @@ACCOUNTDB, @@EXCHANGE, @@SEGMENT, @@ACCOUNTSVR, @@SHAREDB ,@@GROUPID, @@ORDERSEG               
END            
CLOSE @@MAINREC            
