-- Object: PROCEDURE dbo.CLS_RECON_NONCMS_SBI_PROCESS_BKUP_21MAR2018
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------



CREATE PROCEDURE [dbo].[CLS_RECON_NONCMS_SBI_PROCESS_BKUP_21MAR2018]
...
, UPLOADBY)
	...
	, SUBSTRING (SUBSTRING (.DBO.PIECE(FILE_DATA,'	',4),0,CHARINDEX('TRANSFER',.DBO.PIECE(FILE_DATA,'	',4))),CHARINDEX('IGAC',SUBSTRING (.DBO.PIECE(FILE_DATA,'	',4),0,CHARINDEX('TRANSFER',.DBO.PIECE(FILE_DATA,'	',4)))),LEN(SUBSTRING (.DBO.PIECE(FILE_DATA,'	',4),0,CHARINDEX('TRANSFER',.DBO.PIECE(FILE_DATA,'	',4))))) AS 'REFERENCENO'
	,'' AS 'CLTACCOUNT'
