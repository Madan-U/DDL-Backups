-- Object: PROCEDURE dbo.RPT_ACC_PARTYLEDGER_ALL_PARENT
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

CREATE PROCEDURE [dbo].[RPT_ACC_PARTYLEDGER_ALL_PARENT]                    
...
AS                    
  ...
  BEGIN            
/*	Modification:		2023-07-17 (Ajay) Adding Return 0 due to issue with log file 
...
CREATE INDEX #PARTY ON #LEDGERCLIENTS(PARTY_CODE)
