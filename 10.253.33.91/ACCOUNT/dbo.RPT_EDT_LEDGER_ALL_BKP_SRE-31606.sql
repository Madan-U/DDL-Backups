-- Object: PROCEDURE dbo.RPT_EDT_LEDGER_ALL_BKP_SRE-31606
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


CREATE PROCEDURE [dbo].[RPT_EDT_LEDGER_ALL_BKP_SRE-31606] (@TODATE DATETIME,@CLTCODE VARCHAR(11))
...
+ISNULL([SLBS],0)+ISNULL([NSECD],0)+ISNULL([BSECD],0)+ISNULL([MCXCD],0)+ISNULL([MCDX],0)+ISNULL([NCDX],0)
