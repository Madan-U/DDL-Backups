-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_BKP_12SEP2022
...
create  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_BKP_12SEP2022] (@UPLOADID   VARCHAR(50)
, @FILETYPE VARCHAR(50)
, @BANKNAME VARCHAR(50)
, @UPLOAD_FLAG CHAR(1)
...
END 
ELSE 
IF (@FILETYPE = 'NON-CMS' OR @FILETYPE = 'TECHPROCESS'  OR @FILETYPE = 'ICICIPAYOUT' OR  @FILETYPE = 'BILLDESK' OR @FILETYPE='ROZARPAY' OR @FILETYPE = 'ROZARPAY1' OR @FILETYPE = 'SBPAYOUT' OR @FILETYPE = 'BILLDESK_TID') 
BEGIN
...
IF (@BANKNAME = 'ICICI BANK' AND @FILETYPE = 'ICICIPAYOUT') EXEC CLS_RECON_NONCMS_ICICI_PROCESS @UPLOADID,@BANKCODE
...
END
IF(@BANKNAME = 'ICICI BANK' AND @FILETYPE = 'ICICIPAYOUT')
BEGIN 
	UPDATE N
	SET	MATCHEDFLAG = 1
		,MODIFIEDDATE = GETDATE()
