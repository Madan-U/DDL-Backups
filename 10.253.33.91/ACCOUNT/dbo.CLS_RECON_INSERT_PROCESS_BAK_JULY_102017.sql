-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_BAK_JULY_102017
...
CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_BAK_JULY_102017] (@UPLOADID   NVARCHAR(50)
...
SELECT BANKACCOUNT  FROM @TEMPBANKACCOUNTMASTER BM,#CMS_DATA T
WHERE LTRIM(RTRIM(T.ROWTYPE))= BM.BANKACCOUNT 
