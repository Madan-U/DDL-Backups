-- Object: PROCEDURE dbo.BANK_FUNDS_REPORTING_BAK_27072022
...
CREATE PROCEDURE [dbo].[BANK_FUNDS_REPORTING_BAK_27072022]
	@FR_DATE VARCHAR(11),
	@TO_DATE VARCHAR(11),
	@EXCHANGE VARCHAR(10),
	@SEGMENT VARCHAR(10),
...
WHERE VDT BETWEEN @FR_DATE AND @TO_DATE + ' 23:59' AND VTYP NOT  IN (18,15,8,35,21)
...
UPDATE L SET BANK_ACC_NO = ACCOUNTNO FROM #LEDGER_PL L, BANK_ACCOUNT_DETAILS L1
