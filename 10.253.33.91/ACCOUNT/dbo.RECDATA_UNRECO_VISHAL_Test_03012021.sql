-- Object: PROCEDURE dbo.RECDATA_UNRECO_VISHAL_Test_03012021
...
CREATE PROC [dbo].[RECDATA_UNRECO_VISHAL_Test_03012021] (        
  @FROMDATE VARCHAR(11),         
  @TODATE   VARCHAR(11)        
...
set @NSEQUERY = @NSEQUERY + ' from anand1.Account.dbo.Bfile  order by Sno " queryout J:\Backoffice\Bankbook\BankBook_'+convert(varchar,@bank_code+'-'+@fexchange)+'.txt -c -t"," -Sanand1 -Uclassmkt -Pdd$$gnfDTVs244648ysjgZAcc'        
