...
/****** Object:  Stored Procedure dbo.PaymentCalAmt    Script Date: 01/04/1980 1:40:38 AM ******/



/****** Object:  Stored Procedure dbo.PaymentCalAmt    Script Date: 11/28/2001 12:23:45 PM ******/

/****** Object:  Stored Procedure dbo.PaymentCalAmt    Script Date: 29-Sep-01 8:12:05 PM ******/

/****** Object:  Stored Procedure dbo.PaymentCalAmt    Script Date: 8/8/01 1:37:31 PM ******/

/****** Object:  Stored Procedure dbo.PaymentCalAmt    Script Date: 8/7/01 6:03:50 PM ******/

/****** Object:  Stored Procedure dbo.PaymentCalAmt    Script Date: 7/8/01 3:22:49 PM ******/

/****** Object:  Stored Procedure dbo.PaymentCalAmt    Script Date: 2/17/01 3:34:16 PM ******/


/****** Object:  Stored Procedure dbo.PaymentCalAmt    Script Date: 20-Mar-01 11:43:34 PM ******/
...
As
	select  l.cltcode, a.acname, EffCrAmt  =  abs(sum(CVamt) - Sum(DVamt)),
              	creditAmt= isNULL( (SELECT ISNULL(SUM(VAMT),0)    
                            		...
                            		AND   EDT > =  LEFT(CONVERT(VARCHAR,@EFFDATE,109),11) + ' ' + '23:59:59'
...
/*commented by sheetal om 28 feb 2001 to solve the effective date and time problem */
/*CREATE PROCEDURE   PaymentCalAmt   
@advicedate   datetime ,  
@tvdt datetime ,
@effdate datetime,
