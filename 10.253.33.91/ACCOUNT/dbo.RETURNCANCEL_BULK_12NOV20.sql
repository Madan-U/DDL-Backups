-- Object: PROCEDURE dbo.RETURNCANCEL_BULK_12NOV20
...
CREATE PROC [dbo].[RETURNCANCEL_BULK_12NOV20] @VTYPE   SMALLINT, 
                                     @FNAME   VARCHAR(100), 
                                     @UNAME   VARCHAR(25), 
                                     @USERCAT SMALLINT 
AS 
...
UPDATE L SET EDT = CASE WHEN DEPOSIT_FLG = 'N' AND @VTYPE = 2 THEN INST_DATE ELSE '2049-12-31' END 
...
UPDATE L SET EDT = CASE WHEN DEPOSIT_FLG = 'N' AND @VTYPE = 17 THEN INST_DATE ELSE '2049-12-31' END 
FROM LEDGER L, #RECPAY_TABLE R 
    WHERE  L.VNO = R.VNO 
           AND L.VTYP = R.VTYP 
           AND L.BOOKTYPE = R.BOOKTYPE
