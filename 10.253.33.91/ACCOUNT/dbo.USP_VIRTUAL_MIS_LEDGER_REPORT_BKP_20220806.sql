-- Object: PROCEDURE dbo.USP_VIRTUAL_MIS_LEDGER_REPORT_BKP_20220806
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

CREATE PROC [dbo].[USP_VIRTUAL_MIS_LEDGER_REPORT_BKP_20220806]        
(        
...
#virtual V With(nolock)  ,MSAJAG..CLIENT_DETAILS C1  With(nolock)      
 WHERE             
