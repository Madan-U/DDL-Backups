-- Object: PROCEDURE dbo.PostNseCMValanInst
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


/****** Object:  Stored Procedure dbo.PostNseCMValanInst    Script Date: 02/28/2003 2:55:47 PM ******/
CREATE PROCEDURE PostNseCMValanInst
@vtyp smallint,
@BookType char(2),
@vno varchar(12),
@vdt varchar(11),
...
from ledger l, msajag.dbo.iaccbill b, costmast c
