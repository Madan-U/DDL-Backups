-- Object: PROCEDURE dbo.acc_Print_UnReconcile_Test
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


--exec acc_Print_UnReconcile_Test '03026','LIST', 'Jan  9 2019 23:59:59', 'Jan  8 2019 23:59:59'
    
CREATE PROCEDURE  [dbo].[acc_Print_UnReconcile_Test]                      
@code varchar(10),                    
...
WHERE     
 ...
 AND NOT EXISTS    
  ...
  AND L3.VNO = L4.VNO AND L3.VTYP = L4.VTYP AND L3.BOOKTYPE = L4.BOOKTYPE AND L1.BOOKTYPE = L3.BOOKTYPE AND L3.RELDT <='1900-01-02 00:00:00.000')    
 --AND L3.RELDT ='1900-01-01 00:00:00.000'  --OR RELDT >  @tdate )    
 --AND (L3.RELDT ='1900-01-01 00:00:00.000' OR RELDT >  @tdate )
ORDER BY     
