-- Object: PROCEDURE dbo.RECDATA_UNRECO_EDT
...
--------------------------------------------------
 ...
 --EXEC RECDATA_UNRECO_EDT 'APR  1 2019','JUL  1 2019'
                
CREATE PROC [dbo].[RECDATA_UNRECO_EDT] 
		--@FROMDATE VARCHAR(11), 
		--@TODATE   VARCHAR(11)
...
SELECT * 
      ...
      FROM   (SELECT [CLTCODE]=cltcode, 
              ...
              WHERE  L.vno = L1.vno 
                    ...
                    AND L.vtyp in  ('2', '3') 
					 AND L.EDT='2049-12-31'
                     AND L1.RELdt >= 'APR  1 2020' 
                     AND L1.RELdt < = 'JUN 25 2020' 
