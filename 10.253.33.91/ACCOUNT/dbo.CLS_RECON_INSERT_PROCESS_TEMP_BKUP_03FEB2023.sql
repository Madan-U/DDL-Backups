-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_TEMP_BKUP_03FEB2023
...
CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_TEMP_BKUP_03FEB2023] (@UPLOADID   VARCHAR(50)
, @FILETYPE VARCHAR(50)
, @BANKNAME VARCHAR(50)
, @UPLOAD_FLAG CHAR(1)
