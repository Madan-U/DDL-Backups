-- Object: PROCEDURE dbo.pms_cldetails_sta
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

CREATE procedure pms_cldetails_sta (@pmscode as varchar(10),@pmsname as varchar(50), @fdate as datetime, @tdate as datetime, @afdate as datetime, @loca as varchar(25))
as
