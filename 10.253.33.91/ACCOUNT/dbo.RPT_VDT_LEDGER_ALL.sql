...
--ALtered SP under SRE-31606
CREATE PROCEDURE [dbo].[RPT_VDT_LEDGER_ALL] (@TDATE DATETIME,@CLTCODE VARCHAR(11))
...
FROM ANGELCOMMODITY.ACCOUNTNCE.DBO.LEDGER WITH (NOLOCK) WHERE VDT >=@FDATE AND VDT <=@TDATE  + ' 23:59' 
AND CLTCODE = @CLTCODE
GROUP BY CLTCODE
