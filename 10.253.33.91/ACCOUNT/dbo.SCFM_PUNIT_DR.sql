-- Object: PROCEDURE dbo.SCFM_PUNIT_DR
...
--SCFM_PUNIT_dr '2019-09-01' ,'CREDITORS'                                 
                                    
                                    
                              
 CREATE  proc [dbo].[SCFM_PUNIT_DR]                           
  (                                        
...
[Balance] ASC      
  ...
  insert into   #cc                                           
 select cltcode,long_name,replace( PAN_GIR_NO,',','')PAN_GIR_NO,sum(netamt) as Balance  from #ab a,MSAJAG.DBO.CLIENT_DETAILS m                                    
