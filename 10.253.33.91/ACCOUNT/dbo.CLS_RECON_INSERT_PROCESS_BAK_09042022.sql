-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_BAK_09042022
...
CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_BAK_09042022] (@UPLOADID   NVARCHAR(50)
...
UPDATE L1
SET EDT = VALUEDATE
FROM #NONCMS_DATA N, LEDGER L1 (NOLOCK)
WHERE N.VNO = L1.VNO
AND N.VTYP = L1.VTYP
AND N.BOOKTYPE = L1.BOOKTYPE
AND L1.VDT>=DATEADD(DAY,-91,GETDATE())  --91 DAYS LOGIC
