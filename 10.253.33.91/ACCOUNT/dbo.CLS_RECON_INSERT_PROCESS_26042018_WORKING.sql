-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_26042018_WORKING
...
CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_26042018_WORKING] (@UPLOADID   NVARCHAR(50)
...
AND RT.ACCOUNTTYPE=@BANKACCOUNT
		...
		BEGIN
			...
			--SET @@SQL = ''
			--SET @@SQL = "IF NOT EXISTS (SELECT * FROM " +@@ACCOUNTSERVER + "."+ @@ACCOUNTDB+ ".[DBO].RECON_BANK_FILEUPLOAD_LOGS WHERE UPLOADID='"
			--+ @UPLOADID +"' AND BANKACCOUNT= '"+@BANKACCOUNT+"')
			--BEGIN
			--INSERT INTO " 
