-- Object: PROCEDURE dbo.rpt_subclientlist1
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


/****** Object:  Stored Procedure dbo.rpt_subclientlist1    Script Date: 05/08/2002 12:35:18 PM ******/
...
from firstday till last date of slelected year
this query is used if current opening entry date is not found
*/

CREATE proc rpt_subclientlist1
