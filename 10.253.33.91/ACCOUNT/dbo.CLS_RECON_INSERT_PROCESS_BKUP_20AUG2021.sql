-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_BKUP_20AUG2021
...
create  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_BKUP_20AUG2021] (@UPLOADID   NVARCHAR(50)
...
IF (@BANKNAME = 'RAZORPAY') EXEC CLS_RECON_NONCMS_RAZORPAY_PROCESS @UPLOADID,@BANKCODE,@FILE_PATH,@UNAME
