-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_BAK_JAN_03_2017
...
CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_BAK_JAN_03_2017] (@UPLOADID   NVARCHAR(50)
...
IF((@BANKNAME='YES BANK' AND @FILETYPE='CMS') OR @BANKNAME='STANDARD CHARTERED BANK')
	BEGIN
		SELECT	@BANKCODE = BANKCODE,@COMBINEFILE=FILEFORMATE
		FROM RECON_BANK_MASTER_VW 
		WHERE SEGMENT=@SEGMENT AND BANKNAME=@BANKNAME AND FILETYPE=@FILETYPE
