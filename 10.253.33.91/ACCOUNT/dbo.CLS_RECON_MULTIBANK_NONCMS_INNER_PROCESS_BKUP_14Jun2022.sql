-- Object: PROCEDURE dbo.CLS_RECON_MULTIBANK_NONCMS_INNER_PROCESS_BKUP_14Jun2022
...
CREATE PROCEDURE [dbo].[CLS_RECON_MULTIBANK_NONCMS_INNER_PROCESS_BKUP_14Jun2022]
...
INSERT INTO #LEDGER_TO_MAP
	...
	SELECT
		...
		AND L.LNO = L1.LNO
		AND L.BOOKTYPE = L1.BOOKTYPE
		AND	VDT>=@REPDATE    --DATEADD(DAY,-91,GETDATE())
...
SET EDT = VALUEDATE
FROM TEMP_NONCMS_DATA N (NOLOCK)
, (SELECT * FROM LEDGER (NOLOCK) WHERE VDT>=@REPDATE AND EDT >='2049-12-31') L1
WHERE MATCHEDFLAG = 1
AND N.VNO = L1.VNO
AND N.VTYP = L1.VTYP
AND N.BOOKTYPE = L1.BOOKTYPE
