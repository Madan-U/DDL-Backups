-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_BKUP_10SEP2022
...
CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_BKUP_10SEP2022] (@UPLOADID   VARCHAR(50)
, @FILETYPE VARCHAR(50)
, @BANKNAME VARCHAR(50)
, @UPLOAD_FLAG CHAR(1)
...
END 
ELSE 
IF (@FILETYPE = 'NON-CMS' OR @FILETYPE = 'TECHPROCESS' OR  @FILETYPE = 'BILLDESK' OR @FILETYPE='ROZARPAY' OR @FILETYPE = 'ROZARPAY1' OR @FILETYPE = 'SBPAYOUT' OR @FILETYPE = 'BILLDESK_TID') 
BEGIN
