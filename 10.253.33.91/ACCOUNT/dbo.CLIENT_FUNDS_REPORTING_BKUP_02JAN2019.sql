-- Object: PROCEDURE dbo.CLIENT_FUNDS_REPORTING_BKUP_02JAN2019
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


--EXEC CLIENT_FUNDS_REPORTING 'APR  1 2018', 'NOV 27 2018'
CREATE PROCEDURE [dbo].[CLIENT_FUNDS_REPORTING_BKUP_02JAN2019]
	@FR_DATE VARCHAR(11),
	@TO_DATE VARCHAR(11),
	@EXCHANGE VARCHAR(10),
	@SEGMENT VARCHAR(10),
...
FROM MSAJAG..VW_CLIENT_DETAILS_REPORTING WHERE CL_CODE BETWEEN @FR_CODE AND @TO_CODE
...
(
	...
	SELECT CLTCODE = L.CLTCODE, AMOUNT = SUM(CASE WHEN DRCR = 'C' THEN VAMT ELSE -VAMT END)
	FROM LEDGER L, (SELECT DISTINCT CLTCODE FROM #CLIENT_DETAILS) L1, PARAMETER P
