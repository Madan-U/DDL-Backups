-- Object: PROCEDURE dbo.PAYMENT_DATA_TEST
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

 --EXEC PAYMENT_DATA '01/03/2021','31/03/2021'    
                    
CREATE PROC [dbo].[PAYMENT_DATA_TEST] (    
  @FROMDATE VARCHAR(11),     
  @TODATE   VARCHAR(11)    
  ...
  BEGIN     
      ...
      [Entry_DAte]=cdt,    
              ...
              WHERE  L.vno = L1.vno     
                     ...
                     AND L.vtyp  IN (2,16)       
                     AND L.vdt >= @FROMDATE     
                     AND L.vdt < = @TODATE + ' 23:59'     AND NARRATION LIKE '%RTGS/NEFT%'
              UNION ALL     
              SELECT cltcode,     
                     L.vdt,     
                     L.vno,     
