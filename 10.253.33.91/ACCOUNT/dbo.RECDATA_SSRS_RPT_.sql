-- Object: PROCEDURE dbo.RECDATA_SSRS_RPT 
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

 --EXEC RECDATA '13/12/2017','13/12/2017'
                
CREATE PROC [dbo].[RECDATA_SSRS_RPT ] (
		@FROMDATE VARCHAR(11), 
		@TODATE   VARCHAR(11)
      ...
      [DRCR] =L.drcr, 
       ...
       angelcommodity.accountncdx.dbo.ledger1 L1 (nolock) 
     		...
     		union all   
				...
				[DDNO]   = INSTNO,                                                              
				[VTYP]   =L.VTYPE,                                                                            
				[RELDT]  =(CASE WHEN L.VTYPE =2 THEN CR_RELDT ELSE DR_RELDT END),[EDT] =L.EDT, T1.POSTED_ON AS CDT,                                                                            
				[BOOKTYPE]='01',                                                                  
