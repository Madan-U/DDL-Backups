-- Object: PROCEDURE dbo.CLS_RECON_BANK_FILEUPLOAD_LOGS_week_TEST
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


	CREATE  PROCEDURE [dbo].[CLS_RECON_BANK_FILEUPLOAD_LOGS_week_TEST]
	AS
	...
	VALUEDATE DATETIME	)
		...
		WHERE FILETYPE<>'ENCRYPTION' AND SEGMENT in('NSE-CAPITAL')
...
WHILE (SELECT COUNT(*)	FROM #TEMPBANKMASTER)> 0 
	...
	AND R.VALUEDATE BETWEEN  '"+ CONVERT(VARCHAR(11),DATEADD(DAY, -1,   @REPROCUPLOADDATE ), 113)+"'  AND  '"+CONVERT(VARCHAR(11), @REPROCUPLOADDATE ,113)+"'
