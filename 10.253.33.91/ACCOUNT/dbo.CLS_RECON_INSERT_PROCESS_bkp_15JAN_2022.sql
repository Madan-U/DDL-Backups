-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_bkp_15JAN_2022
...
CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_bkp_15JAN_2022] (@UPLOADID   NVARCHAR(50)
...
END 
ELSE 
IF (@FILETYPE = 'NON-CMS' OR @FILETYPE = 'TECHPROCESS' OR  @FILETYPE = 'BILLDESK' OR @FILETYPE='ROZARPAY') 
BEGIN
