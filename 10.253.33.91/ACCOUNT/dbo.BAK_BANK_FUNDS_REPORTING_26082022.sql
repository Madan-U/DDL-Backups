-- Object: PROCEDURE dbo.BAK_BANK_FUNDS_REPORTING_26082022
...
CREATE PROCEDURE [dbo].[BAK_BANK_FUNDS_REPORTING_26082022]
	@FR_DATE VARCHAR(11),
	@TO_DATE VARCHAR(11),
	@EXCHANGE VARCHAR(10),
	@SEGMENT VARCHAR(10),
...
SELECT VDT, EDT, CLTCODE, NARRATION, VNO, DRCR, VAMT, VTYP, BOOKTYPE, PDT FROM LEDGER (NOLOCK) 
WHERE VDT BETWEEN @FR_DATE AND @TO_DATE + ' 23:59' AND VTYP NOT  IN (18,15,8,35,21) AND CLTCODE =@BANK_CODE
...
SELECT l.VDT, l.EDT, l.CLTCODE, l.NARRATION, l.VNO, l.DRCR, l.VAMT, l.VTYP, l.BOOKTYPE, l.PDT into #TEMP 
FROM #LED_DATA S(NOLOCK),LEDGER  L (NOLOCK)
WHERE 
