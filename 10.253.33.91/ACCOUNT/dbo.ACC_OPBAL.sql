...
/* Get Opendate From Sdate, Fdate Received As Parameter */    
   If Upper(@Selectionby) = 'Vdt'    
      Begin    
         Select @@Opendate = ( Select Left(Convert(Varchar, Isnull(Max(Vdt), 0), 109), 11) From Ledger with (nolock) Where Vtyp = 18 And Vdt < = @Fdate )    
      End    
   Else    
      Begin    
         Select @@Opendate = ( Select Left(Convert(Varchar, Isnull(Max(Edt), 0), 109), 11) From Ledger with (nolock) Where Vtyp = 18 And Edt < = @Fdate )    
   End    
/* -------------------------------------------------------------------------- */         
   If Upper(@Selectionby) = 'Vdt'    
      Begin    
...
/* Get Opendate From Sdate, Fdate Received As Parameter */    
   If Upper(@Selectionby) = 'Vdt'    
	 ...
	 Select @@Opendate = ( Select Left(Convert(Varchar, Isnull(Max(Vdt), 0), 109), 11) From Marginledger with (nolock) Where Vtyp = 18 And Vdt < = @Fdate )    
      End    
   Else    
      Begin    
