-- Object: PROCEDURE dbo.CLIENT_PAYIN_PAYOUT_DATA_BULK
...
CREATE PROCEDURE CLIENT_PAYIN_PAYOUT_DATA_BULK      
...
AND CLTCODE IN (SELECT * FROM OLDNEW)      
...
FROM [172.31.16.30].ACCOUNT.DBO.LEDGER A JOIN [172.31.16.30].MSAJAG.dbo.CLIENT_DETAILS B ON A.CLTCODE = B.CL_CODE      
...
FROM [172.31.16.30].ACCOUNT_AB.DBO.LEDGER A JOIN [172.31.16.30].BSEDB_AB.DBO.CLIENT1 B ON A.CLTCODE = B.CL_CODE      
...
FROM [172.31.16.30].ACCOUNTFO.DBO.LEDGER A JOIN [172.31.16.30].NSEFO.DBO.CLIENT1 B ON A.CLTCODE = B.CL_CODE      
...
FROM [172.31.16.30].ACCOUNTCURFO.DBO.LEDGER A JOIN [172.31.16.30].NSECURFO.DBO.CLIENT1 B ON A.CLTCODE = B.CL_CODE      
...
FROM [172.31.16.30].ACCOUNTMCDXCDS.DBO.LEDGER A JOIN [172.31.16.30].MCDXCDS.DBO.CLIENT1 B ON A.CLTCODE = B.CL_CODE      
...
FROM [196.1.115.206].ACCOUNTMCDX.DBO.LEDGER A JOIN [196.1.115.206].MCDX.DBO.CLIENT1 B ON A.CLTCODE = B.CL_CODE      
...
FROM [196.1.115.206].ACCOUNTNCDX.DBO.LEDGER A JOIN [196.1.115.206].NCDX.DBO.CLIENT1 B ON A.CLTCODE = B.CL_CODE      
