-- Object: PROCEDURE dbo.CLS_BANKRECO_FETCH_DUMMY
...
CREATE PROCEDURE [dbo].[CLS_BANKRECO_FETCH_DUMMY]
(
	@FCLTCODE VARCHAR(10),
	@TCLTCODE VARCHAR(10)
...
*/
 	...
 	SELECT CLTCODE,BRANCHCODE  INTO #ACMAST FROM ACMAST
			
			CREATE CLUSTERED INDEX IDX_CL ON #ACMAST
            (
	          CLTCODE
            )
