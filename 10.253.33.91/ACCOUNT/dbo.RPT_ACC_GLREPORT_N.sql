-- Object: PROCEDURE dbo.RPT_ACC_GLREPORT_N
...
*/    
CREATE PROC [dbo].[RPT_ACC_GLREPORT_N]                    
...
SELECT                    
 ...
 CRAMT,                    
 VNO,                    
 NARRATION= ( CASE WHEN CLTCODE ='61310' THEN  REPLACE(REPLACE(REPLACE (NARRATION,'Based Brokerage Debited','fees credited to client'),'of','for'),' trnfd. to income others a/c','')     else  NARRATION END ),             
 DDNO,                    
 CLTCODE,                    
 LONGNAME,                    
 VDT,            
