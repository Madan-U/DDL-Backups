-- Object: PROCEDURE dbo.RETURNCANCEL_BULK_BKUP_22NOV2018
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


Create PROC [dbo].[RETURNCANCEL_BULK_BKUP_22NOV2018] @VTYPE   SMALLINT, 
                                     @FNAME   VARCHAR(100), 
                                     @UNAME   VARCHAR(25), 
                                     @USERCAT SMALLINT 
AS 
