-- Object: PROCEDURE dbo.acc_PrintReconcile_BKUP_26AUG2021
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

    
CREATE PROCEDURE  [dbo].[acc_PrintReconcile_BKUP_26AUG2021]                      
@code varchar(10),                    
...
ON [PRIMARY]    
  ...
  SELECT VNO, VTYP, BOOKTYPE FROM LEDGER (NOLOCK) WHERE CLTCODE = @code AND VDT <= @tdate
...
WHERE     
 ...
 AND (RELDT ='1900-01-01 00:00:00.000' OR RELDT >  @tdate )  --- and L.vno in ('202104268075', '202104289454') and L.Vtyp=3 and L.booktype='01' 
ORDER BY     
