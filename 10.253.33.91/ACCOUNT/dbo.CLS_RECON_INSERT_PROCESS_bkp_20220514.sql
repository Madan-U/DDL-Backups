-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_bkp_20220514
...
CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_bkp_20220514] (@UPLOADID   VARCHAR(50)
, @FILETYPE VARCHAR(50)
, @BANKNAME VARCHAR(50)
, @UPLOAD_FLAG CHAR(1)
...
IF EXISTS(SELECT TOP 1 * FROM #CMS_DATA )
	...
	SELECT VNO, VTYP, BOOKTYPE #TEMPLEDGER FROM LEDGER (NOLOCK)
			   WHERE CLTCODE =  @BANKCODE AND VDT>=@REPDATE
			   AND VTYP IN (2, 3, 17)
