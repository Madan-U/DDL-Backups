-- Object: PROCEDURE dbo.PR_GET_LEDBAL_COMBINE_BKP_14FEB2023
...
CREATE PROCEDURE [dbo].[PR_GET_LEDBAL_COMBINE_BKP_14FEB2023]     
(    
...
IF CONVERT(DATETIME,@MARGINDATE) = CONVERT(DATETIME,'JAN  6 2023')
...
BEGIN 
 	...
 	INSERT INTO #CASH_LED_BAL (CLTCODE,VAMT)
	SELECT PARTY_CODE=CLTCODE, TDAY_LEDGER = SUM(BAL)
	FROM #SEBIPOBAL
	GROUP BY CLTCODE
