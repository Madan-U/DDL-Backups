-- Object: PROCEDURE dbo.V2_OFFLINE_PAYMENTUPLOAD
...
AND ADDBY <>'TPR'    
  ...
  WHERE  VOUCHERTYPE = 3                              
   ...
   END     
	  ...
	  CREATE INDEX #FLDAUTO ON #RECPAY_TABLE(FLD_AUTO)
	  CREATE INDEX #CLTCODE ON #RECPAY_TABLE(CLIENT_CODE)
	  CREATE INDEX #BANKCODE ON #RECPAY_TABLE(BANK_CODE)
