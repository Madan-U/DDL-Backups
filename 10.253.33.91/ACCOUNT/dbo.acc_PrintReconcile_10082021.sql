-- Object: PROCEDURE dbo.acc_PrintReconcile_10082021
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

    
CREATE PROCEDURE  [dbo].[acc_PrintReconcile_10082021]                      
@code varchar(10),                    
...
ON [PRIMARY]    
  ...
  --select * from #LEDGER_BANK
  --Return

  --and Vno='202104289788' and Vtyp='3'
...
WHERE     
 ...
 AND (RELDT ='1900-01-01 00:00:00.000' OR RELDT >  @tdate )  And Cltcode = 'SMRM029'  
ORDER BY     
