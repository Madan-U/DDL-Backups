...
/****** Object:  Stored Procedure dbo.Spa_InsVouchertemp    Script Date: 05/07/2003 5:59:59 PM ******/
...
begin
	...
	update templedger2 set costflag = 'A', rowid = lno
        where upper(category) <> 'BRANCH' and sessionid = @sid and vtype=@vtype and booktype =@booktype and vno= @vno
/* Following line added by VNS on 29-Apr-2003 */
	delete from templedger2 where upper(category) = 'BRANCH' and vtype = 8
end
