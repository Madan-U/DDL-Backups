-- Object: PROCEDURE dbo.RECEIPT_DATA_REVISED_nikhil_modify
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

           
--RECEIPT_DATA_REVISED_nikhil '13/08/2015','13/08/2015'    
                
CREATE PROC [dbo].[RECEIPT_DATA_REVISED_nikhil_modify]                          
(                          
@FROMDATE varchar(11) ,                          
@TODATE   varchar(11)                     
