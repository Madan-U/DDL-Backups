-- Object: PROCEDURE dbo.CLS_RECON_TECHPROCESS_ICICI_PROCESS_TEMP_BKUP_03FEB2023
...
CREATE PROCEDURE [dbo].[CLS_RECON_TECHPROCESS_ICICI_PROCESS_TEMP_BKUP_03FEB2023]
...
SELECT TOP 1 @VALUEDATE=.DBO.PIECE(.DBO.PIECE(FILE_DATA, ':', 2),',',1) FROM MSAJAG..FILEDATA (nolock)
WHERE PROGID=@UPLOADID
ORDER BY SRNO ASC



UPDATE F SET FILE_DATA=ISNULL(.DBO.PIECE(FILE_DATA, ',', 1), '') + ',' +
...
from MSAJAG.DBO.FILEDATA F
WHERE .DBO.PIECE(FILE_DATA, ',', 14) LIKE '%ITC:ABC_123%' AND F.PROGID=@UPLOADID
