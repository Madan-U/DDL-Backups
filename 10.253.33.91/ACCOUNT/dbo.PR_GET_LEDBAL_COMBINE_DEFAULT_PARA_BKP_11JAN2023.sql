-- Object: PROCEDURE dbo.PR_GET_LEDBAL_COMBINE_DEFAULT_PARA_BKP_11JAN2023
...
CREATE PROCEDURE [dbo].[PR_GET_LEDBAL_COMBINE_DEFAULT_PARA_BKP_11JAN2023]     
(    
...
(
	...
	GROUP BY CLTCODE
	HAVING SUM(CASE WHEN A.DRCR ='D' THEN VAMT ELSE -VAMT END) > 0
) A
GROUP BY CLTCODE
end
