-- Object: PROCEDURE dbo.VIRTUAL_MIS_LEDGER_CONVERTER_NEW_Fortesting
...
EXEC VIRTUAL_MIS_LEDGER_CONVERTER 'D:\TEMP\131033382.csv', 'SURESH'                                              
...
*/     
CREATE  PROCEDURE [dbo].[VIRTUAL_MIS_LEDGER_CONVERTER_NEW_Fortesting] @FILENAME VARCHAR(1000),     
                                                     @UNAME    VARCHAR(50)     
														WITH RECOMPILE
AS     
...
set xact_abort on 
    ...
    TRUNCATE TABLE VIRTUAL_MIS_LEDGER_TESTINGPurpose     
...
--PRINT @@SQL   
    ...
    INSERT INTO VIRTUAL_MIS_LEDGER_TESTINGPurpose     
...
--           AND right(substring(B.ACCNO, patindex('%[^0]%',B.ACCNO),20) ,5)   =  Right(REPLACE(#VIRTUAL_MIS.ACCOUNTNO  ,'-','') ,5)  
