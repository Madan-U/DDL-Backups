-- Object: PROCEDURE dbo.NBFC_PAYMENT_nikhil
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


--NBFC_PAYMENT_nikhil 'MAY 25 2015' , 'MAY 26 2015'

CREATE proc [dbo].[NBFC_PAYMENT_nikhil]  
(            
@TODATE varchar (11),            
@FROMDATE  varchar(11)            
)AS            
...
AND L.DRCR ='D' AND L.VTYP =3  AND L.vdt>= @TODATE AND  L.vdt< = @FROMDATE + ' 23:59:59:999' AND L1.reldt ='')  A          
INNER JOIN             
( SELECT CLTCODE,L.vdt,L.vno,L.narration,L.vamt,L.DRCR,L1.ddno,            
 L.vtyp,L1.reldt,L.BOOKTYPE            
 FROM LEDGER L(NOLOCK), LEDGER1 L1 (NOLOCK)            
WHERE L.VNO=L1.VNO AND L.VTYP=L1.VTYP AND L.BOOKTYPE=L1.BOOKTYPE             
and L.DRCR ='C' AND L.VTYP =3  AND L.VDT>= @TODATE AND  L.vdt< = @FROMDATE + ' 23:59:59:999'  AND L1.reldt ='')   B         
...
SELECT C.*,b.SHORT_NAME,b.REGION,b.BRANCH_CD,b.SUB_BROKER FROM #TEMP C            
left outer JOIN            
