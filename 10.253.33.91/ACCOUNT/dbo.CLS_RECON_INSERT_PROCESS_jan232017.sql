-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_jan232017
...
CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_jan232017] (@UPLOADID   NVARCHAR(50)
...
IF (@BANKNAME = 'YES BANK' AND @REPROCESS_FLAG <> 'R') 
BEGIN
...
ELSE
BEGIN
		SELECT 'REPROCESS SUCCESSFULLY 1'
END
