-- Object: PROCEDURE dbo.CLS_RECON_MATCH_UNMATCH_REPORT_WRAPPER_bkp27052024
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


CREATE  PROCEDURE [dbo].[CLS_RECON_MATCH_UNMATCH_REPORT_WRAPPER_bkp27052024]
(
...
SELECT * INTO #RECON_BANK_FILEUPLOAD_LOGS FROM RECON_BANK_FILEUPLOAD_LOGS (NOLOCK) WHERE FILEUPLOAD_SDATE > = DATEADD(DAY,-91,GETDATE())

CREATE NONCLUSTERED INDEX IDX_FILTER ON #RECON_BANK_FILEUPLOAD_LOGS ([SEGMENT],[BANKCODE],[BANKNAME],[FILETYPE])
INCLUDE ([UPLOADFILENAME],[UPLOADSTATUS],[FILEUPLOAD_SDATE],[FILEUPLOAD_EDATE])
...
EXEC [CLS_RECON_MATCH_UNMATCH_REPORT_PT_18AUG2023]	@FROM_DATE
										,@TO_DATE
										,@BANKCODE
										,@MATCHEDFLAG
										,@FILETYPE
...
GROUP BY	FILEUPLOADID
   ...
   CREATE INDEX #TVNO ON #TEMP_REPORT_WRAPPER (VNO,VTYP,BOOKTYPE)
   CREATE INDEX #LVNO ON #LEDGER_TO_MAP (VNO,VTYP,BOOKTYPE)
