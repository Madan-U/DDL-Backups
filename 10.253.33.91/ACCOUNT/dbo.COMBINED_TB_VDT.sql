...
--------------------------------------------------
     ...
     ---COMBINED_TB_VDT 'JUL 28 2021'        
          
          
 CREATE PROCEDURE [dbo].[COMBINED_TB_VDT]          
 (          
 @FROMDATE VARCHAR(20)          
 )          
 AS           
