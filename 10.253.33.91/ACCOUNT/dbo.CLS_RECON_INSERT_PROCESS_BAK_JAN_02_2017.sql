-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_BAK_JAN_02_2017
...
CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_BAK_JAN_02_2017] (@UPLOADID   NVARCHAR(50)
...
IF (@BANKNAME <> 'YES BANK' OR @REPROCESS_FLAG = 'R') 
BEGIN
...
INSERT INTO #LEDGER_TO_MAP_NON
		...
		,DRCR
		,Edt
		,Vdt FROM #LEDGER_TO_MAP_NON_HDFC
		GROUP BY	DDNO
		,RELAMT
		,DRCR
		,EDT
