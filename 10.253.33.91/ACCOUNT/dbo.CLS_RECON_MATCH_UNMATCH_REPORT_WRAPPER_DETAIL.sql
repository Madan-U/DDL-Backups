-- Object: PROCEDURE dbo.CLS_RECON_MATCH_UNMATCH_REPORT_WRAPPER_DETAIL
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

CREATE  PROCEDURE [dbo].[CLS_RECON_MATCH_UNMATCH_REPORT_WRAPPER_DETAIL]
(
...
SELECT
	...
	,COUNT(MATCHEDFLAG) AS 'TOTALRECORD'
...
AND (BANKCODE = @BANKCODE OR @BANKCODE = '')
