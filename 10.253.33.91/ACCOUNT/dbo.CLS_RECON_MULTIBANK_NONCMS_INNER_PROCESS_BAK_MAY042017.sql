-- Object: PROCEDURE dbo.CLS_RECON_MULTIBANK_NONCMS_INNER_PROCESS_BAK_MAY042017
...
CREATE PROCEDURE [dbo].[CLS_RECON_MULTIBANK_NONCMS_INNER_PROCESS_BAK_MAY042017]
...
INSERT INTO BANKRECO (CLTCODE, BOOKDATE, DESCRIPTION, AMOUNT, DRCR, VALUEDATE, REFERENCENO, STATUSID, STATUSNAME, LOGINNAME, CROSSREFERENCENO, STATUS, MICRNO, DUMMY1, DUMMY2, CMS_SRNO)
	...
	AND   BR.DESCRIPTION NOT LIKE  ( SELECT EXCLUDEDATA FROM RECON_EXCLUDE_MASTER_VW EM
	WHERE  FILETYPE=@FILETYPE	AND BANKNAME=@BANKNAME)
