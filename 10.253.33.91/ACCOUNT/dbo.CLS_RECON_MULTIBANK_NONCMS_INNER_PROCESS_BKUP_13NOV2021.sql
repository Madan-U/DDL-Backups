-- Object: PROCEDURE dbo.CLS_RECON_MULTIBANK_NONCMS_INNER_PROCESS_BKUP_13NOV2021
...
CREATE PROCEDURE [dbo].[CLS_RECON_MULTIBANK_NONCMS_INNER_PROCESS_BKUP_13NOV2021]
...
IF EXISTS(SELECT * FROM TEMP_NONCMS_DATA(NOLOCK) WHERE DESCRIPTION LIKE 'BIL/%' AND  UPLOADID=@UPLOADID )
	...
	--UPDATE T SET BILLDDNO=SUBSTRING(.DBO.PIECE(DESCRIPTION,'/',2), PATINDEX('%[^0]%',.DBO.PIECE(DESCRIPTION,'/',2)), 30)
