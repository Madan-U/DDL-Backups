...
select * into #nse_cr from ledger (nolock) where vdt >=getdate()-60 and vtyp=2 and drcr='C' and  cltcode='5100000002'    
    
select * into #nse_dr from ledger (nolock) where vdt >=getdate()-60 and vtyp=3 and drcr='D' and  cltcode='5100000002'    
