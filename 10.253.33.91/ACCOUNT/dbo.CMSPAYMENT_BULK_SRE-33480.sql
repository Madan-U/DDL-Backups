-- Object: PROCEDURE dbo.CMSPAYMENT_BULK_SRE-33480
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------



CREATE PROC [dbo].[CMSPAYMENT_BULK_SRE-33480]          
...
IF LEFT(@FNAME, 25) <> 'J:\BackOffice\CMSPayment\'          
 BEGIN          
  SELECT 'THE FILE YOU ARE UPLOADING MUST BE LOCATED IN J:\BackOffice\CMSPayment OF DATA SERVER', 'NA', 'NA'          
  RETURN          
 END          
