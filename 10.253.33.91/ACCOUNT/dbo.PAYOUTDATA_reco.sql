-- Object: PROCEDURE dbo.PAYOUTDATA_reco
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

      
CREATE proc [dbo].[PAYOUTDATA_reco] (                                
...
and L.vdt< = @TODATE + ' 23:59' and L1.reldt='2015-11-13 00:00:00.000'                              
--and L1.reldt='2015-11-09 00:00:00.000'        
UNION ALL                                
...
SELECT CLTCODE,L.vdt,L.VNO,L.narration,L.vamt,L.DRCR,L1.ddno,                              
 ...
 FROM LEDGER L, LEDGER1 L1 (NOLOCK)                              
WHERE L.VNO=L1.VNO AND L.VTYP=L1.VTYP AND L.BOOKTYPE=L1.BOOKTYPE                               
AND L.DRCR ='C' AND L.VTYP =3  AND L.vdt> =@FROMDATE                          
and L.vdt< = @TODATE + ' 23:59' and L1.reldt='2015-11-13 00:00:00.000'        
...
--PAYOUTDATA_reco '01/07/2015','13/11/2015'
