-- Object: PROCEDURE dbo.CHEQUERETURNDATA
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

 --EXEC CHEQUERETURNDATA '05/11/2019','05/11/2019'
                
CREATE PROC [dbo].[CHEQUERETURNDATA] (
		@FROMDATE VARCHAR(11), 
		@TODATE   VARCHAR(11)
      ...
      [DRCR] =L.drcr, 
       ...
       angelcommodity.accountncdx.dbo.ledger1 L1 (nolock) 
     		...
     		union all   
				...
				[DDNO]   = INSTNO,                                                              
				[VTYP]   =L.VTYPE,                                                                            
				[RELDT]  =(CASE WHEN L.VTYPE =17 THEN CR_RELDT ELSE DR_RELDT END),T1.POSTED_ON AS CDT,                                                                            
				[BOOKTYPE]='01',                                                                  
