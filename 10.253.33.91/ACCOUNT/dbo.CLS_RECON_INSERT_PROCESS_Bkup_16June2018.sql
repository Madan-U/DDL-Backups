-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS_Bkup_16June2018
...
Create  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS_Bkup_16June2018] (@UPLOADID   NVARCHAR(50)
...
SELECT UPLOADID,SEGMENT,BANKCODE,"+@BANKCODE+",FILETYPE,"+@BANKACCOUNT+",UPLOADFILENAME,MODIFIEDDATE,UPLOADSTATUS,FILEUPLOAD_SDATE,FILEUPLOAD_EDATE,VALUEDATE FROM [DBO].RECON_BANK_FILEUPLOAD_LOGS WHERE UPLOADID='"+@UPLOADID+ "'
END"
...
INSERT INTO @TEMPBANKACCOUNT
	SELECT DISTINCT BANKACCOUNT	FROM #NONCMS_DATA
