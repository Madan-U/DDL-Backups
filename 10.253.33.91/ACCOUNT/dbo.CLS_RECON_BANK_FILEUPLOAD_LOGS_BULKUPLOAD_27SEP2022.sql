-- Object: PROCEDURE dbo.CLS_RECON_BANK_FILEUPLOAD_LOGS_BULKUPLOAD_27SEP2022
...
create PROCEDURE [dbo].[CLS_RECON_BANK_FILEUPLOAD_LOGS_BULKUPLOAD_27SEP2022] (
...
--AND BANKCODE='02020' AND SEGMENT ='NSE-CAPITAL'
--WHERE BANKNAME=@BANKNAME and BANKCODE='02014' AND FILETYPE<>'ENCRYPTION' and Segment ='NSE-CAPITAL' --AND FILETYPE='NON-CMS'
