-- Object: PROCEDURE dbo.AccountDrCrEdtSp
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


/****** Object:  Stored Procedure dbo.AccountDrCrEdtSp    Script Date: 02/22/2002 1:56:02 PM ******/
/************************************************************************************************************************************************************************************************
...
if @flag = 1
begin
	select isnull(p.cltcode,''),isnull(p.acname,''),bal =round(Sum(debit) - Sum(credit),2)  	from partydrcredtview p,parameter,acmast a  
