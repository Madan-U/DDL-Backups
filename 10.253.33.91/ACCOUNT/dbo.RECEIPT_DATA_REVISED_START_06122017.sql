-- Object: PROCEDURE dbo.RECEIPT_DATA_REVISED_START_06122017
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------


                                          
 --     [RECEIPT_DATA_REVISED_START]     '06/11/2017'   ,'13/11/2017'                                                   
CREATE PROC [dbo].[RECEIPT_DATA_REVISED_START_06122017]                                                                          
(                                                                        
@fromdate varchar(11) ,                                                                          
@todate   varchar(11)                                                                                                                                          
)                                                                          
