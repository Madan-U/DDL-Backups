-- Object: PROCEDURE dbo.CLS_RECON_INSERT_PROCESS
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------



CREATE  PROCEDURE [dbo].[CLS_RECON_INSERT_PROCESS] (@UPLOADID   VARCHAR(50)
, @FILETYPE VARCHAR(50)
, @BANKNAME VARCHAR(50)
, @UPLOAD_FLAG CHAR(1)
...
if(@BANKCODE='3320' AND @BANKACCOUNT='918020001632189')
begin 
	EXEC CLS_RECON_NONCMS_AXIS_PROCESS  @UPLOADID,@BANKACCOUNT,@BANKCODE,@UPLOADFILENAME,@UNAME
	set @BANKNAME='AXIS BANK'
end
...
--IF (@BANKNAME = 'AXIS BANK') EXEC CLS_RECON_NONCMS_AXIS_PROCESS  @UPLOADID,@BANKACCOUNT,@BANKCODE,@UPLOADFILENAME,@UNAME
