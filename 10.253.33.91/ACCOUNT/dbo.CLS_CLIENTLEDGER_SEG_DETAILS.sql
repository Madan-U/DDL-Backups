-- Object: PROCEDURE dbo.CLS_CLIENTLEDGER_SEG_DETAILS
...
SELECT @CHARGES_FLAG = ISNULL(PVALUE, 0) FROM CLS_CLIENT_LEDGER_PARAMETERS WHERE SESSIONID = @SESSIONID AND PKEY = 'ddlCharges'
