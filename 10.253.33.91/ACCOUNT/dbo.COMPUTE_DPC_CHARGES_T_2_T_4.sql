-- Object: PROCEDURE dbo.COMPUTE_DPC_CHARGES_T_2_T_4
-- Server: 10.253.33.91 | DB: ACCOUNT
--------------------------------------------------

CREATE PROCEDURE [dbo].[COMPUTE_DPC_CHARGES_T_2_T_4]
(                        
...
(                        
 ...
 SELECT                         
  ...
  CL_TYPE                        
 FROM                        
  LEDGER L, .DBO.GET_DPC_CLIENTS(@FROM_PARTY, @TO_PARTY, @FROM_DATE) C, MSAJAG.DBO.GET_SETT_CALENDER(@@OPEN_DATE, @TO_DATE, 4)                        
 WHERE                        
  L.CLTCODE = PARTY_CODE        
