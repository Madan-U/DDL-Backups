-- Object: PROCEDURE dbo.AUTO_PROC_CM_MARGIN_DWLOAD_JOB
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE PROC [dbo].[AUTO_PROC_CM_MARGIN_DWLOAD_JOB]     
(    
...
BEGIN     
 ...
 EXEC msdb.DBO.SP_START_JOB 'AUTO_PROC_CM_MARGIN_DWLOAD'     
  ...
  \\ABVSNSECM.angelone.in\j$\Backoffice\Automation\UPDATION\MARGIN_EXCHANGE_REPORTING\  ....!!!    
