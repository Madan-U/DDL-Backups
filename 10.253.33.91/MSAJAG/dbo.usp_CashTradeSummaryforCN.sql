-- Object: PROCEDURE dbo.usp_CashTradeSummaryforCN
...
CREATE PROCEDURE [dbo].[usp_CashTradeSummaryforCN] 
...
AS
	BEGIN
		...
		CREATE TABLE #Temp
		( 
					 Trade_Type varchar(20) NOT NULL, EXCHANGE varchar(10) NOT NULL, SETT_NO varchar(20) NULL, PARTY_CODE varchar(10) NULL, SAUDA_DATE date NULL, TRD_DT varchar(11) NULL, SCRIP_CD varchar(8000) NULL, SCRIPName varchar(8000) NULL, Buy_qty int NULL, BuyMarketRate money NULL, Sell_qty int NULL, SellMarketRate money NULL, BROKERAGE money NULL, STT money NULL, Other_charges money NULL, TO_TAX money NULL, SEBI_TAX money NULL, STAMPDUTY money NULL, SER_TAX money NULL, BILLFLAG int NOT NULL, Grand_Total money NULL, Long_Name varchar(8000), Address varchar(8000), Branch_Cd varchar(800), pan_gir_no varchar(80), Period varchar(800), ReportDate varchar(80), OrderPriority bigint
		);
