-- Object: PROCEDURE dbo.rpt_servicetax_client
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.rpt_servicetax_client    Script Date: 10/19/01 3:33:31 PM ******/
CREATE procedure rpt_servicetax_client
@trdt as varchar(20),
...
left(convert(varchar,sauda_date,106),11) as sauda_date,
...
where left(convert(varchar,sauda_date,106),11) = @trdt
and sett_type = @settyp
and sett_no = @setno
...
group by left(convert(varchar,sauda_date,106),11),settlement.party_code,c1.short_name,c1.branch_cd,sett_type,sett_no
...
group by left(convert(varchar,sauda_date,106),11),history.party_code,c1.short_name,c1.branch_cd,sett_type,sett_no
