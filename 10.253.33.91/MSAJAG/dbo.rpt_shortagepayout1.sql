-- Object: PROCEDURE dbo.rpt_shortagepayout1
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE procedure rpt_shortagepayout1
...
If @statusid = 'broker'
Begin	
select d.sett_no,d.sett_type,d.Party_Code,Short_Name=c1.Short_Name + ' (' + C1.Branch_cd + ' )',d.Scrip_cd,d.Series,ToGive=(Case When Inout = 'O' Then D.Qty Else -D.Qty End )+Sum(Case When DrCr = 'C' Then isnull(De.qty,0)Else 0 End),
Given = Sum(Case When DrCr = 'D' Then isnull(De.qty,0)Else 0 End) 
 ...
 group by d.sett_no,d.sett_type,d.Party_Code,c1.Short_Name,d.scrip_cd,d.series,d.qty,Inout,C1.Branch_cd
...
Union 
select d.sett_no,d.sett_type,d.Party_Code,Short_Name=c1.Short_Name + ' (' + C1.Branch_cd + ' )',d.Scrip_cd,d.Series,
...
and series = d.series and party_code = d.party_code ) And ShareType <> 'AUCTION'
group by d.sett_no,d.sett_type,d.Party_Code,c1.Short_Name,d.scrip_cd,d.series,C1.Branch_cd
