-- Object: PROCEDURE dbo.rpt_acctrialbalallpartydrcrbr
...
CREATE PROCEDURE  rpt_acctrialbalallpartydrcrbr
...
begin
	...
	where l2.drcr = 'D'  and vdt  >=@openentry and  vdt <=  @vdt + ' 23:59:59'  and a.cltcode=l3.cltcode and a.accat=4 and vtyp <> '18'  and c.costcode=l2.costcode and 
	...
	where l2.drcr = 'C'  and vdt  >=@openentry and  vdt <=  @vdt + ' 23:59:59' and a.cltcode=l3.cltcode and a.accat=4 and vtyp <> '18' and  c.costcode=l2.costcode and 
	l2.vtype=l3.vtyp and
	l2.vno=l3.vno and
	l2.lno=l3.lno and
	l2.booktype=l3.booktype and a.cltcode=l3.cltcode and ct.category='branch'  and c.costname=@statusname
...
begin
	select dramt = ( select isnull(sum(camt),0) from account.dbo.ledger l3, account.dbo.acmast a  , account.dbo.ledger2 l2, account.dbo.costmast c , account.dbo.category ct
	where l2.drcr = 'D'  and edt  >=@openentry and edt <=  @vdt + ' 23:59:59'  and a.cltcode=l3.cltcode and a.accat=4 and vtyp <> '18' and c.costcode=l2.costcode and 
	l2.vtype=l3.vtyp and
	l2.vno=l3.vno and
	l2.lno=l3.lno and
	l2.booktype=l3.booktype and a.cltcode=l3.cltcode and ct.category='branch'  and c.costname=@statusname
	...
	cramt = (select isnull(sum(camt),0) from account.dbo.ledger l3 ,account.dbo.acmast a, account.dbo.ledger2 l2, account.dbo.costmast c , account.dbo.category ct
	where l2.drcr = 'C'  and edt  >=@openentry and  edt <=  @vdt + ' 23:59:59' and a.cltcode=l3.cltcode and a.accat=4 and vtyp <> '18' and c.costcode=l2.costcode and 
	l2.vtype=l3.vtyp and
	l2.vno=l3.vno and
	l2.lno=l3.lno and
	l2.booktype=l3.booktype and a.cltcode=l3.cltcode and ct.category='branch'  and c.costname=@statusname
