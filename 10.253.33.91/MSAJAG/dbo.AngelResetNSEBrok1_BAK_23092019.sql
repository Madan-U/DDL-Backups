-- Object: PROCEDURE dbo.AngelResetNSEBrok1_BAK_23092019
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE Procedure [dbo].[AngelResetNSEBrok1_BAK_23092019] (@sauda_date Varchar(11))
As
...
Where
Cast(Left(Convert(varchar,sauda_date,109),11) As SmallDatetime) >= @Sauda_date+ ' 00:00' 
and Cast(Left(Convert(varchar,sauda_date,109),11) As SmallDatetime) <= @Sauda_date+ ' 23:59'
and
Flag1 = 'N')
