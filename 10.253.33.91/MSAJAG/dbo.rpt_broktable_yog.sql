-- Object: PROCEDURE dbo.rpt_broktable_yog
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

 CREATE procedure rpt_broktable_yog  
...
begin  
select 'NSE',table_no,line_no,Table_name,Upper_lim,val_perc,Day_puc,Day_Sales,Sett_Purch,sett_sales,NORMAL,round_to,  
