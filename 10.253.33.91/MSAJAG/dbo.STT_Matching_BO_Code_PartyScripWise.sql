-- Object: PROCEDURE dbo.STT_Matching_BO_Code_PartyScripWise
...
CREATE PROC
	STT_Matching_BO_Code_PartyScripWise
	(
		@FromDate VarChar(11),
		@ToDate VarChar(11),
		@CliType VarChar(2),
...
where
	...
	c.party_code <= @ToCode
group by
	c.party_code, c.scrip_cd, e.tpsttdel, e.tssttdel, e.tsstttrd, e.totalstt, c.rectype
order by
	1,c.rectype desc
