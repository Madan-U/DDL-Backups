-- Object: PROCEDURE dbo.NSECMVALAN_bkp31July2017
...
CREATE PROC [dbo].[NSECMVALAN_bkp31July2017] (                                
@SETT_NO VARCHAR(7),                                           
@SETT_TYPE VARCHAR(2),                                
@SDATE VARCHAR(11),                                
...
INSERT INTO PROCESS_MONITOR VALUES ('VALAN GENERATION',@SETT_NO + @SETT_TYPE,'','NSECMVALAN','DONE-DELETE FROM #CMBILLVALAN. RECCOUNT: ' + CONVERT(CHAR,@@ROWCOUNT),'INSERT NORMAL TRADE FROM SETTLEMENT_VALAN W/O ND SCRIP',GETDATE(),GETDATE())                    
...
INSERT INTO PROCESS_MONITOR VALUES ('VALAN GENERATION',@SETT_NO + @SETT_TYPE,'','NSECMVALAN','DONE-INSERT NORMAL TRADE FROM SETTLEMENT_VALAN W/O ND SCRIP. RECCOUNT: ' + CONVERT(CHAR,@@ROWCOUNT),'INSERT INSTITUTIONAL TRADE FROM ISETTLEMENT_VALAN',GETDATE(),GETDATE())
...
INSERT INTO PROCESS_MONITOR VALUES ('VALAN GENERATION',@SETT_NO + @SETT_TYPE,'','NSECMVALAN','DONE-INSERT INSTITUTIONAL TRADE FROM ISETTLEMENT_VALAN. RECCOUNT: ' + CONVERT(CHAR,@@ROWCOUNT),'UPDATE SCRIPNAME/SECTOR/TRACK FROM SCRIP1 & 2',GETDATE(),GETDATE())   
