-- Object: PROCEDURE dbo.V2_CONTCUMBILL_SECTION_DETAIL_TEXT_04122013
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE  PROC [dbo].[V2_CONTCUMBILL_SECTION_DETAIL_TEXT_04122013](                              
           @STATUSID       VARCHAR(15),                              
...
--        SCRIPNAME1='',                              
 ISIN,                              
 BRANCH_GROUP,    
 START_DATE,END_DATE,FUNDS_PAYIN,FUNDS_PAYOUT,AREA,REGION,FAMILY,PARTYNAME,L_ADDRESS1,L_ADDRESS2,L_ADDRESS3,L_CITY,L_STATE,L_ZIP,PAN_GIR_NO,OFF_PHONE1,OFF_PHONE2,MAPIDID,UCC_CODE,SEBI_NO,    
 Participant_Code,CL_TYPE,SERVICE_CHRG,M.PRINTF            
--INTO CONTRACTTEXT  
