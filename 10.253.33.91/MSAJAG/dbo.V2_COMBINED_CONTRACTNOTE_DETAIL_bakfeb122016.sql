-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_DETAIL_bakfeb122016
...
WHERE 
 ...
 BEGIN                    
	...
	AND EXISTS (SELECT EXCHANGE FROM #EXCHANGELIST E WHERE E.EXCHANGE = LTRIM(RTRIM(COMMON_CONTRACT_DATA.EXCHANGE))+LTRIM(RTRIM(COMMON_CONTRACT_DATA.SEGMENT)) )
 END                    
