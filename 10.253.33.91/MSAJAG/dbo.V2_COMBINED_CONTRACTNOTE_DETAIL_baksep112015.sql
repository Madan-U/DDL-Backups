-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_DETAIL_baksep112015
...
CREATE PROCEDURE [dbo].[V2_COMBINED_CONTRACTNOTE_DETAIL_baksep112015]                       
...
--SELECT @PRINTF = 'ALL'                                                
 ...
 SELECT                      
  ...
  NETRATE=(CASE WHEN LEFT(SCRIPNAME,3)='OPT' THEN (CASE WHEN SELL_BUY =1 THEN NETRATE+BROK ELSE NETRATE-BROK END)    
            ELSE NETRATE END),                      
