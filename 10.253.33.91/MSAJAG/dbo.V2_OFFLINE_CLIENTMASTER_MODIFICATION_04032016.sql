-- Object: PROCEDURE dbo.V2_OFFLINE_CLIENTMASTER_MODIFICATION_04032016
...
CREATE   PROC V2_OFFLINE_CLIENTMASTER_MODIFICATION_04032016(    
   @StatusId  Varchar(15),  
...
*/            
 ...
 SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED        
      ...
      FROM     (SELECT             
       EDIT_BY = 'IN MASTER',            
       EDIT_ON = Convert(datetime,'Dec 31 2049',109),            
