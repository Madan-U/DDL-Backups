-- Object: PROCEDURE dbo.PROC_PNLPROCESS_Daily_BBG
...
CREATE PROC [dbo].[PROC_PNLPROCESS_Daily_BBG]                                          
(                                                                      
...
UPDATE TBL_PNL_DATA_NEW_SIVA SET OPPDATE = ORGDATE + 366 WHERE SETT_TYPE IN ('A','X','AC','AD') AND RECTYPE = 'OPEN'
...
INTO #CHARGES_DETAIL FROM ANAND.BSEDB_AB.DBO.CHARGES_DETAIL WITH(NOLOCK)           WHERE CD_SAUDA_DATE LIKE @SAUDA_DATE + '%'                                                
