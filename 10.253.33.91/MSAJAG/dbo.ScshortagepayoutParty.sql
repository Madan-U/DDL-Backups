-- Object: PROCEDURE dbo.ScshortagepayoutParty
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.ScshortagepayoutParty    Script Date: 3/17/01 9:56:09 PM ******/

/****** Object:  Stored Procedure dbo.ScshortagepayoutParty    Script Date: 3/21/01 12:50:29 PM ******/

/****** Object:  Stored Procedure dbo.ScshortagepayoutParty    Script Date: 20-Mar-01 11:39:08 PM ******/

/*
Control : PayoutShortageCtl
Use : To calculate scripwise payout of party of given settlement no,   settlement  type and for selected range of pary codes
Written by : Kalpana
Date : 08/02/2001
*/
CREATE procedure  ScshortagepayoutParty
@settno varchar(7),
@settype varchar(3),
...
and d.party_code >= @PartycodeFrom and d.party_code <= @PartycodeTo
