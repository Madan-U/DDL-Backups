-- Object: PROCEDURE dbo.rpt_congextrdwisets
...
/****** Object:  Stored Procedure dbo.rpt_congextrdwisets    Script Date: 04/21/2001 6:05:20 PM ******/

/*written by neelambari on 31 mar 2001*/
/*this query gives us the trader name and all details of
  trading of each trader for selected branch from
  trade and settlement
*/
CREATE procedure rpt_congextrdwisets
@branch varchar(3),
@settno varchar(7),
@settype varchar(3)
as
