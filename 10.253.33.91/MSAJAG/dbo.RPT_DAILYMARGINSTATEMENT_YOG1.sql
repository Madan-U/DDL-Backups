-- Object: PROCEDURE dbo.RPT_DAILYMARGINSTATEMENT_YOG1
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROC [dbo].[RPT_DAILYMARGINSTATEMENT_YOG1]                                  
 (                                  
 @MDATE VARCHAR(11),                                  
...
AND T1.COLL_TYPE = 'SEC'                                        
 ...
 WHERE S1.CO_CODE = S2.CO_CODE                                  
   ...
   CREATE NONCLUSTERED INDEX [mar_index] ON [dbo].[#FINAL_REPORT] 
(
	[MARGINDATE] ASC,
	[PARTY_CODE] ASC,
	[EXCHANGE] ASC,
