-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_DETAIL_01082014
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

    
CREATE PROCEDURE [dbo].[V2_COMBINED_CONTRACTNOTE_DETAIL_01082014]       
 (      
 @STATUSID VARCHAR(15),      
...
COMPANYNAME,      
 ...
 FROM       
  ...
  #PARTY P--,  
  --MSAJAG.DBO.FUN_PRINTF(@PRINTF) CP      
 WHERE      
