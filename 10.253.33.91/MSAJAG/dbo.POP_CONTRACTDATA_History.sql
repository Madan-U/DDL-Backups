-- Object: PROCEDURE dbo.POP_CONTRACTDATA_History
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

/*         
BEGIN TRAN      
EXEC POP_CONTRACTDATA_history '2013020','A','JAN 30 2013','h8061','h8061'      
 ROLLBACK        
*/        
CREATE PROC POP_CONTRACTDATA_History(                      
           @SETT_NO        VARCHAR(7),                      
           @SETT_TYPE      VARCHAR(2),                      
