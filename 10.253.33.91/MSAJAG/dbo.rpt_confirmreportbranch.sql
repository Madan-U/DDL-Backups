-- Object: PROCEDURE dbo.rpt_confirmreportbranch
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.rpt_confirmreportbranch    Script Date: 07/11/2002 6:02:05 PM ******/
...
CREATE PROCEDURE rpt_confirmreportbranch
@statusid varchar(15),
...
if @statusid = 'broker'
begin
SELECT c1.branch_cd, tm=convert(varchar,sauda_date,108),
...
and c1.trader like ltrim(@trader)+'%'
 AND s.TRADEQTY <> '0'  
 and status <> 'N'
 group by c1.branch_cd,billno,  trade_no, sauda_date, s.scrip_cd, s.series, 
...
select c1.branch_cd,tm=(Select Convert(Varchar,Min(Sauda_Date),108) from Isettlement i where i.scrip_cd = s.scrip_cd and i.dummy2 = s.dummy2 
           and i.party_code = c1.branch_cd and i.Sauda_Date like @SDate + '%' and i.series = s.series and i.sell_buy = s.sell_buy ),
...
group by c1.branch_cd,s.scrip_cd,s.series, sell_buy, c1.short_name, c1.trader, c1.Res_Phone1, c2.service_chrg, 
c1.cl_code ,marketrate,  s.dummy2,  /* User_Id, */    Sett_No,contractno

Order By c1.branch_cd, s.Scrip_CD,s.series
end
...
and sb.sub_broker = c1.sub_broker
and c1.sub_broker = @statusname
group by c1.branch_cd,s.scrip_cd,s.series,
