-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_DETAIL_history
...
Create PROCEDURE [dbo].[V2_COMBINED_CONTRACTNOTE_DETAIL_history]                       
...
SELECT * INTO #COMMON_DATA FROM COMMON_CONTRACT_DATA_History C (NOLOCK)   
