-- Object: PROCEDURE dbo.Proc_NewBasicReport_Parent_client
...
CREATE  Procedure [dbo].[Proc_NewBasicReport_Parent_client] (   
...
AND PARTY_CODE IN (
SELECT DISTINCT PARTY_CODE FROM CMBILLVALAN S (NOLOCK)--, #PARTYVIEW C (NOLOCK)
