-- Object: PROCEDURE dbo.RPT_DAILYMARGINSTATEMENT_COM_TEST
...
CREATE PROC [dbo].[RPT_DAILYMARGINSTATEMENT_COM_TEST]                                          
(                                          
@MDATE VARCHAR(11),                                          
...
EXEC            RPT_DAILYMARGINSTATEMENT_COM_TEST 'JUL 29 2019', 'G18085','G18085','','ZZZZZZZZZ',  '','ZZZZZZZZZ','BROKER','BROKER',1,0,'C',1                                          
*/                             
...
SELECT  EFFDATE,EXCHANGE,SEGMENT,PARTY_CODE,SCRIP_CD,SERIES,ISIN,MRG_CL_RATE,AMOUNT=QTY*MRG_CL_RATE,
