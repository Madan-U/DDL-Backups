-- Object: PROCEDURE dbo.CALCULATE_STAMP_DUTY_02012018
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE    PROC [dbo].[CALCULATE_STAMP_DUTY_02012018]              
(                    
 @SETT_TYPE VARCHAR(2),              
...
BEGIN TRAN
	...
	SELECT STATE,TRDSTAMPDUTY,DELSTAMPDUTY,PROSTAMPDUTY,MIN_MULTIPLIER,FOR_TURNOVER,MAXIMUM_LIMIT,
           DEL_MIN_MULTIPLIER,DEL_FOR_TURNOVER,DEL_MAXIMUM_LIMIT 
    INTO #STATE_MASTER 
  ...
  WHERE L_STATE NOT IN (SELECT STATE FROM #STATE_MASTER )  
		...
		WHERE PARTY_CODE NOT IN (SELECT PARTY_CODE FROM #CLTAX)
		AND Brokernote = 0 
...
--STAMP DUTY FOR BOND-
		...
		AND SERIES IN ('N1','N2','N3','N4','N5','N6','N7','N8','N9','Y3','NA','ND')                  
		AND AUCTIONPART NOT IN ('AP', 'AR', 'FP', 'FL', 'FC', 'FP', 'FA', 'FS')          
		And C2.Party_Code Between @FromParty And @ToParty 
		AND NOT EXISTS (SELECT PARTY_CODE FROM #CLTAX              
		WHERE SETTLEMENT.PARTY_CODE = #CLTAX.PARTY_CODE) AND WDMSTAMPDUTY > -1  
		...
		TRD_TURNOVER = SUM(CASE WHEN BILLFLAG < 4 AND SERIES NOT IN ('N1','N2','N3','N4','N5','N6','N7','N8','N9','Y3','NA','ND') 
							    THEN TRADEQTY*MARKETRATE ELSE 0 END),            
		DEL_TURNOVER = SUM(CASE WHEN BILLFLAG > 3 AND SERIES NOT IN ('N1','N2','N3','N4','N5','N6','N7','N8','N9','Y3','NA','ND') 
							    THEN TRADEQTY*MARKETRATE ELSE 0 END),            
		WDM_TURNOVER = SUM(CASE WHEN SERIES IN ('N1','N2','N3','N4','N5','N6','N7','N8','N9','Y3','NA','ND') 
							    THEN TRADEQTY*MARKETRATE ELSE 0 END),
		ROUNDEDTURNOVER = SUM(TRADEQTY*MARKETRATE),              
		TRD_ROUNDEDTURNOVER = SUM(CASE WHEN BILLFLAG < 4 AND SERIES NOT IN ('N1','N2','N3','N4','N5','N6','N7','N8','N9','Y3','NA','ND')
									   THEN TRADEQTY*MARKETRATE ELSE 0 END),            
		DEL_ROUNDEDTURNOVER = SUM(CASE WHEN BILLFLAG > 3 AND SERIES NOT IN ('N1','N2','N3','N4','N5','N6','N7','N8','N9','Y3','NA','ND')
									   THEN TRADEQTY*MARKETRATE ELSE 0 END),
		WDM_ROUNDEDTURNOVER = SUM(CASE WHEN SERIES IN ('N1','N2','N3','N4','N5','N6','N7','N8','N9','Y3','NA','ND') 
							    THEN TRADEQTY*MARKETRATE ELSE 0 END)
		INTO #STAMP              
		...
		*/
		...
		SELECT SETT_NO, SETT_TYPE, S.PARTY_CODE, L_STATE,
		BROKER_NOTE = SUM(BROKER_CHRG),
		TRD_BROKER_NOTE = SUM(CASE WHEN BILLFLAG < 4 
							    THEN BROKER_CHRG ELSE 0 END),
		DEL_BROKER_NOTE = SUM(CASE WHEN BILLFLAG > 3 
							    THEN BROKER_CHRG ELSE 0 END),
		TOBECHRG_STAMPDUTY = SUM(BROKER_CHRG), 
		TURNOVER = SUM(TRADEQTY*MARKETRATE),              
		TRD_TURNOVER = SUM(CASE WHEN BILLFLAG < 4 
							    THEN TRADEQTY*MARKETRATE ELSE 0 END),            
		DEL_TURNOVER = SUM(CASE WHEN BILLFLAG > 3 
							    THEN TRADEQTY*MARKETRATE ELSE 0 END),            
		/*WDM_TURNOVER = SUM(CASE WHEN SERIES IN ('N1','N2','N3','N4','N5','N6','N7','N8','N9','Y3','NA','ND') 
							    THEN TRADEQTY*MARKETRATE*0 ELSE 0 END),*/
		ROUNDEDTURNOVER = SUM(TRADEQTY*MARKETRATE),              
		TRD_ROUNDEDTURNOVER = SUM(CASE WHEN BILLFLAG < 4 
									   THEN TRADEQTY*MARKETRATE ELSE 0 END),            
		DEL_ROUNDEDTURNOVER = SUM(CASE WHEN BILLFLAG > 3
									   THEN TRADEQTY*MARKETRATE ELSE 0 END)/*,
		WDM_ROUNDEDTURNOVER = SUM(CASE WHEN SERIES IN ('N1','N2','N3','N4','N5','N6','N7','N8','N9','Y3','NA','ND') 
							    THEN TRADEQTY*MARKETRATE*0 ELSE 0 END)*/
		INTO #STAMP              
