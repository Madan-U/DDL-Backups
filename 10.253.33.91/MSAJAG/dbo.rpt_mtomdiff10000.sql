-- Object: PROCEDURE dbo.rpt_mtomdiff10000
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



/****** Object:  Stored Procedure dbo.rpt_mtomdiff10000    Script Date: 04/27/2001 4:32:45 PM ******/

/****** Object:  Stored Procedure dbo.rpt_mtomdiff10000    Script Date: 3/21/01 12:50:20 PM ******/

/****** Object:  Stored Procedure dbo.rpt_mtomdiff10000    Script Date: 20-Mar-01 11:39:00 PM ******/

/****** Object:  Stored Procedure dbo.rpt_mtomdiff10000    Script Date: 2/5/01 12:06:21 PM ******/

/****** Object:  Stored Procedure dbo.rpt_mtomdiff10000    Script Date: 12/27/00 8:58:55 PM ******/

/* Report : mtom
  File : diff10000.asp
*/
CREATE PROCEDURE rpt_mtomdiff10000
@statusid varchar(15),
...
from trade4432 t,client1 c1,client2 c2 
where c1.cl_code=c2.cl_code and t.party_code = c2.party_code and t.series= 'BE' 
and t.party_code like ltrim(@code)+'%' and c2.exposure_lim <> 0 and c1.trader = @statusname
group by c1.short_name,t.party_code,c2.Cl_Code,t.scrip_cd ,t.series,t.sell_buy,c2.exposure_lim 
Union all 
select t.scrip_cd,t.series,qty =sum(t.TradeQty),amount = sum(t.marketrate * t.tradeqty),
t.sell_buy,c1.short_name,t.party_code,c2.exposure_lim,c2.Cl_Code 
