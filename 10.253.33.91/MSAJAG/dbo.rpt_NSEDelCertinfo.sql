...
/****** Object:  Stored Procedure dbo.rpt_NSEDelCertinfo    Script Date: 05/08/2002 12:35:16 PM ******/
...
/****** Object:  Stored Procedure dbo.rpt_NSEDelCertinfo    Script Date: 04/27/2001 4:32:47 PM ******/

/****** Object:  Stored Procedure dbo.rpt_NSEDelCertinfo    Script Date: 3/21/01 12:50:22 PM ******/

/****** Object:  Stored Procedure dbo.rpt_NSEDelCertinfo    Script Date: 20-Mar-01 11:39:01 PM ******/

/****** Object:  Stored Procedure dbo.rpt_NSEDelCertinfo    Script Date: 2/5/01 12:06:22 PM ******/

/****** Object:  Stored Procedure dbo.rpt_NSEDelCertinfo    Script Date: 12/27/00 8:58:57 PM ******/


/****** Object:  Stored Procedure dbo.rpt_NSEDelCertinfo    Script Date: 06/26/2001 8:49:10 PM ******/
...
begin
/* select C.Sett_no,C.Sett_Type,C.Party_Code,C.Scrip_cd,C.Series,TargetParty=D.Party_Code,D.Qty,C.TransDate,C.CertNo,C.HolderName,C.FolioNo, D.TrType, D.Reason, D.CltDpId,D.DpId from DelTrans D,DelTrans C where C.sett_no = @SettNo and C.sett_type = @Settype
...
from DelTrans where sett_no = @SettNo and sett_type = @Settype
