-- Object: PROCEDURE dbo.RPT_CLIENT_COLL_ALLOC_BKP_20220801
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROC [dbo].[RPT_CLIENT_COLL_ALLOC_BKP_20220801]
(
	@RUNDATE	VARCHAR(11),
	@FLAG		INT = 0
)
...
AND EXCHANGE NOT IN ('NSE','NSX')
 
INSERT INTO #DATA 
SELECT PARTY_CODE=CLIENTCODE, SEGMENT_INDICATOR='', CP_CODE='', ACCOUNT_TYPE=(CASE WHEN CLIENTCODE = '' THEN 'P' ELSE 'C' END), 
...
AND #ALLOC_SEG.PARTY_CODE = TBL_CLIENT_COLL_RECO.CLIENTCODE)
