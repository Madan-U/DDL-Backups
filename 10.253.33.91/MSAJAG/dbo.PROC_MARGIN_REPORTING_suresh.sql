-- Object: PROCEDURE dbo.PROC_MARGIN_REPORTING_suresh
...
--EXEC PROC_MARGIN_REPORTING_suresh 'JUL 20 2012','A43555','A43555'

--ROLLBACK
  
CREATE PROC [dbo].[PROC_MARGIN_REPORTING_suresh] (@SAUDA_DATE VARCHAR(11), @FROMPARTY VARCHAR(10), @TOPARTY VARCHAR(10))                  
AS                  
