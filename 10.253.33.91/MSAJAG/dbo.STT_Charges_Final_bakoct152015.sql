-- Object: PROCEDURE dbo.STT_Charges_Final_bakoct152015
...
AND EXISTS (SELECT PARTY_CODE FROM #SETT WHERE SAUDA_DATE BETWEEN FROMDATE AND TODATE AND #SETT.PARTY_CODE = C.PARTY_CODE)                  
