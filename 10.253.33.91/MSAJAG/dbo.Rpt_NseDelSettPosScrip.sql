-- Object: PROCEDURE dbo.Rpt_NseDelSettPosScrip
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


Create Proc Rpt_NseDelSettPosScrip 
...
from DeliveryClt D, Client2 C2, Client1 C1, Scrip1 S1, Scrip2 S2 Where sett_no = @SettNo and sett_type = @Sett_Type 
...
Order By S1.Short_Name,D.Party_Code,C1.Long_Name
End
if @statusid = 'branch'
begin
select D.Party_Code,C1.Long_Name,ScripName=S1.Short_Name,D.Scrip_Cd,D.Series,ToDelQty=(Case When Inout = 'O' then Qty Else 0 end ), ToRecQty=(Case When Inout = 'I' then Qty Else 0 end ) 
from DeliveryClt D, Client2 C2, Client1 C1, Scrip1 S1, Scrip2 S2,branches br  
...
begin
select D.Party_Code,C1.Long_Name,ScripName=S1.Short_Name,D.Scrip_Cd,D.Series,ToDelQty=(Case When Inout = 'O' then Qty Else 0 end ), ToRecQty=(Case When Inout = 'I' then Qty Else 0 end ) 
from DeliveryClt D, Client2 C2, Client1 C1, Scrip1 S1, Scrip2 S2, subbrokers sb  
Where sett_no = @SettNo and sett_type = @Sett_Type 
And D.Party_Code = C2.Party_Code and C1.Cl_Code = C2.Cl_Code And Qty > 0 
And S1.Co_Code = S2.Co_Code and S2.Scrip_Cd = D.Scrip_cd and S1.series = s2.series and D.series = s2.series
