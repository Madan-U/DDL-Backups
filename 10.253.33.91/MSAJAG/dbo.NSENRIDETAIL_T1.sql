-- Object: PROCEDURE dbo.NSENRIDETAIL_T1
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROC  [dbo].[NSENRIDETAIL_T1] (@SDATE AS VARCHAR(11),@SELL_BUY AS VARCHAR(1))                                  
AS               
...
AS TRANACTIONAMT ,cd.SCRIPNAME,cd.SCRIP_CD ,SETT_NO, (Cd.PRATE+cd.SRATE)TRATE  ,Service_Tax OtherCharges,INS_CHRG STT                       
