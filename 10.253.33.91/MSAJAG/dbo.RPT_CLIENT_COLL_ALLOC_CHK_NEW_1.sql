-- Object: PROCEDURE dbo.RPT_CLIENT_COLL_ALLOC_CHK_NEW_1
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE PROC [dbo].[RPT_CLIENT_COLL_ALLOC_CHK_NEW_1]
(
	@RUNDATE	VARCHAR(11),
	@FLAG		INT = 0,
...
C_ALLOCATECASH=CONVERT(NUMERIC(18,2),0),EXCHANGE,SEGMENT, ALLOCATION = 'P' 
...
C_ALLOCATECASH=CONVERT(NUMERIC(18,2),0),EXCHANGE,SEGMENT, ALLOCATION = 'P' 
FROM TBL_CLIENT_COLL_ALLOCATE (nolock) 
WHERE PROCESS_DT = @PREVDATE
AND ALLOCATECASH > 0
...
C_ALLOCATECASH=CONVERT(NUMERIC(18,2),0),EXCHANGE,SEGMENT, ALLOCATION = 'C' 
...
C_ALLOCATECASH=(CASE WHEN ALLOCATECASH > 0 THEN ALLOCATECASH ELSE 0 END),EXCHANGE,SEGMENT, ALLOCATION = 'C' 
