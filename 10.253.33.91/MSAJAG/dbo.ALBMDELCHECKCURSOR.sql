-- Object: PROCEDURE dbo.ALBMDELCHECKCURSOR
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.ALBMDELCHECKCURSOR    Script Date: 3/17/01 9:55:43 PM ******/

/****** Object:  Stored Procedure dbo.ALBMDELCHECKCURSOR    Script Date: 3/21/01 12:49:59 PM ******/

/****** Object:  Stored Procedure dbo.ALBMDELCHECKCURSOR    Script Date: 20-Mar-01 11:38:41 PM ******/

/****** Object:  Stored Procedure dbo.ALBMDELCHECKCURSOR    Script Date: 2/5/01 12:06:06 PM ******/

/****** Object:  Stored Procedure dbo.ALBMDELCHECKCURSOR    Script Date: 12/27/00 8:59:18 PM ******/

/* DROP PROC ALBMDELCHECKCURSOR  */
CREATE PROC ALBMDELCHECKCURSOR (@SETT_NO VARCHAR(7),@SETT_TYPE VARCHAR(2),@Memcode varchar(15),@Tmark varchar(1)) AS
...
BEGIN 
	...
	BEGIN
		...
		*/
			...
			AND BILLFLAG = 5 order by marketrate Desc  
			OPEN @@SETTCUR 
			FETCH NEXT FROM @@SETTCUR INTO @@TRADE_NO,@@LQTY
	...
	BEGIN
		...
		*/
			...
			AND BILLFLAG = 4 order by marketrate Desc  
			OPEN @@SETTCUR 
			FETCH NEXT FROM @@SETTCUR INTO @@TRADE_NO,@@LQTY
			WHILE @@FETCH_STATUS = 0 AND @@PDIFF > 0 
			BEGIN
