-- Object: PROCEDURE dbo.SettBrokReCalUp
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.SettBrokReCalUp    Script Date: 4/6/01 7:04:01 PM ******/
/****** Object:  Stored Procedure dbo.SettBrokReCalUp    Script Date: 3/30/01 2:45:02 PM ******/
...
CREATE procedure SettBrokReCalUp (@Sett_no Varchar(7),@Sett_Type Varchar(2),@Party_Code Varchar(10),@Scrip_Cd Varchar(12),@series Varchar(2),@MarketRate Numeric(18,9),@Flag Int) as
if @Flag = 1 
Begin
...
/*                             Then ((settlement.marketrate - round((broktable.sett_sales/100) * settlement.marketrate ,broktable.round_to))) */
   ...
   Else  0 
      ...
      FROM BrokTable,Client2,taxes,globals,scrip1,scrip2,Sett_mst,client1,BrokCursorSalePur C
      WHERE 
 ...
 AND
  ...
  and settlement.sauda_date like c.sauda_date + '%'
