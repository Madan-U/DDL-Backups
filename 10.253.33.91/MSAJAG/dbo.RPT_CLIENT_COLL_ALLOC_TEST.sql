-- Object: PROCEDURE dbo.RPT_CLIENT_COLL_ALLOC_TEST
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROC [DBO].[RPT_CLIENT_COLL_ALLOC_TEST]
(
	@RUNDATE	VARCHAR(11)
)
AS
...
-- EXEC RPT_CLIENT_COLL_ALLOC_TEST @RUNDATE = 'NOV 16 2021'

SET @SNO=0
SET @FILEREC = 1000

SELECT @MEMBERCODE = MEMBERCODE, @ORGMEM = MEMBERCODE FROM OWNER 

SELECT @PREVDATE = ISNULL(MAX(PROCESS_DT),'APR  1 2020') FROM TBL_CLIENT_COLL_ALLOCATE WHERE PROCESS_DT < @RUNDATE
