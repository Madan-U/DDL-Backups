-- Object: PROCEDURE dbo.POP_COMMON_CONTRACTDATA_NEWTDAY
...
/* ADDED BY VINAY ON OCT 27 2014 FOR ND TRADE */     
  ...
  SET @STRSQL = @STRSQL + ' WHERE S.ORDER_NO = #CONTRACT.ORDER_NO AND S.TRADE_NO = #CONTRACT.TRADE_NO '                                    
  SET @STRSQL = @STRSQL + ' AND S.PARTY_CODE = #CONTRACT.PARTY_CODE '
  SET @STRSQL = @STRSQL + ' AND S.SETT_NO = #CONTRACT.SETT_NO '                                    
