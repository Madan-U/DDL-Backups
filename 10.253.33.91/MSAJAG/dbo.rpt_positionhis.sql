-- Object: PROCEDURE dbo.rpt_positionhis
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



/****** Object:  Stored Procedure dbo.rpt_positionhis    Script Date: 04/27/2001 4:32:48 PM ******/

/****** Object:  Stored Procedure dbo.rpt_positionhis    Script Date: 3/21/01 12:50:22 PM ******/

/****** Object:  Stored Procedure dbo.rpt_positionhis    Script Date: 20-Mar-01 11:39:02 PM ******/

/****** Object:  Stored Procedure dbo.rpt_positionhis    Script Date: 2/5/01 12:06:22 PM ******/

/****** Object:  Stored Procedure dbo.rpt_positionhis    Script Date: 12/27/00 8:58:57 PM ******/

/* report : historyposition report 
   file : hispositionreport.asp */
/* displays clientwise,scripwise position of a party code for a particular settlement */
CREATE PROCEDURE rpt_positionhis
@statusid varchar(15),
...
and s.scrip_cd like  ltrim(@scripcd)+'%' and s.sett_no like  ltrim(@settno)+'%' and s.sett_type like  ltrim(@settype)+'%' 
