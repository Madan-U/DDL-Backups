-- Object: PROCEDURE dbo.POP_PNLDATA_010411_To_100411
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

      
CREATE PROC [dbo].[POP_PNLDATA_010411_To_100411]           
(          
 @FROMDATE VARCHAR(11),           
 @TODATE VARCHAR(11),          
...
BEGIN              
 EXEC PROC_PNLPROCESS_010411_To_100411 @SAUDA_DATE, @FROMPARTY, @TOPARTY          
 FETCH NEXT FROM @DATECUR INTO @SAUDA_DATE, @YY, @MM, @DD              
END              
CLOSE @DATECUR              
DEALLOCATE @DATECUR
