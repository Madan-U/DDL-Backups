-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_DETAIL_Archival
...
Create PROCEDURE [dbo].[V2_COMBINED_CONTRACTNOTE_DETAIL_Archival]                       
...
SELECT * INTO #COMMON_DATA FROM [172.31.16.30].MSAJAG.DBO.COMMON_CONTRACT_DATA C (NOLOCK)   
