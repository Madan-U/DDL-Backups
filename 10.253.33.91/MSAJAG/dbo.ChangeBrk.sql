-- Object: PROCEDURE dbo.ChangeBrk
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.ChangeBrk    Script Date: 3/17/01 9:55:48 PM ******/

/****** Object:  Stored Procedure dbo.ChangeBrk    Script Date: 3/21/01 12:50:04 PM ******/

/****** Object:  Stored Procedure dbo.ChangeBrk    Script Date: 20-Mar-01 11:38:47 PM ******/

/****** Object:  Stored Procedure dbo.ChangeBrk    Script Date: 2/5/01 12:06:10 PM ******/

/****** Object:  Stored Procedure dbo.ChangeBrk    Script Date: 12/27/00 8:58:47 PM ******/

CREATE Procedure ChangeBrk (@party varchar(10) , @s_date varchar(12)) as 
update settlement set  BrokApplied = (  case  
 ...
 when (Settlement.SettFlag = 2  and broktable.val_perc ="P" ) 
  ...
  (sett_mst.sett_type = 
   ...
   when Settlement.series = 'EQ'  and Settlement.markettype = '3'
   then 
   'L'
   ...
   when Settlement.series = 'EQ'  and Settlement.markettype = '4'
   then 
   'A'
   end)
       ) 
