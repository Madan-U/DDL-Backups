-- Object: PROCEDURE dbo.PROC_PNLPROCESS_010411_To_100411
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

                    
                    
CREATE PROC [dbo].[PROC_PNLPROCESS_010411_To_100411]                
(                                            
...
INSERT INTO TBL_PNL_DATA_TMP                                            
  ...
  ---FROM   BSEDB_AB_HISTORY010411TO180711.dbo.NSEHISTORY WITH(NOLOCK)     
    FROM   BSEDB_AB_HISTORY010411TO180711.dbo.NSEHISTORY_010411_To_10042011 WITH(NOLOCK)     
 /* select * into BSEDB_AB_HISTORY010411TO180711.dbo.NSEHISTORY_010411_To_10042011     
  From  MSAJAG.DBO.HISTORY     
  where Sauda_date between '2011-04-01 00:00:00.000' and '2011-04-11 23:59:59.000'    
  Create clustered index IX_Sauda_date on BSEDB_AB_HISTORY010411TO180711.dbo.NSEHISTORY_010411_To_10042011    
  (Sauda_date)    
*/    
...
INSERT INTO TBL_PNL_DATA_TMP                                      
  ...
  ORGDATE=LEFT(SAUDA_DATE,11),                                        
   0, 1, RECTYPE = (CASE WHEN SETTFLAG IN (2,3) THEN 'SPEC' ELSE 'OPEN' END)                                  
  FROM  BSEDB_AB_HISTORY010411TO180711.dbo.HISTORY_010411_To_100411  WITH(NOLOCK)      
  --FROM   BSEDB_AB_HISTORY010411TO180711.dbo.HISTORY WITH(NOLOCK)      
        
   /* select * into BSEDB_AB_HISTORY010411TO180711.dbo.HISTORY_010411_To_100411    
  From  [anand].BSEDB_AB.DBO.HISTORY     
  where Sauda_date between '2011-04-01 00:00:00.000' and '2011-04-10 23:59:59.000'  
  go  
  Create clustered index IX_Sauda_date on BSEDB_AB_HISTORY010411TO180711.dbo.HISTORY_010411_To_100411     
  (Sauda_date)    
  */    
...
AND LEFT(CD_SAUDA_DATE,11) = LEFT(SAUDA_DATE,11)              
  ...
  UPDATE TBL_PNL_DATA_TMP                                                      
  SET    ISIN = M.ISIN                                                   
  FROM   BSEDB_AB_HISTORY010411TO180711.DBO.CMBILLVALAN_NSE_DJ46 M                                                       
