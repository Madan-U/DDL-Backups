-- Object: PROCEDURE dbo.RPT_FTPARTYDETAILS
...
,Deactive_Remarks =ISNULL(CB.Deactive_Remarks,''),
--Deactive_Remarks1 =left(ISNULL(CB.Deactive_Remarks,''),CHARINDEX('(',ISNULL(CB.Deactive_Remarks,''))-1),
Deactive_value=case Deactive_value when 'R' THEN 'ReActive' WHEN 'C'THEN 'Closure'    
WHEN 'I'THEN 'In Active'WHEN 'D'THEN 'Dormant'WHEN 'O'THEN 'Other'WHEN 'L'THEN 'Legal Case'WHEN 'S'THEN 'SEBI Banned'WHEN 'E'THEN 'Contract Notes - RTO' ELSE '' END                            
 FROM                                  
