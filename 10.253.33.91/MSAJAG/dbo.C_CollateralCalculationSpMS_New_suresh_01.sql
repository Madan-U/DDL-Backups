-- Object: PROCEDURE dbo.C_CollateralCalculationSpMS_New_suresh_01
...
CREATE PROCEDURE [dbo].[C_CollateralCalculationSpMS_New_suresh_01]                                                                             
(                                                                            
    @EXCHANGE VARCHAR(3),                                                                             
    @SEGMENT VARCHAR(20),                                                                             
...
SET @APPRSEC = 1                                                                        
 ...
 /*=======================================================                                                                            
 EXEC C_CollateralCalculationSpMS_New_suresh_01                                                                             
         @EXCHANGE = 'MCX',                                                                             
         @SEGMENT = 'FUTURES',                                                                             
         @FROMPARTY = 'hka090',                                                                             
         @TOPARTY = 'hka090',                                                                             
 ...
 AND TRTYPE in (904, 905, 909, 1002)                                                                                
 AND DRCR = 'D'                                                                                 
 AND DELIVERED = '0'                                       
 AND FILLER2 = 1                                                                                
 AND SHARETYPE = 'DEMAT'                                 
...
AND #C_CALCULATESECVIEW.PARTY_CODE = ''                             
    ...
    END                                                
        ...
        UPDATE  #C_CALCULATESECVIEW SET SECHAIRCUT=15.00
 ...
 END */                                                                        
  ...
  select * from #C_CALCULATESECVIEW   where party_code='hka090' and  Isin='ine678h01010'                                                                    
  select *from #VAR where Isin='ine678h01010'     
