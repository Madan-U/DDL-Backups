-- Object: PROCEDURE dbo.BAK_POP_COMMON_CONTRACTDATA_12072016
...
CREATE PROCEDURE [dbo].[BAK_POP_COMMON_CONTRACTDATA_12072016] 
(
@FROMDATE VARCHAR(11),
@USERNAME VARCHAR(20) = '',
...
UPDATE #CONTRACT                                    
SET CONTRACT_HEADER_DET = EXCHANGE + ' - ' + SEGMENT + ' - ' + (CASE WHEN SEGMENT = 'CAPITAL' THEN SETTTYPE_DESC + ' (' + LTRIM(RTRIM(SETT_NO)) + ' - ' + LTRIM(RTRIM(SETT_TYPE)) + ' - ' + LTRIM(RTRIM(SETT_DATE)) + ' - REF. NO: ' + LTRIM(RTRIM(CONTRACTNO))+ ')' ELSE 'REF. NO: ' + LTRIM(RTRIM(CONTRACTNO)) END)                                    
