-- Object: PROCEDURE dbo.STP_ContractDetails_Group_BULK_16012014
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

      
CREATE    Proc [dbo].[STP_ContractDetails_Group_BULK_16012014]          
@FromDate Varchar(11),              
@ToDate Varchar(11),              
...
ins_chrg=isnull(sum(ins_chrg), 0),CPID              
