-- Object: PROCEDURE dbo.PROC_MARING_REPORT_NEW_BAK_CHANGE_27112018
...
CREATE PROC [dbo].[PROC_MARING_REPORT_NEW_BAK_CHANGE_27112018]                                            
(                                                      
...
ADD_MARGIN = 0 --SUM(BILLAMOUNT + NONCASH_COLL-MRG_REP_COLL_NCASH)                                                       
...
Begin
	...
	ADD_MARGIN = SUM(ISNULL(ADDMARGIN,0)+ISNULL(MTOMLOSS,0)+ISNULL(NONSPREADMARGIN,0))
	FROM ANGELFO.NSEFO.DBO.FOMARGINNEW M WITH (NOLOCK), #TPARTY C                                                      
	WHERE M.MDATE BETWEEN  @MARGINDATE AND @MARGINDATE  +' 23:59'                                                      
	AND M.PARTY_CODE = C.PARTY_CODE                                                      
	GROUP BY M.PARTY_CODE                                           
