-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_DETAIL_3008
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROCEDURE [dbo].[V2_COMBINED_CONTRACTNOTE_DETAIL_3008]                     
...
SELECT distinct party_code  INTO #PARTY1 FROM COMMON_CONTRACT_DATA_01092016 WHERE  EXCHANGE ='BSE' AND SAUDA_DATE ='2016-08-31'


SELECT * INTO #COMMON_DATA FROM COMMON_CONTRACT_DATA_01092016 C (NOLOCK) 
...
AND PARTY_CODE IN (SELECT * FROM #PARTY1)
