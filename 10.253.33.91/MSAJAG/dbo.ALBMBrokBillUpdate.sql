-- Object: PROCEDURE dbo.ALBMBrokBillUpdate
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.ALBMBrokBillUpdate    Script Date: 4/6/01 7:03:59 PM ******/
/****** Object:  Stored Procedure dbo.ALBMBrokBillUpdate    Script Date: 3/17/01 9:55:43 PM ******/
/****** Object:  Stored Procedure dbo.ALBMBrokBillUpdate    Script Date: 3/21/01 12:49:58 PM ******/
/****** Object:  Stored Procedure dbo.ALBMBrokBillUpdate    Script Date: 20-Mar-01 11:38:41 PM ******/
/****** Object:  Stored Procedure dbo.ALBMBrokBillUpdate    Script Date: 2/5/01 12:06:05 PM ******/
/****** Object:  Stored Procedure dbo.ALBMBrokBillUpdate    Script Date: 12/27/00 8:58:41 PM ******/
/*  CHANGED BY BBG    24 APR 2001  For Rounding   */

CREATE procedure ALBMBrokBillUpdate (@settno varchar(7), @sett_type varchar(2),@PARTY VARCHAR(10),@tscrip_cd varchar(12),@Series varchar(2)) as 
...
/*and settlement.trade_no = c.trade_no
and settlement.tradeqty = c.tradeqty*/
and settlement.tmark = c.tmark
/*and settlement.marketrate = c.marketrate*/
