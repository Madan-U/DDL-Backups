-- Object: PROCEDURE dbo.NSENRIDETAIL_03Dec2020
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

--select SETT_NO FROM  SETT_MST WHERE START_DATE LIKE 'jun 29 2020'+'%'  AND SETT_TYPE ='N'
--NSENRIDETAIL 'Jun 29 2020' ,1

CREATE PROC  [dbo].[NSENRIDETAIL_03Dec2020] (@SDATE AS VARCHAR(11),@SELL_BUY AS VARCHAR(1))                    
AS 
...
--AND VALID=1 AND SETT_NO='2020204' AND SELL_BUY = @SELL_BUY
