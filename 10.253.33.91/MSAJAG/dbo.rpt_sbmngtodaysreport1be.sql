-- Object: PROCEDURE dbo.rpt_sbmngtodaysreport1be
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



/****** Object:  Stored Procedure dbo.rpt_sbmngtodaysreport1be    Script Date: 04/27/2001 4:32:49 PM ******/

/****** Object:  Stored Procedure dbo.rpt_sbmngtodaysreport1be    Script Date: 3/21/01 12:50:23 PM ******/

/****** Object:  Stored Procedure dbo.rpt_sbmngtodaysreport1be    Script Date: 20-Mar-01 11:39:02 PM ******/
...
if albm trades of settlement type w are not required to be shown then use this query otherwise
rpt_sbmngtodaysreport1
 **/
/* changed by mousami on 6th march 2001
    added family login
*/
CREATE PROCEDURE rpt_sbmngtodaysreport1be
@statusid varchar(15),
