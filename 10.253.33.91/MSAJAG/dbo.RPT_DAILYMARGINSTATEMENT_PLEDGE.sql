-- Object: PROCEDURE dbo.RPT_DAILYMARGINSTATEMENT_PLEDGE
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

create PROC [DBO].[RPT_DAILYMARGINSTATEMENT_PLEDGE]                                        
(                                        
@MDATE VARCHAR(11),                                        
...
SELECT                                        
	...
	PLD_DETAILS = CONVERT(NUMERIC(18,4),0) 
INTO                           
#FINAL_REPORT                                        
FROM                                 
...
SELECT * INTO #COLL_DETAIL_PLDG FROM CLIENTWISEDATEWISE_PLEDGEDETAILS C
...
PLD_DETAILS = CONVERT(NUMERIC(18,4),0)
--  INTO COLL_DETAIL_PLDG_23
FROM  #COLL_DETAIL_PLDG
...
PLEDGE_QTY=SUM(PLEDGE_QTY),
BORROWING=SUM(BORROWING),PLD_DETAILS=0                                       
