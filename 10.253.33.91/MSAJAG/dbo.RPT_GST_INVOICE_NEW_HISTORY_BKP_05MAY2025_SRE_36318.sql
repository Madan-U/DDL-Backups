-- Object: PROCEDURE dbo.RPT_GST_INVOICE_NEW_HISTORY_BKP_05MAY2025_SRE_36318
...
CREATE   PROC [dbo].[RPT_GST_INVOICE_NEW_HISTORY_BKP_02may2025_2018 GST]      
(      
...
*/      
 ...
 SELECT Cl_COde into #cl  FROM MSAJAG.DBO.CLIENT_DETAILS C (NOLOCK)    
 --WHERE C.GST_NO <> ''   
