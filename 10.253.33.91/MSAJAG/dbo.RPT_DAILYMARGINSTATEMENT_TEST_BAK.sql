-- Object: PROCEDURE dbo.RPT_DAILYMARGINSTATEMENT_TEST_BAK
...
CREATE PROC [dbo].[RPT_DAILYMARGINSTATEMENT_TEST_BAK]                                          
(                                          
@MDATE VARCHAR(11),                                          
...
SELECT  EFFDATE,(CASE WHEN EXCHANGE ='POA' THEN 'DP' ELSE EXCHANGE END) ,(CASE WHEN SEGMENT ='POA' THEN 'HOLDING' ELSE SEGMENT END),
