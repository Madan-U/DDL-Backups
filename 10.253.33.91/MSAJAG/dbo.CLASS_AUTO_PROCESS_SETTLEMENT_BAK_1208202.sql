-- Object: PROCEDURE dbo.CLASS_AUTO_PROCESS_SETTLEMENT_BAK_1208202
...
----EXEC CLASS_AUTO_PROCESS_SETTLEMENT 'AUG 12 2021'            
...
UPDATE TBL_AUTO_PROCESS_DETAIL SET PROCESS_STATUS = 98, INTERNAL_PROCESS_ID = 1005 WHERE PROCESS_DATE='FEB 14 2018'
AND PROCESS_FOR='COMMON CONT CASHFNO PROCESS' AND PROCESS_STATUS = 0 
...
AND D.IS_DEPEND_ON = ''            
AND IS_FILE_BASED <> ''   
AND D.PROCESS_FOR ='SCB BANK UPLOAD' 
 ...
 BEGIN            
  ...
  EXEC (@CMD)            
	...
	---------for * ------
	  IF @FILE_DWLOAD_NAME LIKE '%*%'   	          
	  BEGIN
	      EXEC CLASS_AUTO_PROCESS_FILE @PROCESS_FILE_NAME_NEW, @PROCESS_DATE, @FLD_FILEDATE OUTPUT, @FLD_FILENAME OUTPUT       
	  END                  
	  ELSE
	  BEGIN
