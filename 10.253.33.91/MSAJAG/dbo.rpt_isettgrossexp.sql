-- Object: PROCEDURE dbo.rpt_isettgrossexp
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



/****** Object:  Stored Procedure dbo.rpt_isettgrossexp    Script Date: 04/27/2001 4:32:43 PM ******/

/****** Object:  Stored Procedure dbo.rpt_isettgrossexp    Script Date: 3/21/01 12:50:19 PM ******/

/****** Object:  Stored Procedure dbo.rpt_isettgrossexp    Script Date: 20-Mar-01 11:38:59 PM ******/

/****** Object:  Stored Procedure dbo.rpt_isettgrossexp    Script Date: 2/5/01 12:06:20 PM ******/

/****** Object:  Stored Procedure dbo.rpt_isettgrossexp    Script Date: 12/27/00 8:59:12 PM ******/
...
CREATE PROCEDURE rpt_isettgrossexp
@statusid varchar(15),
...
t4.sell_buy from isettlement t4,client1 c1,client2 c2 
...
Union all
select c1.short_name,party=rtrim(t4.party_code),t4.scrip_cd,t4.series,qty=sum(t4.tradeqty),Amount=sum(t4.tradeqty*t4.marketrate),
t4.sell_buy from isettlement t4,client1 c1,client2 c2, branches b 
where c2.party_code = t4.party_code and c1.cl_code = c2.cl_code 
and c1.short_name like ltrim(@partyname)+'%' and t4.scrip_cd like ltrim(@scripcd)+'%' 
and t4.party_code like ltrim(@partycode)+'%' 
and t4.sett_no = @settno and t4.sett_type =@settype
...
Union all
select c1.short_name,party=rtrim(t4.party_code),t4.scrip_cd,t4.series,qty=sum(t4.tradeqty),Amount=sum(t4.tradeqty*t4.marketrate),
t4.sell_buy from isettlement t4,client1 c1,client2 c2 , subbrokers sb
where c2.party_code = t4.party_code and c1.cl_code = c2.cl_code 
and c1.short_name like ltrim(@partyname)+'%' and t4.scrip_cd like ltrim(@scripcd)+'%' 
and t4.party_code like ltrim(@partycode)+'%' 
and t4.sett_no = @settno and t4.sett_type =@settype
