-- Object: PROCEDURE dbo.usp_nxt_getOrderBasedBrokerageReport_V3_paginated
...
CREATE PROCEDURE usp_nxt_getOrderBasedBrokerageReport_V3_paginated   
 --declare    
...
case when SCHEME_NAME like '%prime%' then 'iTrade Prime Plan'   
	...
	when SCHEME_NAME like '%ITrade Premier%' then 'ITrade Premier'      
else 'iTrade Plan' end  end ) as SCHEME_NAME,     
sub_broker      
