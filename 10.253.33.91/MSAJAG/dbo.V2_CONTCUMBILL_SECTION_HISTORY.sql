...
CREATE PROC [DBO].[V2_CONTCUMBILL_SECTION_HISTORY]          
...
IF (SELECT ISNULL(COUNT(1),0) FROM (SELECT TOP 1 PARTY_CODE 

FROM HISTORY WHERE SETT_NO = @SETT_NO AND SETT_TYPE = @SETT_TYPE) A) > 0           
