-- Object: PROCEDURE dbo.Usp_DpFileforBackoffice_28092022
...
Create Proc [dbo].[Usp_DpFileforBackoffice_28092022]          
...
from #TBl_DP_Final_Data a inner join [196.1.115.182].general.dbo.tbl_ISIN_100per_Haricut b      
on a.hld_isin_code=b.ISIN      
      
      
update #TBl_DP_Final_Data      
set AppVar =100      
where hld_isin_code in  (select [ISIN No] from  [196.1.115.182].general.dbo.TBL_NRMS_RESTRICTED_SCRIPS where [Angel scrip category]='Poor') 

update a      
set a.AppVar =b.VARMARGIN      
from #TBl_DP_Final_Data_Var_Right a inner join [196.1.115.182].general.dbo.tbl_ISIN_100per_Haricut b      
on a.deli_ISIN=b.ISIN      
      
      
update #TBl_DP_Final_Data_Var_Right      
set AppVar =100      
where deli_ISIN in  (select [ISIN No] from  [196.1.115.182].general.dbo.TBL_NRMS_RESTRICTED_SCRIPS where [Angel scrip category]='Poor')          
