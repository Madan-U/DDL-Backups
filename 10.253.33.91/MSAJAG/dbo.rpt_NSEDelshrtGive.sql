-- Object: PROCEDURE dbo.rpt_NSEDelshrtGive
...
/****** Object:  Stored Procedure dbo.rpt_NSEDelshrtGive    Script Date: 05/08/2002 12:35:16 PM ******/
...
CREATE PROCEDURE rpt_NSEDelshrtGive
@dematid varchar(2),
@settno varchar(7),
@settype varchar(3)
AS
...
begin
 ...
 GivenNse= isnull(( select Sum(qty)from DelTrans where sett_no = d.sett_no and sett_type = d.sett_type and 
...
having Sum(d.Deliver_Qty) <> isnull(( select Sum(qty)from DelTrans where sett_no = d.sett_no and sett_type = d.sett_type and 
