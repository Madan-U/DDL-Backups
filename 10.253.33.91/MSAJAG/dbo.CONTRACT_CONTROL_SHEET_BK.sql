-- Object: PROCEDURE dbo.CONTRACT_CONTROL_SHEET_BK
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROC [dbo].[CONTRACT_CONTROL_SHEET_BK]                        
(                          
  @FROMDATE VARCHAR(11),                          
  @TODATE VARCHAR(11),                          
...
SELECT DISTINCT CL_CODE into #CL            
 FROM CLIENT_BROK_DETAILS (NOLOCK) WHERE PRINT_OPTIONS = 0 --AND EXCHANGE NOT IN ('MCX','NCX')     
 AND CL_CODE IN            
