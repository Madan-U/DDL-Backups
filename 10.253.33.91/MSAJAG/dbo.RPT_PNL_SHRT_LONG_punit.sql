-- Object: PROCEDURE dbo.RPT_PNL_SHRT_LONG_punit
...
CREATE PROC [dbo].[RPT_PNL_SHRT_LONG_punit]                                                                        
(                                                                          
 @STATUSID VARCHAR(25),                                                                          
...
REGION  = CONVERT(VARCHAR(20),'')                                        
 ...
 CREATE CLUSTERED INDEX  [INX_PNL_DATA]                                               
  ...
  SELECT A.*,B.Dealer1 INTO #TBL_PNL_DATA_N             
  FROM TBL_PNL_DATA A WITH(NOLOCK),INTRANET.[Mimansa].[dbo].[B2B_Bulk_DealerMapping] B  WITH(NOLOCK)           
...
INTO #CLIENT_DETAILS                                        
FROM                                              
 CLIENT_DETAILS C (NOLOCK) ,INTRANET.[Mimansa].[dbo].[B2B_Bulk_DealerMapping] D (NOLOCK)                                         
...
AND @STATUSNAME = (CASE                                                                                       
   ...
   WHEN @STATUSID = 'DEALER' THEN D.Dealer1                                                                                      
