...
/****** Object:  Stored Procedure dbo.rpt_detailperiodledger    Script Date: 01/19/2002 12:15:14 ******/  
  
/****** Object:  Stored Procedure dbo.rpt_detailperiodledger    Script Date: 01/04/1980 5:06:26 AM ******/  
...
begin  
 select  left(convert(varchar,VDT,103),11), l.vtyp,vno,lno,drcr,  
  ...
  nar=isnull((select top 1 l3.narr from account.dbo.ledger3 l3  where L.VTYP = L3.VTYP AND L.VNO = L3.VNO and l.booktype = l3.booktype AND l3.naratno=1) ,''),  
