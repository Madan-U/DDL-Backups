-- Object: PROCEDURE dbo.Usp_DpFileforBackoffice_04072022
...
Create Proc [dbo].[Usp_DpFileforBackoffice_04072022]        
...
(ceiling (AppVar))/100 as AppVar,(isnull (Qty,0)+isnull (deli_Qty,0)) as Limit_Qty,(case when cl_rate IS null then Rate else CL_RATE end) as Rate ,GETDATE()              
