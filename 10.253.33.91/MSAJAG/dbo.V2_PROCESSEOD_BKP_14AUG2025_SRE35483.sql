-- Object: PROCEDURE dbo.V2_PROCESSEOD_BKP_14AUG2025_SRE35483
...
--EXEC V2_PROCESSEOD '', 'SURESH', 'OCT 12 2020'
 ...
 CREATE PROC [dbo].[V2_PROCESSEOD_BKP_14AUG2025_SRE35483](      
...
AS      
  ...
  SELECT @NEWPROCESSDATE = isnull(LEFT(MIN(START_DATE),11),'JAN  1 2000') FROM SETT_MST      
    WHERE START_DATE > @PROCESSDATE + ' 23:59:59' AND SETT_TYPE IN ('M','Z','A', 'X','H','T','BX','DX','TX')   
 ...
 AND S.SETT_TYPE IN ('M','Z', 'A', 'X','H','T','BX','DX','AF','F','TX')  
