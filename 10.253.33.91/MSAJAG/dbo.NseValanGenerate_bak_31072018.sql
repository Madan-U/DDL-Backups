-- Object: PROCEDURE dbo.NseValanGenerate_bak_31072018
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE PROC [dbo].[NseValanGenerate_bak_31072018] (@SETT_NO VARCHAR(7),@SETT_TYPE VARCHAR(2),@FLAGFORINCLUSIVEBROKERAGE INT) 
with recompile
AS              
DECLARE               
