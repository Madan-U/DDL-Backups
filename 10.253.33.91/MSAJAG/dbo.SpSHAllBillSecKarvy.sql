-- Object: PROCEDURE dbo.SpSHAllBillSecKarvy
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE Proc SpSHAllBillSecKarvy (@Sett_No varchar(10),@Sett_Type Varchar(2), @Party_code varchar(10)) as
