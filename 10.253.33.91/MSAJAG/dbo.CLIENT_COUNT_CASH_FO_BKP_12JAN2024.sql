-- Object: PROCEDURE dbo.CLIENT_COUNT_CASH_FO_BKP_12JAN2024
...
CREATE PROCEDURE [dbo].[CLIENT_COUNT_CASH_FO_BKP_12JAN2024]
(    
@DATE VARCHAR(20)    
)    
AS    
...
select Distinct party_code into #party from cash_cn where sdate >=@DATE and sdate <=@DATE +' 23:59:00'  
