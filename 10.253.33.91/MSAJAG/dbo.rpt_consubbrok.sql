-- Object: PROCEDURE dbo.rpt_consubbrok
...
/****** Object:  Stored Procedure dbo.rpt_consubbrok    Script Date: 04/21/2001 6:05:20 PM ******/

/****** Object:  Stored Procedure dbo.rpt_consubbrok    Script Date: 3/21/01 12:50:14 PM ******/

/****** Object:  Stored Procedure dbo.rpt_consubbrok    Script Date: 20-Mar-01 11:38:55 PM ******/
...
*/
CREATE procedure rpt_consubbrok  
@saudadate varchar(11)
as
If (select count(*) from trade where convert(varchar,sauda_date,103) =@saudadate)>0 
begin
	select  sb.sub_broker ,sell_buy ,qty=sum(tradeqty), amount= sum(marketrate*tradeqty)
	...
	group by sb.sub_broker ,sell_buy
	order by sb.sub_broker,sell_buy
end
else
