-- Object: PROCEDURE dbo.SettBrokReCal
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.SettBrokReCal    Script Date: 3/17/01 9:56:10 PM ******/

/****** Object:  Stored Procedure dbo.SettBrokReCal    Script Date: 3/21/01 12:50:30 PM ******/

/****** Object:  Stored Procedure dbo.SettBrokReCal    Script Date: 20-Mar-01 11:39:08 PM ******/

/****** Object:  Stored Procedure dbo.SettBrokReCal    Script Date: 2/7/2001 12:40:11 PM ******/
CREATE Proc SettBrokReCal (@Sett_no Varchar(7),@Sett_Type Varchar(2),@Party_Code Varchar(10),@Scrip_Cd Varchar(12),@series Varchar(2),@MarketRate Numeric(18,9),@Flag Int)
as 
If @Flag = 1 
Begin
...
Order By S.Party_Code,S.Scrip_Cd,S.Series,S.sell_buy,S.Trade_No
End
else
Begin
Select  S.Trade_No,S.Party_Code,S.Scrip_Cd,S.Series,Brok=S.brokapplied,NewBork=Convert(Numeric(9,4), C.Brokapplied),S.TradeQty,S.MarketRate,s.Sell_buy,s.BillNo From Settlement S, SettConfirmView C
