-- Object: PROCEDURE dbo.rpt_congexsbcltt4ts
...
/****** Object:  Stored Procedure dbo.rpt_congexsbcltt4ts    Script Date: 04/21/2001 6:05:19 PM ******/
...
*/
CREATE procedure  rpt_congexsbcltt4ts
@settno varchar(7),
@settype varchar(3),
