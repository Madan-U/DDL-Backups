-- Object: PROCEDURE dbo.updbilltax
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE  proc updbilltax  (@Sett_no As Varchar(10),@Sett_type As Varchar(3)) as
...
/*          Ins_chrg  = round(((taxes.insurance_chrg * settlement.marketrate * settlement.Tradeqty)/100),broktable.round_to), 
  ...
  and Taxes.Trans_cat  = (Case When Cl_Type = 'PRO' Then 'PRO' Else 'DEL' End )
           And
             (taxes.exchange = 'NSE')
/*           And
             (taxes.Sett_type = 'N')    
