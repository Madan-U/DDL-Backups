-- Object: PROCEDURE dbo.rpt_positionsettscrip1report
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



/****** Object:  Stored Procedure dbo.rpt_positionsettscrip1report    Script Date: 04/27/2001 4:32:48 PM ******/
CREATE PROCEDURE rpt_positionsettscrip1report
@settno varchar(7),
@settype varchar(3),
@partycode varchar(6),
@scripcd varchar(12),
