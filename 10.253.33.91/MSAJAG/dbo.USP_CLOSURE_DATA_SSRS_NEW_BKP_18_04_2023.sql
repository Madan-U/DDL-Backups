-- Object: PROCEDURE dbo.USP_CLOSURE_DATA_SSRS_NEW_BKP_18_04_2023
...
CREATE PROC USP_CLOSURE_DATA_SSRS_NEW_BKP_18_04_2023 
AS  
...
DECLARE @NSEQUERY VARCHAR(MAX) SET @NSEQUERY = ' bcp " select TOP 10 * '         
...
') +'.xlsx -c -t"," -SABMUMBODBN03 -Usa -Psuropt09'
