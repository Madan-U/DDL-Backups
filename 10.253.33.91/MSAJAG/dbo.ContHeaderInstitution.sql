-- Object: PROCEDURE dbo.ContHeaderInstitution
...
/****** Object:  Stored Procedure dbo.ContHeaderInsP    Script Date: 09/07/2001 11:08:52 PM ******/

/****** Object:  Stored Procedure dbo.ContHeaderInsP    Script Date: 7/1/01 2:26:22 PM ******/

/****** Object:  Stored Procedure dbo.ContHeaderInsP    Script Date: 06/26/2001 8:47:49 PM ******/
...
CREATE proc ContHeaderInstitution (@Sdate varchar(12), @Sett_Type varchar(2), @ContNo varchar(6),@flag smallint,@Party_code varchar(10)) as
if @flag = 1
begin
 ...
 client1.pan_gir_no   /* added by sandeep on 28 Nov 2001 */
