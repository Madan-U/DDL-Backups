-- Object: PROCEDURE dbo.PROC_ALL_PDAY_EPN_CALCULATION
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROCEDURE PROC_ALL_PDAY_EPN_CALCULATION (@MARGINDATE VARCHAR(11))

AS ---- EXEC PROC_ALL_PDAY_EPN_CALCULATION 'SEP 19 2022'
...
SELECT @VARKEY = DETAILKEY FROM VARCONTROL WHERE RECDATE >= @EPNDATE AND RECDATE <= @EPNDATE + ' 23:59'
...
SELECT  PARTY_CODE, EPI_CCE = SUM(EPIACCOUNT) , POOLACCOUNT=SUM(POOLACCOUNT)
FROM
(
SELECT 
