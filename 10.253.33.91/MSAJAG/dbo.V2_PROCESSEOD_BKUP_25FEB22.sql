-- Object: PROCEDURE dbo.V2_PROCESSEOD_BKUP_25FEB22
...
--EXEC V2_PROCESSEOD '', 'SURESH', 'OCT 12 2020'
 ...
 CREATE PROC [dbo].[V2_PROCESSEOD_BKUP_25FEB22](      
...
AS      
  ...
  WHERE START_DATE > @PROCESSDATE + ' 23:59:59' AND SETT_TYPE IN ('N', 'W','M','Z','A', 'X','H','T','BX','DX','TX')   
 ...
 AND S.SETT_TYPE IN ('N', 'W','M','Z', 'A', 'X','H','T','BX','DX','AF','F','TX')  
