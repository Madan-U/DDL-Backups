-- Object: PROCEDURE dbo.Rpt_GrpExpNew
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.Rpt_GrpExpNew    Script Date: 05/20/2002 5:24:32 PM ******/
CREATE proc Rpt_GrpExpNew
...
begin
	...
	and Family >= @fcode  and Family <= @tcode and C1.Cl_Code = C2.Cl_Code and C2.Party_Code = S.Party_Code
	union all
	select sett_no,sett_type,s.party_code,c1.short_name,family,scrip_cd,series,sell_buy,Pqty,Pamt,Sqty,samt,Branch_Cd,Sub_Broker
...
begin
	...
	and Family >= @fcode  and Family <= @tcode
