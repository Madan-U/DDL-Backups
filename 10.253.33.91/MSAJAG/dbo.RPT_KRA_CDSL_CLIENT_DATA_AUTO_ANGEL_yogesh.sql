-- Object: PROCEDURE dbo.RPT_KRA_CDSL_CLIENT_DATA_AUTO_ANGEL_yogesh
...
CREATE PROC [dbo].[RPT_KRA_CDSL_CLIENT_DATA_AUTO_ANGEL_yogesh] (  
 @OPT_TYPE VARCHAR(2),  
 @CL_TYPE VARCHAR(1)  
 )  
AS  
  
---EXEC RPT_KRA_CDSL_CLIENT_DATA_AUTO_ANGEL_yogesh 'A','N'  
...
FROM CLIENT_STATIC_CODES  
WHERE APP_COR_STATE = DESCRIPTION  
 AND KRA_TYPE = 'CDSL'  
 AND CATEGORY = 'STATE'  
...
FROM CLIENT_STATIC_CODES  
WHERE APP_PER_STATE = DESCRIPTION  
 AND KRA_TYPE = 'CDSL'  
 AND CATEGORY = 'STATE'  
...
BEGIN  
 ...
 SET @FILE_UPLOAD_MAP_DRIVE = 'X:'  
 SET @FILE_UPLOAD_LOCATION = '\\196.1.115.133:21\KRATeam'  
 ...
 SET @CMD = 'EXEC XP_CMDSHELL ''FTP USE ' + @FILE_UPLOAD_MAP_DRIVE + ' ' + @FILE_UPLOAD_LOCATION + ' /USER:' + @FILE_UPLOAD_USERID + ' ' + @FILE_UPLOAD_PWD + ' /persistent:Y'' ' --- , NO_OUTPUT'  
 EXEC (@CMD)  
  
 SET @CMD = 'EXEC XP_CMDSHELL ''COPY ' + @FILEPATH + @FILENAME + ' ' + @FILE_UPLOAD_MAP_DRIVE + '\' + @FILE_UPLOAD_NAME + ''' ' -- , NO_OUTPUT'  
 EXEC (@CMD)  
  
 SET @CMD = 'EXEC XP_CMDSHELL ''FTP USE ' + @FILE_UPLOAD_MAP_DRIVE + ' /delete'', NO_OUTPUT'  
 EXEC (@CMD)  
