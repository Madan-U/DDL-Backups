-- Object: PROCEDURE dbo.NseValanGenerate_bkp07Aug2017
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROC [dbo].[NseValanGenerate_bkp07Aug2017] (@SETT_NO VARCHAR(7),@SETT_TYPE VARCHAR(2),@FLAGFORINCLUSIVEBROKERAGE INT) AS              
DECLARE               
