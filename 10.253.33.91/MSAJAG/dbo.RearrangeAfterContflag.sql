-- Object: PROCEDURE dbo.RearrangeAfterContflag
...
/****** Object:  Stored Procedure dbo.RearrangeAfterContflag    Script Date: 12/16/2003 2:31:22 PM ******/



/****** Object:  Stored Procedure dbo.RearrangeAfterContflag    Script Date: 05/08/2002 12:35:05 PM ******/

/****** Object:  Stored Procedure dbo.RearrangeAfterContflag    Script Date: 01/14/2002 20:32:46 ******/

/****** Object:  Stored Procedure dbo.RearrangeAfterContflag    Script Date: 12/26/2001 1:23:12 PM ******/



/****** Object:  Stored Procedure dbo.RearrangeAfterContflag    Script Date: 5/4/01 5:14:52 PM ******/

/****** Object:  Stored Procedure dbo.RearrangeAfterContflag    Script Date: 4/5/01 6:40:56 PM ******/

/****** Object:  Stored Procedure dbo.RearrangeAfterContflag    Script Date: 3/21/01 12:50:11 PM ******/

/****** Object:  Stored Procedure dbo.RearrangeAfterContflag    Script Date: 20-Mar-01 11:38:52 PM ******/

/****** Object:  Stored Procedure dbo.RearrangeAfterContflag    Script Date: 2/5/01 12:06:15 PM ******/

/****** Object:  Stored Procedure dbo.RearrangeAfterContflag    Script Date: 12/27/00 8:59:17 PM ******/

CREATE  PROCEDURE RearrangeAfterContflag (@Sett_Type varchar(2),@Party Varchar(10),@Scrip varchar(12),@Series varchar(2),@TDate Varchar(10),@Memcode varchar(15),@Tmark varchar(1)) AS 
declare 
 @@trade_no varchar(14),
 @@Pqty numeric(9), 
 @@Sqty numeric(9),
 ...
 @@loop cursor
	...
	Update Settlement set settflag = (case when s.sell_buy = 1 then 2
						else 3 end )
	 from Settlement s,CursorContSale b 
	...
	Update Settlement set settflag = 4 from Settlement s,CursorContSale b 
	where b.sett_type = s.sett_type 
	and b.party_code = s.party_code	
 	and b.scrip_cd = s.scrip_Cd           
	and b.series = s.series          
	...
	Update Settlement set settflag = 5 from Settlement s,CursorContSale b 
	where b.sett_type = s.sett_type 
	and b.party_code = s.party_code	
 	and b.scrip_cd = s.scrip_Cd           
	and b.series = s.series          
...
set @@Flag = cursor for
	 select pqty,sqty from CursorContUnEqualSalePur
...
exec SettBrokUpdate @Party,@TDate ,@scrip,@Series
