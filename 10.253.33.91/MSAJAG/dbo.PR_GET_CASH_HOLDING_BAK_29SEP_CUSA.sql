-- Object: PROCEDURE dbo.PR_GET_CASH_HOLDING_BAK_29SEP_CUSA
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROC [dbo].[PR_GET_CASH_HOLDING_BAK_29SEP_CUSA]      
(    
@EFFDATE Varchar(11),    
@INTMODE INT = 0      
) AS      
...
DELETE FROM DELHOLD_COLL WHERE TRANSDATE = @EFFDATE    
    
INSERT INTO DELHOLD_COLL     
SELECT     
