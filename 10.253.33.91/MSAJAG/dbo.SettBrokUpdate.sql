-- Object: PROCEDURE dbo.SettBrokUpdate
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.SettBrokUpdate    Script Date: 4/6/01 7:04:01 PM ******/
/****** Object:  Stored Procedure dbo.SettBrokUpdate    Script Date: 3/30/01 2:45:02 PM ******/
...
CREATE procedure SettBrokUpdate (@tparty varchar(10), @tdate varchar(10),@tscrip_cd varchar(12),@Series varchar(2)) as 
...
/*                             Then ((s.marketrate - round((broktable.sett_sales/100) * s.marketrate ,broktable.round_to))) */
   ...
   Else  0 
      ...
      FROM BrokTable,Client2,settlement s,taxes,globals,scrip1,scrip2,Sett_mst,client1, BrokCursorSalePur C
      WHERE 
