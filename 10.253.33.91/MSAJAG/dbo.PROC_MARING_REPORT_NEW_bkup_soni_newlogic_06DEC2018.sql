-- Object: PROCEDURE dbo.PROC_MARING_REPORT_NEW_bkup_soni_newlogic_06DEC2018
...
CREATE PROC [dbo].[PROC_MARING_REPORT_NEW_bkup_soni_newlogic_06DEC2018]                                            
(                                                      
...
FROM                                            
 ...
 FROM                                            
  TBL_MG02 (NOLOCK)                                            
 WHERE                                             
  MARGIN_DATE BETWEEN @MARGINDATE AND @MARGINDATE + ' 23:59:59'                                            
 ...
 SELECT                                             
  DISTINCT PARTY_CODE                                            
 FROM                                            
 ANAND.BSEDB_AB.DBO.TBL_MG02 WITH (NOLOCK)                                            
 WHERE                                             
  MARGIN_DATE BETWEEN @MARGINDATE AND @MARGINDATE + ' 23:59:59'                                            
 ...
 SELECT                                             
  DISTINCT PARTY_CODE                                            
 FROM                                            
  ANGELFO.NSEFO.DBO.FOMARGINNEW WITH (NOLOCK)                                            
 WHERE                                             
  MDATE BETWEEN @MARGINDATE AND @MARGINDATE + ' 23:59:59'                                            
  --AND TRADETYPE = 'BT'                                            
 UNION                                            
 SELECT                                             
  DISTINCT PARTY_CODE                                            
 FROM                                            
  ANGELFO.NSECURFO.DBO.FOMARGINNEW WITH (NOLOCK)                                            
 WHERE                                             
  MDATE BETWEEN @MARGINDATE AND @MARGINDATE + ' 23:59:59'                                            
 -- AND TRADETYPE = 'BT'                             
   UNION                                        
 SELECT                                             
  DISTINCT PARTY_CODE                                            
 FROM                                            
  ANGELCOMMODITY.MCDXCDS.DBO.FOMARGINNEW WITH (NOLOCK)                                            
 WHERE                             
  MDATE BETWEEN @MARGINDATE AND @MARGINDATE + ' 23:59:59'                                            
  --AND TRADETYPE = 'BT'                                      
 ) A                                            
