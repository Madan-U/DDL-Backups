-- Object: PROCEDURE dbo.Usp_DpFileforBackoffice_22082022
...
Create Proc [dbo].[Usp_DpFileforBackoffice_22082022]          
...
select tradingid,hld_isin_code,sum (netqty) as netqty,PLEDGE_QTY,Rate,sum(FREE_QTY) as FREE_QTY,FREEZE_QTY,LOCKIN_QTY,cl_rate  
into #Dp_FreeHolding  
from #Dp_FreeHolding_New    
group by tradingid,hld_isin_code,PLEDGE_QTY,Rate,FREEZE_QTY,LOCKIN_QTY,cl_rate  
