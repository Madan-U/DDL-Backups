-- Object: PROCEDURE dbo.HistBrokDelUpdate
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.HistBrokDelUpdate    Script Date: 4/6/01 7:04:00 PM ******/
/****** Object:  Stored Procedure dbo.HistBrokDelUpdate    Script Date: 3/30/01 2:45:02 PM ******/
/* CHANGED BY BBG 24 APR 2001 For Rounding  */
/* CREATED BY ANIMESH */
CREATE procedure HistBrokDelUpdate (@sett_no varchar(7),@sett_type varchar(2) ,@tparty varchar(10)) as 
update history set 
