-- Object: PROCEDURE dbo.rpt_congexbrwisets
...
/****** Object:  Stored Procedure dbo.rpt_congexbrwisets    Script Date: 04/21/2001 6:05:19 PM ******/
...
*/
create procedure rpt_congexbrwisets
@settno varchar(7),
@settype varchar(3)
as
