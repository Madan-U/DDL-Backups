-- Object: PROCEDURE dbo.rpt_congexsbrkwiset4ts
...
/****** Object:  Stored Procedure dbo.rpt_congexsbrkwiset4ts    Script Date: 04/21/2001 6:05:19 PM ******/

/*written by neelambari on 31 mar 2001*/
/*this query gives us the subbrokers  name and all details of
  trading of each subbroker from trade4432 and settlement
*/
CREATE procedure rpt_congexsbrkwiset4ts
@settno varchar(7),
@settype varchar(3)
as
