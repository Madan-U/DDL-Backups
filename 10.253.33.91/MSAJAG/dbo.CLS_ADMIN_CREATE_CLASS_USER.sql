-- Object: PROCEDURE dbo.CLS_ADMIN_CREATE_CLASS_USER
...
CREATE PROC [dbo].[CLS_ADMIN_CREATE_CLASS_USER]  
(
 @FLDAUTO VARCHAR(50),	  
 @USERNAME VARCHAR(25),  
 @PASSWORD VARCHAR(50),  
	...
	IF UPPER(@ACTION_FLAG) = 'EDIT' 
     BEGIN
		...
		IF @@ERROR = 0
		 BEGIN
		 	--print 'if @@ERROR = 0  2' 
			INSERT INTO MSAJAG.DBO.ADD_ADMIN_RESULT (UNAME,FIRSTNAME,CATEGORYNAME,RESULT, EXCHANGE, SEGMENT, SESSION_ID)
