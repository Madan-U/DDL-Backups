-- Object: PROCEDURE dbo.Insproc_T1Change_25022022
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE Procedure [dbo].[Insproc_T1Change_25022022]  @Settno  Varchar (7) , @Sett_Type Char(3)  As  
...
If UPPER(LTRIM(RTRIM(@Sett_Type))) <> 'W' /* For Sett Type = 'C' Condition Is Different So This If Loop Is Required For All Other Settlement */  
Begin  
