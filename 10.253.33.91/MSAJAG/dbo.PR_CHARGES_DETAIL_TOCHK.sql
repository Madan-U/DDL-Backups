-- Object: PROCEDURE dbo.PR_CHARGES_DETAIL_TOCHK
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


--[PR_CHARGES_DETAIL] '2014065','n','a','zzzzz'    
CREATE PROC [dbo].[PR_CHARGES_DETAIL_TOCHK]                       
(                    
 @F_SETT_NO VARCHAR(7),                      
...
GROUP BY                     
 ...
 SP_COMPUTATION_LEVEL,SP_MIN_BROKAMT,SP_MAX_BROKAMT,SP_MIN_SCRIPAMT,SP_MAX_SCRIPAMT,SP_TRD_TYPE                      
