-- Object: PROCEDURE dbo.PR_CHARGES_DETAIL_BKP_20220509
...
CREATE  PROC [dbo].[PR_CHARGES_DETAIL_BKP_20220509]                       
(                    
 @F_SETT_NO VARCHAR(7),                      
...
NBROKAPP = 0, N_NETRATE = MARKETRATE,                       
SERVICE_TAX = 0, NSERTAX = 0                       
FROM VBB_CHARGES_DETAIL_TEMP_1  (Nolock)                      
WHERE SETTLEMENT.SETT_NO = @F_SETT_NO AND                 
SETTLEMENT.SETT_TYPE = @F_SETT_TYPE AND                    
 SETTLEMENT.PARTY_CODE BETWEEN  @FROM_PARTY AND @TO_PARTY AND                    
 SETTLEMENT.TRADEQTY > 0                
 and VBB_CHARGES_DETAIL_TEMP_1.CD_SETT_NO = SETTLEMENT.SETT_NO                      
