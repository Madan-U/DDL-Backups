-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_NEW_Archival
...
CREATE PROCEDURE [dbo].[V2_COMBINED_CONTRACTNOTE_NEW_Archival] (              
 @STATUSID VARCHAR(15),              
...
--BEGIN            
--print 'vin'        
 EXEC V2_COMBINED_CONTRACTNOTE_DETAIL_Archival @STATUSID,@STATUSNAME,@FROMDATE,@TODATE,@FROMPARTY,@TOPARTY,@FROMBRANCH,@TOBRANCH,@FROMSUB_BROKER,@TOSUB_BROKER,@FROMCONTRACT,@TOCONTRACT,@CONTFLAG,@EXCHANGE,@BOUNCEDFLAG,@PRINTFLAG,@COMPANY_NAME,@CONTRACTGROUP
-- RETURN            
--END           
 /*         
