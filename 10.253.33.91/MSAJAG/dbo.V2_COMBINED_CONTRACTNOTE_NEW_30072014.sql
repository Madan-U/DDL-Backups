-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_NEW_30072014
...
BEGIN    
 EXEC V2_COMBINED_CONTRACTNOTE_DETAIL @STATUSID,@STATUSNAME,@FROMDATE,@TODATE,@FROMPARTY,@TOPARTY,@FROMBRANCH,@TOBRANCH,@FROMSUB_BROKER,@TOSUB_BROKER,@FROMCONTRACT,@TOCONTRACT,@CONTFLAG,@EXCHANGE,@BOUNCEDFLAG,@PRINTFLAG,@SETT_TYPE,@COMPANY_NAME    
 RETURN    
END  
