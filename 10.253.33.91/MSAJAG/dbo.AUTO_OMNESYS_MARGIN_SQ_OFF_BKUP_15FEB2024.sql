-- Object: PROCEDURE dbo.AUTO_OMNESYS_MARGIN_SQ_OFF_BKUP_15FEB2024
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROC [dbo].[AUTO_OMNESYS_MARGIN_SQ_OFF_BKUP_15FEB2024]
(
...
--SET @EXCH ='COMM'
	 ...
	 /*End the code comment*/
      ...
      EXEC [196.1.115.159].SSISDB.dbo.USP_CNT_OMNESYS_BULKUPLOAD_ALL --@OnDate
      ...
      FROM [196.1.115.159].SSISDB.DBO.tbl_CNT_Omnesys_all_temp WITH(NOLOCK) 
  ...
  SELECT TOP 1  @OnDate_1= [Trade Date] FROM [196.1.115.159].SSISDB.DBO.tbl_CNT_Omnesys_all_temp WITH(NOLOCK) 
