-- Object: PROCEDURE dbo.Usp_DpFileforBackoffice_16082022
...
Create Proc [dbo].[Usp_DpFileforBackoffice_16082022]          
...
(ceiling (AppVar))/100 as AppVar, deli_Qty as Limit_Qty,(case when cl_rate IS null then 0 else CL_RATE end) as Rate ,GETDATE()                
from #TBl_DP_Final_Data_Var_Right  order by hld_isin_code desc       
