-- Object: PROCEDURE dbo.CLASS_AUTO_PROCESS_SETUP_BAK_30012023
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROC [dbo].[CLASS_AUTO_PROCESS_SETUP_BAK_30012023]            
(            
...
WHERE SEC_PAYIN > @BUSINESS_DATE AND SETT_TYPE IN ('N', 'D', 'W', 'C'))  
AND M.SETT_TYPE IN ('N', 'D', 'W', 'C')  
