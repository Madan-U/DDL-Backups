-- Object: PROCEDURE dbo.rpt_mtom3dtry1
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



/****** Object:  Stored Procedure dbo.rpt_mtom3dtry1    Script Date: 04/27/2001 4:32:45 PM ******/

/****** Object:  Stored Procedure dbo.rpt_mtom3dtry1    Script Date: 3/21/01 12:50:20 PM ******/

/****** Object:  Stored Procedure dbo.rpt_mtom3dtry1    Script Date: 20-Mar-01 11:39:00 PM ******/


/****** Object:  Stored Procedure dbo.rpt_mtom3dtry1    Script Date: 2/5/01 12:06:21 PM ******/

/****** Object:  Stored Procedure dbo.rpt_mtom3dtry1    Script Date: 12/27/00 8:58:55 PM ******/

/* Report : mtom
   File :3dtry1.asp
*/
CREATE PROCEDURE rpt_mtom3dtry1
@statusid varchar(15),
...
where c1.cl_code=c2.cl_code and t.party_code = c2.party_code 
and t.series= 'BE' and t.party_code like ltrim(@code)+'%' 
and c1.trader = @statusname and t.billno = 0 
group by c1.short_name,t.party_code,t.scrip_cd ,t.series,t.sell_buy 
end
