-- Object: PROCEDURE dbo.SpSettBillFooter
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.SpSettBillFooter    Script Date: 3/17/01 9:56:11 PM ******/

/****** Object:  Stored Procedure dbo.SpSettBillFooter    Script Date: 3/21/01 12:50:31 PM ******/

/****** Object:  Stored Procedure dbo.SpSettBillFooter    Script Date: 20-Mar-01 11:39:10 PM ******/



/****** Object:  Stored Procedure dbo.SpSettBillFooter    Script Date: 2/5/01 12:06:29 PM ******/

/****** Object:  Stored Procedure dbo.SpSettBillFooter    Script Date: 12/27/00 8:59:04 PM ******/


/****** Object:  Stored Procedure dbo.SpSettBillFooter    Script Date: 12/20/2000 12:38:58 PM ******/
/****** Object:  Stored Procedure dbo.SpSettBillFooter    Script Date: 12/7/2000 1:29:08 PM ******/
CREATE proc SpSettBillFooter (@Sett_No varchar(10), @Sett_Type varchar(2), @Party varchar(10)) as
select Pamt = isnull((case sell_buy
  when 1 then  ( case when service_chrg = 1 then
			sum(tradeqty * (marketrate + brokapplied) + nsertax )  
		else 
	         		sum(tradeqty * (marketrate + brokapplied))  
		end )
	end),0),
