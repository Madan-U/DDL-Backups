-- Object: PROCEDURE dbo.V2_PROCESSEOD
...
AS      
  ...
  SELECT @NEWPROCESSDATE = isnull(LEFT(MIN(START_DATE),11),'JAN  1 2000') FROM SETT_MST      
    WHERE START_DATE > @PROCESSDATE + ' 23:59:59' AND SETT_TYPE IN ('M','Z','A', 'X','H','T','BX','DX','TX','5')  -- T0 CHANGES  
  ----WHERE START_DATE > @PROCESSDATE + ' 23:59:59' AND SETT_TYPE IN ('N', 'W','M','Z','A', 'X','H','T','BX','DX','TX')   -- Above condition changed Dt 01 Feb 23 by Vaibhav
 ...
 AND S.SETT_TYPE IN ('M','Z', 'A', 'X','H','T','BX','DX','AF','F','TX','5') -- T0 CHANGES  
  --AND S.SETT_TYPE IN ('N', 'W','M','Z', 'A', 'X','H','T','BX','DX','AF','F','TX')  -- Above condition changed Dt 01 Feb 23 by Vaibhav 
