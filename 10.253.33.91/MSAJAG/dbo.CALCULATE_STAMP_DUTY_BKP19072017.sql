-- Object: PROCEDURE dbo.CALCULATE_STAMP_DUTY_BKP19072017
...
CREATE PROC [dbo].[CALCULATE_STAMP_DUTY_BKP19072017]                  
(                        
 @SETT_TYPE VARCHAR(2),                  
...
BEGIN TRAN    
 ...
 SELECT STATE,TRDSTAMPDUTY,DELSTAMPDUTY,PROSTAMPDUTY,MIN_MULTIPLIER,FOR_TURNOVER,MAXIMUM_LIMIT,    
           DEL_MIN_MULTIPLIER,DEL_FOR_TURNOVER,WDMSTAMPDUTY,WDMMin_Multiplier      
    INTO #STATE_MASTER     
