-- Object: PROCEDURE dbo.SPX_GETPOAUPDATONFROMKYC_REVISEDPROCESS_PartyCodeWise_Mismatch_2025_03_06
...
Create PROC [dbo].[SPX_GETPOAUPDATONFROMKYC_REVISEDPROCESS_PartyCodeWise_Mismatch_2025_03_06]                      
@UserId varchar(15)             
AS                      
...
--**********************************CODE START FOR CLIENT4 PROCESS **********************------------------------                    
 ...
 from client4 a where nise_party_code=Party_code        
 and DefDp='1' and Depository='CDSL' and isnull(nsdlflag,'')<>'y' and BankID NOT IN ('12033200','12033201','12033202','12033203')        
   --AND ISNULL(NSE,'') NOT IN ('NO','N')       
 ...
 and BankID in ( '12033200', '12033201','12033202','12033203')        
  --AND ISNULL(NSE,'') NOT IN ('NO','N')       
      
        
 update #SYNERGY_DATA_FINAL set CDSlStatusFlag='y'        
 from client4 a where nise_party_code=Party_code        
 and DefDp='1' and Depository='CDSL' and isnull(nsdlflag,'')<>'y' AND ISNULL(NonAngelCDSLFlag,'')<>'y'  and BankID in ('12033200', '12033201','12033202','12033203')      
...
DELETE FROM client4 WHERE depositOry='CDSL' AND BankID in ('12033200', '12033201','12033202','12033203') AND Party_code IN      
 (      
...
) AND DEPOSITORY='CDSL' AND BankID in ('12033200', '12033201','12033202','12033203') AND DefDp='0'      
...
--AND ISNULL(NSE,'N')='Y'       
AND DPID in ('12033200', '12033201','12033202','12033203') AND A.DpType='CDSL'          
...
AND #SYNERGY_DATA_FINAL.CLIENT_CODE=LTRIM(RTRIM(CLTDPNO))                    
--AND ISNULL(NSE,'N')='Y'       
AND DPID in ('12033200', '12033201','12033202','12033203') AND STATUS='Active' AND A.DpType='CDSL'                 
...
--AND ISNULL(NSE,'N')='Y'       
AND DPID in ('12033200', '12033201','12033202','12033203') AND DEF='0' AND ISNULL(MultiFlag,'')='Y' AND A.DpType='CDSL'       
