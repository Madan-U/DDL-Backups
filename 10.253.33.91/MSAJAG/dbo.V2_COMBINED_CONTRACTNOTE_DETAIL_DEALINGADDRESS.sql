-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_DETAIL_DEALINGADDRESS
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

  
  
CREATE  PROCEDURE [dbo].[V2_COMBINED_CONTRACTNOTE_DETAIL_DEALINGADDRESS]                       
...
-- )  
 ...
 SELECT   C.*,b.BRANCH,B.Long_Name,B.Address1,B.Address2,B.City,B.State ,B.Zip,B.Phone1 FROM #CONTRACT C, BRANCH B  -- WHERE QTY > 0  
 --where CONTRACTNO_NEW <> ''    
 WHERE BRANCH_CODE=BRANCH_CD                         
