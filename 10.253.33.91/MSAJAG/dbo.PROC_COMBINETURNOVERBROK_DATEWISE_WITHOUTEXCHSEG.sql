-- Object: PROCEDURE dbo.PROC_COMBINETURNOVERBROK_DATEWISE_WITHOUTEXCHSEG
...
CREATE PROC [dbo].[PROC_COMBINETURNOVERBROK_DATEWISE_WITHOUTEXCHSEG]         
(        
 @STATUSID		VARCHAR(25),      
...
--EXEC  PROC_COMBINETURNOVERBROK_DATEWISE_WITHOUTEXCHSEG 'BROKER','BROKER','APR  1 2020','APR 30 2020 23:23','','ZZZZZZ'
