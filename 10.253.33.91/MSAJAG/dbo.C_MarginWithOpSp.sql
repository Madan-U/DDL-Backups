-- Object: PROCEDURE dbo.C_MarginWithOpSp
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/*Calculate the Ledger Balance From The Opening Entry Date*/
CREATE Proc C_MarginWithOpSp 
(@Exchange Varchar(3), 
@Segment Varchar(20), 
...
from ' + @AccountDb + '.dbo.MarginLedger where vdt >= "'+@Sdt+'"' + 'and vdt <= "'+@Tdt+'"' + 
