-- Object: PROCEDURE dbo.RPT_GST_INVOICE_NEW_VK
...
CREATE   PROC [dbo].[RPT_GST_INVOICE_NEW_VK]    
(    
...
SELECT     
 ...
 FROM    
 TBL_GST_INVOICE L (NOLOCK),   
 MSAJAG.DBO.TBL_CLIENT_GST_DATA CD (NOLOCK),   
 --[AngelCommodity].MCDX.DBO.TBL_CLIENT_GST_DATA CD (NOLOCK),   
