-- Object: PROCEDURE dbo.rpt_SamePlus1ALBM
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



/****** Object:  Stored Procedure dbo.rpt_SamePlus1ALBM    Script Date: 04/27/2001 4:32:48 PM ******/

/****** Object:  Stored Procedure dbo.rpt_SamePlus1ALBM    Script Date: 3/21/01 12:50:23 PM ******/

/****** Object:  Stored Procedure dbo.rpt_SamePlus1ALBM    Script Date: 20-Mar-01 11:39:02 PM ******/

/****** Object:  Stored Procedure dbo.rpt_SamePlus1ALBM    Script Date: 2/5/01 12:06:22 PM ******/

/****** Object:  Stored Procedure dbo.rpt_SamePlus1ALBM    Script Date: 12/27/00 8:58:57 PM ******/

/****** Object:  Stored Procedure dbo.rpt_SamePlus1ALBM    Script Date: 10/23/2000 11:04:47 AM ******/
/* 
...
*/
CREATE PROCEDURE rpt_SamePlus1ALBM
@partycode varchar(6),
@settno varchar(7)
AS
if (  select count(t.party_code) from trade4432 t, sett_mst m 
 ...
 and m.sett_no = @settno and m.sett_type = 'L' and t.party_code like ltrim(@partycode) + '%'   ) > 0
  begin
 select m.sett_no, m.sett_type, t.party_code, c1.short_name, t.Scrip_Cd, t.series, Qty = sum(t.tradeqty), Amt= sum(t.tradeqty * t.marketrate), t.sell_buy
...
union all 
 select s.sett_no ,s.sett_type , c2.party_code, c1.short_name,s.scrip_cd, s.series, Qty = sum(s.tradeqty), Amt = sum(s.tradeqty * s.N_NetRate), s.sell_buy 
