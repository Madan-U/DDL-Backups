-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_NEW_bakfeb102016
...
--BEGIN            
--print 'vin'        
 EXEC V2_COMBINED_CONTRACTNOTE_DETAIL @STATUSID,@STATUSNAME,@FROMDATE,@TODATE,@FROMPARTY,@TOPARTY,@FROMBRANCH,@TOBRANCH,@FROMSUB_BROKER,@TOSUB_BROKER,@FROMCONTRACT,@TOCONTRACT,@CONTFLAG,@EXCHANGE,@BOUNCEDFLAG,@PRINTFLAG,@COMPANY_NAME     
-- RETURN            
--END           
 /*         
