-- Object: PROCEDURE dbo.InsDelTransPrint_NBFC_PLEDGE
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE Proc InsDelTransPrint_NBFC_PLEDGE (@OptFlag Int, @BDpType Varchar(4), @BDpId Varchar(8), @BCltDpID Varchar(16))       
As  
If @OptFlag = 1   
Begin  
...
Insert Into DelTransTemp_NBFC    
Select N.SNo, N.Sett_No, N.Sett_type, N.RefNo, N.TCode, TrType = 909, N.Party_Code, N.scrip_cd, N.series, N.Qty, N.FromNo, N.ToNo, N.CertNo, D.FolioNo,     
