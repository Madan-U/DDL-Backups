-- Object: PROCEDURE dbo.PROC_COMMON_CONTRACT_AUTOGEN_test
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROC [dbo].[PROC_COMMON_CONTRACT_AUTOGEN_test]                           
(                          
...
-- EXEC PROC_COMMON_CONTRACT_AUTOGEN_test  @SAUDA_DATE = 'OCT 18 2016', @FILE_FOR = 'COMBINE_MARGIN', @FROMPARTY='A101817', @TOPARTY='A101817'                          
...
if @FILE_FOR = 'COMMON_CONTRACT' OR  @FILE_FOR = 'CURR_COMMON_CONTRACT'       
BEGIN        
...
BEGIN        
 ...
 EXEC (@CMD)          
END         
if @FILE_FOR = 'COMBINE_MARGIN' OR  @FILE_FOR = 'COMBINE_MARGIN'       
BEGIN        
 SET @MYURL = @INTERNAL_URL + @PROCESS_URL + '&FILENAME=' + @PROCESS_URL_FILE                          
