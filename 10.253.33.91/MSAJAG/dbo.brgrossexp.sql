-- Object: PROCEDURE dbo.brgrossexp
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.brgrossexp    Script Date: 3/17/01 9:55:45 PM ******/

/****** Object:  Stored Procedure dbo.brgrossexp    Script Date: 3/21/01 12:50:01 PM ******/

/****** Object:  Stored Procedure dbo.brgrossexp    Script Date: 20-Mar-01 11:38:44 PM ******/

/****** Object:  Stored Procedure dbo.brgrossexp    Script Date: 2/5/01 12:06:08 PM ******/

/****** Object:  Stored Procedure dbo.brgrossexp    Script Date: 12/27/00 8:58:44 PM ******/

/* Report : Gross exposure report
    File : grossexptrdset.asp
displays details of trade from settlement and trade
*/
CREATE PROCEDURE brgrossexp
@br varchar(3),
...
and b.branch_cd = @br and
c1.short_name like ltrim(@shortname)+'%' and t4.scrip_cd like ltrim(@scripcd)+'%' 
and t4.party_code like ltrim(@partycode)+'%' and c1.trader like ltrim(@trader)+'%'
