-- Object: PROCEDURE dbo.NSE_SCRIPMAPPINGUPLOAD
...
CREATE PROC [dbo].[NSE_SCRIPMAPPINGUPLOAD] (@FilePath Varchar(100)) AS            
...
SELECT *,0 FROM #TBL_EXCHG_SCRIP_MAP_TMP  WHERE NSE_SERIES <>'T0' AND BSECODE NOT LIKE '1%'
