...
/****** Object:  Stored Procedure dbo.InsCltDelWise    Script Date: 4/12/01 1:05:15 PM ******/
...
Set @@DelClt = CurSor for
 select Dt.scrip_cd,Dt.series,Dt.Party_code,Qty=IsNull(Sum(Dt.Qty+(Case When InOut = 'O' Then D.Qty Else 0 End)),0)-Isnull((Case When InOut='I' Then D.Qty Else 0 End),0),Flag='E' from 
 ...
 where dt.sett_no = @Sett_no and dt.Sett_Type = @Sett_Type And Reason Not Like 'ADJ%'
