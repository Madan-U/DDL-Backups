-- Object: PROCEDURE dbo.MULTIBANK_CITRUS_Client_BAK_12042024
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

   
 create PROC [dbo].MULTIBANK_CITRUS_Client_BAK_12042024
 ...
 Select BOPARTYCODE=@party_code ,BANK_NAME=@Bank_name ,BANK_BRANCH=@branch_name ,DEFAULTBANK=@DEFAULTBANK ,BANK_IFSC_CODE=@IFSC_Code   
 ,BANK_MICR_CODE=@micr  ,BANK_ACC_NO=@bank_acc_No ,BANK_AC_TYPE=(Case when  @ACtype ='S' Then 'Savings' Else 'Current' End),Long_name=@long_name  
 ,Exchange,Segment into #temp   
 FROM MSAJAG.dbo.client_brok_details where Cl_code =@party_code   
