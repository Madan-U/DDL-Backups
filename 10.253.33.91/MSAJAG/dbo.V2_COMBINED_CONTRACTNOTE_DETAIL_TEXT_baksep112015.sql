-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_DETAIL_TEXT_baksep112015
...
CREATE PROCEDURE [dbo].[V2_COMBINED_CONTRACTNOTE_DETAIL_TEXT_baksep112015]             
 (            
 @STATUSID VARCHAR(15),            
...
--SELECT @PRINTF = 'ALL'                                      
 ...
 SELECT            
  ...
  PRINTF=C.PRINTF,            
  BROK,            
  NETRATE =(CASE WHEN LEFT(SCRIPNAME,3)='OPT' THEN
   (CASE WHEN SELL_BUY =1 THEN NETRATE+BROK ELSE NETRATE-BROK END)
            ELSE NETRATE END), 
  --NETRATE,                  
  CL_RATE,            
  UCC_CODE,            
