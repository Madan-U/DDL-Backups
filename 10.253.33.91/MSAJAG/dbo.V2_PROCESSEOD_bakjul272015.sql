-- Object: PROCEDURE dbo.V2_PROCESSEOD_bakjul272015
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

 CREATE PROC V2_PROCESSEOD(        
...
AS        
  ...
  WHERE START_DATE > @PROCESSDATE + ' 23:59:59' AND SETT_TYPE IN ('N', 'W', 'A', 'X','H')      
