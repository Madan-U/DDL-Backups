-- Object: PROCEDURE dbo.PROC_PNLPROCESS_Daily_vin
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROC [dbo].[PROC_PNLPROCESS_Daily_vin]                                      
(                                                                  
...
/*
begin tran
exec PROC_PNLPROCESS_Daily_vin 'jan 13 2012','A75206','A75206'
ROLLBACK
*/
...
SELECT   SNO, PARTY_CODE, SCRIP_CD, SERIES, BSECODE, ISIN, TRADEQTY, ORGDATE1=LEFT(ORGDATE,11), ORGDATE                                                  
