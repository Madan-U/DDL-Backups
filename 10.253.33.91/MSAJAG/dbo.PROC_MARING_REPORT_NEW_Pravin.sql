-- Object: PROCEDURE dbo.PROC_MARING_REPORT_NEW_Pravin
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

                          
--PROC_MARING_REPORT_NEW_Pravin '','','' 
                                
CREATE PROC [dbo].[PROC_MARING_REPORT_NEW_Pravin]                                            
(                                                      
...
ADD_MARGIN = CONVERT(NUMERIC(18,4),0)                                                        
FROM ANGELFO.NSEFO.DBO.TBL_CLIENTMARGIN D WITH (NOLOCK) , #TPARTY C                                                      
...
DELETE FROM TBL_MAR_REPORT_PRAVIN                                                      
...
INSERT INTO TBL_MAR_REPORT_PRAVIN                                                      
...
DELETE FROM TBL_MAR_REPORT_PRAVIN                      
WHERE PARTY_CODE NOT IN ( SELECT PARTY_CODE FROM #CLCODE)                      
AND TRADE_DAY  BETWEEN @SAUDA_DATE AND @SAUDA_DATE  + ' 23:59'                      
