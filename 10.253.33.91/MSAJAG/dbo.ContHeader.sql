-- Object: PROCEDURE dbo.ContHeader
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.ContHeader    Script Date: 3/17/01 9:55:49 PM ******/

/****** Object:  Stored Procedure dbo.ContHeader    Script Date: 3/21/01 12:50:05 PM ******/

/****** Object:  Stored Procedure dbo.ContHeader    Script Date: 20-Mar-01 11:38:48 PM ******/

/****** Object:  Stored Procedure dbo.ContHeader    Script Date: 2/5/01 12:06:11 PM ******/

/****** Object:  Stored Procedure dbo.ContHeader    Script Date: 12/27/00 8:58:48 PM ******/

CREATE proc ContHeader (@Sdate varchar(12), @Sett_Type varchar(2), @ContNo varchar(6)) as
...
sett_mst.start_date,sett_mst.end_date,client1.l_address1,client1.l_address2,client1.l_address3,client1.l_city,client1.l_zip,settlement.sauda_date
...
and settlement.tradeqty <> 0 and settlement.party_code not in ('30','40')
UNION
