-- Object: PROCEDURE dbo.RPT_CLIENTMARGINREPORT_TEST
...
CREATE PROC [dbo].[RPT_CLIENTMARGINREPORT_TEST]    
 (          
 @MDATE VARCHAR(11),          
...
WHERE    
 ...
 SELECT        
  ...
  AMOUNT = SUM(AMOUNT),    
  FREE_QTY = SUM(HOLDING_QTY-PLEDGE_QTY),    
