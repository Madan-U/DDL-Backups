-- Object: PROCEDURE dbo.NSENRIHEADER_t1_BKP_20FEB2025_SRE_34258
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE PROC  [dbo].[NSENRIHEADER_t1_BKP_20FEB2025_SRE_34258] (@SDATE AS VARCHAR(11),@SELL_BUY AS VARCHAR(1))             
AS                          
...
NO_OF_TRANSACTIONS, SUM(TOTALAMT) AS TOTALAMT,SETT_NO
FROM #DATA
