...
--------------------------------------------------
 ...
 ----EXEC C_SECURITYVALUATION 'BSX','FUTURES','angelcommodity','jul 31 2017'     

CREATE PROC [dbo].[C_SECURITYVALUATION](        
...
=============================================================================*/        
  ...
  FROM   (SELECT I.ISIN,        
          ...
          FROM   AngelBSECM.BSEDB_AB.DBO.CLOSING C1 WITH (nolock),        

                 ANGELDEMAT.BSEDB.DBO.MULTIISIN I WITH (nolock)        

          WHERE  SYSDATE = (SELECT MAX(SYSDATE)        

                            FROM   AngelBSECM.BSEDB_AB.DBO.CLOSING C2 WITH (nolock)        
