...
Purpose = (Case when DrCr = 'D' Then 'Payout' Else           
  (Case when DrCr = 'C' Then 'Payin' Else '' End)           
  End),          
Balance = 0,        
...
Group By           
d.Party_Code,                    
c1.Long_Name, D.TransDate, DrCr, d.Scrip_Cd, s1.long_name                
...
d.Party_Code,           
c1.Long_Name,           
D.TransDate, DrCr, d.Scrip_Cd, s1.long_name                  
