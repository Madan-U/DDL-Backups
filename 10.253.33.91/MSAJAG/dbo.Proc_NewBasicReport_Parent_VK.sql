-- Object: PROCEDURE dbo.Proc_NewBasicReport_Parent_VK
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


--EXEC Proc_NewBasicReport_Parent_VK 'feb 17 2022', 'FEB 17 2022'

--EXEC Proc_Newbasicreport_parent '', '', '%', 'Feb 17 2022 ', 'Feb 17 2022 ', '', '', '00000000', 'ZZZZZZZZ', 'PARTY_CODE', 'Br', '0', '1', '1', 'All', 'broker', 'broker'
...
CREATE Procedure [dbo].[Proc_NewBasicReport_Parent_VK] ( 
@sauda_date Varchar(11),
@todate Varchar(11),
@sett_no Varchar(10) ='',	---1  Settlement No(from)  
@tosett_no Varchar(10) ='',  ---2  Settlement No (to)  
@sett_type Varchar(3) ='BX',   ---3  Settlement Type   
 @fromscrip Varchar(10)='',   ---6 From Scrip_cd (from)  
@toscrip Varchar(10) ='',   ---7 To Scrip_cd (to)  
@from Varchar(20)='0000000',     ---8  From Consol  
@to Varchar (20)='ZZZZZZZZ',     ---9  To Consol  
@consol Varchar(10) ='PARTY_CODE',   ---10  Consol Indicates That Whether Is "party_code","trader","sub Broker","branch"  
@detail Varchar(3)='Br',    ---11  This Is Other Details In Query "b" = "bill","c" = "confirmation","p" = "position","br" = "brokerage","s" = "sauda Summary"  
@level  Smallint ='0',            ---12 Will Be Used To Select  Level Of Consolidation Default 0  
@groupf Varchar(500) ='1',   ---13 (any Necessary Grouping) This Can Be Defined On The Fly By Developer  
@orderf Varchar(500)='1',   ---14 (any Necessary Order By) This Can De Defined On The Fly By Developer   
@use1 Varchar(10) ='ALL',           ---15 To Be Used Later  For Other Purposes  
...
INTO	
	#PARTYVIEW
FROM	
	CLIENT1 C1 (NOLOCK), CLIENT2 C2 (NOLOCK)
WHERE	
...
Begin  
 ...
 Set @@fromtable = " From Cmbillvalan S Left Outer Join BRANCH BR On (S.Branch_CD = BR.Branch_Code) Left Outer Join SUBBROKERS SB On (S.sub_broker = SB.Sub_Broker), #PARTYVIEW C (NOLOCK) "  
End  
Else  
Begin  
