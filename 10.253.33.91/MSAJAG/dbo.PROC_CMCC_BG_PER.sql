-- Object: PROCEDURE dbo.PROC_CMCC_BG_PER
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


 
CREATE PROC [DBO].[PROC_CMCC_BG_PER] (@TDATE VARCHAR(10), @FILEFOR VARCHAR(20), @FILETYPE VARCHAR(50), @PROGID VARCHAR(50), @UNAME VARCHAR(50), @FILENAME VARCHAR(200)='')  
AS   
...
END  
 ...
 DELETE FROM TBL_CMCC_BG_PER   
 WHERE TRANSDATE = CONVERT(DATETIME, @TDATE,103)  
  
 INSERT INTO TBL_CMCC_BG_PER  
