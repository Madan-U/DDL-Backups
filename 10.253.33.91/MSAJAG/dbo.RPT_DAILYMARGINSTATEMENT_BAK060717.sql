-- Object: PROCEDURE dbo.RPT_DAILYMARGINSTATEMENT_BAK060717
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROC [dbo].[RPT_DAILYMARGINSTATEMENT_BAK060717]                                            
 (                                            
 @MDATE VARCHAR(11),                                            
...
INSERT INTO #MARGIN_DETAIL                                            
 ...
 SELECT                                            
  ...
  SUB_BROKER,                                            
  RPT_ORD = '1DET',                                            
  SCRIP_CD= CONVERT(VARCHAR(20),''),                                              SERIES = CONVERT(VARCHAR(5),''),                                            
...
(                                
 ...
 WHERE  EFFDATE BETWEEN @MDATE AND @MDATE + ' 23:59:59'                                            
    AND EXISTS (SELECT DISTINCT PARTY_CODE FROM #FINAL_REPORT WHERE C.PARTY_CODE = #FINAL_REPORT.PARTY_CODE) AND    EXCHANGE NOT IN ('MCX','NCX')                                        
 END                                        
