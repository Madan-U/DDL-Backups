-- Object: PROCEDURE dbo.TRD_CLIENTMASTER_T1Change_25022022
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROCEDURE [dbo].[TRD_CLIENTMASTER_T1Change_25022022]                  
...
(      
 ...
 UPDATE TRADE SET AUCTIONPART = 'DX'      
  ...
  SET    AUCTIONPART = (CASE             
                          WHEN TRADE.SERIES = 'BE' OR TRADE.SERIES = 'DE' OR TRADE.SERIES = 'ST' OR TRADE.SERIES ='BZ' THEN 'W'            
                          WHEN TRADE.MARKETTYPE = '4' THEN 'A'            
                          ELSE 'N'            
                        END)       
 WHERE TRADE.SERIES NOT IN ('IS', 'RS','BB','DS','TO')
