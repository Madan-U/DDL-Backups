-- Object: PROCEDURE dbo.CLASS_AUTO_PROCESS_SETTLEMENT_TEST
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROCEDURE [dbo].[CLASS_AUTO_PROCESS_SETTLEMENT_TEST]            
(             
 @PROCESS_DATE VARCHAR(11)            
)            
AS            
            
-- EXEC CLASS_AUTO_PROCESS_SETTLEMENT_TEST 'AUG 18 2015'            
