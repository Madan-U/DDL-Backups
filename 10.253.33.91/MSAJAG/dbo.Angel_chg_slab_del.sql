-- Object: PROCEDURE dbo.Angel_chg_slab_del
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE procedure Angel_chg_slab_del(@sbcode as varchar(10),@dslab as varchar(10))  
as  
...
update client2 set sub_tableno=@dslab where party_code in (Select party_code from #file1)  
