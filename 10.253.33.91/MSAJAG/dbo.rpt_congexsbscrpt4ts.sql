-- Object: PROCEDURE dbo.rpt_congexsbscrpt4ts
...
/****** Object:  Stored Procedure dbo.rpt_congexsbscrpt4ts    Script Date: 04/21/2001 6:05:20 PM ******/

/*written by neelambari on 4 april 2001*/
/*this query gives us the list of scrip and all details of   trading of each scrip from
  trade4432  and settlement for selected subbroker
*/
create procedure  rpt_congexsbscrpt4ts
@settno varchar(7),
@settype varchar(3),
