-- Object: PROCEDURE dbo.RPT_PNL_SHRT_LONG_pratham
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

---EXEC RPT_PNL_SHRT_LONG 'broker','broker','Apr  1 2019','Sep 23 2019','A105847','A105847','','Y', 'S','W', 'e54873'

                              

---EXEC RPT_PNL_SHRT_LONG_pratham 'BROKER','BROKER','APR  1 2015','MAR 31 2016','a00','zz99','','Y', 'S','W'--944                                        

---EXEC RPT_PNL_SHRT_LONG_pratham 'broker','broker','Apr  1 2019','Sep 23 2019','a001','zz999','','Y', 'S','W', 'e54873'

                                          

CREATE PROC [DBO].[RPT_PNL_SHRT_LONG_pratham]                                                                        
...
REGION  = CONVERT(VARCHAR(20),'')                                        
 ...
 WHERE 1 = 2              and   T.PARTY_CODE in (select * from OLDNEW)                        
 ...
 CREATE CLUSTERED INDEX  [INX_PNL_DATA]                                               
  ...
  WHERE PARTY_CODE in (select * from OLDNEW)                     
...
AND CL_CODE in (select * from OLDNEW)                                           
