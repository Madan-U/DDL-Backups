-- Object: PROCEDURE dbo.STP_ContractDetails_Group_INCR
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE        Proc [dbo].[STP_ContractDetails_Group_INCR]      
@FromDate Varchar(11),      
@ToDate Varchar(11),      
...
ISIN = Left(Isin + '            ',12), TradeDate, MarketType, Sett_No, TradeFlag,       
...
Insurance_Chrg,IsNull(C1.FD_Code,''),I.Series     
