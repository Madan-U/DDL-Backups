-- Object: PROCEDURE dbo.RPT_PNL_SHRT_LONG_UAT
...
CREATE PROC [DBO].[RPT_PNL_SHRT_LONG_UAT]                                                            
(                                                              
 @STATUSID VARCHAR(25),                                                              
...
-- CREATED BY SIVA  FOR DATA VERIFICATION                                                            
AS                                  
...
AREA  = '',                            
REGION  = ''                            
 FROM TBL_PNL_DATA_05MAY T WITH (NOLOCK) --, #CLIENT_DETAILS C WITH (NOLOCK)                                                     
