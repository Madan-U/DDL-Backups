-- Object: PROCEDURE dbo.V2_CONTCUMBILL_SECTION_Karvy
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROC V2_CONTCUMBILL_SECTION_Karvy  
(    
 @STATUSID VARCHAR(15),    
 ...
 Where Rpt_Type = 'ORDER' And Rpt_PrintFlag_Digi = 1    
  ...
  cpid    
        ...
        SELECT  Contractno,       
                ...
                Tmark,    
  cpid = '        '    
        FROM    SETTLEMENT with(INdex(party),Nolock)    
