-- Object: PROCEDURE dbo.RPT_GST_INVOICE_NEW_HISTORY
...
--------------------------------------------------
 ...
 --ALTERED THIS SP UNDER SRE-36318    
CREATE   PROC [dbo].[RPT_GST_INVOICE_NEW_HISTORY]        
(        
...
--EXEC RPT_GST_INVOICE_NEW_HISTORY 'MAR2021','Y14884','Y14884','','zzzzzzzzzzz','','zzzzzzzzzzz','broker','broker'  
--EXEC RPT_GST_INVOICE_NEW_HISTORY 'MAR2021','A100873','A100873','','zzzzzzzzzzz','','zzzzzzzzzzz','broker','broker'  
--go  
...
Create table  #cl  (CL_code varchar(10))
      
IF @FROMCODE =''

		Begin 
		  INSERT INTO #cl 
		 SELECT Cl_COde  FROM MSAJAG.DBO.CLIENT_DETAILS C (NOLOCK)   
		...
		begin
		   ...
		   INSERT INTO #cl 
		 SELECT Cl_COde FROM MSAJAG.DBO.CLIENT_DETAILS C (NOLOCK)   WHERE CL_CODE >=@FROMCODE and CL_CODE <=@TOCODE

		End

 --WHERE C.GST_NO <> ''     
    
 --SELECT T.* INTO #GSTINVOICE      
 --FROM TBL_GST_INVOICE_HISTORY T (NOLOCK)     ,#cl C  
...
CREATE TABLE [dbo].#GSTINVOICE(
 ...
 --Apr  1 2018	Apr 30 2018
  IF CONVERT(DATE,@FROMDATE,103) >= '2017-07-01' AND CONVERT(DATE,@TODATE,103) <= '2020-12-31'
 --IF @FROMDATE >= 'jun  1 2017' AND @TODATE <= 'dec 31 2020'
BEGIN
...
INSERT INTO #GSTINVOICE  
 ...
 FROM [10.253.33.239].MSAJAG.dbo.TBL_GST_INVOICE   T (NOLOCK)     ,#cl C 
