-- Object: PROCEDURE dbo.AngelResetNSEBrok1_RL
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE Procedure [dbo].[AngelResetNSEBrok1_RL] (@sauda_date Varchar(11))
As
...
Delete  charges_detail where cd_party_code in (Select Party_code from AngelNSEResetBrok where Nsebrokerage >= 30 and sauda_date >= @Sauda_date+ ' 00:00' and sauda_date <= @Sauda_date+ ' 23:59')
And cd_sauda_date >= @Sauda_date+ ' 00:00' and cd_sauda_date <= @Sauda_date+ ' 23:59' and cd_sett_type in('N','W')
...
Select * into #Temp1 from (Select party_code,sett_type,Amount = Sum(trade_amount) from settlement where party_code in (select party_code from AngelNSEResetBrok where sauda_date >= @Sauda_date+ ' 00:00' and sauda_date <= @Sauda_date+ ' 23:59')
and sauda_date >= @Sauda_date+ ' 00:00' and sauda_date <= @Sauda_date+ ' 23:59'
