...
CREATE PROC [dbo].[RPT_MARGIN_SETT_FUNDINGREPORT_NEW]                
@FDATE VARCHAR(11),                
@TDATE VARCHAR(11),                
@REPOPTION VARCHAR(1)                
AS                
...
SELECT * INTO #V2_CLIENTFUNDINGDATA2 FROM         #V2_CLIENTFUNDINGDATA1
Where TOTALAMOUNT = (
SELECT   MAX(TOTALAMOUNT)AS AMT FROM #V2_CLIENTFUNDINGDATA1        
)     
/*------------------------------------*/        
