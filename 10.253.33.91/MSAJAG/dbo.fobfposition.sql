-- Object: PROCEDURE dbo.fobfposition
...
/****** Object:  Stored Procedure dbo.fobfposition    Script Date: 5/26/01 4:17:00 PM ******/
CREATE proc fobfposition(@sdate  varchar(11), @party  varchar(12)) as
select 
...
where c.Inst_Type = s.inst_type and
     ...
     and convert(varchar,c.expirydate,103) = convert(varchar,s.expirydate,103)
                            ...
                            and c.strike_price=s.strike_price
...
sell_buy,convert(varchar,c.expirydate,103)
