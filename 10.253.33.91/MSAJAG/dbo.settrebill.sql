-- Object: PROCEDURE dbo.settrebill
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.settrebill    Script Date: 3/17/01 9:56:10 PM ******/

/****** Object:  Stored Procedure dbo.settrebill    Script Date: 3/21/01 12:50:30 PM ******/

/****** Object:  Stored Procedure dbo.settrebill    Script Date: 20-Mar-01 11:39:09 PM ******/

/****** Object:  Stored Procedure dbo.settrebill    Script Date: 2/5/01 12:06:28 PM ******/

/****** Object:  Stored Procedure dbo.settrebill    Script Date: 12/27/00 8:59:03 PM ******/

/****** Object:  Stored Procedure dbo.settrebill    Script Date: 12/18/99 8:24:11 AM ******/
CREATE proc settrebill 
...
SELECT distinct settlement.party_code, settlement.billno,settlement.contractno, settlement.order_no ,tm=convert(char,sauda_date,8),
 ...
 scripname=scrip1.short_name,sdt=convert(VARchar,sauda_date,103),
 ...
 sett_mst.sett_no,sett_mst.sett_type,sett_mst.start_date,sett_mst.end_date,
...
order by settlement.party_code,scrip1.short_name
