-- Object: PROCEDURE dbo.RPT_KRA_CDSL_CLIENT_DATA_OLD
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

          
              
CREATE PROC [dbo].[RPT_KRA_CDSL_CLIENT_DATA_OLD]              
 (              
 @FROMDATE VARCHAR(11),              
 @TODATE  VARCHAR(11),              
 ...
 */              
 ...
 BEGIN              
  ...
  INTO              
   #SEL_PARTY              
  FROM CLASSFILEUPD WHERE SESSION_ID = 979259530              
