-- Object: PROCEDURE dbo.AtBseRearrangeAfterBillflag
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE  Procedure AtBseRearrangeAfterBillflag (@Sett_No varchar(7),@Sett_Type varchar(2),@Party_code Varchar(10),@Scrip_cd varchar(12),@Series varchar(3),@tmark varchar(2),@Participantcode varchar(15)) AS             
Declare 
@@trade_no varchar(14),
 @@Pqty numeric(9), 
 @@Sqty numeric(9),
