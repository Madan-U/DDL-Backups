-- Object: PROCEDURE dbo.usp_nxt_getOrderBasedBrokerageReport
...
CREATE PROCEDURE usp_nxt_getOrderBasedBrokerageReport     
 --declare      
...
BEGIN       
	...
	BEGIN     
		...
		when a.SCHEME_NAME like '%ITrade Premier Plus%' then 'ITrade Premier Plus' 
		...
		when @schemeType = 'ITradePremierPlus' then 'ITrade Premier Plus VBB'--ITrade Premier Plus VBB     
...
case when SCHEME_NAME like '%prime%' then 'iTrade Prime Plan'     
	...
	when SCHEME_NAME like '%ITrade Premier Plus VBB%' then 'ITrade Premier Plus'        
else 'iTrade Plan' end  end ) as SCHEME_NAME,       
sub_broker        
...
when @schemeType = 'ValueAdd' then 'Value Add Plan'     
when @schemeType = 'ITradePremierPlus' then 'ITrade Premier Plus'        
