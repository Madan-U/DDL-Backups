-- Object: PROCEDURE dbo.rpt_currentsettscrip
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



/****** Object:  Stored Procedure dbo.rpt_currentsettscrip    Script Date: 04/27/2001 4:32:38 PM ******/

/****** Object:  Stored Procedure dbo.rpt_currentsettscrip    Script Date: 3/21/01 12:50:14 PM ******/

/****** Object:  Stored Procedure dbo.rpt_currentsettscrip    Script Date: 20-Mar-01 11:38:55 PM ******/
/* created on 23/02/2001
    report : netposition
    file: nsedelcurrentscrip
*/
/* finds  total of sell and buy for a particular scrip of a particular client for a particular series and settlement
    It also finds whether that client has deposited any shares with us in advance */
CREATE PROCEDURE rpt_currentsettscrip
...
group by c.sett_no,c.sett_type,c.series,c.scrip_cd),0 )
 ...
 and d.sett_no =@settno and d.sett_type =@settype  and d.scrip_cd = @scripcd 
 and d.series = @series  
