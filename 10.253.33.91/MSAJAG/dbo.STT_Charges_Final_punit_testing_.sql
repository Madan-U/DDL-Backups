-- Object: PROCEDURE dbo.STT_Charges_Final_punit_testing_
...
--------------------------------------------------
 ...
 CREATE PROC [dbo].[STT_Charges_Final_punit_testing_] (                        
 @Sett_Type VARCHAR(2)                        
...
select * from STT_SETT_TABLE	where Party_Code ='D68655'		            
