-- Object: PROCEDURE dbo.NseValanGenerate_BAKJUL012017
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROC [dbo].[NseValanGenerate_BAKJUL012017] (@SETT_NO VARCHAR(7),@SETT_TYPE VARCHAR(2),@FLAGFORINCLUSIVEBROKERAGE INT) AS              
DECLARE               
@START_DATE DATETIME,              
@END_DATE DATETIME,              
@SEC_PAYIN DATETIME,              
