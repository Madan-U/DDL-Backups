-- Object: PROCEDURE dbo.rpt_ibranchwise
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



/****** Object:  Stored Procedure dbo.rpt_ibranchwise    Script Date: 04/27/2001 4:32:43 PM ******/

/****** Object:  Stored Procedure dbo.rpt_ibranchwise    Script Date: 3/21/01 12:50:18 PM ******/

/****** Object:  Stored Procedure dbo.rpt_ibranchwise    Script Date: 20-Mar-01 11:38:59 PM ******/

/****** Object:  Stored Procedure dbo.rpt_ibranchwise    Script Date: 2/5/01 12:06:19 PM ******/

/****** Object:  Stored Procedure dbo.rpt_ibranchwise    Script Date: 12/27/00 8:59:12 PM ******/
...
*/
CREATE PROCEDURE rpt_ibranchwise
@settno varchar(7),
@settype varchar(3),
@statusid varchar(15),
...
and s.partipantcode like rtrim(@pcode) + '%'
group by sett_no,sett_type,scrip_Cd,series,sell_buy
union all
select sett_no,sett_type,scrip_Cd,sell_buy,series,
qty=sum(tradeqty),amt=sum(marketrate*tradeqty) from ihistory s, client1 c1, client2 c2, branches b
