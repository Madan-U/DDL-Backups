-- Object: PROCEDURE dbo.PROC_COLL_RECO_UPLOAD-12082022
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE PROC [dbo].[PROC_COLL_RECO_UPLOAD-12082022] (@TDATE VARCHAR(10), @FILEFOR VARCHAR(20), @FILETYPE VARCHAR(50), @PROGID VARCHAR(50), @UNAME VARCHAR(50),@FILENAME VARCHAR(500) = '')
...
SELECT @BSEMEMBERCODE = MEMBERCODE FROM ANAND.BSEDB_AB.DBO.OWNER
...
/* Ajay/Ganesh (2022-Aug-11 Performacne Issue) -> Converting table into [CX] */
create clustered index ci_DATA on #DATA (TRANSDATE,EXCHANGE);
...
BEGIN
	...
	SELECT CONVERT(DATETIME,@TDATE,103), 
		   ...
		   .DBO.PIECE(FILE_DATA,',',4),  @FILENAME,UPLOAD_ON = GETDATE(),
			UPLOAD_BY = @UNAME,
