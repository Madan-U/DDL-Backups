-- Object: PROCEDURE dbo.RPT_CLIENT_COLL_ALLOC_bkp_20220509
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



create PROC [dbo].[RPT_CLIENT_COLL_ALLOC_bkp_20220509]
(
	@RUNDATE	VARCHAR(11)
)
AS
...
WHERE PROCESS_DT = @PREVDATE
AND ALLOCATECASH > 0
AND 1 = (CASE WHEN(EXCHANGE = 'MCX' AND SEGMENT ='FUTURES') THEN 1 ELSE 0 END)
*/
