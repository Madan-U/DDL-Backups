-- Object: PROCEDURE dbo.PROC_PNLPROCESS_Daily_SIVA
...
CREATE PROC [dbo].[PROC_PNLPROCESS_Daily_SIVA]                                          
(                                                                      
...
FROM  TBL_PNL_DATA_NEW_SIVA      WITH(NOLOCK)                                                                
...
FROM TBL_PNL_DATA_NEW_SIVA T (NOLOCK) WHERE SETT_TYPE IN ('A','X','AC','AD') AND RECTYPE = 'OPEN'
...
INTO #CHARGES_DETAIL FROM ANAND.BSEDB_AB.DBO.CHARGES_DETAIL WITH(NOLOCK)           WHERE CD_SAUDA_DATE >= @SAUDA_DATE AND CD_SAUDA_DaTE <=@SAUDA_DATE +' 23:59:59'
