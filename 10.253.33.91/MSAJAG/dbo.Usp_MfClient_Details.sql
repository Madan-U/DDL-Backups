-- Object: PROCEDURE dbo.Usp_MfClient_Details
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

    
CREATE proc [dbo].[Usp_MfClient_Details]
(                  
...
left outer join        
(select glcode,subcode from [196.1.115.143].investment_pan.dbo.sub_mast where subcode not like ''%0000'' and category not in(''E'',''L''))z        
