-- Object: PROCEDURE dbo.RPT_PNL_SHRT_LONG_V1
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

---EXEC RPT_PNL_SHRT_LONG 'BROKER','BROKER','APR  1 2020','MAR 31 2021','ZR1048R','ZR1048R','','Y', 'S','W'--944                                        
                                          
CREATE PROC [dbo].[RPT_PNL_SHRT_LONG_V1]
(                                                                          
 @STATUSID VARCHAR(25),                                                                          
