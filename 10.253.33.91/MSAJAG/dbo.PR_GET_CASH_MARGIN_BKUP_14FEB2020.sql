-- Object: PROCEDURE dbo.PR_GET_CASH_MARGIN_BKUP_14FEB2020
...
CREATE PROC [dbo].[PR_GET_CASH_MARGIN_BKUP_14FEB2020]      
(    
@EFFDATE Varchar(11),    
@INTMODE INT = 0      
) AS      
...
SELECT       
 ...
 QTY = SUM(QTY)      
FROM    
MSAJAG.DBO.DELTRANS D, MSAJAG.DBO.DELIVERYDP DP    
WHERE       
 D.BDPID = DP.DPID      
...
SELECT       
 ...
 QTY = SUM(QTY)      
FROM       
BSEDB.DBO.DELTRANS D , BSEDB.DBO.DELIVERYDP DP       
WHERE       
 D.BDPID = DP.DPID      
 AND DP.DESCRIPTION NOT LIKE '%POOL%'      
 AND DP.DESCRIPTION NOT LIKE '%PRINC%'      
