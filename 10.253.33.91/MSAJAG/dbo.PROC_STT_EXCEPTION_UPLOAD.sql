-- Object: PROCEDURE dbo.PROC_STT_EXCEPTION_UPLOAD
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROC [dbo].[PROC_STT_EXCEPTION_UPLOAD]  
(  
...
CASE WHEN REPLACE((REPLACE(PRADNYA.DBO.PIECE(FILETEXT,',',5),' ' ,'')),CHAR(13),'')='RE' THEN '2' ELSE '1' END 
...
'AUTO',GETDATE(),'AUTO',GETDATE(),  
PRADNYA.DBO.PIECE(FILETEXT,',',2),  
(CASE WHEN @FILETYPE = 'IND' THEN 1 ELSE 0 END)  
FROM MSAJAG.DBO.STT_TMP WHERE LEN(PRADNYA.DBO.PIECE(FILETEXT,',',2)) = 2  
END
