-- Object: PROCEDURE dbo.ContSectionAngel_ND
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE  Proc ContSectionAngel_ND 
(@StatusId Varchar(15), @StatusName Varchar(25), @Sauda_Date Varchar(11), @Sett_No Varchar(7), @Sett_Type Varchar(2), @FromParty_code Varchar(10) ,@ToParty_code Varchar(10), @Branch Varchar(10), @Sub_broker Varchar(10),@ToSub_broker Varchar(10))
As
...
S.billno,
convert(varchar,M.start_date,103) as start_date ,
convert(varchar,M.end_date,103) as end_date,
c1.email, 
...
Select ContractNo, S.Party_code, Order_No, TM=Convert(Varchar,Sauda_Date,108), Trade_no, Sauda_Date, S.Scrip_Cd, S.Series, 
ScripName = S1.Short_Name, SDT = Convert(Varchar,Sauda_date,103), Sell_Buy, S.MarketType,
Broker_Chrg =0, turn_tax=0,sebi_tax=0,s.other_chrg,
Ins_chrg = 0,Service_Tax = 0,NSerTax=0,
Sauda_Date1 = Left(Convert(Varchar,Sauda_date,109),11),
PQty = (Case When Sell_Buy = 1 Then TradeQty Else 0 End),
SQty = (Case When Sell_Buy = 2 Then TradeQty Else 0 End),
PRate = (Case When Sell_Buy = 1 Then MarketRate Else 0 End),
...
Select ContractNo, S.Party_code, Order_No, TM=Convert(Varchar,Sauda_Date,108), Trade_no, Sauda_Date, S.Scrip_Cd, S.Series, 
ScripName = S1.Short_Name , SDT = Convert(Varchar,Sauda_date,103), Sell_Buy=(CASE WHEN SELL_BUY = 1 THEN 2 ELSE 1 END), S.MarketType, Broker_Chrg =0, turn_tax=0,sebi_tax=0,s.other_chrg,
Ins_chrg = 0,Service_Tax = 0,NSerTax=0,
Sauda_Date1 = Left(Convert(Varchar,Sauda_date,109),11),
...
l_address1,l_address2,l_address3,l_city,l_zip,service_chrg,Branch_cd,sub_broker,pan_gir_no,
billno,end_date,start_date ,email, 
Off_Phone1,Off_Phone2,Printf
...
l_city,l_zip,service_chrg,Branch_cd,sub_broker,pan_gir_no,
billno,end_date,start_date ,email, 
Off_Phone1,Off_Phone2,Printf
...
order by Branch_cd,Party_code,Partyname,ScripName,Order_No, Trade_No
