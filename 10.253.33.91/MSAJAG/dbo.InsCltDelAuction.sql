...
CREATE Proc InsCltDelAuction ( @Sett_no Varchar(7),@Sett_Type Varchar(2),@RefNo int) as
 		...
 		begin
	  		...
	  		begin
				...
				begin    
					...
					,HolderName,Reason='Auction PayOut '+Right(@@ASett_no,3)+'-'+@@ASett_Type,'D',Delivered,OrgQty,DpType,'','',BranchCd,PartipantCode,SlipNo,BatchNo,ISett_No,ISett_Type,ShareType,TransDate,Filler1,1,Filler3,BDpType,BDpId,BCltDpId,Filler4,Filler5
					...
					update DelTrans set Reason='Transfered To Auction PayOut',Delivered='D'
   				...
   				begin
					...
					,HolderName,Reason='Auction PayOut '+Right(@@ASett_no,3)+'-'+@@ASett_Type,DrCr,Delivered,OrgQty,DpType,'','',BranchCd,PartipantCode,SlipNo,BatchNo,ISett_No,ISett_Type,ShareType,TransDate,Filler1,1,Filler3,BDpType,BDpId,BCltDpId,Filler4,Filler5
					from DelTrans
					where sett_no  = @sett_no and sett_type = @sett_type
   					and RefNo = @RefNo 
   					AND SNO = @@SNo and TCode = @@TCode	
...
And Delivered = '0' And TrType = 904 And Reason Like 'Auction PayOut%'
...
And Sett_No = @Sett_no And Sett_Type = @Sett_Type And Reason Like 'Excess %' And TrType = 904 And Reason Like 'Auction PayOut%'
