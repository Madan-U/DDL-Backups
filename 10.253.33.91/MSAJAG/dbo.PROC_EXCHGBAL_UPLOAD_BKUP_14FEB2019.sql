-- Object: PROCEDURE dbo.PROC_EXCHGBAL_UPLOAD_BKUP_14FEB2019
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE PROC [dbo].[PROC_EXCHGBAL_UPLOAD_BKUP_14FEB2019]      
(      
 @TDATE  VARCHAR(10),       
 @FILEFOR VARCHAR(20),       
 @FILETYPE VARCHAR(50),       
...
END  
 ...
 DELETE FROM ACCOUNT.DBO.TBL_EXCHGBAL_DATA   
 WHERE EFF_DATE = CONVERT(DATETIME, @TDATE,103)  
  
 INSERT INTO ACCOUNT.DBO.TBL_EXCHGBAL_DATA  
