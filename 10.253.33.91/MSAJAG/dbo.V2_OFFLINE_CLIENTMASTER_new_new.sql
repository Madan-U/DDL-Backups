-- Object: PROCEDURE dbo.V2_OFFLINE_CLIENTMASTER_new_new
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROC [dbo].[V2_OFFLINE_CLIENTMASTER_new_new](                                                      
...
(select cl_code from #y) and Inactive_from =  '2049-12-31 00:00:00.000' and LEFT(active_date,11)=@ModifyDate            
)            
