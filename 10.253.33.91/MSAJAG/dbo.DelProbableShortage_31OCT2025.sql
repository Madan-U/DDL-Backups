-- Object: PROCEDURE dbo.DelProbableShortage_31OCT2025
...
CREATE Proc [dbo].[DelProbableShortage_31OCT2025] ( @OptionFlag  int = 0) As                         
DeClare                         
@@Sett_No Varchar(7),                        
@@Sett_Type Varchar(2),                        
...
Insert into #NSE_DelPayInMatch    
 ...
 Where Filler2 = 1 And DrCr = 'D' And Delivered <> 'D' And TrType in (907,908) and certno <> 'AUCTION'            
