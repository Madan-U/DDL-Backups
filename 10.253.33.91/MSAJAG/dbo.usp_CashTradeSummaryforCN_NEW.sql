-- Object: PROCEDURE dbo.usp_CashTradeSummaryforCN_NEW
...
CREATE PROCEDURE [dbo].[usp_CashTradeSummaryforCN_NEW] 
...
AS
	BEGIN
		...
		( 
					 ...
					 TO_TAX money NULL, SEBI_TAX money NULL, STAMPDUTY money NULL, SER_TAX money NULL,IPFT_CHRG  money, BILLFLAG int NOT NULL, Grand_Total money NULL,
		...
		INSERT INTO #Temp( Trade_Type, EXCHANGE, SETT_NO, PARTY_CODE, SAUDA_DATE, TRD_DT, SCRIP_CD, SCRIPName, Buy_qty, BuyMarketRate, Sell_qty, SellMarketRate, BROKERAGE, STT, Other_charges, TO_TAX, SEBI_TAX, STAMPDUTY, SER_TAX,IPFT_CHRG, BILLFLAG, Grand_Total )
			   SELECT Trade_Type, EXCHANGE, SETT_NO, PARTY_CODE, SAUDA_DATE, TRD_DT, SCRIP_CD, SCRIPName, Buy_qty, BuyMarketRate, Sell_qty, SellMarketRate, BROKERAGE, STT, Other_charges, TO_TAX, SEBI_TAX, STAMPDUTY, SER_TAX,IPFT_CHRG, BILLFLAG, Grand_Total
			   FROM vw_NSESauda
		...
		INSERT INTO #Temp( Trade_Type, EXCHANGE, SETT_NO, PARTY_CODE, SAUDA_DATE, TRD_DT, SCRIP_CD, SCRIPName, Buy_qty, BuyMarketRate, Sell_qty, SellMarketRate, BROKERAGE, STT, Other_charges, TO_TAX, SEBI_TAX, STAMPDUTY, SER_TAX,IPFT_CHRG, BILLFLAG, Grand_Total )
			   SELECT Trade_Type, EXCHANGE, SETT_NO, PARTY_CODE, SAUDA_DATE, TRD_DT, SCRIP_CD, SCRIPName, Buy_qty, BuyMarketRate, Sell_qty, SellMarketRate, BROKERAGE, STT, Other_charges, TO_TAX, SEBI_TAX, STAMPDUTY, SER_TAX,0, BILLFLAG, Grand_Total
...
/* Added below 1st update by dinesh jadhav to update Additional brokerage of scrip_cd type BRKSCR */
	    ...
	    insert into Tbl_CashTradeSummaryforCN (Trade_Type,EXCHANGE,SETT_NO,PARTY_CODE,SAUDA_DATE,TRD_DT,SCRIP_CD,SCRIPName,Buy_qty,BuyMarketRate,Sell_qty,SellMarketRate,BROKERAGE,STT,Other_charges,
 TO_TAX,SEBI_TAX,STAMPDUTY,SER_TAX,BILLFLAG,Grand_Total,Long_Name,Address,Branch_Cd,pan_gir_no,Period,ReportDate,	OrderPriority,IPFT_CHRG)
		SELECT  Trade_Type,EXCHANGE,SETT_NO,PARTY_CODE,SAUDA_DATE,TRD_DT,SCRIP_CD,SCRIPName,Buy_qty,BuyMarketRate,Sell_qty,SellMarketRate,BROKERAGE,STT,Other_charges,
 TO_TAX,SEBI_TAX,STAMPDUTY,SER_TAX,BILLFLAG,Grand_Total,Long_Name,Address,Branch_Cd,pan_gir_no,Period,ReportDate,	OrderPriority,IPFT_CHRG
 FROM #temp ORDER BY EXCHANGE,OrderPriority, SCRIPName
