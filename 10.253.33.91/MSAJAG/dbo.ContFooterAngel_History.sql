-- Object: PROCEDURE dbo.ContFooterAngel_History
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE proc ContFooterAngel_History (@Sdate varchar(12), @Sett_Type varchar(2), @ContNo varchar(7), @sell_buy varchar(1),@Sett_no Varchar(10),@Party_code Varchar(15)) as  
 Select  
...
TotalDelivery = isnull(sum(tradeqty*(NBrokApp-Brokapplied)),0)   from History where   
