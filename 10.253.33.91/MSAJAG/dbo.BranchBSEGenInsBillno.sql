-- Object: PROCEDURE dbo.BranchBSEGenInsBillno
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROCEDURE BranchBSEGenInsBillno (@Sett_no varchar(7),@sett_Type varchar(3),@statusid varchar(12),@statusname varchar(12)) as 
Declare @@Party varchar(12),
	 ...
	 Begin	
	        Set @@PartyCont = cursor for 
                 Select Distinct ISettlement.Party_Code,Isnull(Billno,0) From ISettlement, Client2 ,Branches
                 Where Sett_no = @Sett_no and sett_type = @Sett_type  
	 	 and client2.party_code = ISettlement.party_code 
                 and ISettlement.user_id = branches.terminal_id		
                 And Branches.Branch_cd = @StatusName
                 /* Group by Party_Code  */
                 Order By ISettlement.Party_code 
	End
	Else
	Begin
	        Set @@PartyCont = cursor for 
