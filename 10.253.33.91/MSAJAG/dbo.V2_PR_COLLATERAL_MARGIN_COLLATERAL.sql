-- Object: PROCEDURE dbo.V2_PR_COLLATERAL_MARGIN_COLLATERAL
...
CREATE TABLE #BSEVAR (
	...
	IF CONVERT(DATETIME, @EFFDATE) <= CONVERT(DATETIME, 'Jun 27 2025')
	...
	BEGIN
                ...
                WHERE V.DETAILKEY = C.DETAILKEY
                                ...
                                AND C.RECDATE = (
                                                ...
                                                WHERE C1.RECDATE <= @PRV_DATE + ' 23:59'
...
BEGIN
                ...
                WHERE V.DETAILKEY = C.DETAILKEY
                                ...
                                AND C.RECDATE = (
                                                ...
                                                WHERE C1.RECDATE <= @EFFDATE + ' 23:59'
