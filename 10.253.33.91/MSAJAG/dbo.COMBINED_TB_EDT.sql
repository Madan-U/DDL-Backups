...
--------------------------------------------------
 ...
 CREATE PROCEDURE COMBINED_TB_EDT      
 (      
 @FROMDATE VARCHAR(20)      
 )      
 AS       
 ...
 into #TEMP1      
   ...
   WHERE       
    ...
    ---AND CLTCODE IN ('ZZZU1002','ZZZW1012','ZZZW1044','ZZZW1042')      
     ...
     SELECT * into #d FROM #TEMP1  WHERE   TOTAL<>0 and cltcode between 'a0'and 'zzz999'      
...
union      
 ...
 UNION        
  ...
  SELECT * FROM #FINAL_DATA WHERE cltcode BETWEEN 'Q0'AND 'UZZZ999'      
   SELECT * FROM #FINAL_DATA WHERE cltcode BETWEEN 'V0'AND 'UZZZ999'      
   END
