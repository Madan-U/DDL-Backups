-- Object: PROCEDURE dbo.PROC_PNLPROCESS_DJ46
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

                  
                  
CREATE PROC [dbo].[PROC_PNLPROCESS_DJ46]              
(                                          
...
INSERT INTO TBL_PNL_DATA_TMP                                          
  ...
  ---FROM   BSEDB_AB_HISTORY010411TO180711.dbo.NSEHISTORY WITH(NOLOCK)   
    FROM   BSEDB_AB_HISTORY010411TO180711.dbo.NSEHISTORY_010410_To_310311_DJ46 WITH(NOLOCK)   
 /* select * into BSEDB_AB_HISTORY010411TO180711.dbo.NSEHISTORY_010410_To_310311_DJ46    
  From  MSAJAG.DBO.HISTORY   
  where Sauda_date between '2010-04-01 00:00:00.000' and '2011-03-31 23:59:59.000'  
  and Party_code='DJ46'  
  Create clustered index IX_Sauda_date on BSEDB_AB_HISTORY010411TO180711.dbo.NSEHISTORY_010410_To_310311_DJ46  
  (Sauda_date)  
*/  
...
INSERT INTO TBL_PNL_DATA_TMP                                    
  ...
  ORGDATE=LEFT(SAUDA_DATE,11),                                      
   0, 1, RECTYPE = (CASE WHEN SETTFLAG IN (2,3) THEN 'SPEC' ELSE 'OPEN' END)                                
  FROM  BSEDB_AB_HISTORY010411TO180711.dbo.HISTORY_010410_To_310311_DJ46  WITH(NOLOCK)    
  --FROM   BSEDB_AB_HISTORY010411TO180711.dbo.HISTORY WITH(NOLOCK)    
      
   /* select * into BSEDB_AB_HISTORY010411TO180711.dbo.HISTORY_010410_To_310311_DJ46    
  From  [anand].BSEDB_AB.DBO.HISTORY   
  where Sauda_date between '2010-04-01 00:00:00.000' and '2011-03-31 23:59:59.000'  
  and Party_code='DJ46'  
  Create clustered index IX_Sauda_date on BSEDB_AB_HISTORY010411TO180711.dbo.HISTORY_010410_To_310311_DJ46   
  (Sauda_date)  
  */  
