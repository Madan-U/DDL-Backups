-- Object: PROCEDURE dbo.Rpt_GrpExpNewSub
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.Rpt_GrpExpNewSub    Script Date: 05/20/2002 5:24:33 PM ******/
CREATE proc Rpt_GrpExpNewSub
...
begin
	...
	and Sub_Broker >= @fcode  and Sub_Broker <= @tcode and C1.Cl_Code = C2.Cl_Code and C2.Party_Code = S.Party_Code
	union all
	select sett_no,sett_type,s.party_code,c1.short_name,family,scrip_cd,series,sell_buy,Pqty,Pamt,Sqty,samt,Branch_Cd,Sub_Broker
...
begin
	...
	where sett_no like @sett_no+'%' and sett_type like @sett_type+'%' 
	and Sub_Broker >= @fcode  and Sub_Broker <= @tcode
	and c1.cl_code = c2.cl_code and c2.party_code = S.Party_Code  
