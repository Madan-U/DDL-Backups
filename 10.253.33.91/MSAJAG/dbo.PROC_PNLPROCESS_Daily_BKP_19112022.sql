-- Object: PROCEDURE dbo.PROC_PNLPROCESS_Daily_BKP_19112022
...
CREATE PROC [dbo].[PROC_PNLPROCESS_Daily_BKP_19112022]                                          
(                                                                      
...
UPDATE TBL_PNL_DATA SET OPPDATE = ORGDATE + 366 WHERE SETT_TYPE IN ('A','X','AC','AD') AND RECTYPE = 'OPEN'
