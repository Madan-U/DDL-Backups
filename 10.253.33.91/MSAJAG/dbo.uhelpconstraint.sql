-- Object: PROCEDURE dbo.uhelpconstraint
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.uhelpconstraint    Script Date: 3/17/01 9:56:12 PM ******/

/****** Object:  Stored Procedure dbo.uhelpconstraint    Script Date: 3/21/01 12:50:33 PM ******/

/****** Object:  Stored Procedure dbo.uhelpconstraint    Script Date: 20-Mar-01 11:39:11 PM ******/

/****** Object:  Stored Procedure dbo.uhelpconstraint    Script Date: 2/5/01 12:06:30 PM ******/

/****** Object:  Stored Procedure dbo.uhelpconstraint    Script Date: 12/27/00 8:59:05 PM ******/

/****** Object:  Stored Procedure dbo.uhelpconstraint    Script Date: 12/18/99 8:24:06 AM ******/
create procedure uhelpconstraint --1996/07/02 16:33
...
--------
if exists (select * from sysobjects where id = object_id('dbo.spcnsttab') )
 drop table dbo.spcnsttab
if exists (select * from sysobjects where id = object_id('dbo.spcnstkeys'))
 drop table dbo.spcnstkeys
select
       @bitDisabled           = 0x4000
