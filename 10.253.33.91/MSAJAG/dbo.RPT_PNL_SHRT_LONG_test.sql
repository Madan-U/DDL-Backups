-- Object: PROCEDURE dbo.RPT_PNL_SHRT_LONG_test
...
CREATE PROC [DBO].[RPT_PNL_SHRT_LONG_test]                                                                            
(                                                                              
 @STATUSID VARCHAR(25),                                                                              
...
REGION  = CONVERT(VARCHAR(20),'')                                            
 ...
 FROM TBL_PNL_DATA T                                                                      
 WHERE 1 = 2                                            
       and party_code in (select cltcode from OLDNEW )      
  --select * from #TBL_PNL_DATA where party_code='A100510'  
  --return                                          
...
ISIN,                                                                      
 ...
 #TBL_PNL_DATA T                                            
 WHERE                                            
 PARTY_CODE IN (SELECT DISTINCT PARTY_CODE FROM #CLIENT_DETAILS )       and party_code in (select cltcode from OLDNEW )                                             
    /*                                            
