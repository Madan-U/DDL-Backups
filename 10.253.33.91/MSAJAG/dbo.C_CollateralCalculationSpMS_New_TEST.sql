-- Object: PROCEDURE dbo.C_CollateralCalculationSpMS_New_TEST
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


-- EXEC C_CollateralCalculationSpMS_New_test 'NSE', 'FUTURES', '0', 'ZZZ', 'AUG  6 2013', 'AUG  6 2013', 'NSEFO', '', 0                             
                                                                                
CREATE PROCEDURE [dbo].[C_CollateralCalculationSpMS_New_test]                                                                             
(                                                                            
    @EXCHANGE VARCHAR(3),                                                                             
    @SEGMENT VARCHAR(20),                                                                             
...
SET @APPRSEC = 1                                                                        
 ...
 /*=======================================================                                                                            
 EXEC C_COLLATERALCALCULATIONSPMS                                                                             
         @EXCHANGE = 'NSE',                                                                             
         @SEGMENT = 'FUTURES',                                                                             
         @FROMPARTY = 'klns516',                                                                             
         @TOPARTY = 'klns516',                                                                             
 ...
 HAIRCUT       =0  ,                                                                        
 TOTALSECAMOUNT=0                                                                                
 FROM ANGELDEMAT.MSAJAG.DBO.bak_deltrans_inst D (nolock), 
 ...
 HAIRCUT       =0  ,                                                                        
 TOTALSECAMOUNT=0                                                                                  
 FROM ANGELDEMAT.BSEDB.DBO.bak_deltrans_inst D (nolock), 
