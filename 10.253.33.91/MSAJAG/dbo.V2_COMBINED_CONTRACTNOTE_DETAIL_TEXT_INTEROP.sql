-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_DETAIL_TEXT_INTEROP
...
CREATE PROCEDURE [dbo].[V2_COMBINED_CONTRACTNOTE_DETAIL_TEXT_INTEROP]             
 (            
 @STATUSID VARCHAR(15),            
...
AND EXISTS (SELECT EXCHANGE FROM #EXCHANGELIST E WHERE E.EXCHANGE = LTRIM(RTRIM(C.EXCHANGE))+LTRIM(RTRIM(C.SEGMENT)) )
 ...
 SELECT            
  ...
  TRADE_NO,            
  TRADE_TIME,            
 SCRIPNAME = CASE WHEN SEGMENT ='CAPITAL' THEN REPLACE(SCRIPNAME,'BROKERAGE','DELIVERY HANDLNG CHRG') ELSE SCRIPNAME END + (CASE WHEN @INTEROP <> '' THEN '-' + EXCHANGE ELSE '' END),
  QTY,            
 TMARK = (CASE WHEN @INTEROP <> '' THEN '' ELSE CASE WHEN SEGMENT ='FUTURES' THEN '' ELSE TMARK END END),  
  ...
  BFCF_FLAG,            
  CONTRACT_HEADER_DET,            
  REMARK=EXCHANGE + (CASE WHEN REMARK_ID <> '' THEN ' - ' + REMARK_ID ELSE '' END),
  COMPANYNAME,            
  REMARK_ID,            
  REMARK_DESC,            
  NETOBLIGATION,             
