-- Object: PROCEDURE dbo.NSE_SCRIPMAPPINGUPLOAD_BKP_19APR2024_SRE_24991
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



--ALTERED SP due to T0 series blocker issue under SRE-24443

CREATE PROC [dbo].[NSE_SCRIPMAPPINGUPLOAD_BKP_19APR2024_SRE_24991] (@FilePath Varchar(100)) AS            
...
SELECT *,0 FROM #TBL_EXCHG_SCRIP_MAP_TMP  WHERE NSE_SERIES <>'T0'
