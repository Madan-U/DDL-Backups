-- Object: PROCEDURE dbo.USP_Update_Party_Bank_Details_NEW
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROCEDURE [dbo].[USP_Update_Party_Bank_Details_NEW]          
AS         
BEGIN             
...
SELECT * INTO #Party_Bank_Detailstemp    
              FROM MSAJAG.DBO.tbl_Party_Bank_Details_NEW WITH(NOLOCK) WHERE 1=0   
...
--SELECT * INTO tbl_Party_Bank_Details_NEW FROm Party_Bank_Details  WITH(NOLOCK) WHERE 1=0
  ...
  TRUNCATE TABLE MSAJAG.DBO.tbl_Party_Bank_Details_NEW

  INSERT INTO MSAJAG.DBO.tbl_Party_Bank_Details_NEW
