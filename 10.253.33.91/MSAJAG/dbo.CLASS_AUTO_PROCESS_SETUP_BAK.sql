-- Object: PROCEDURE dbo.CLASS_AUTO_PROCESS_SETUP_BAK
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROC [dbo].[CLASS_AUTO_PROCESS_SETUP_BAK]            
(            
...
BEGIN            
 ...
 FROM   TBL_AUTO_PROCESS_MASTER_BAK            
 ...
 BEGIN            
  ...
  FROM TBL_AUTO_PROCESS_MASTER_BAK T, SETT_MST M             
...
AND @BUSINESS_DATE IN (SELECT SEC_PAYIN FROM SETT_MST WHERE SEC_PAYIN = @BUSINESS_DATE)             
  ...
  SELECT PROCESS_ID, SETT_NO, SETT_TYPE,             
   ...
   PROCESS_START_DATE=CONVERT(DATETIME,LEFT(GETDATE(),11) + ' ' + PROCESS_START_TIME),            
   PROCESS_END_DATE=CONVERT(DATETIME,LEFT(GETDATE(),11) + ' ' + PROCESS_END_TIME)             
  FROM TBL_AUTO_PROCESS_MASTER_BAK T            
...
ORDER BY 1  
 ...
 SELECT M.PROCESS_ID, M.SETT_NO, M.SETT_TYPE,             
  ...
  FROM TBL_AUTO_PROCESS_MASTER_BAK M, #DATA D            
 ...
 DELETE TBL_AUTO_PROCESS_DETAIL_BAK            
 WHERE PROCESS_DATE = LEFT(GETDATE(),11)            
             
 INSERT INTO TBL_AUTO_PROCESS_DETAIL_BAK            
 ...
 SELECT PROCESS_DATE=LEFT(GETDATE(),11),BUSINESS_DATE=CONVERT(DATETIME,S.BUSINESS_DATE),            
  ...
  PROCESS_OUTPUT_QUERY,'',      
  PROCESS_ORDER_ID            
 FROM TBL_AUTO_PROCESS_MASTER_BAK M, #MASTER_SETUP S            
