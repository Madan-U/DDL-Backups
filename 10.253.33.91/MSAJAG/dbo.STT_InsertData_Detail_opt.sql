-- Object: PROCEDURE dbo.STT_InsertData_Detail_opt
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



Create Proc [dbo].[STT_InsertData_Detail_opt] 
(
	@Sett_Type Varchar(2), 
...
Begin  
 ...
 Where Sett_type = @sett_type And Sauda_Date >=@Sauda_Date And Sauda_Date <=@Sauda_Date + ' 23:59'--And Sauda_date Like @sauda_date + '%'  
