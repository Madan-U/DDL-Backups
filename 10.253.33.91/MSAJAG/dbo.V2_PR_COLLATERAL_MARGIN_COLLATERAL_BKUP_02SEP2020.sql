-- Object: PROCEDURE dbo.V2_PR_COLLATERAL_MARGIN_COLLATERAL_BKUP_02SEP2020
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


  --BEGIN TRAN  
  --   EXEC V2_PR_COLLATERAL_MARGIN_COLLATERAL 'APR 28 2020'     
       
       
  --   ROLLBACK         
            
 CREATE PROCEDURE [dbo].[V2_PR_COLLATERAL_MARGIN_COLLATERAL_BKUP_02SEP2020]            
(                  
  @EFFDATE VARCHAR(11),                  
