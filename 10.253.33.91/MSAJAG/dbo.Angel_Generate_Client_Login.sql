-- Object: PROCEDURE dbo.Angel_Generate_Client_Login
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE Procedure Angel_Generate_Client_Login       
as        
...
(
--fldauto
 fldusername,fldpassword,fldfirstname,fldmiddlename
,fldlastname,fldsex,fldaddress1,fldaddress2
,fldphone1,fldphone2,fldcategory,fldadminauto
,fldstname,PWD_EXPIRY_DATE
)
select * from #file1             
