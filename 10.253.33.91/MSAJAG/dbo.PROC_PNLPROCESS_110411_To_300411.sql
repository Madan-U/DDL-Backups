-- Object: PROCEDURE dbo.PROC_PNLPROCESS_110411_To_300411
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE PROC [dbo].[PROC_PNLPROCESS_110411_To_300411]                                
(                                                            
...
INSERT INTO TBL_PNL_DATA_TMP                                                            
  ...
  ---FROM BSEDB_AB_HISTORY010411TO180711.dbo.NSEHISTORY WITH (NOLOCK)                     
    FROM BSEDB_AB_HISTORY010411TO180711.dbo.NSEHISTORY_310511_To_30062011 WITH (NOLOCK)                     
 /*             
...
INSERT INTO TBL_PNL_DATA_TMP                                                      
  ...
  ORGDATE=LEFT(SAUDA_DATE,11),                                                        
   0, 1, RECTYPE = (CASE WHEN SETTFLAG IN (2,3) THEN 'SPEC' ELSE 'OPEN' END)                                                  
  FROM  BSEDB_AB_HISTORY010411TO180711.dbo.HISTORY_310511_To_300611  WITH(NOLOCK)                      
...
INTO #CHARGES_DETAIL   
FROM ANAND.BSEDB_AB.DBO.CHARGES_DETAIL with (nolock)   
...
PNLRATE = PNLRATE + (CASE WHEN SELL_BUY = 1 AND BILLFLAG = 2                                      
         ...
         ELSE 0                                      
        END)                                      
FROM #CHARGES_DETAIL with (nolock)                                    
...
AND VALID = 1                                                            
 ...
 FROM MSAJAG.DBO.CMBILLVALAN M   
  ...
  UPDATE TBL_PNL_DATA_TMP                                                                      
  SET ISIN = M.ISIN                                             
 FROM BSEDB_AB_HISTORY010411TO180711.DBO.BSE_CMBILLVALAN M  
