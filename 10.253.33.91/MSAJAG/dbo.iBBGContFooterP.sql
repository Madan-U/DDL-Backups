-- Object: PROCEDURE dbo.iBBGContFooterP
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE proc iBBGContFooterP (@Sdate varchar(12), @Sett_Type varchar(2), @ContNo varchar(6), @sell_buy varchar(1),@flag smallint,@Sett_no Varchar(10),@Party_code Varchar(15)) as
 ...
 SETT_TYPE, contractno  from isettlement where 
