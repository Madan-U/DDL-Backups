-- Object: PROCEDURE dbo.focheckqty1
...
/****** Object:  Stored Procedure dbo.focheckqty1    Script Date: 5/26/01 4:17:00 PM ******/
CREATE proc focheckqty1 (@sdate smalldatetime,@inst varchar(6),@symbol varchar(12),@expirydate smalldatetime) as
...
totalqty=( isnull(( select sum(tradeqty) from fosettlement 
                	   where sell_buy = 1 and 
                           ...
                           fosettlement.party_code=s1.party_code),0)
            -
