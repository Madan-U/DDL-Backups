-- Object: PROCEDURE dbo.DELPOSITIONUP_T1Change_25022022
...
CREATE PROC [dbo].[DELPOSITIONUP_T1Change_25022022] @SETT_NO VARCHAR(10),@SETT_TYPE VARCHAR(3),@PARTY_CODE VARCHAR(10),@SCRIP_CD VARCHAR(12)          
AS           
