...
-- // DESCREPTION IMPORT ALLOCATION_CC01 FILE INTO TABLE SRE:- 16355  
...
CREATE PROC [dbo].[USP_ALLOCATION_CC01_IMPORT] (@DATE AS DATETIME, @PATH VARCHAR (100), @EXCHANGE VARCHAR(3),@SEGMENT VARCHAR(7) )  
...
INSERT INTO DUSTBIN.DBO.ALLOCATE_TEMP_NEW  
