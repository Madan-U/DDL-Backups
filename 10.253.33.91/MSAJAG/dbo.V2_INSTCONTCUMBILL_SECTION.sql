-- Object: PROCEDURE dbo.V2_INSTCONTCUMBILL_SECTION
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE Proc [dbo].[V2_INSTCONTCUMBILL_SECTION]  
(  
@STATUSID VARCHAR(15),  
...
-- EXEC  V2_INSTCONTCUMBILL_SECTION 'broker', 'broker', 'APR 25 2013', '2013079', 'N', '0', 'ZZ', '0', 'ZZ', '0', 'ZZ', '0', '9999999', 'CONTRACT'
...
where exists (select co_code from #scrip2 where #scrip2.co_code = scrip1.co_code and #scrip2.series = scrip1.series)
	...
	FROM	CUSTODIAN   
	WHERE   #INSTCONTCUMBILL.CUSTODIANCODE = CUSTODIAN.CUSTODIANCODE    
