-- Object: PROCEDURE dbo.NSENRIHEADER_t1_BKP_18FEB2025_SRE_34258
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------



CREATE PROC  [dbo].[NSENRIHEADER_t1_BKP_18FEB2025_SRE_34258] (@SDATE AS VARCHAR(11),@SELL_BUY AS VARCHAR(1))             
AS                          
...
SELECT @@SETT_NO1 = SETT_NO FROM SETT_MST WHERE START_DATE LIKE @SDATE+'%'  AND SETT_TYPE ='N'       
 ...
 FROM                        
(SELECT  'NSECM' AS EXCHANGE,PARTY_CODE,SAUDA_DATE,SELL_BUY,MAX (CONTRACTNO) AS CONTRACTNO,                          
