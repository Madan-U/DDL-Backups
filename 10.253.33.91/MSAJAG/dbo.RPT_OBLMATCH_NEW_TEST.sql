-- Object: PROCEDURE dbo.RPT_OBLMATCH_NEW_TEST
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROC [dbo].[RPT_OBLMATCH_NEW_TEST]               
...
AS              
      ...
      ---  EXEC RPT_OBLMATCH_NEW_TEST '2019174' ,'N','SEP 16 2019', 'Y' 
...
MATCHSTATUS = 1          
INTO #BSE_OBL      
FROM ANAND.BSEDB_AB.DBO.TBL_BSE_OBL   
WHERE 1 = 2 
...
BEGIN
	...
	BEGIN 
		...
		INSERT INTO #BSE_OBL
		EXEC ANAND.BSEDB_AB.DBO.RPT_OBLMATCH @OTHER_SETT_NO, @OTHER_SETT_TYPE
		...
		WHERE M.ISIN = #BSE_OBL.ISIN AND @Start_Date BETWEEN FROM_DATE AND TO_DATE 
		 ...
		 SELECT * FROM #BSE_OBL --WHERE SCRIP_CD ='ROLTA' 
...
SELECT * FROM #SETT_FIN WHERE SCRIP_CD ='ROLTA'
RETURN
...
SELECT * FROM TBL_NSE_OBL WHERE SETT_NO ='2019174' AND sCRIP_CD ='ROLTA'
