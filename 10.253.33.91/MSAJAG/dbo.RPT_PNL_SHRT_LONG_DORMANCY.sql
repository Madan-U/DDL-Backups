-- Object: PROCEDURE dbo.RPT_PNL_SHRT_LONG_DORMANCY
...
CREATE PROC [dbo].[RPT_PNL_SHRT_LONG_DORMANCY]                                                                        
(                                                                          
 @STATUSID VARCHAR(25),                                                                          
...
REGION  = CONVERT(VARCHAR(20),'')                                        
 ...
 CREATE CLUSTERED INDEX  [INX_PNL_DATA]                                               
  ...
  SELECT a.* INTO #TBL_PNL_DATA_N             
  FROM TBL_PNL_DATA a WITH(NOLOCK)
  INNER JOIN ##temp_party_codes b on a.PARTY_CODE =  b.party_code             
...
INNER JOIN ##temp_party_codes b on c.CL_CODE =  b.party_code                                       
WHERE                                              
...
SELECT c.* INTO #T FROM INTRANET.RISK.DBO.CLIENT_DETAILS c WITH (NOLOCK) 
INNER JOIN ##temp_party_codes b on c.CL_CODE =  b.party_code                        
...
REGION  = ''                                        
 ...
 WHERE
-- T.PARTY_CODE BETWEEN @FROMPARTY AND @TOPARTY                                                                          
