-- Object: PROCEDURE dbo.RPT_DAILYMARGINSTATEMENT_Aws_Bak_29102021
...
Create PROC [dbo].[RPT_DAILYMARGINSTATEMENT_Aws_Bak_29102021]                                          
...
from anand1.msajag.dbo.TBL_COMBINE_REPORTING where MARGINDATE =@MDATE    ---and party_code ='HEMC004'
...
from anand1.msajag.dbo.TBL_COMBINE_REPORTING_peak where MARGINDATE =@MDATE  --and party_code ='HEMC004'
group by party_code,TDAY_MARGIN_SHORT,TDAY_MTM_SHORT,MARGINDATE
)A
