-- Object: PROCEDURE dbo.rpt_confirmreportfamily
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


/****** Object:  Stored Procedure dbo.rpt_confirmreportfamily    Script Date: 07/11/2002 6:02:06 PM ******/
/* Changed by Girish 11 jul 2002 added sett no and removed union with history
execute rpt_confirmreportgir 'broker','broker', 'N','2002043','2002043','n00020','n00020','','feb 28 2002'
 */ 
...
CREATE PROCEDURE rpt_confirmreportfamily
@statusid varchar(15),
...
if @statusid = 'broker'
begin
SELECT c1.family, tm=convert(varchar,sauda_date,108),
...
/*   N_NetRate,CL_RATE=0,*/
 ...
 and c1.family >= @fcode and c1.family <= @tcode
and left(convert(varchar,s.sauda_date,109),11) =@sdate 
and c1.trader like ltrim(@trader)+'%'
 AND s.TRADEQTY <> '0'  
 and status <> 'N'
 group by c1.family,billno,  trade_no, sauda_date, s.scrip_cd, s.series, 
...
select c1.family,tm=(Select Convert(Varchar,Min(Sauda_Date),108) from Isettlement i where i.scrip_cd = s.scrip_cd and i.dummy2 = s.dummy2 
           and i.party_code = c1.family and i.Sauda_Date like @SDate + '%' and i.series = s.series and i.sell_buy = s.sell_buy ),
...
group by c1.family,s.scrip_cd,s.series, sell_buy, c1.short_name, c1.trader, c1.Res_Phone1, c2.service_chrg, 
c1.cl_code ,marketrate,  s.dummy2,  /* User_Id, */    Sett_No,contractno

Order By c1.family, s.Scrip_CD,s.series
end
...
and sb.sub_broker = c1.sub_broker
and c1.sub_broker = @statusname
group by c1.family,s.scrip_cd,s.series,
