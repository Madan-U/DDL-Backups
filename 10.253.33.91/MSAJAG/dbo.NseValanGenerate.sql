-- Object: PROCEDURE dbo.NseValanGenerate
...
CREATE PROC [dbo].[NseValanGenerate] (@SETT_NO VARCHAR(7),@SETT_TYPE VARCHAR(2),@FLAGFORINCLUSIVEBROKERAGE INT) 
with recompile
AS                 
...
DECLARE  
@SETT_NO_L VARCHAR(7),@SETT_TYPE_L VARCHAR(2),@FLAGFORINCLUSIVEBROKERAGE_L INT,
...
SET @FLAGFORINCLUSIVEBROKERAGE_L = @FLAGFORINCLUSIVEBROKERAGE
-------------------------------------              
...
SELECT @START_DATE = START_DATE FROM SETT_MST WHERE SETT_TYPE = @SETT_TYPE_L AND SETT_NO = @SETT_NO_L              
...
FROM CLIENT1 C1,          
     CLIENT2 C2          
WHERE SETTLEMENT.SETT_NO = @SETT_NO_L          
     AND SETTLEMENT.SETT_TYPE = @SETT_TYPE_L          
...
EXEC NSECMVALAN @SETT_NO_L,@SETT_TYPE_L,'%','%','%','%','VALAN'              
              
--INSERT INTO BBGLOG VALUES('DID NSECMVALAN',GETDATE())              
              
EXEC NSEACCVALAN @SETT_NO_L,@SETT_TYPE_L              
--EXEC REMMISSOR_SHARING @SETT_NO_L,@SETT_TYPE_L              
--INSERT INTO BBGLOG VALUES('DID NSEACCVALAN',GETDATE())                    
DELETE FROM ACCBILL WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L              
DELETE FROM IACCBILL WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L              
...
FROM NSEBILLVALAN WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L              
AND TRDTYPE = 'N'              
...
SET @VALANAMTCUR = CURSOR FOR               
 ...
 FROM NSEBILLVALAN WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L AND TRDTYPE = 'N'              
...
BEGIN                
 ...
 IF @FLAGFORINCLUSIVEBROKERAGE_L = 1               
 BEGIN                
...
/*   SELECT @TBRKREVERSED =  @TBRKREVERSED + ABS(@TBROKERAGE)*/ /* COMMENTERD BY ANIMESH FOR -VE BROKERAGE */              
 ...
 INSERT INTO ACCBILL VALUES ( @CLRHSGPARTY,0,@SELL_BUY,@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TEXCHANGE,2),@DUMMYBRANCH_CD,'BILL POSTED')               
                  
 INSERT INTO ACCBILL VALUES ( @BRKRELPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TBROKERAGE,2),@DUMMYBRANCH_CD,'BILL POSTED')               
              
 INSERT INTO ACCBILL VALUES ( @DELCHRGPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,               
         ROUND(@TDELBROKERAGE,2),@DUMMYBRANCH_CD,'BILL POSTED')              
                
 INSERT INTO ACCBILL VALUES ( @SERTAXPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TSERVICE_TAX,2),@DUMMYBRANCH_CD,'BILL POSTED')              
            
 IF ROUND(@TCESS_TAX,2) <> 0             
 INSERT INTO ACCBILL VALUES ( @CESSTAXPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
 ...
 INSERT INTO ACCBILL VALUES ( @SERTAXPAYPARTY,0,'1',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TEXSERVICE_TAX,2),@DUMMYBRANCH_CD,'BILL POSTED')              
             
 IF ROUND(@TEXCESS_TAX,2) <> 0             
 INSERT INTO ACCBILL VALUES ( @CESSTAXPAYPARTY,0,'1',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
 ...
 INSERT INTO ACCBILL VALUES ( @TURNTAXPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TTURN_TAX,2),@DUMMYBRANCH_CD,'BILL POSTED')              
              
 INSERT INTO ACCBILL VALUES ( @SEBITAXPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TSEBI_TAX,2),@DUMMYBRANCH_CD,'BILL POSTED')              
              
 INSERT INTO ACCBILL VALUES ( @INSCHRGPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TINS_CHRG,2),@DUMMYBRANCH_CD,'BILL POSTED')              
              
 INSERT INTO ACCBILL VALUES ( @BRKNOTEPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TBROKER_CHRG,2),@DUMMYBRANCH_CD,'BILL POSTED')              
 IF @SETT_TYPE_L = 'A'               
 INSERT INTO ACCBILL VALUES ( @AUCCHRGPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TOTHER_CHRG,2),@DUMMYBRANCH_CD,'BILL POSTED')              
 ELSE              
 INSERT INTO ACCBILL VALUES ( @OTHCHRGPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TOTHER_CHRG,2),@DUMMYBRANCH_CD,'BILL POSTED')              
 IF @TBRKREVERSED > 0               
 INSERT INTO ACCBILL VALUES ( @BRKREVERSEDPARTY,0,'1',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
...
SELECT BRANCH_CD,PENAMT=SUM(TRADEQTY)*D.PENALTY/QTY FROM SETTLEMENT S, CLIENT2 C2, CLIENT1 C1, DELAUCSCRIP D WHERE S.SETT_TYPE = @SETT_TYPE_L AND S.SETT_NO = @SETT_NO_L              
...
BEGIN              
 ...
 END              
 UPDATE ACCBILL SET AMOUNT = AMOUNT - @NETPENAMT WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L AND PARTY_CODE = @OTHCHRGPARTY AND BRANCHCD = @DUMMYBRANCH_CD              
END              
CLOSE @AUCCUR              
...
FROM REMISSOR_TRANS WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L              
...
SET @VALANAMTCUR = CURSOR FOR              
 ...
 SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L AND BRANCHCD <> 'ZZZ'              
...
BEGIN              
 ...
 END              
 IF @NETDIFFAMT > 0               
   INSERT INTO ACCBILL VALUES ( @RNDOFFPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
            ROUND(@NETDIFFAMT,2),@DUMMYBRANCH_CD,'BILL POSTED')              
 ELSE IF @NETDIFFAMT < 0               
   INSERT INTO ACCBILL VALUES ( @RNDOFFPARTY,0,'1',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
...
BEGIN              
 ...
 BEGIN              
  ...
  BEGIN              
   SET @VALANACCCUR = CURSOR FOR              
    SELECT AMOUNT,SELL_BUY FROM ACCBILL WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L              
 ...
 BEGIN              
  ...
  END              
  IF @REVAMT > 0               
   INSERT INTO ACCBILL VALUES ( @DUMMYREVCODE,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
           ROUND(@REVAMT,2),'ZZZ','BILL POSTED')                
  ELSE              
   INSERT INTO ACCBILL VALUES ( @DUMMYREVCODE,0,'1',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
           ROUND(ABS(@REVAMT),2),'ZZZ','BILL POSTED')                
 END               
 IF @OPPAMT > 0                
  INSERT INTO ACCBILL VALUES ( @DUMMYOPPCODE,0,'1',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
          ROUND(@OPPAMT,2),'ZZZ','BILL POSTED')                 
 ELSE              
  INSERT INTO ACCBILL VALUES ( @DUMMYOPPCODE,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
...
FROM NSEBILLVALAN WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L AND TRDTYPE = 'I'              
GROUP BY SETT_NO,SETT_TYPE,BRANCH_CD,PARTY_CODE              
...
/*   SELECT @TBRKREVERSED =  @TBRKREVERSED + ABS(@TBROKERAGE)*/ /* COMMENTERD BY ANIMESH FOR -VE BROKER*/              
 ...
 INSERT INTO IACCBILL VALUES ( @BRKRELPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TBROKERAGE,2),@DUMMYBRANCH_CD,'BILL POSTED')               
              
 INSERT INTO IACCBILL VALUES ( @DELCHRGPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TDELBROKERAGE,2),@DUMMYBRANCH_CD,'BILL POSTED')              
                
 INSERT INTO IACCBILL VALUES ( @SERTAXPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TSERVICE_TAX,2),@DUMMYBRANCH_CD,'BILL POSTED')              
             
 IF ROUND(@TCESS_TAX,2) <> 0            
 INSERT INTO IACCBILL VALUES ( @CESSTAXPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TCESS_TAX,2),@DUMMYBRANCH_CD,'BILL POSTED')              
 ...
 INSERT INTO IACCBILL VALUES ( @SERTAXPAYPARTY,0,'1',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TEXSERVICE_TAX,2),@DUMMYBRANCH_CD,'BILL POSTED')              
             
 IF ROUND(@TEXCESS_TAX,2) <> 0            
 INSERT INTO IACCBILL VALUES ( @CESSTAXPAYPARTY,0,'1',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TEXCESS_TAX,2),@DUMMYBRANCH_CD,'BILL POSTED')              
 ...
 INSERT INTO IACCBILL VALUES ( @TURNTAXPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TTURN_TAX,2),@DUMMYBRANCH_CD,'BILL POSTED')              
              
 INSERT INTO IACCBILL VALUES ( @SEBITAXPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TSEBI_TAX,2),@DUMMYBRANCH_CD,'BILL POSTED')              
              
 INSERT INTO IACCBILL VALUES ( @INSCHRGPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
      ROUND(@TINS_CHRG,2),@DUMMYBRANCH_CD,'BILL POSTED')              
              
 INSERT INTO IACCBILL VALUES ( @BRKNOTEPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TBROKER_CHRG,2),@DUMMYBRANCH_CD,'BILL POSTED')              
              
 INSERT INTO IACCBILL VALUES ( @OTHCHRGPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TOTHER_CHRG,2),@DUMMYBRANCH_CD,'BILL POSTED')              
            
 IF @TBRKREVERSED > 0               
 INSERT INTO IACCBILL VALUES ( @BRKREVERSEDPARTY,0,'1',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
         ROUND(@TBRKREVERSED,2),@DUMMYBRANCH_CD,'BILL POSTED')              
...
INSERT INTO IACCBILL VALUES ( @CLRHSGPARTY,0,@SELL_BUY,@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
       ROUND(ABS(@NETEXCHANGE),2),'ZZZ','BILL POSTED')              
...
BEGIN              
 ...
 END              
 IF @NETDIFFAMT > 0               
   INSERT INTO IACCBILL VALUES ( @RNDOFFPARTY,0,'2',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
            ROUND(@NETDIFFAMT,2),@DUMMYBRANCH_CD,'BILL POSTED')              
 ELSE IF @NETDIFFAMT < 0               
   INSERT INTO IACCBILL VALUES ( @RNDOFFPARTY,0,'1',@SETT_NO_L,@SETT_TYPE_L,@START_DATE,@END_DATE,@SEC_PAYIN,@SEC_PAYOUT,              
            ROUND(ABS(@NETDIFFAMT),2),@DUMMYBRANCH_CD,'BILL POSTED')                
...
IF @SETT_TYPE_L = 'A' OR @SETT_TYPE_L = 'AF'               
BEGIN              
IF ( SELECT ISNULL(COUNT(*),0) FROM SETTLEMENT WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L AND AUCTIONPART LIKE 'F%' ) > 0               
 UPDATE ACCBILL SET NARRATION = 'FINAL BILL' WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L               
ELSE              
 UPDATE ACCBILL SET NARRATION = 'PROVISIONAL BILL' WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L               
END            
            
DELETE FROM ACCBILL WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L AND AMOUNT = 0             
DELETE FROM IACCBILL WHERE SETT_NO = @SETT_NO_L AND SETT_TYPE = @SETT_TYPE_L AND AMOUNT = 0             
      
  
EXEC VALAN_ADDITIONAL_PROCESS @SETT_NO_L, @SETT_TYPE_L  
Exec VALAN_GST_BILLPOST @SETT_NO_L,@SETT_TYPE_L

EXEC VALAN_ADDITIONAL_CHARGES @SETT_NO,@SETT_TYPE

EXEC VALAN_INTEROP @SETT_NO_L,@SETT_TYPE_L
  
IF @SETT_TYPE = 'AF'

BEGIN

        DELETE FROM ANGELFO.NSEFO.DBO.ACCBILL

        WHERE SETT_NO = @SETT_NO AND SETT_TYPE = @SETT_TYPE 

		 INSERT INTO ANGELFO.NSEFO.DBO.ACCBILL
		SELECT * FROM ACCBILL
		WHERE SETT_NO = @SETT_NO AND SETT_TYPE = @SETT_TYPE 
		DELETE FROM ACCBILL
	    WHERE SETT_NO = @SETT_NO AND SETT_TYPE = @SETT_TYPE 

		UPDATE ANGELFO.NSEFO.DBO.ACCBILL SET PARTY_CODE='99885'WHERE PARTY_CODE='99985'
		AND SETT_NO = @SETT_NO AND SETT_TYPE = @SETT_TYPE 
		UPDATE ANGELFO.NSEFO.DBO.ACCBILL SET PARTY_CODE='200'WHERE PARTY_CODE='100'
		AND SETT_NO = @SETT_NO AND SETT_TYPE = @SETT_TYPE 
