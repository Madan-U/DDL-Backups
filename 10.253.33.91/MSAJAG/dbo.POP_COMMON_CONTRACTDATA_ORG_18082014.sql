-- Object: PROCEDURE dbo.POP_COMMON_CONTRACTDATA_ORG_18082014
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

                    
CREATE PROCEDURE [dbo].[POP_COMMON_CONTRACTDATA_ORG_18082014] (                    
 @FROMDATE VARCHAR(11),                    
 @USERNAME VARCHAR(20) = ''                    
 )                    
AS                    
...
'' AND ''' + @TOPARTY + ''''                    
  ...
  SET @STRSQL = @STRSQL + ' M.PARTICIPANT_CODE,'                      SET @STRSQL = @STRSQL + ' M.CL_TYPE,'                    
