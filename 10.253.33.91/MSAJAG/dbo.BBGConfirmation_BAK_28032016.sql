-- Object: PROCEDURE dbo.BBGConfirmation_BAK_28032016
...
CREATE Procedure [dbo].[BBGConfirmation_BAK_28032016] ( 
...
Set @@SelectFlex = @@SelectFlex + " from Settlement S,Client1 C1 ,Client2 C2 where s.party_code = C2.Party_code and C2.cl_code = C1.Cl_code and Tradeqty > 0 and S.Auctionpart not like 'A%' and S.AuctionPart not Like 'F%'"
...
Set @@SelectFlex1 = @@SelectFlex1 + " from HISTORY S,Client1 C1 ,Client2 C2 where s.party_code = C2.Party_code and C2.cl_code = C1.Cl_code and Tradeqty > 0 and S.Auctionpart not like 'A%' and S.AuctionPart not Like 'F%' "
