-- Object: PROCEDURE dbo.MIG_CITRUS_TO_CLIENT_DETAILS_EQUITY_UPDATE _MFSS 
...
CREATE PROC [dbo].[MIG_CITRUS_TO_CLIENT_DETAILS_EQUITY_UPDATE _MFSS ]      
(      
 @FDATE VARCHAR(11)='',      
 @TDATE VARCHAR(11)=''      
)      
...
INSERT INTO #DATA                                      
  ...
  **/  
  ...
  AND EXISTS (SELECT TABLE_NO FROM AngelBSECM.BSEDB_AB.DBO.BROKTABLE WITH (NOLOCK) WHERE TABLE_NO = TRD_BROK      
  AND TRD_DEL = CASE WHEN BROK_SCHEME <> 0 THEN 'F' ELSE TRD_DEL END)      
