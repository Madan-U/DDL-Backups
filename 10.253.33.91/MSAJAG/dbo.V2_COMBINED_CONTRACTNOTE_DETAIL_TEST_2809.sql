-- Object: PROCEDURE dbo.V2_COMBINED_CONTRACTNOTE_DETAIL_TEST_2809
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROCEDURE [dbo].[V2_COMBINED_CONTRACTNOTE_DETAIL_TEST_2809]                       
 ...
 */                      
 ...
 DROP TABLE #REMARK_DET                      
   ...
   CREATE INDEX #PARTY ON   #CONTSETT_DET  (PARTY_CODE)   
   CREATE INDEX #SETT ON   #CONTSETT_DET  (SAUDA_DATE)          
...
AND CONVERT(DATETIME,SAUDA_DATE,103) BETWEEN EFF_FROM_DATE AND EFF_TO_DATE  
 ...
 CREATE INDEX #GST ON #GSTDATA (PARTY_CODE,SAUDA_DATE)
 CREATE INDEX #GST_PER ON #GSTDATA (GST_PER)
