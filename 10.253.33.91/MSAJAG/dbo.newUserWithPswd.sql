-- Object: PROCEDURE dbo.newUserWithPswd
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------

CREATE procedure [dbo].[newUserWithPswd] 
(
@sbcd as varchar(10),
@pswd as varchar(10),
...
begin    
 ...
 (
 --FLDAUTO,
 FLDUSERID,FLDPWDEXPIRY,FLDMAXATTEMPT,FLDATTEMPTCNT,FLDSTATUS,FLDLOGINFLAG,
 FLDACCESSLVL,FLDIPADD,FLDTIMEOUT ,FLDFIRSTLOGIN,FLDFORCELOGOUT ,FLD_MAC_ID
 )
 Values (@fldat,10,10,0, 0,0,'F', '127.0.0.1', 20,'Y',0,0)    
 ...
 select  
 a.FLDAUTO, b.FLDPWDEXPIRY, b.FLDMAXATTEMPT,0,0,0,b.FLDACCESSLVL,'',b.FLDTIMEOUT,b.FLDFIRSTLOGIN,b.FLDFORCELOGOUT,''     
 FROM TBLPRADNYAUSERS A 
      left OUTER JOIN TBLUSERCONTROLMASTER X  ON (A.FLDAUTO = X.FLDUSERID) , TBLUSERCONTROLGLOBALS B     
