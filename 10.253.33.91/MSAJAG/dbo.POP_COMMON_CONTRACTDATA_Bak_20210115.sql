-- Object: PROCEDURE dbo.POP_COMMON_CONTRACTDATA_Bak_20210115
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


Create PROCEDURE [dbo].[POP_COMMON_CONTRACTDATA_Bak_20210115]   
(  
@FROMDATE VARCHAR(11),  
@USERNAME VARCHAR(20) = '',  
...
BEGIN                                      
 ...
 IF @SHARESERVER = @@SERVERNAME 
	...
	END
 IF @SHARESERVER = @@SERVERNAME AND @SHAREDB = 'MSAJAG'	  
	BEGIN
	    SET @SHAREDB = ''
	END	                               
