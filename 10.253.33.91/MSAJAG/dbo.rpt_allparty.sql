...
/****** Object:  Stored Procedure dbo.rpt_allparty    Script Date: 01/19/2002 12:15:13 ******/

/****** Object:  Stored Procedure dbo.rpt_allparty    Script Date: 01/04/1980 5:06:25 AM ******/
...
begin
	...
	nar=isnull((select l3.narr from account.dbo.ledger3 l3  where L.VTYP = L3.VTYP AND L.VNO = L3.VNO and l.booktype = l3.booktype AND l3.naratno=0) ,''),
