-- Object: PROCEDURE dbo.GET_EPI_POOL_ACCOUNT_BKUP_20JAN2021
-- Server: 10.253.33.91 | DB: MSAJAG
--------------------------------------------------


CREATE PROCEDURE [dbo].[GET_EPI_POOL_ACCOUNT_BKUP_20JAN2021]
...
SELECT EXCHANGE, SEGMENT, PARTY_CODE, POOLACCOUNT = SUM(POOLACCOUNT), EPIACCOUNT = SUM(EPIACCOUNT), LEDACCOUNT = SUM(LEDACCOUNT)
FROM
(
SELECT 
EXCHANGE = 'NSE', SEGMENT = 'CAPITAL', PARTY_CODE, 
