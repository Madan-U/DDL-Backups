-- Object: PROCEDURE dbo.Angel_NRI_ClientWiseData_LEC_UAT
-- Server: 10.253.33.91 | DB: INHOUSE
--------------------------------------------------

CREATE proc Angel_NRI_ClientWiseData_LEC_UAT  
(  
...
Begin  
    ...
    convert(varchar,convert(decimal(14,2),Sum(isnull((Service_Tax*10)/10.3,0))))+'|'+          
    convert(varchar,convert(decimal(14,2),Sum(isnull(Service_Tax-(Service_Tax*10)/10.3,0))))+'|'+   
    ...
    convert(varchar,convert(decimal(14,2),Sum(isnull(Sebi_Tax+Turn_Tax,0))))+'|'+   
