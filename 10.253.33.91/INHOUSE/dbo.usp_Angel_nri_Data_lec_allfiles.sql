-- Object: PROCEDURE dbo.usp_Angel_nri_Data_lec_allfiles
-- Server: 10.253.33.91 | DB: INHOUSE
--------------------------------------------------

--use 196-- inhouse                                              
--exec usp_Angel_nri_Data_lec_allfiles '28/10/2024',0          
        
CREATE proc [dbo].[usp_Angel_nri_Data_lec_allfiles]        
(        
@SDATE  AS VARCHAR(11),                                          
@BANKID AS INT                          
)        
...
#contract b where a.PARTY_CODE=b.PARTY_CODE and a.sauda_date=b.SAUDA_DATE and a.isin=b.isin and      
 ...
 TOTALAMT,TYPE,nseSett_no2,nseBank,rbi_refno,CliPISNo,CliBnkAcc,cliBankBranch,angelAcc,c.CONTRACTNO_NEW,b.DPid1,b.cltdpID1,b.Short_Name,c.SCRIP_CD,c.EXCHANGE,c.ISIN,c.SCRIP_NAME,c.BUYDELIVERYCHRG+c.SELLDELIVERYCHRG as Brokearge,c.PTRADEDQTY+c.STRADEDQTY as Qty,c.PMARKETRATE+c.SMARKETRATE as Rate,      
