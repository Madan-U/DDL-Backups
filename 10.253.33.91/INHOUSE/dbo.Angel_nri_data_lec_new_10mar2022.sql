-- Object: PROCEDURE dbo.Angel_nri_data_lec_new_10mar2022
-- Server: 10.253.33.91 | DB: INHOUSE
--------------------------------------------------

--use inhouse                                    
--exec Angel_nri_data_lec_new '23/02/2022',2,0,'NSE'                                      
CREATE PROC Angel_nri_data_lec_new_10mar2022(@SDATE  AS VARCHAR(11),                
                                   @TYPE   AS INT,                
                                   @BANKID AS INT,                
                                   @SEG    AS VARCHAR(5))                
AS                
...
00'      
  ...
  insert into tbl_NRILec_temp(fldcol)    
  select * from #TEMP1    
