-- Object: PROCEDURE dbo.usp_mimansa_ucc_nse_cm_client_data_pop_new_modification_process63Col_SAN
...
CREATE proc
	...
	[dbo].[usp_mimansa_ucc_nse_cm_client_data_pop_new_modification_process63Col_SAN]
	(
...
begin
	...
	/*************Fetch Adress Details*************/
		...
		/*Added by priyanka B on Jun 21 2018 suggested by Ajay Gupta*/
		Email=ltrim(rtrim(isnull(c1.email,''))),
