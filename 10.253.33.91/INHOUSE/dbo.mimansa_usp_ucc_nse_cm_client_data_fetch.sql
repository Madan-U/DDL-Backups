-- Object: PROCEDURE dbo.mimansa_usp_ucc_nse_cm_client_data_fetch
...
CREATE proc
	...
	[dbo].[mimansa_usp_ucc_nse_cm_client_data_fetch]
as
...
where
	ltrim(rtrim(replace(isnull(mimansa_angel_ucc_nse_cm_client_data.pan, ''), ',', ''))) = ltrim(rtrim(isnull(bp.panno, '')))
	and len(bp.panno)=10
