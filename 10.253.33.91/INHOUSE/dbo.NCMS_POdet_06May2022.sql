-- Object: PROCEDURE dbo.NCMS_POdet_06May2022
...
Begin         
update [196.1.115.132].CMS.dbo.ncms_batch_process set StartDate=GETDATE() where srno=4
end 
...
if((CONVERT(VARCHAR(5),GETDATE(),108)>='06:59') and (CONVERT(VARCHAR(5),GETDATE(),108)<='23:59'))    
Begin
update [196.1.115.132].CMS.dbo.ncms_batch_process set EndDate=GETDATE(),Flag=1 where srno=4
end 
