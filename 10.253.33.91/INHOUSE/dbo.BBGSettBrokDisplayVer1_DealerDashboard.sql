-- Object: PROCEDURE dbo.BBGSettBrokDisplayVer1_DealerDashboard
-- Server: 10.253.33.91 | DB: INHOUSE
--------------------------------------------------

CREATE  procedure
	[dbo].[BBGSettBrokDisplayVer1_DealerDashboard]
	(
		@Sett_no Varchar(7),
		@Sett_type Varchar(2),
...
as
-- Exec [BBGSettBrokDisplayVer1_DealerDashboard] '1','D','ALWR1937','532296','','1',100,1000,2,'JAN  1 2000','broker','','AJYC'
-- Exec [BBGSettBrokDisplayVer1_DealerDashboard] '1','D','M98194','532296','','1',4,1070.40,4,'JAN  1 2000','broker','','E60022'
