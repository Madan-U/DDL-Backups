-- Object: PROCEDURE dbo.Usp_Ekyc_ActivateDeactivateUserCode_process
...
-- =============================================
CREATE PROCEDURE [dbo].[Usp_Ekyc_ActivateDeactivateUserCode_process]
		 ...
		 Begin
			...
			Begin
				...
				BEGIN					
					...
					Set @InActive_Date= (Select top 1 InActive_From from msajag.dbo.client_brok_details where cl_code=@party_Code and Exchange in('MCX','NCX','NCE'))
					Print  'InActive_From: ' +@InActive_Date
