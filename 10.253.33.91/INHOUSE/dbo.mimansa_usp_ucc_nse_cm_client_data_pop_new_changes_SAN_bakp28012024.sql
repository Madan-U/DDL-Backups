-- Object: PROCEDURE dbo.mimansa_usp_ucc_nse_cm_client_data_pop_new_changes_SAN_bakp28012024
...
CREATE proc  
 ...
 [dbo].[mimansa_usp_ucc_nse_cm_client_data_pop_new_changes_SAN_bakp28012024]  
 (  
...
begin  
 print 'SELECTED'  
  insert into #TempClient  
  select distinct cl_code = ltrim(rtrim(isnull(cl_code, '')))  
  from msajag.dbo.client5 c5 with(nolock),tblUCCClientCode A with(nolock)  
...
and d.Deactive_value in ('C','M','T','P') and d.exchange='NSE' and d.Segment in ('CAPITAL') /* added by yogesh on Aug 01 2023 */
