-- Object: PROCEDURE dbo.USP_Closure_Process_B2C
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_Closure_Process_B2C]
...
BEGIN CATCH
    ...
    SET @Subject = 'Error: [AngelNseCM].msajag.dbo.USP_Closure_Process_B2C '+@party_Code;
