-- Object: PROCEDURE dbo.USP_Closure_Process_MF
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_Closure_Process_MF]
...
print 'catch'   
	...
	Print @ErrorFlag
      ...
      set @Subject = 'Error: [AngelNseCM].msajag.dbo.USP_Closure_Process_MF '+@party_Code
