-- Object: PROCEDURE dbo.Usp_Ekyc_BulkReactivateUserCodes_Mimansa_bkp19032025
...
-- =============================================
CREATE PROCEDURE [dbo].[Usp_Ekyc_BulkReactivateUserCodes_Mimansa_bkp19032025]
...
BEGIN TRY	
	...
	select ProcessID ,Emp_code from mimansa.CRM.dbo.tbl_Ekyc_RctivateUserCode_process with(nolock) where
ProcessingStatus='P' order by  RequestReceivedOn asc
