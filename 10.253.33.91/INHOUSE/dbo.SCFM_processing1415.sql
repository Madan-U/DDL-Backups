-- Object: PROCEDURE dbo.SCFM_processing1415
-- Server: 10.253.33.91 | DB: INHOUSE
--------------------------------------------------

--exec SCFM_processing1415 'mar 31 2015 23:59:59:000','apr  1 2015 23:59:59'        
CREATE procedure SCFM_processing1415        
(        
@startdate datetime,        
@enddate datetime        
)        
 ...
 */        
 ...
 into #nsecm        
 from anand1.Account.dbo.ledger where vdt >@startdate        
 and edt <=@enddate        
...
WHERE  CLTCODE LIKE '98%' AND CLTCODE=CL_cODE   
 ...
 delete from SCFM_FY1415 where effectivedate=@enddate        
         
 insert into SCFM_FY1415        
