...
[BROKER A/C NO]=V.Fld_AngelAcc  
INTO #FINAL_HDFC_YES
FROM #MAIN_DATA C LEFT JOIN TBL_TDS_UPLOAD_BUYBACK_LEC T ON C.PARTY_CODE= T.CLIENT_CODE  
...
INTO #FINAL_KOTAK          
FROM #MAIN_DATA M LEFT JOIN TBL_TDS_UPLOAD_BUYBACK_LEC T ON M.PARTY_CODE= T.CLIENT_CODE  
