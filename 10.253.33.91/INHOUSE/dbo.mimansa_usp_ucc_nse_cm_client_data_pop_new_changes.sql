-- Object: PROCEDURE dbo.mimansa_usp_ucc_nse_cm_client_data_pop_new_changes
...
CREATE proc
	...
	[dbo].[mimansa_usp_ucc_nse_cm_client_data_pop_new_changes]
...
as
	...
	from 
		[ABCSOORACLEMDLW].synergy.dbo.VW_EXP_NEWCLIENT_POA a1 
	where
