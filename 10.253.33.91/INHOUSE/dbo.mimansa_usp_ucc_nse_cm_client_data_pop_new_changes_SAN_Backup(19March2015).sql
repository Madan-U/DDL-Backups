-- Object: PROCEDURE dbo.mimansa_usp_ucc_nse_cm_client_data_pop_new_changes_SAN_Backup(19March2015)
...
Create  proc
	...
	[dbo].[mimansa_usp_ucc_nse_cm_client_data_pop_new_changes_SAN_Backup(19March2015)]
	(
