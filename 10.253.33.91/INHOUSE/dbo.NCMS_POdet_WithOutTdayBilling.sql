...
BEGIN            
 ...
 from account.dbo.ledger  with (nolock) where vtyp in (15,35) and (narration like '%NSECMNBILL POSTED%' or narration like '%NSECMWBILL POSTED%')
...
BEGIN            
 ...
 update NCMS_PO set VBal=VBal+t.B2Bamt
 from #tdaybill t where NCMS_PO.cltcode =T.CLTCODE and NCMS_PO.Cltcode=@pcode 
