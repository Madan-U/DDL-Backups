-- Object: PROCEDURE dbo.USP_Closure_Process_B2B_bkp14Jun2018
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_Closure_Process_B2B_bkp14Jun2018]
...
print 'catch'   
	...
	Print @ErrorFlag
      ...
      set @Subject = 'Error: [anand1].msajag.dbo.USP_Closure_Process_B2B '+@party_Code
