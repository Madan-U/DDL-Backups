-- Object: PROCEDURE dbo.Fetch_CliUnreco_GSec
...
BEGIN  
 ...
 insert into BO_client_deposit_recno_GSec select co_code='NSECM',getdate(),* from #recodet (nolock)       
...
BEGIN  
 ...
 insert into BO_client_deposit_recno_GSec select co_code='NSECM',getdate(),* from #recodetc (nolock)         
