...
Begin         
update INTRANET.CMS.dbo.ncms_batch_process set StartDate=GETDATE() where srno=4
end 
...
if((CONVERT(VARCHAR(5),GETDATE(),108)>='06:45') and (CONVERT(VARCHAR(5),GETDATE(),108)<='23:59'))    
Begin
update INTRANET.CMS.dbo.ncms_batch_process set EndDate=GETDATE(),Flag=1 where srno=4
end 
