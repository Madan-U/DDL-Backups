-- Object: PROCEDURE dbo.mimansa_usp_ucc_nse_cm_client_data_pop_new_changes_SAN_SegmentActivation
...
CREATE proc  
 ...
 [dbo].[mimansa_usp_ucc_nse_cm_client_data_pop_new_changes_SAN_SegmentActivation]  
 (  
...
as  
--exec [mimansa_usp_ucc_nse_cm_client_data_pop_new_changes_SAN_SegmentActivation] 'Nov 26 2020','Nov 26 2020','',''  
 set nocount on  
...
begin  
 print 'DATARANGE'  
  ...
  from anand1.msajag.dbo.client5 c5 with(nolock)  
...
begin  
 print 'SELECTED'  
  insert into #TempClient  
  select distinct cl_code = ltrim(rtrim(isnull(cl_code, '')))  
  from anand1.msajag.dbo.client5 c5 with(nolock),tblUCCClientCode A with(nolock)  
...
delete  
 #mimansa_angel_ucc_nse_cm_client_data_new_changes  
from  
 --[MIDDLEWARE].inhouse.dbo.AllSebiBannedEntities bp with (nolock)  
...
--Alter table #mimansa_angel_ucc_nse_cm_client_data_new_changes   
--add  ActivefromClient varchar(20)  
  
--Update #mimansa_angel_ucc_nse_cm_client_data_new_changes set ActivefromClient=a.Activefrom  
--from mimansa.angelcs.dbo.angelclient1 a   
--where #mimansa_angel_ucc_nse_cm_client_data_new_changes.Client_Code=a.party_code   
  
--delete from #mimansa_angel_ucc_nse_cm_client_data_new_changes where isnull(ActivefromClient,'')=''  
  
--delete #mimansa_angel_ucc_nse_cm_client_data_new_changes  
--from mimansa.angelcs.dbo.angelclient1  a  
--where #mimansa_angel_ucc_nse_cm_client_data_new_changes.Client_Code=a.party_code   
--and a.ActiveFrom>=convert(varchar(12),getdate(),109)  
...
/************Segment  Activation*********************/  
 ...
 delete from #mimansa_angel_ucc_nse_cm_client_data_new_changes  
 where client_code in (select client_code   
 from mimansa.ucc.dbo.tbl_Nsecm_DataInsertedon with(nolock))  
   
  
  
 Insert Into mimansa.ucc.dbo.tbl_Nsecm_DataInsertedon  
 select Client_Code,InsertedOn=getdate() from #mimansa_angel_ucc_nse_cm_client_data_new_changes  
