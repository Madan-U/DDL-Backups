-- Object: PROCEDURE dbo.usp_mimansa_ucc_nse_cm_client_data_pop_new_modification_process63Col_SAN_DateRangeWise
...
CREATE proc
	...
	[dbo].[usp_mimansa_ucc_nse_cm_client_data_pop_new_modification_process63Col_SAN_DateRangeWise]
	(
...
begin
	...
	create table #TempTable1
       ...
       set @@ToDate1=convert(datetime,@@ToDate)
		...
		from AngelNseCM.msajag.dbo.CLIENT_M_CI c1  with(nolock),AngelNseCM.msajag.dbo.client5 c5 with(nolock)
		where c5.inactivefrom>@@getdate
		...
		from #TempTable1 c1  with(nolock),AngelNseCM.msajag.dbo.client5 c5 with(nolock)
...
/*************Fetch Adress Details*************/
	...
	/*Update POA*/
		Update 
	      ...
	      where
		#temp_nse_modification_Clients.party_code = m.Party_code
