-- Object: PROCEDURE dbo.mimansa_usp_ucc_nse_cm_client_data_pop_new_changes_SAN
...
CREATE proc  
 ...
 [dbo].[mimansa_usp_ucc_nse_cm_client_data_pop_new_changes_SAN]  
 (  
...
--and d.Deactive_value in ('C','M','T','P') and d.exchange='NSE' and d.Segment in ('CAPITAL') /* added by yogesh on Aug 01 2023 */
 and d.Deactive_value in ('C','T') and d.exchange='NSE' and d.Segment in ('CAPITAL') 
/* End  */  
