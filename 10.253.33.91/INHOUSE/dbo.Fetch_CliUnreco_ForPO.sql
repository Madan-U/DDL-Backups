-- Object: PROCEDURE dbo.Fetch_CliUnreco_ForPO
...
BEGIN
  ...
  create index #PO_cli on #PO_client_unreco(Party_code)
	...
	from account.dbo.LEDGER b with (nolock) ,#PO_client_unreco p            
	...
	into #led1      
	from account.dbo.ledger1 t with (nolock)  , #vdet l where l.vtyp = t.vtyp and l.vno= t.vno and l.booktype = t.booktype     
...
BEGIN
	...
	insert into BO_client_deposit_recno select co_code='NSECM',getdate(),* from #recodetc (nolock)       
