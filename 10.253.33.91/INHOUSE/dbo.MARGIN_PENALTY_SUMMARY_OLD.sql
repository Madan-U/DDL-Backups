-- Object: PROCEDURE dbo.MARGIN_PENALTY_SUMMARY_OLD
...
CREATE PROC [dbo].[MARGIN_PENALTY_SUMMARY_OLD] ( @FROMDATE VARCHAR(11) ,@TODATE VARCHAR(11) ,@CLT VARCHAR(1) = 'D')                            
AS                            
...
EXEC MARGIN_PROC_YN @FROMDATE , @TODATE  ,'N'                      
