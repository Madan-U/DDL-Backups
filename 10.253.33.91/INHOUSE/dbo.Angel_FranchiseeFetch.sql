...
CREATE Procedure [dbo].[Angel_FranchiseeFetch](@fydate as varchar(25),@tdate as varchar(25))                          
as                          
...
where segment='ACDLCM' and   flag<>'X' and code not in ('99990','61310') union select '520012'                          
                          
truncate table  dbo.angel_tempnse                          
                          
insert into  dbo.angel_tempnse                          
select l2.cltcode ,l.vtyp,l2.drcr,camt,costcode                          
from account.dbo.ledger l(nolock)  , account.dbo.ledger2 l2 (nolock)                                                            
