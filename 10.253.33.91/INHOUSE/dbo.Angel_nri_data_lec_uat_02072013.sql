-- Object: PROCEDURE dbo.Angel_nri_data_lec_uat_02072013
-- Server: 10.253.33.91 | DB: INHOUSE
--------------------------------------------------

--use inhouse                          
--exec Angel_nri_data_lec_uat '27/06/2013',2,0,'BSE'                            
CREATE PROC Angel_nri_data_lec_uat_02072013(@SDATE  AS VARCHAR(11),      
                                   @TYPE   AS INT,      
                                   @BANKID AS INT,      
                                   @SEG    AS VARCHAR(5))      
AS      
  BEGIN      
      ...
      --SET @SDATE ='18/03/2013' SET @TYPE ='2' SET @BANKID =0 SET @SEG='BSE'                                              
      ...
      ELSE      
        BEGIN      
            ...
            EXEC ANAND.BSEDB_AB.DBO.Bsenridetail      
              @SDATE,      
              @TYPE      
      ...
      IF @BSE = 0      
        ...
        BEGIN      
            ...
            WHERE  SAUDA_DATE = CONVERT(DATETIME, @SDATE, 103) --AND PARTY_CODE LIKE 'ZR%'                         UNION                                              
            SELECT DISTINCT PARTY_CODE      
        ...
        BEGIN      
            ...
            IF @SEG = 'BSE'      
              BEGIN      
                  ...
                  IF @TYPE = 1      
                    BEGIN      
                        SELECT @CALCULATION = CONVERT(DECIMAL(14, 2), @TRANS_AMOUNT) + CONVERT(DECIMAL(14, 2), SERVICE_TAX) + CONVERT(DECIMAL(14, 2), EDUCESS) + CONVERT(DECIMAL(14, 2), EXCHAGE_LEVIES) + CONVERT(DECIMAL(14, 2), STT) + CONVERT(DECIMAL(14, 2 ), STAMPDUTY)   
                  ...
                  SELECT 'H' + '|' + Ltrim(Rtrim(PARTY_CODE)) + '|' + Replace(CONVERT(VARCHAR(11), SAUDA_DATE, 102), '.', '') + '|' + CONVERT(VARCHAR, CONTRACTNO) + '|' + CONVERT(VARCHAR, CONVERT(DECIMAL(14, 2), Sum(Isnull(SERVICE_TAX, 0)))) + '|' + '0.00' + '|' + CONVERT(VARCHAR, CONVERT(DECIMAL(14, 2), Sum(Isnull(EXCHAGE_LEVIES, 0)))) + '|' + CONVERT(VARCHAR, CONVERT(DECIMAL(14, 2), Sum(Isnull(STT, 0)))) + '|' + CONVERT(VARCHAR, CONVERT(DECIMAL(14, 2), Sum(Isnull(STAMPDUTY, 0)))) + '|' + CASE           
                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                  WHEN @diffamt
 BETWEEN -0.03 AND 0.03 THEN CONVERT(VARCHAR, CONVERT(DECIMAL(14, 2), ( Sum(CONVERT(DECIMAL(14, 2), Isnull(MINBROKERAGE, 0)) + CONVERT(DECIMAL(14, 2), Isnull(OTHER_CHARGES, 0))) + @diffamt )))      
                                                                                                                                                                                                                                                               
  
    
                                                                                                               ELSE CONVERT(VARCHAR, CONVERT(DECIMAL(14, 2), ( Sum(Isnull(MINBROKERAGE, 0) + Isnull(OTHER_CHARGES, 0)) )))      
                                                                                                              END + '|' + CONVERT(VARCHAR, @TRANCNT) + '|' + CONVERT(VARCHAR, CONVERT(DECIMAL( 14, 2), ( Sum(TOTALAMT) * (case when @type = 1 then -1 else 1 end) )))      
                  FROM   #BSE_HEADER WITH (NOLOCK)      
                  ...
                  + '|' + Ltrim(Rtrim(CONVERT(VARCHAR, CONVERT(DEC(10, 2), BROK_PERSCRIP)))) + '|' + Ltrim(Rtrim(CONVERT(DEC(10, 2), TRANACTIONAMT * (case when @type = 1 then -1 else 1 end))))      
                  FROM   #BSE_DETAILS X      
...
CONVERT(DECIMAL(14, 2), MINBROKERAGE) + CONVERT(DECIMAL(14, 2), OTHER_CHARGES)  
 ...
 + '|' + CONVERT(VARCHAR, CONVERT(DECIMAL(14, 2), Sum(Isnull(EXCHAGE_LEVIES, 0)))) + '|' + CONVERT(VARCHAR, CONVERT(DECIMAL(14, 2), Sum(Isnull(STT, 0)))) + '|' + CONVERT(VARCHAR, CONVERT(DECIMAL(14, 2), Sum(Isnull(STAMPDUTY, 0)))) + '|' + CASE  
         ...
         END + '|' + CONVERT(VARCHAR, @TRANCNT) + '|' + CONVERT(VARCHAR, CONVERT(DECIMAL(14, 2), ( Sum(TOTALAMT) * ( CASE  
                 ...
                 SELECT 'T' + '|' + Ltrim(Rtrim(PARTY_CODE)) + '|' + Ltrim(Rtrim(CONTRACTNO)) + '|' + CASE  
                                                                                                        ...
                                                                                                        WHEN @TYPE = 2 THEN 'S'  
                                                                                                      END + '|' + Ltrim(Rtrim(Isnull(ISIN, ''))) + '|' + Ltrim(Rtrim(CONVERT(VARCHAR, QTY))) + '|' + Ltrim(Rtrim(CONVERT(VARCHAR, CONVERT(DEC(15, 2), RATE)))) 
+ '|' + Ltrim(Rtrim(CONVERT(VARCHAR, CONVERT(DEC(10, 2), BROK_PERSCRIP)))) + '|' + Ltrim(Rtrim(CONVERT(DEC(10, 2), TRANACTIONAMT * ( CASE  
