-- Object: PROCEDURE dbo.BBGSettBrokDisplayVer1_BrokSlab
-- Server: 10.253.33.91 | DB: INHOUSE
--------------------------------------------------

CREATE  procedure
	[dbo].[BBGSettBrokDisplayVer1_BrokSlab]
	(
		@Sett_no Varchar(7),
		@Sett_type Varchar(2),
		...
		@MarginSlab VarChar(50),
		@Emp_no VarChar(50)
	)

as
-- Exec BBGSettBrokDisplayVer1 '1','D','N4511','','','2',500,88.15,4,'JAN  1 2000','broker',''
