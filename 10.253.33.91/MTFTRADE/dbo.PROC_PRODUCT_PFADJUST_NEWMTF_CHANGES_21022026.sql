-- Object: PROCEDURE dbo.PROC_PRODUCT_PFADJUST_NEWMTF_CHANGES_21022026
...
CREATE PROC [dbo].[PROC_PRODUCT_PFADJUST_NEWMTF_CHANGES_21022026]
(
...
BEGIN
	...
	*/
	...
	--AND EDT <= @SAUDA_DATE + ' 23:59'  -- CHANGES ON 21/02/2026 FOR VDT LED BALANCE
	--AND VTYP IN ( 67, 6,8,2,3)
	---AND VTYP IN ( 6,8,2,3) --- Changes done   :SRE-44021 (TO REMOVE VTYPE 8)
	AND VTYP IN ( 6,2,3)
	GROUP BY CLTCODE

	/**  CHANGES ON 21/02/2026
