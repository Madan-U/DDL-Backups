-- Object: PROCEDURE dbo.PROC_PRODUCT_PFADJUST_NEWMTF_BKP_SRE-44021
...
Create PROC [dbo].[PROC_PRODUCT_PFADJUST_NEWMTF_BKP_SRE-44021]
(
...
BEGIN
	...
	*/
	...
	FROM LEDGER 
	WHERE VDT >= @SDTCUR  ---CONVERT(NVARCHAR(10), VDT, 120) >= '2017-04-01'  --- SWAPNIL : 23/12/2025 : FOR Financial year wise Payin Amount
