-- Object: PROCEDURE dbo.RPT_MTR_MTFFILE_NEW_test
...
CREATE PROC [dbo].[RPT_MTR_MTFFILE_NEW_test]      
(      
...
END
	...
	SET		CORP_QTY = ISNULL(P.QTY,0),
			CORP_AMT = P.NETAMT, --(ISNULL(P.QTY,0)-(#NSERPT.BODQTY))*ROUND(P.NETAMT/#NSERPT.BODQTY,4),
			--CORP_QTY = ISNULL(P.QTY,0)-(#NSERPT.BODQTY),
	...
	SELECT * FROM #NSERPT WHERE scrip_cd ='SHILPAMED'
