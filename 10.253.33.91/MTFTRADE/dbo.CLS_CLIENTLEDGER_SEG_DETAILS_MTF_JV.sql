-- Object: PROCEDURE dbo.CLS_CLIENTLEDGER_SEG_DETAILS_MTF_JV
...
SELECT @CHARGES_FLAG = ISNULL(PVALUE, 0)  FROM Account.dbo.CLS_CLIENT_LEDGER_PARAMETERS WHERE SESSIONID = @SESSIONID AND PKEY = 'ddlCharges'
