-- Object: PROCEDURE dbo.PROC_MTF_ONETIME_ALLOC_NEW_BAK_05022026
-- Server: 10.253.33.91 | DB: MTFTRADE
--------------------------------------------------



CREATE PROC [dbo].[PROC_MTF_ONETIME_ALLOC_NEW_BAK_05022026]
	(
	...
	*/
	...
	BEGIN
		...
		UPDATE	TBL_MTR_OPEN_BALANCE 
		SET		M_QTY = M_QTY + FLOOR(((PAYIN_AMT_BAL/M_PRICE*1.0)))
		WHERE	M_PRICE > 0 AND PAYIN_AMT_BAL > 0
				AND PRO_PER = 100

		UPDATE	TBL_MTR_OPEN_BALANCE 
		SET		M_AMT = M_AMT + ROUND((M_PRICE*M_QTY),6),
				M_ALLOC_BALANCE = 0 --M_ALLOC_BALANCE + @PAYIN_AMT - ROUND((M_PRICE*M_QTY),2),
		WHERE	PAYIN_AMT_BAL > 0
