-- Object: PROCEDURE dbo.RPT_MTR_MTFFILE_NEW_16102025
...
CREATE PROC [dbo].[RPT_MTR_MTFFILE_NEW_16102025]      
(      
...
END
	...
	SET		CORP_QTY = ISNULL(P.QTY,0),
			...
			FRESHSQTY = 0, --FRESHSQTY-#NSERPT.BODQTY,    
			FRESHSELL = 0 --FRESHSELL-#NSERPT.BODVALUE
