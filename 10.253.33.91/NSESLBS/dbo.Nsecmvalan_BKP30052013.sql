-- Object: PROCEDURE dbo.Nsecmvalan_BKP30052013
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------

 CREATE   Proc [dbo].[Nsecmvalan_BKP30052013] (          
@sett_no Varchar(7),                     
@sett_type Varchar(2),          
@sdate Varchar(11),          
...
Delete From MSAJAG.DBO.CMBillValan Where Sett_no = @sett_no And Sett_type = @sett_type          
  
Insert into MSAJAG.DBO.CmBillValan  
