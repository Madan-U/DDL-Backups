-- Object: PROCEDURE dbo.BBGInsSettBrokUpdateNew_With_ContNo
...
CREATE   procedure
BBGInsSettBrokUpdateNew_With_ContNo
(
	@tparty varchar(10),
...
WHERE C1.CL_CODE = C2.CL_CODE AND C2.PARTY_CODE = @tparty
SELECT * INTO #ClientBrok_Scheme FROM ClientBrok_Scheme WHERE PARTY_CODE = @tparty
AND @Tdate BETWEEN FROM_DATE AND TO_DATE
SELECT * INTO #ClientTaxes_New FROM ClientTaxes_New WHERE PARTY_CODE = @tparty
...
begin
	...
	(
		...
		'BBGInsSettBrokUpdateNew_With_ContNo',	/*called_from*/
		getdate(),	/*timestamp*/
