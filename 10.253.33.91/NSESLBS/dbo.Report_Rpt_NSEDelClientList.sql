-- Object: PROCEDURE dbo.Report_Rpt_NSEDelClientList
...
CREATE Proc Report_Rpt_NSEDelClientList (@StatusId Varchar(15),@StatusName Varchar(25),@SettNo varchar(7),@Sett_Type Varchar(2),@Party_Code Varchar(10) )
as 
If @statusid = 'broker'
Begin	
