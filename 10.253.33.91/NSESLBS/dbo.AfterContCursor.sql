...
Set @@Cno = Cursor For    
        select contractno = client1.cl_type from settlement,client2,client1    
...
Begin    
 ...
 Select @@Contractno = (Case when client1.cl_type = 'PRO' then '0000000' else contractno end ) From Settlement,Client2,Client1    
 Where settlement.party_code = @Toparty    
