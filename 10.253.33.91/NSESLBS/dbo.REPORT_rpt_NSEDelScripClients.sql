-- Object: PROCEDURE dbo.REPORT_rpt_NSEDelScripClients
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------



CREATE PROCEDURE REPORT_rpt_NSEDelScripClients      
...
If @statusid = 'broker'      
Begin       
select distinct d.sett_no,d.sett_type,d.party_code,c1.short_name,d.Scrip_cd,d.Series,d.inout,d.Qty,      
...
Union All      
select distinct d.sett_no,d.sett_type,d.party_code,c1.short_name,d.Scrip_cd,d.Series,inout='I',Qty=0,      
...
And De.Party_Code = D.Party_Code And De.Filler2 = 1 And De.Series = D.Series )       
 where  D.party_code = c2.party_code and c1.cl_code =c2.cl_code      
 and d.sett_no = @settno and d.sett_type = @settype and d.scrip_cd like @scripcd       
 and d.series like @series  and br.short_name = c1.trader and br.branch_cd = @statusname      
 group by d.sett_no,d.sett_type,d.scrip_cd,d.series,c1.short_name,d.party_code,d.inout,D.Qty      
Union All      
select distinct d.sett_no,d.sett_type,d.party_code,c1.short_name,d.Scrip_cd,d.Series,inout='I',Qty=0,      
RecQty = Sum((Case When DrCr = 'C' Then IsNull(D.Qty,0) Else 0 End)),      
...
where  D.party_code = c2.party_code and c1.cl_code =c2.cl_code      
and d.sett_no = @settno and d.sett_type = @settype and d.scrip_cd like @scripcd       
and d.series like @series And Filler2 = 1 and br.short_name = c1.trader and br.branch_cd = @statusname      
And d.Party_code Not In ( Select Party_Code From DeliveryClt_Report De Where De.Sett_no = D.Sett_No And D.sett_Type = De.SetT_Type and D.Scrip_CD = De.Scrip_CD      
And De.Party_Code = D.Party_Code And De.Series = D.Series )       
group by d.sett_no,d.sett_type,d.scrip_cd,d.series,c1.short_name,d.party_code      
...
And De.Party_Code = D.Party_Code And De.Filler2 = 1 And De.Series = D.Series )       
 where  D.party_code = c2.party_code and c1.cl_code =c2.cl_code      
 and d.sett_no = @settno and d.sett_type = @settype and d.scrip_cd like @scripcd       
 and d.series like @series  and  sb.sub_broker = c1.sub_broker and sb.sub_broker = @statusname      
 group by d.sett_no,d.sett_type,d.scrip_cd,d.series,c1.short_name,d.party_code,d.inout,D.Qty      
Union All      
select distinct d.sett_no,d.sett_type,d.party_code,c1.short_name,d.Scrip_cd,d.Series,inout='I',Qty=0,      
RecQty = Sum((Case When DrCr = 'C' Then IsNull(D.Qty,0) Else 0 End)),      
...
where  D.party_code = c2.party_code and c1.cl_code =c2.cl_code      
and d.sett_no = @settno and d.sett_type = @settype and d.scrip_cd like @scripcd       
and d.series like @series And Filler2 = 1 and  sb.sub_broker = c1.sub_broker and sb.sub_broker = @statusname      
And d.Party_code Not In ( Select Party_Code From DeliveryClt_Report De Where De.Sett_no = D.Sett_No And D.sett_Type = De.SetT_Type and D.Scrip_CD = De.Scrip_CD      
And De.Party_Code = D.Party_Code And De.Series = D.Series )       
group by d.sett_no,d.sett_type,d.scrip_cd,d.series,c1.short_name,d.party_code      
 order by d.sett_no,d.sett_type,D.scrip_cd,d.series,c1.short_name,d.party_code      
...
And De.Party_Code = D.Party_Code And De.Filler2 = 1 And De.Series = D.Series )       
 where  D.party_code = c2.party_code and c1.cl_code =c2.cl_code      
 and d.sett_no = @settno and d.sett_type = @settype and d.scrip_cd like @scripcd       
 and d.series like @series  and c1.trader = @statusname      
 group by d.sett_no,d.sett_type,d.scrip_cd,d.series,c1.short_name,d.party_code,d.inout,D.Qty      
Union All      
select distinct d.sett_no,d.sett_type,d.party_code,c1.short_name,d.Scrip_cd,d.Series,inout='I',Qty=0,      
RecQty = Sum((Case When DrCr = 'C' Then IsNull(D.Qty,0) Else 0 End)),      
...
where  D.party_code = c2.party_code and c1.cl_code =c2.cl_code      
and d.sett_no = @settno and d.sett_type = @settype and d.scrip_cd like @scripcd       
and d.series like @series And Filler2 = 1 and c1.trader = @statusname      
And d.Party_code Not In ( Select Party_Code From DeliveryClt_Report De Where De.Sett_no = D.Sett_No And D.sett_Type = De.SetT_Type and D.Scrip_CD = De.Scrip_CD      
And De.Party_Code = D.Party_Code And De.Series = D.Series )       
group by d.sett_no,d.sett_type,d.scrip_cd,d.series,c1.short_name,d.party_code      
 order by d.sett_no,d.sett_type,D.scrip_cd,d.series,c1.short_name,d.party_code      
...
And De.Party_Code = D.Party_Code And De.Filler2 = 1 And De.Series = D.Series )       
 where  D.party_code = c2.party_code and c1.cl_code =c2.cl_code      
 and d.sett_no = @settno and d.sett_type = @settype and d.scrip_cd like @scripcd       
 and d.series like @series   and c2.party_code = @statusname      
 group by d.sett_no,d.sett_type,d.scrip_cd,d.series,c1.short_name,d.party_code,d.inout,D.Qty      
Union All      
select distinct d.sett_no,d.sett_type,d.party_code,c1.short_name,d.Scrip_cd,d.Series,inout='I',Qty=0,      
RecQty = Sum((Case When DrCr = 'C' Then IsNull(D.Qty,0) Else 0 End)),      
...
where  D.party_code = c2.party_code and c1.cl_code =c2.cl_code      
and d.sett_no = @settno and d.sett_type = @settype and d.scrip_cd like @scripcd       
and d.series like @series And Filler2 = 1 and c2.party_code = @statusname      
And d.Party_code Not In ( Select Party_Code From DeliveryClt_Report De Where De.Sett_no = D.Sett_No And D.sett_Type = De.SetT_Type and D.Scrip_CD = De.Scrip_CD      
And De.Party_Code = D.Party_Code And De.Series = D.Series )       
group by d.sett_no,d.sett_type,d.scrip_cd,d.series,c1.short_name,d.party_code      
 order by d.sett_no,d.sett_type,D.scrip_cd,d.series,c1.short_name,d.party_code      
...
And De.Party_Code = D.Party_Code And De.Filler2 = 1 And De.Series = D.Series )       
 where  D.party_code = c2.party_code and c1.cl_code =c2.cl_code      
 and d.sett_no = @settno and d.sett_type = @settype and d.scrip_cd like @scripcd       
 and d.series like @series   and c1.family = @statusname      
 group by d.sett_no,d.sett_type,d.scrip_cd,d.series,c1.short_name,d.party_code,d.inout,D.Qty      
Union All      
select distinct d.sett_no,d.sett_type,d.party_code,c1.short_name,d.Scrip_cd,d.Series,inout='I',Qty=0,      
RecQty = Sum((Case When DrCr = 'C' Then IsNull(D.Qty,0) Else 0 End)),      
...
where  D.party_code = c2.party_code and c1.cl_code =c2.cl_code      
and d.sett_no = @settno and d.sett_type = @settype and d.scrip_cd like @scripcd       
and d.series like @series And Filler2 = 1  and c1.family = @statusname      
And d.Party_code Not In ( Select Party_Code From DeliveryClt_Report De Where De.Sett_no = D.Sett_No And D.sett_Type = De.SetT_Type and D.Scrip_CD = De.Scrip_CD      
And De.Party_Code = D.Party_Code And De.Series = D.Series )       
group by d.sett_no,d.sett_type,d.scrip_cd,d.series,c1.short_name,d.party_code      
 order by d.sett_no,d.sett_type,D.scrip_cd,d.series,c1.short_name,d.party_code      
