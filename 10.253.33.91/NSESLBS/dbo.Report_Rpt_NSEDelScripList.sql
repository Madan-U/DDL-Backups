-- Object: PROCEDURE dbo.Report_Rpt_NSEDelScripList
...
CREATE Proc Report_Rpt_NSEDelScripList (
@StatusId Varchar(15),@StatusName Varchar(25),@SettNo varchar(7),@Sett_Type Varchar(2),@Scrip_Cd Varchar(12),@Series Varchar(3))
as 
If @statusid = 'broker'
Begin	
select distinct d.scrip_cd,d.series,Qty=Sum(Case When Inout = 'I' Then d.qty Else -D.Qty End) from DeliveryClt_Report D, Client2_Report C2, Client1_Report C1
...
If @statusid = 'branch'
Begin	
select distinct d.scrip_cd,d.series,Qty=Sum(Case When Inout = 'I' Then d.qty Else -D.Qty End) from DeliveryClt_Report D, Client2_Report C2, Client1_Report C1, branches br  
where d.sett_no like @settno and d.sett_type like @Sett_Type and d.scrip_cd like @Scrip_Cd and d.series like @Series
And D.Party_Code = C2.Party_Code And C1.Cl_Code = C2.Cl_Code 
...
Begin	
select distinct d.scrip_cd,d.series,Qty=Sum(Case When Inout = 'I' Then d.qty Else -D.Qty End) from DeliveryClt_Report D, Client2_Report C2, Client1_Report C1, subbrokers sb
where d.sett_no like @settno and d.sett_type like @Sett_Type and d.scrip_cd like @Scrip_Cd and d.series like @Series
And D.Party_Code = C2.Party_Code And C1.Cl_Code = C2.Cl_Code 
