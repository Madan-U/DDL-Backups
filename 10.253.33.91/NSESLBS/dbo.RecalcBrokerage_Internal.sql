-- Object: PROCEDURE dbo.RecalcBrokerage_Internal
...
Create procedure RecalcBrokerage_Internal
(
	@Sett_no Varchar(7),
	@Sett_type Varchar(2),
...
Declare
	...
	Exec BBGSETTBROKRECAL @Sett_No, @Sett_Type, @Party_Code, @Scrip_Cd, @Series, @Sauda_Date, @StatusName, @FromWhere
	...
	If Convert(Numeric(10), @billNo) > 0
		Begin
			Exec NewUpdBillTaxReCal @Sett_No, @Sett_Type, @Party_Code, @Scrip_Cd, @Series, @Sauda_Date, @StatusName, @FromWhere
		End
