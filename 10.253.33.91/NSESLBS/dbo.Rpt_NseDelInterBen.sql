-- Object: PROCEDURE dbo.Rpt_NseDelInterBen
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------

CREATE Proc Rpt_NseDelInterBen (  
...
qty=sum(d.Qty), d.Delivered, D.ISett_No,D.ISett_Type from deltrans d, client1 c1, client2 c2   
...
Set Transaction Isolation level read uncommitted  
select ISIN=d.CertNo,d.party_code,c1.short_name ,d.Sett_No, d.Sett_type,d.scrip_cd, d.SlipNo,   
qty=sum(d.Qty), d.Delivered, D.ISett_No,D.ISett_Type from deltrans d, client1 c1, client2 c2 , branches br    
where c1.cl_code = c2.cl_code and c2.party_code = d.party_code and d.TrType = 1000 and d.drcr = 'D'   
...
Set Transaction Isolation level read uncommitted  
select ISIN=d.CertNo,d.party_code,c1.short_name ,d.Sett_No, d.Sett_type,d.scrip_cd, d.SlipNo,   
qty=sum(d.Qty), d.Delivered, D.ISett_No,D.ISett_Type from deltrans d, client1 c1, client2 c2 , subbrokers sb  
where c1.cl_code = c2.cl_code and c2.party_code = d.party_code and d.TrType = 1000 and d.drcr = 'D'   
