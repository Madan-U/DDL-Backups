-- Object: PROCEDURE dbo.CBO_InsDelDpCharges
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------


CREATE Proc CBO_InsDelDpCharges
(
...
BEGIN
	...
	SELECT @ProcessFlag = ISNULL(@ProcessFlag, '')
	...
	If @ProcessFlag = '' OR @ProcessFlag = 'IS'  -- Inter Settlement                
	Begin                
	...
	If @ProcessFlag = '' OR @ProcessFlag = 'PO'  -- POOL To Client Payout   
	Begin                
		Insert into tempDpChargeCalculation                 
		select sett_no='',sett_type='',refno,trtype,party_code,scrip_cd,series,                
	...
	If @ProcessFlag = '' OR @ProcessFlag = 'PB'  -- POOL To Ben  
	Begin                
		Insert into tempDpChargeCalculation                 
		select sett_no='',sett_type='',refno,trtype,party_code,scrip_cd,series,                
		Qty=Sum(qty),certno,DL.dptype,DL.dpid,DL.cltdpid,                
	...
	If @ProcessFlag = '' OR  @ProcessFlag = 'BP'  -- Ben To Pool                
	Begin                
		Insert into tempDpChargeCalculation                 
	...
	If @ProcessFlag = '' OR @ProcessFlag = 'OM'  -- Ben To Client Payout Off Market                
	Begin                
		Insert into tempDpChargeCalculation                 
		select sett_no='',sett_type='',refno,trtype,party_code,scrip_cd,series,                
		Qty=Sum(qty),certno,DL.dptype,DL.dpid,DL.cltdpid,                
