-- Object: PROCEDURE dbo.CBO_ADDREGION
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------

CREATE PROCEDURE [dbo].[CBO_ADDREGION]
(
...
While @@Fetch_Status = 0       
	BEGIN
		SET @SQL = "INSERT INTO #REGIONEXIST (REGIONCODE) SELECT REGIONCODE FROM " + @share_server + "." + @share_db + ".DBO.REGION WHERE REGIONCODE = '" + @region_code + "'"
		--PRINT @SQL
	    EXEC(@SQL)
