-- Object: PROCEDURE dbo.NewBBGSPostest
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------


/****** Object:  Stored Procedure dbo.NewBBGSPostest    Script Date: 03/16/2004 3:52:58 PM ******/  
  
  
/****** Object:  Stored Procedure dbo.NewBBGSPostest    Script Date: Apr 26 2003 11:52:41 ******/  
  
/****** Object:  Stored Procedure dbo.NewBBGSPostest    Script Date: Apr 15 2003 17:31:12 ******/  
  
/****** Object:  Stored Procedure dbo.NewBBGSPostest    Script Date: Apr 15 2003 11:35:57 ******/  
  
/****** Object:  Stored Procedure dbo.NewBBGSPostest    Script Date: 04/15/2003 11:25:01 AM ******/  
  
  
/****** Object:  Stored Procedure dbo.NewBBGSPostest    Script Date: Jan 14 2003 5:55:49 PM ******/  

  
--EXEC newbbgspostest '', '', '%', 'Jun  1 2000', 'Jun  1 2007', '', '', 'HO', 'HO', 'BRANCH_CD', 'Br', '0', '1', '1', '', 'broker', 'broker'  
...
begin  
     ...
     Select @@FromRegion = @statusname
     Select @@ToRegion = @statusname    
End  
  
else If (@Consol = "REGION")  And  ((@From = "") And (@To = "" ) )   
begin  
     Select @@ToParty_code =  Max(Party_code) ,@@FromParty_code = Min(Party_code) From Details   
     Select @@FromRegion = @statusname, @@ToRegion=@statusname
End  
...
Set @@WhereText =  " Where S.Sauda_date   Between '" + @Sauda_date  + " 00:00:00'  And '"   + @Todate  + " 00:00:00' And S.Scrip_cd Between '"  + @Fromscrip + "' And  '"+  @Toscrip +"' And S.Sett_no Between '" + @Sett_no + "' And '" + @Tosett_no +"' "
