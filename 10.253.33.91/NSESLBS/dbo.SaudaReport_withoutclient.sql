-- Object: PROCEDURE dbo.SaudaReport_withoutclient
...
--EXEC SaudaReport_withoutclient '2008041', '2008041', 'N', 'FEB 26 2008', 'FEB 26 2008', '', '', '', '', '', '', 'PARTY_CODE', '2', 'BROKER', 'BROKER'

CREATE Proc [dbo].[SaudaReport_withoutclient]  
(         
@Sett_no Varchar(10),    
...
if @Groupby = '1'         
 ...
 select sett_no,sett_type,s.party_code,replace(long_Name,"'","") as party_name,scrip_cd,series,PTradedqty=Sum(Pqty),PtradedAmt=Sum(Pamt),        
