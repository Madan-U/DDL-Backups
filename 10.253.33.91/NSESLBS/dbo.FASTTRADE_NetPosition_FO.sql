-- Object: PROCEDURE dbo.FASTTRADE_NetPosition_FO
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------



CREATE   Procedure FASTTRADE_NetPosition_FO ( @TradeDate Varchar(11)) AS  
/*  
 -------------------------------------------------------------------------------------------  
 Procedure Name  : sp_NetPosition_FO for NSEFO  
 Arguments  : Trade Date in MMM DD YYYY format   
 Description : Fetching Client's Net Position for a given date  
     Price for Option trades will not be available  currently  
 -------------------------------------------------------------------------------------------  
*/  
...
Select   
 ...
 OptionType   = (Case When Left(foEa_Inst_Type,3) ='OPT' Then FoEa_Option_Type Else FoEa_Option_Type End),  
...
From  
 NSEFO.dbo.FOExerciseAllocation (nolock)  
Where  
