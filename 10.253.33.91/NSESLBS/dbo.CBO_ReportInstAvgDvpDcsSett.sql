-- Object: PROCEDURE dbo.CBO_ReportInstAvgDvpDcsSett
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------



CREATE      procedure CBO_ReportInstAvgDvpDcsSett              
@ofdate varchar(10),               
@fparty varchar(10),               
@tparty varchar(10),               
@fscrip varchar(10),               
...
from           
      ...
      (          
            ...
            Where           
                  CreationDate >= Convert(Varchar(11), Convert(Datetime,@ofdate, 103), 109)         
            Group By           
      ...
      client2 c2 (nolock)               
where           
left(convert(varchar,Sauda_date,109),11) = Convert(Varchar(11), Convert(Datetime,@ofdate, 103), 109)         
