-- Object: PROCEDURE dbo.Proc_newbasicreport_New
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------


--EXEC Proc_Newbasicreport_New '', '', '%', 'Feb 15 2006 ', 'Oct  9 2007 ', '', '', '0A141', '0A141', 'PARTY_CODE', 'S', '0', '1', '1', '', 'broker', 'broker'

CREATE  Procedure [dbo].[Proc_newbasicreport_New]
( 
	@sett_no Varchar(10), 		 ---1 Settlement No(from)
	@tosett_no Varchar(10),		 ---2 Settlement No (to)

	@sett_type Varchar(3),		 ---3 Settlement Type [N],[M] 
	...
	@statusid Varchar(15),	     ---16 Session ID
	@statusname Varchar(25)	     ---17 Session usname
)
