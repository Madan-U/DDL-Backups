-- Object: PROCEDURE dbo.ContCumBill_Digital
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------

CREATE Proc ContCumBill_Digital    
...
Select * Into #Settlement From Settlement with(index(stt_index))    
...
Partipantcode,Status,Pro_Cli,Cpid,Instrument,Booktype,Branch_Id,Tmark,
Scheme,Dummy1,Dummy2
From Settlement with(index(stt_index))    
