-- Object: PROCEDURE dbo.rms_new_details_MOSL
...
Declare  
 ...
 Begin  
  ...
  Begin    
   If (@WhatCode = 'CLIENT') Begin Set @strSelect = @strSelect + "party_code, Left(party_name,25) AS party_name,cl_type,PType,NPercentScrip,NPercent,BPercentScrip,BPercent,SALES_PERSON,CUST_EXECUTIVE, " End  
   If (@WhatCode = 'BRANCH') Begin Set @strSelect = @strSelect + "BRANCH_CD,party_code, Left(party_name,25) AS party_name,cl_type,PType,NPercentScrip,NPercent,BPercentScrip,BPercent,SALES_PERSON,CUST_EXECUTIVE, " End  
   If (@WhatCode = 'SUBBROKER') Begin Set @strSelect = @strSelect + "sub_broker,party_code, Left(party_name,25) AS party_name,cl_type,PType,NPercentScrip,NPercent,BPercentScrip,BPercent,SALES_PERSON,CUST_EXECUTIVE, " End  
   If (@WhatCode = 'TRADER') Begin Set @strSelect = @strSelect + "trader,party_code, Left(party_name,25) AS party_name,cl_type,PType,NPercentScrip,NPercent,BPercentScrip,BPercent,SALES_PERSON,CUST_EXECUTIVE, " End  
   If (@WhatCode = 'FAMILY') Begin Set @strSelect = @strSelect + "family, Left(Familyname,25) AS familyname,party_code,Left(party_name,25) AS party_name,cl_type,PType,NPercentScrip,NPercent,BPercentScrip,BPercent,SALES_PERSON,CUST_EXECUTIVE, " End  
  End  
  ...
  End  
  if @CLType <> 'ALL'
  Set @strWhere = @strWhere + "Cl_type = '"+ @CLType +"' AND "
	
  if @PType <> 'ALL'
  Set @strWhere = @strWhere + "Ptype = '"+ @PType +"' AND "
  ...
  Begin  
   If ((@WhatCode = 'BROKER') OR (@WhatCode = 'CLIENT')) Begin Set @strGroupBy = @strGroupBy + "party_code, party_name,cl_type,PType,NPercentScrip,NPercent,BPercentScrip,BPercent,SALES_PERSON,CUST_EXECUTIVE " End  
   If (@WhatCode = 'BRANCH') Begin Set @strGroupBy = @strGroupBy + "BRANCH_CD,party_code, party_name,cl_type,PType,NPercentScrip,NPercent,BPercentScrip,BPercent,SALES_PERSON,CUST_EXECUTIVE " End  
   If (@WhatCode = 'SUBBROKER') Begin Set @strGroupBy = @strGroupBy + "sub_broker,party_code, party_name,cl_type,PType,NPercentScrip,NPercent,BPercentScrip,BPercent,SALES_PERSON,CUST_EXECUTIVE " End  
   If (@WhatCode = 'TRADER') Begin Set @strGroupBy = @strGroupBy + "trader,party_code, party_name,cl_type,PType,NPercentScrip,NPercent,BPercentScrip,BPercent,SALES_PERSON,CUST_EXECUTIVE " End  
   If (@WhatCode = 'FAMILY') Begin Set @strGroupBy = @strGroupBy + "family,FamilyName,party_code, party_name,cl_type,PType,NPercentScrip,NPercent,BPercentScrip,BPercent,SALES_PERSON,CUST_EXECUTIVE " End  
