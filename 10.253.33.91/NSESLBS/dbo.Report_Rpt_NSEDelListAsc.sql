-- Object: PROCEDURE dbo.Report_Rpt_NSEDelListAsc
...
/****** Object:  Stored Proc Report_dbo.Rpt_NSEDelListAsc    Script Date: 12/16/2003 2:31:23 PM ******/

Create Proc Report_Rpt_NSEDelListAsc (@StatusId Varchar(15),@StatusName Varchar(25),@SettNo varchar(7),@Sett_Type Varchar(2),@Party_Code Varchar(10) )
as 
If @statusid = 'broker'
Begin	
