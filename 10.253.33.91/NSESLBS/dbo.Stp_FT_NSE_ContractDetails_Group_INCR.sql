-- Object: PROCEDURE dbo.Stp_FT_NSE_ContractDetails_Group_INCR
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------



--Exec Stp_FT_NSE_ContractDetails_Group_INCR 'Mar 22 2004','Mar 22 2004', '0000181','0017852', 'UT056', 'UT056', '','0000005', '10208','IN231111131', 'NSE','','brokerage inclusive of STT In FT'

CREATE    PROC

Stp_FT_NSE_ContractDetails_Group_INCR
...
And ContractNo NOT IN (SELECT ContractNo FROM stp_header_New WHERE serviceProvider ='FT')
