-- Object: PROCEDURE dbo.Stt_exception_partywise_nsecm
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------

/****** Object:  Stored Procedure Dbo.stt_exception_partywise_nsecm    Script Date: 01/15/2005 1:16:17 Pm ******/  
  
/****** Object:  Stored Procedure Dbo.stt_exception_partywise_nsecm    Script Date: 11/18/2004 7:51:20 Pm ******/  
  
CREATE  Proc  
 Stt_exception_partywise_nsecm  
 (  
 @fromdate Varchar(11),  
 @todate Varchar(11),  
 @clitype Varchar(2),  
...
Set @fromclause = @fromclause + ' Stt_clientdetail C Full Outer Join Stt_exchg_view_party_nsecm E'  
...
Set @fromclause = @fromclause + ' C.sett_type = E.sett_type '  
...
Begin  
 ...
 --no E.rectype = 20 Condition Here Because Of The Outer Join, E.rectype Will Return Null If No Corres. Rec. Is Found  
 ...
 --list Only Recs Whose Party Codes In Stt_exchg_view_party Are Null  
 --ie They R Present Only In Bo  
 Set @whereclause = @whereclause + ' And E.party_code Is Null'  
   
 Set @groupby = @groupby + ' Group By'  
 Set @groupby = @groupby + ' C.branch_id, E.tpsttdel, E.tssttdel, E.tsstttrd, E.totalstt'  
End  
  
If @exceptiontype = 'ex' --conditions On Stt_exchg_view_party View  
Begin  
 Set @whereclause = @whereclause + ' E.rectype = 20 And'  --get Party Summary Recs Only.  
 --no E.rectype = 20 Condition Here Because Of The Outer Join, C.rectype Will Return Null If No Corres. Rec. Is Found  
 ...
 --list Only Recs Whose Party Codes (branch_ids) In Stt_clientdetail Are Null  
 --ie They R Present Only In Ex  
 Set @whereclause = @whereclause + ' And C.branch_id Is Null'  
  
 Set @groupby = @groupby + ' Group By'  
 Set @groupby = @groupby + ' E.party_code, E.tpsttdel, E.tssttdel, E.tsstttrd, E.totalstt'  
End  
