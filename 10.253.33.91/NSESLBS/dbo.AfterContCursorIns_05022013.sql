-- Object: PROCEDURE dbo.AfterContCursorIns_05022013
...
CREATE    procedure  
 [dbo].[AfterContCursorIns_05022013]  
 (  
  @orderno varchar(16),  
  @tradeno varchar (20),  
  @partycd VARCHAR(10),  
...
If @@Error < > 0  
Insert into errorlog Values (Getdate(), '  In AfterContcursorins   Error Occured in section Consolidation  ', @OrderNo + '     ' +@Tradeno + '   '+ @Partycd + '      ' +@Scripcd +'   ' +@Tdate + '   ' +Convert(Varchar,@Mkrate) + '    ' +  @Sellbuy  +  '   ' + @Sett_type +'   '+ @@Sett_no ,' ' + Convert(Varchar,@Flag) + '     ' + @Memcode + '   ' +@ToParty  + '    ' +  Convert(Varchar,@Tqty),'  ')  
