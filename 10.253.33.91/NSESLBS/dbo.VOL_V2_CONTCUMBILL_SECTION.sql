-- Object: PROCEDURE dbo.VOL_V2_CONTCUMBILL_SECTION
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------



CREATE   PROC VOL_V2_CONTCUMBILL_SECTION    
(    
 @STATUSID VARCHAR(15),    
