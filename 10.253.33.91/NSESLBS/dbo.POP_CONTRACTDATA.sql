-- Object: PROCEDURE dbo.POP_CONTRACTDATA
...
AREA, REGION, CL_TYPE, FAMILY
 ...
 ON (    S2.SCRIP_CD  = S.CD_SCRIP_CD         
  ...
  AND CD_Trade_No = '' 
                ...
                =========================================================================*/   
        INSERT   
        INTO    CONTRACT_DATA_TMP SELECT  CONTRACTNO,   
                S.PARTY_CODE,   
                ORDER_NO,   
                ORDER_TIME=(     
                CASE   
 ...
 UPDATE CONTRACT_DATA_TMP SET   
         START_DATE = CONVERT(CHAR,(S.START_DATE),103),  
 ...
 AND S.SETT_TYPE = @SETT_TYPE  
        ...
        WHERE   M.SCRIP_CD   = CONTRACT_DATA_TMP.SCRIP_CD      
                AND M.SERIES = (  
                CASE   
                        WHEN CONTRACT_DATA_TMP.SERIES = 'BL'   
                        THEN 'EQ'   
                        WHEN CONTRACT_DATA_TMP.SERIES = 'IL'   
                        THEN 'EQ'   
                        ELSE CONTRACT_DATA_TMP.SERIES   END)      
                AND VALID = 1   
  ...
  SELECT CONTRACTNO,PARTY_CODE,ORDER_NO,ORDER_TIME,TM,TRADE_NO,SAUDA_DATE,SCRIP_CD,SERIES,SCRIPNAME,SDT,
  SELL_BUY,BROKER_CHRG,TURN_TAX,SEBI_TAX,OTHER_CHRG,INS_CHRG,SERVICE_TAX,NSERTAX,SAUDA_DATE1,PQTY,SQTY,
  PRATE,SRATE,PBROK,SBROK,PNETRATE,SNETRATE,PAMT,SAMT,BROKERAGE,SETT_NO,SETT_TYPE,TRADETYPE,TMARK,PRINTF,
  ORDERFLAG,SCRIPNAMEForOrderBy,SCRIPNAME1,ActSell_buy,ISIN,ROUNDTO = 2  
  FROM CONTRACT_DATA_TMP   
         WITH     
                 (     
                         NOLOCK     
