-- Object: PROCEDURE dbo.Report_Rpt_NseDeltrans_Reportaction
...
CREATE Proc Report_Rpt_NseDeltrans_Reportaction (
...
from Deltrans_Report D, Client1_Report C1, Client2_Report C2 where c1.cl_code = c2.cl_code and c2.Party_code = d.party_code 
...
Transno = D.FolioNo, D.DrCr, D.TransDate,D.reason, D.certno, D.SlipNo,DpType,CltDpNo=CltDpId,DpId
from Deltrans_Report D where D.transdate >= @FromDate and D.transdate <= @ToDate + ' 23:59:59'
and D.Party_Code Like @Party_Code and D.Scrip_Cd like @Scrip_Cd And Filler2 = 1 
And Party_Code not in (Select Party_Code From Client2_Report Where Party_Code = D.Party_Code )
Union All 
...
from demattrans D, Client1_Report C1, Client2_Report C2 where c1.cl_code = c2.cl_code and c2.Party_code = d.party_code 
...
select D.Party_Code, c1.short_name,D.scrip_cd, D.series, D.Sett_No, D.Sett_type, D.TCode, D.Qty,
Transno = D.FolioNo, D.DrCr, D.TransDate,D.reason, D.certno, D.SlipNo,DpType,CltDpNo=CltDpId,DpId
from Deltrans_Report D, Client1_Report C1, Client2_Report C2, branches br   where c1.cl_code = c2.cl_code and c2.Party_code = d.party_code 
...
select D.Party_Code, c1.short_name,D.scrip_cd, D.series, D.Sett_No, D.Sett_type, D.TCode, D.Qty, Transno, D.DrCr, 
TransDate=TrDate,Reason='', certno=IsIn, SlipNo =0,DpType,CltDpNo=CltAccNo,DpId 
from demattrans D, Client1_Report C1, Client2_Report C2, branches br   where c1.cl_code = c2.cl_code and c2.Party_code = d.party_code 
...
select D.Party_Code, c1.short_name,D.scrip_cd, D.series, D.Sett_No, D.Sett_type, D.TCode, D.Qty,
Transno = D.FolioNo, D.DrCr, D.TransDate,D.reason, D.certno, D.SlipNo,DpType,CltDpNo=CltDpId,DpId
from Deltrans_Report D, Client1_Report C1, Client2_Report C2, subbrokers sb where c1.cl_code = c2.cl_code and c2.Party_code = d.party_code 
...
select D.Party_Code, c1.short_name,D.scrip_cd, D.series, D.Sett_No, D.Sett_type, D.TCode, D.Qty, Transno, D.DrCr, 
TransDate=TrDate,Reason='', certno=IsIn, SlipNo =0,DpType,CltDpNo=CltAccNo,DpId 
from demattrans D, Client1_Report C1, Client2_Report C2, subbrokers sb where c1.cl_code = c2.cl_code and c2.Party_code = d.party_code 
