-- Object: PROCEDURE dbo.V2_CONTCUMBILL_SECTION_HISTORY_ANGEL
...
CREATE   PROC V2_CONTCUMBILL_SECTION_HISTORY_ANGEL
(
	@STATUSID VARCHAR(15),
...
ELSE
	...
	CREATE CLUSTERED INDEX [scr]   
        ...
        SELECT  C2.PARTY_CODE, 
                ...
                C1.OFF_PHONE1, 
                C1.OFF_PHONE2, 
                PRINTF = (CASE WHEN PRINTF IN (0, 2, 5) THEN 0 
			       WHEN PRINTF IN (3, 6) THEN 3
			       WHEN PRINTF = 4 AND @CONTFLAG = 'CONTRACT' THEN 3
			       WHEN PRINTF = 4 AND @CONTFLAG = 'DIGITAL' THEN 0
			       ELSE 0
			  END),
                MAPIDID,
		UCC_CODE,
        ...
        WHERE   C2.CL_CODE       = C1.CL_CODE 
                ...
                AND 1 = (CASE WHEN @CONTFLAG = 'CONTRACT' AND PRINTF IN (0, 3, 4, 5) THEN 1 
			      WHEN @CONTFLAG = 'DIGITAL' AND PRINTF IN (2, 4, 5, 6) THEN 1 
			      WHEN @CONTFLAG = '' THEN 1 
			      ELSE 0 
                         END)
