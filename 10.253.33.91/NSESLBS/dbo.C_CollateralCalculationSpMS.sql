-- Object: PROCEDURE dbo.C_CollateralCalculationSpMS
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------



CREATE PROCEDURE [dbo].[C_CollateralCalculationSpMS]     
(    
    @Exchange Varchar(3),     
    @Segment Varchar(20),     
...
As        
    ...
    INTO    #CollateralDetails SELECT EffDate = @Effdate                 ,
            ...
            Qty                               = 0                        ,
            HairCut                           = BgHaircut                ,
            FinalAmount                       = #COLLATERALDATA.BgAmount ,
            PercentageCash                    = Cash_Compo               ,
            PerecntageNonCash                 = NonCash_Compo            ,
            Receive_Date                      = Receive_Date             ,
            Maturity_Date                     = Maturity_Date            ,
    ...
    =====================================================*/
    /* commneted by animesh as mosl required the VAR Haircut
    UPDATE #C_CalculateSecView
    Set SecHaircut = HairCut
    FROM (
