-- Object: PROCEDURE dbo.getClient_Brok_Detail
-- Server: 10.253.33.91 | DB: NSESLBS
--------------------------------------------------

CREATE   Proc getClient_Brok_Detail                   
 ...
 begin                                         
   ...
   Begin                  
     Select m.Exchange as exchange1, m.Segment as segment1,                          
       ...
       isnull(c.Fut_Brok_Applicable,0) Fut_Brok_Applicable1,isnull(c.Fut_Stt,0) Fut_Stt1,isnull(c.Fut_Tran_Chrgs,0)Fut_Tran_Chrgs1,                                
       isnull(c.Fut_SEBI_Fees,0) Fut_SEBI_Fees1,isnull(c.Fut_Stamp_Duty,0) Fut_Stamp_Duty1,isnull(c.Fut_Other_Chrgs,0) Fut_Other_Chrgs1,*,                                   
       isnull(c.Brok_Scheme,0)Brok_Scheme1,isnull(cl_code,'')  cl_code                               
     From                  
