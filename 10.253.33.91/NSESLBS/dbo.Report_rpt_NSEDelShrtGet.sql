-- Object: PROCEDURE dbo.Report_rpt_NSEDelShrtGet
...
/****** Object:  Stored Proc Report_dbo.rpt_NSEDelShrtGet    Script Date: 05/08/2002 12:35:16 PM ******/
...
CREATE Proc Report_rpt_NSEDelShrtGet
@dematid varchar(2),
@settno varchar(7),
@settype varchar(3)
AS
...
begin
 ...
 RecievedNse= isnull(( select Sum(qty)from Deltrans_Report where sett_no = d.sett_no and sett_type = d.sett_type and 
...
having Sum(d.Qty) <> isnull(( select Sum(qty)from Deltrans_Report where sett_no = d.sett_no and sett_type = d.sett_type and 
