-- Object: PROCEDURE dbo.usp_Get_rpt_Approve_details_Ipartner_BKP_24APR25_SRE35996
...
--usp_Get_rpt_Approve_details_Ipartner 'MOYR','1556551'
--usp_Get_rpt_Approve_details_Ipartner_UAT 'MOYR','1556551'
CREATE Procedure [dbo].[usp_Get_rpt_Approve_details_Ipartner_BKP_24APR25_SRE35996]
(
...
select Party_code, sub_broker into #sb_client_details 
from [citrus_usr].vw_sb_client_details with(nolock)
...
exec AngelDP5.DMAT.[citrus_usr].rpt_Approve_details @pa_id='3',@pa_tab='ALL_RECORD_TYPE',@pa_type='CDSL',@pa_from_dt='',@pa_to_dt='23:55:55',@pa_trastm_cd='DMAT',@pa_login_pr_entm_id=1,@pa_login_entm_cd_chain='HO|*~|',@pa_slip_no=@pa_slip_no,@pa_clientid='',@pa_drnno=''


insert into #rpt_Approve_details
exec AGMUBODPL3.DMAT.[citrus_usr].rpt_Approve_details @pa_id='3',@pa_tab='ALL_RECORD_TYPE',@pa_type='CDSL',@pa_from_dt='',@pa_to_dt='23:55:55',@pa_trastm_cd='DMAT',@pa_login_pr_entm_id=1,@pa_login_entm_cd_chain='HO|*~|',@pa_slip_no=@pa_slip_no,@pa_clientid='',@pa_drnno=''


insert into #rpt_Approve_details
exec ANGELDP202.DMAT.[citrus_usr].rpt_Approve_details @pa_id='3',@pa_tab='ALL_RECORD_TYPE',@pa_type='CDSL',@pa_from_dt='',@pa_to_dt='23:55:55',@pa_trastm_cd='DMAT',@pa_login_pr_entm_id=1,@pa_login_entm_cd_chain='HO|*~|',@pa_slip_no=@pa_slip_no,@pa_clientid='',@pa_drnno=''

insert into #rpt_Approve_details
exec ABVSDP203.DMAT.[citrus_usr].rpt_Approve_details @pa_id='3',@pa_tab='ALL_RECORD_TYPE',@pa_type='CDSL',@pa_from_dt='',@pa_to_dt='23:55:55',@pa_trastm_cd='DMAT',@pa_login_pr_entm_id=1,@pa_login_entm_cd_chain='HO|*~|',@pa_slip_no=@pa_slip_no,@pa_clientid='',@pa_drnno=''

insert into #rpt_Approve_details
exec ABVSDP204.DMAT.[citrus_usr].rpt_Approve_details @pa_id='3',@pa_tab='ALL_RECORD_TYPE',@pa_type='CDSL',@pa_from_dt='',@pa_to_dt='23:55:55',@pa_trastm_cd='DMAT',@pa_login_pr_entm_id=1,@pa_login_entm_cd_chain='HO|*~|',@pa_slip_no=@pa_slip_no,@pa_clientid='',@pa_drnno=''
