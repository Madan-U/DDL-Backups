-- Object: PROCEDURE dbo.usp_Get_rpt_Approve_details_Ipartner_UAT
...
--usp_Get_rpt_Approve_details_Ipartner_UAT '1556551','MOYR'

 --ALTER THIS VIEW UNDER SRE-34226


CREATE Procedure [dbo].[usp_Get_rpt_Approve_details_Ipartner_UAT]
(
...
select Party_code, sub_broker into #sb_client_details from [citrus_usr].vw_sb_client_details with(nolock)
