-- Object: PROCEDURE dbo.usp_Get_rpt_Approve_details_Ipartner_BKUP_02JUNE_2022
...
Create Procedure [dbo].[usp_Get_rpt_Approve_details_Ipartner_BKUP_02JUNE_2022]
(
...
exec [172.31.16.94].DMAT.[citrus_usr].rpt_Approve_details @pa_id='3',@pa_tab='ALL_RECORD_TYPE',@pa_type='CDSL',@pa_from_dt='',@pa_to_dt='23:55:55',@pa_trastm_cd='DMAT',@pa_login_pr_entm_id=1,@pa_login_entm_cd_chain='HO|*~|',@pa_slip_no=@pa_slip_no,@pa_clientid='',@pa_drnno=''

insert into #rpt_Approve_details
exec [172.31.16.141].DMAT.[citrus_usr].rpt_Approve_details @pa_id='3',@pa_tab='ALL_RECORD_TYPE',@pa_type='CDSL',@pa_from_dt='',@pa_to_dt='23:55:55',@pa_trastm_cd='DMAT',@pa_login_pr_entm_id=1,@pa_login_entm_cd_chain='HO|*~|',@pa_slip_no=@pa_slip_no,@pa_clientid='',@pa_drnno=''
