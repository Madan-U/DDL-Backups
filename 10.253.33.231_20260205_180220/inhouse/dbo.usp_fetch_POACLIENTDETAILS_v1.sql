-- Object: PROCEDURE dbo.usp_fetch_POACLIENTDETAILS_v1
-- Server: 10.253.33.231 | DB: inhouse
--------------------------------------------------

create proc [dbo].[usp_fetch_POACLIENTDETAILS_v1]
as BEGIN
...
UPDATE BUYBACK_POACLIENTDETAILS SET POA_FLAG=(CASE WHEN OLD_POA ='Y' AND NEW_POA ='N' THEN '1' ELSE (CASE WHEN NEW_POA ='Y' THEN '1' ELSE '0' END)  END),
