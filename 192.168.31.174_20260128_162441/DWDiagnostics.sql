...
-- Exported: 2026-01-28T16:24:55.633867

USE DWDiagnostics;
GO

-- --------------------------------------------------
-- INDEX dbo.pdw_component_alerts_data
-- --------------------------------------------------
CREATE NONCLUSTERED INDEX [IX_pdw_component_alerts_data] ON [dbo].[pdw_component_alerts_data] ([Builtin_DateTimeEntryCreated])

GO

-- --------------------------------------------------
-- INDEX dbo.pdw_component_health_data
-- --------------------------------------------------
CREATE NONCLUSTERED INDEX [IX_pdw_component_health_data] ON [dbo].[pdw_component_health_data] ([Builtin_DateTimeEntryCreated])
...
-- INDEX dbo.pdw_component_health_data
-- --------------------------------------------------
CREATE NONCLUSTERED INDEX [IX_pdw_component_health_data_SourceNameNodeId] ON [dbo].[pdw_component_health_data] ([CustomContext.SourceName], [CustomContext.CurrentNode.Id])

GO

-- --------------------------------------------------
-- INDEX dbo.pdw_errors
-- --------------------------------------------------
CREATE NONCLUSTERED INDEX [IX_pdw_errors] ON [dbo].[pdw_errors] ([Builtin_DateTimeEntryCreated])

GO

-- --------------------------------------------------
-- INDEX dbo.pdw_loader_backup_run_details_data
-- --------------------------------------------------
CREATE NONCLUSTERED INDEX [IX_pdw_loader_backup_run_details_data] ON [dbo].[pdw_loader_backup_run_details_data] ([Builtin_DateTimeEntryCreated])

GO

-- --------------------------------------------------
-- INDEX dbo.pdw_loader_backup_runs_data
-- --------------------------------------------------
CREATE NONCLUSTERED INDEX [IX_pdw_loader_backup_runs_data] ON [dbo].[pdw_loader_backup_runs_data] ([Builtin_DateTimeEntryCreated])

GO

-- --------------------------------------------------
-- INDEX dbo.pdw_loader_run_stages_data
-- --------------------------------------------------
CREATE NONCLUSTERED INDEX [IX_pdw_loader_run_stages_data] ON [dbo].[pdw_loader_run_stages_data] ([Builtin_DateTimeEntryCreated])

GO

-- --------------------------------------------------
-- INDEX dbo.pdw_os_event_logs
-- --------------------------------------------------
CREATE NONCLUSTERED INDEX [IX_pdw_os_event_logs] ON [dbo].[pdw_os_event_logs] ([Builtin_DateTimeEntryCreated])

GO

-- --------------------------------------------------
-- INDEX dbo.pdw_performance_data
-- --------------------------------------------------
CREATE NONCLUSTERED INDEX [IX_pdw_performance_data] ON [dbo].[pdw_performance_data] ([Builtin_DateTimeEntryCreated])

GO

-- --------------------------------------------------
-- PK_UNIQUE dbo.pdw_component_alerts_data
-- --------------------------------------------------
ALTER TABLE [dbo].[pdw_component_alerts_data] ADD CONSTRAINT [PK_pdw_component_alerts_data] PRIMARY KEY ([Builtin_RowId])

GO

-- --------------------------------------------------
-- PK_UNIQUE dbo.pdw_component_health_data
-- --------------------------------------------------
ALTER TABLE [dbo].[pdw_component_health_data] ADD CONSTRAINT [PK_pdw_component_health_data] PRIMARY KEY ([Builtin_RowId])

GO

-- --------------------------------------------------
-- PK_UNIQUE dbo.pdw_diagnostics_sessions
-- --------------------------------------------------
ALTER TABLE [dbo].[pdw_diagnostics_sessions] ADD CONSTRAINT [PK__pdw_diag__08F643FBC3D138B5] PRIMARY KEY ([session_name])

GO

-- --------------------------------------------------
-- PK_UNIQUE dbo.pdw_errors
-- --------------------------------------------------
ALTER TABLE [dbo].[pdw_errors] ADD CONSTRAINT [PK_pdw_errors] PRIMARY KEY ([Builtin_RowId])

GO

-- --------------------------------------------------
-- PK_UNIQUE dbo.pdw_health_components_data
-- --------------------------------------------------
ALTER TABLE [dbo].[pdw_health_components_data] ADD CONSTRAINT [PK_pdw_health_components_data] PRIMARY KEY ([Builtin_RowId])

GO

-- --------------------------------------------------
-- PK_UNIQUE dbo.pdw_loader_backup_run_details_data
-- --------------------------------------------------
ALTER TABLE [dbo].[pdw_loader_backup_run_details_data] ADD CONSTRAINT [PK_pdw_loader_backup_run_details_data] PRIMARY KEY ([Builtin_RowId])

GO

-- --------------------------------------------------
-- PK_UNIQUE dbo.pdw_loader_backup_runs_data
-- --------------------------------------------------
ALTER TABLE [dbo].[pdw_loader_backup_runs_data] ADD CONSTRAINT [PK_pdw_loader_backup_runs_data] PRIMARY KEY ([Builtin_RowId])

GO

-- --------------------------------------------------
-- PK_UNIQUE dbo.pdw_loader_run_stages_data
-- --------------------------------------------------
ALTER TABLE [dbo].[pdw_loader_run_stages_data] ADD CONSTRAINT [PK_pdw_loader_backup_run_stages_data] PRIMARY KEY ([Builtin_RowId])

GO

-- --------------------------------------------------
-- PK_UNIQUE dbo.pdw_os_event_logs
-- --------------------------------------------------
ALTER TABLE [dbo].[pdw_os_event_logs] ADD CONSTRAINT [PK_pdw_os_event_logs] PRIMARY KEY ([Builtin_RowId])

GO

-- --------------------------------------------------
-- PK_UNIQUE dbo.pdw_performance_data
-- --------------------------------------------------
ALTER TABLE [dbo].[pdw_performance_data] ADD CONSTRAINT [PK_pdw_performance_data] PRIMARY KEY ([Builtin_RowId])

GO

-- --------------------------------------------------
-- PROCEDURE dbo.PublishHealthStatusData
-- --------------------------------------------------
CREATE PROCEDURE [dbo].[PublishHealthStatusData]
			...
			BEGIN
				...
				MERGE [pdw_component_health_data] WITH(TablockX) AS target
...
-- --------------------------------------------------
-- PROCEDURE dbo.PublishPerformanceCounterData
-- --------------------------------------------------
...
-- --------------------------------------------------
-- PROCEDURE dbo.UpgradeDWDiagnostics
-- --------------------------------------------------
...
CREATE PROCEDURE [dbo].[UpgradeDWDiagnostics]
	...
	BEGIN
		...
		BEGIN
			...
			GRANT EXEC ON [DWDiagnostics].dbo.PublishHealthStatusData TO [NT AUTHORITY\NETWORK SERVICE]
			GRANT EXEC ON [DWDiagnostics].dbo.PublishHealthStatusData TO [HP\PdwComputeNodeAccess]

			GRANT EXEC ON TYPE::[dbo].[HealthStatusData] TO [NT AUTHORITY\NETWORK SERVICE]
			GRANT EXEC ON TYPE::[dbo].[HealthStatusData] TO [HP\PdwComputeNodeAccess]
		END
		...
		-- Re-create index on the different columns to avoid inefficiency in publishing health data on large appliance
		-- Modify PublishHealthStatusData stored procedure to acquire TablelockX lock before MERGE statement
		IF (@StoredVer < 104)
		BEGIN

			SET @Sql = 'ALTER TABLE [dbo].[pdw_component_health_data] DROP CONSTRAINT [PK_pdw_component_health_data]';
			EXECUTE(@Sql);

			SET @Sql = 'ALTER TABLE [dbo].[pdw_component_health_data] ADD  CONSTRAINT [PK_pdw_component_health_data] PRIMARY KEY CLUSTERED
				(
					   [Builtin_RowId] ASC
				)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF,ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = OFF)';
			EXECUTE(@Sql);

			SET @Sql = 'DROP INDEX IF EXISTS [IX_pdw_component_health_data_SourceNameNodeId] ON [dbo].[pdw_component_health_data]

			CREATE NONCLUSTERED INDEX [IX_pdw_component_health_data_SourceNameNodeId] ON [dbo].[pdw_component_health_data]
				(
					   [CustomContext.SourceName]  ASC,
					   [CustomContext.CurrentNode.Id] ASC
				)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF,DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = OFF) ON [PRIMARY]';
			...
			SET @Sql = 'ALTER PROCEDURE [dbo].[PublishHealthStatusData]
				@HealthStatusDataBatch AS HealthStatusData READONLY,
				@PdwNodeId AS INT,
				@SourceName AS nvarchar(255),
				@ClusterId AS nvarchar(255) = NULL -- Unique id of the cluster this particular monitoring source belongs to.
...
-- --------------------------------------------------
-- TABLE dbo.pdw_component_alerts_data
-- --------------------------------------------------
...
(
    ...
    [DateTimePublished] DATETIME2 NOT NULL,
    [Builtin_DateTimeEntryCreated] DATETIME2 NOT NULL,
    [Builtin_RowId] UNIQUEIDENTIFIER NOT NULL,
    [Builtin_HasData] BIT NOT NULL
);
...
-- --------------------------------------------------
-- TABLE dbo.pdw_component_health_data
-- --------------------------------------------------
CREATE TABLE [dbo].[pdw_component_health_data]
(
    [CustomContext.SourceName] NVARCHAR(128) NOT NULL,
...
-- --------------------------------------------------
-- TABLE dbo.pdw_component_health_data_lock
-- --------------------------------------------------
CREATE TABLE [dbo].[pdw_component_health_data_lock]
(
    [CustomContext.SourceName] NVARCHAR(255) NOT NULL,
    [CustomContext.ClusterId] NVARCHAR(255) NOT NULL
);
...
-- --------------------------------------------------
-- TABLE dbo.pdw_diagnostics_sessions
-- --------------------------------------------------
...
-- --------------------------------------------------
-- TABLE dbo.pdw_health_components_data
-- --------------------------------------------------
...
-- --------------------------------------------------
-- TABLE dbo.pdw_loader_backup_run_details_data
-- --------------------------------------------------
...
-- --------------------------------------------------
-- TABLE dbo.pdw_loader_backup_runs_data
-- --------------------------------------------------
CREATE TABLE [dbo].[pdw_loader_backup_runs_data]
(
    [CustomContext.Run_Id] INT NOT NULL,
...
-- --------------------------------------------------
-- TABLE dbo.pdw_loader_run_stages_data
-- --------------------------------------------------
...
(
    ...
    [CustomContext.TimeGeneated] DATETIME2 NOT NULL,
    [CustomContext.TimeWritten] DATETIME2 NOT NULL,
    [Message] NVARCHAR(MAX) NULL,
    [Builtin_DateTimeEntryCreated] DATETIME2 NOT NULL,
    [Builtin_RowId] UNIQUEIDENTIFIER NOT NULL,
    [Builtin_HasData] BIT NOT NULL
...
-- --------------------------------------------------
-- TABLE dbo.pdw_performance_data
-- --------------------------------------------------
CREATE TABLE [dbo].[pdw_performance_data]
(
    [MachineName] NVARCHAR(255) NOT NULL,
    [CustomContext.Node.Id] INT NOT NULL,
    [CustomContext.CounterValue] FLOAT NOT NULL,
...
-- --------------------------------------------------
-- TABLE dbo.pdw_population_template
-- --------------------------------------------------
...
-- --------------------------------------------------
-- VIEW dbo.dm_pdw_component_health_active_alerts
-- --------------------------------------------------
...
-- --------------------------------------------------
-- VIEW dbo.dm_pdw_component_health_alerts
-- --------------------------------------------------
...
-- --------------------------------------------------
-- VIEW dbo.dm_pdw_component_health_status
-- --------------------------------------------------
...
-- --------------------------------------------------
-- VIEW dbo.dm_pdw_os_performance_counters
-- --------------------------------------------------
...
-- --------------------------------------------------
-- VIEW dbo.pdw_health_component_groups
-- --------------------------------------------------
...
-- --------------------------------------------------
-- VIEW dbo.pdw_health_component_properties
-- --------------------------------------------------
...
-- --------------------------------------------------
-- VIEW dbo.pdw_health_component_status_mappings
-- --------------------------------------------------
...
-- --------------------------------------------------
-- VIEW dbo.pdw_health_components
-- --------------------------------------------------
