-- Object: PROCEDURE citrus_usr.pr_select_trxgen_cdsl_bak25042016
...
--rollback
create PROCEDURE [citrus_usr].[pr_select_trxgen_cdsl_bak25042016]  
(  
...
Print 'Y'
 ...
 SELECT CONVERT(VARCHAR(16),ISNULL(CLSR_BO_ID,''))AS CLSR_BO_ID ,
		...
		REPLACE(CONVERT(VARCHAR(10), CLSR_DATE, 103), '/', '')+LEFT(REPLACE(CONVERT(VARCHAR(12), CLSR_DATE, 114),':','') ,6) CLSR_DATE
