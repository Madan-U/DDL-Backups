-- Object: PROCEDURE citrus_usr.inward_list_slip
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------



--exec inward_list_slip @pa_po_no='100',@pa_excsm_id=4,@pa_trastm_id=639,@pa_book_no='3'
-- select * from order_slip where ors_po_no = '100'

CREATE procedure  [citrus_usr].[inward_list_slip](@pa_po_no varchar(25),@pa_excsm_id numeric,@pa_trastm_id numeric
,@pa_book_no varchar(25))
as  
begin  
...
where 
slibm_book_name between ors_from_no and ors_to_no 
...
,ors_to_no
,ors_from_slip
,case when @pa_trastm_id='10000' then 'B' else ors_book_type end
,ors_tratm_id 
