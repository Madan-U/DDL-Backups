-- Object: PROCEDURE citrus_usr.pr_fill_and_upd_properties_obj
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------


CREATE procedure [citrus_usr].[pr_fill_and_upd_properties_obj]
(
...
and dppd_gpabpa_flg = citrus_usr.fn_splitval(@pa_value,3)
...
--		+ISNULL(ltrim(rtrim(poam_name3)),'')+'|*~|'
        ...
        EXEC pr_ins_upd_dppd_mod '1',@pa_crnno,'EDT','MIG',@l_dppd_details,2,'*|~*','|*~|',''    
