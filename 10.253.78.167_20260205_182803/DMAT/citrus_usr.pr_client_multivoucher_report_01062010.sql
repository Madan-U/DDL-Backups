-- Object: PROCEDURE citrus_usr.pr_client_multivoucher_report_01062010
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--pr_client_multivoucher_report	0,'HO|*~|HO|*~|*|~*','1|*~|2|*~|3|*~|6|*~|7|*~|*|~*','1205990000001177|*~|1206350000000105|*~|0|*~|100|*~|25/09/2008|*~|25/09/2009|*~|ACTIVE|*~|1','1|*~|7|*~|6|*~|','','HO'
--pr_client_multireport	0,'HO|*~|HO|*~|*|~*','|*~||*~||*~||*~||*~||*~||*~|N|*~|25/09/2008|*~|25/09/2009|*~|ACTIVE|*~|1','1|*~|21|*~|','','HO'
CREATE proc [citrus_usr].[pr_client_multivoucher_report_01062010](@pa_id numeric  
  ...
  ,@l_filter_hiercy varchar(2000)  
   ...
   declare	@l_counter numeric  
    ...
    begin
							...
							select @l_sql1  = @l_sql1 + isnull(formula,'') + ','  from tbl_select_criteria_voucher where id in (select id from @l_select)  AND formula <> ''
	print @l_sql1				  
							...
							set @l_sql2 = ' from dp_acct_mstr dpam,ledger3 ldg --, fin_account_mstr fina
							...
							set @l_sql5 = @l_sql5 + ' order by ldg_voucher_no , ' + case when  @pa_grp_by ='BR'   then ' Groupby , ' else '' end + '[' + (select select_desc from tbl_select_criteria_voucher where id = citrus_usr.fn_splitval(@pa_main_filters_values ,8)) + '] '  
