...
select 'COD- FILE - CDSL-12033203 Auto Import From New DP',GETDATE(),'','RUNNING','AUTO',MAX(task_id)+1,'',null,null,null  
 from filetask 
 
 select top 1 @PA_TASK_ID = task_id from FileTask where task_name ='COD- FILE - CDSL-12033203 Auto Import From New DP'  and STATUS ='RUNNING' 
...
where task_name ='COD- FILE - CDSL-12033203 Auto Import From New DP'  and STATUS ='RUNNING' and task_id =@PA_TASK_ID  
