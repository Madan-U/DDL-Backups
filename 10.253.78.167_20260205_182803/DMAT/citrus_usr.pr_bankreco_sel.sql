-- Object: PROCEDURE citrus_usr.pr_bankreco_sel
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--pr_bankreco_sel '1','y',3,'feb 01 2010','feb 28 2010','1',''	
CREATE proc [citrus_usr].[pr_bankreco_sel](@pa_fin_id varchar(10), @pa_rec_flg char(1),@pa_dpm_id numeric,@pa_from_dt varchar(20),@pa_to_dt varchar(20),@pa_voucher_type varchar(10),@pa_acct_cd varchar(20),@pa_out varchar(20) out)  
as  
begin 
