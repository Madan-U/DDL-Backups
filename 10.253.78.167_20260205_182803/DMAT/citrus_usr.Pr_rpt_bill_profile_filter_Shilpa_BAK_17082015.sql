-- Object: PROCEDURE citrus_usr.Pr_rpt_bill_profile_filter_Shilpa_BAK_17082015
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--PR_RPT_BILL_PROFILE_FILTER 	'CDSL',3,'JAN 26 2009','JUN 26 2009','N','N','1234567890123456','','','N','Y','',1,'HO|*~|',''	

CREATE PROC [citrus_usr].[Pr_rpt_bill_profile_filter_Shilpa_BAK_17082015]              
@PA_DPTYPE VARCHAR(4),                      
@PA_EXCSMID INT,                      
...
PRINT 'SS'
 ...
 INSERT INTO #TEMPMAINCDSL(DPAM_ID,DPAM_SBA_NAME,DPAM_ACCTNO,TRANS_DESC,DPM_TRANS_NO,TRANS_DATE,ISIN_CD,OPENING_BAL,QTY,ORDER_BY,LINE_NO,CHARGE_VAL)           
  SELECT DPAM_ID,DPAM_SBA_NAME,DPAM_ACCTNO,'<b>NET AMOUNT</b>','5',@PA_TODATE,'E',NULL,NULL,2,0,SUM(CASE WHEN  TRANS_DESC = '<b>TOTAL CHARGES</b>' THEN CHARGE_VAL           
  ...
  FROM #TEMPMAINCDSL GROUP BY DPAM_ID,DPAM_SBA_NAME,DPAM_ACCTNO
	...
	,RATE = ISNULL(CLOPM_CDSL_RT,0) --INTO BILL_ANGEL_13082015 
