-- Object: PROCEDURE citrus_usr.pr_ins_upd_dps8_pc2
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------


CREATE proc [citrus_usr].[pr_ins_upd_dps8_pc2]
as
begin 
update s8 set 
s8.PurposeCode2=b9.PurposeCode2
...
from dps8_pc2 s8 , dpb9_pc2 b9
where s8.boid = b9.boid 


insert into dps8_pc2 (	PurposeCode2
,	TypeOfTrans
,	Title
,	Name
,	MiddleName
...
from dpb9_pc2 b9 where 	 not exists(SELECT BOID FROM DPS8_PC2 s8 WHERE s8.BOID = b9.boid)   
