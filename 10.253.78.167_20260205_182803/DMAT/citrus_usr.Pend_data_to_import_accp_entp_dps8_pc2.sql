-- Object: TABLE citrus_usr.Pend_data_to_import_accp_entp_dps8_pc2
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[Pend_data_to_import_accp_entp_dps8_pc2]
(
    [PurposeCode2] VARCHAR(100) NULL,
