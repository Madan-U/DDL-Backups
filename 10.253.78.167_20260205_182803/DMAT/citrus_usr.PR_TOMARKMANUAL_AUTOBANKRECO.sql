-- Object: PROCEDURE citrus_usr.PR_TOMARKMANUAL_AUTOBANKRECO
...
CREATE PROCEDURE [citrus_usr].[PR_TOMARKMANUAL_AUTOBANKRECO]
(
 @PA_FIN_ID NUMERIC, 
 @PA_ACTION CHAR(10),
 @PA_DPM_ID NUMERIC,
...
PRINT '133'
  SET @P_SQL1 = 'SELECT DISTINCT CASE WHEN A.LDG_VOUCHER_TYPE = 1 THEN ''PAYMENT'' WHEN A.LDG_VOUCHER_TYPE = 2 THEN ''RECIEPT'' WHEN A.LDG_VOUCHER_TYPE = 4 THEN ''CONTRA'' END LDG_VOUCHER_TYPE
					...
					,A.LDG_AMOUNT
					,A.ACCTNO
					,A.ORD,ISNULL(B.LDG_BANK_CL_DATE,''1900-01-01 00:00:00.000'') LDG_BANK_CL_DATE
				FROM (SELECT ISNULL(LDG_BANK_CL_DATE,''1900-01-01 00:00:00.000'') LDG_BANK_CL_DATE,LDG_VOUCHER_TYPE , CONVERT(VARCHAR(11),LDG_VOUCHER_DT,103) LDG_VOUCHER_DT,LDG_VOUCHER_NO 
                      ...
                      WHERE  LDG_VOUCHER_TYPE ' 	+ CASE WHEN @PA_CREDIT<>'0.00' then '   IN  (''1'',''4'') ' ELSE '  IN  (''2'',''4'')' END + ' AND '  
                        + case when @PA_ACTION = 'USD' then  ' ISNULL(LDG_BANK_CL_DATE,''1900-01-01 00:00:00.000'') <> ''1900-01-01 00:00:00.000'' '  else  ' ISNULL(LDG_BANK_CL_DATE,''1900-01-01 00:00:00.000'') = ''1900-01-01 00:00:00.000'' ' end 					                        
				...
				AND   B.LDG_VOUCHER_TYPE '  + CASE WHEN @PA_CREDIT<>'0.00' then ' IN  (''1'',''4'') ' ELSE '  IN  (''2'',''4'')' END  
