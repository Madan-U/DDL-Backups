-- Object: PROCEDURE citrus_usr.pr_inv_allocation_Bak_02042018
...
create   proc [citrus_usr].[pr_inv_allocation_Bak_02042018](@pa_action varchar(100),@pa_dpm_id numeric,@pa_from_dt datetime,@pa_to_dt datetime
