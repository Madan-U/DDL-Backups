-- Object: TABLE citrus_usr.Pend_data_to_import_accp_entp_dps8_pc12
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[Pend_data_to_import_accp_entp_dps8_pc12]
(
    [PurposeCode12] VARCHAR(100) NULL,
