-- Object: PROCEDURE citrus_usr.pr_ins_upd_entro_bak_oldrole28022012
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

create PROCEDURE [citrus_usr].[pr_ins_upd_entro_bak_oldrole28022012]( @pa_id         varchar(8000)
          ...
          --
            ...
            --
              ...
              --
                ...
                BEGIN
                -- 
                  SET @@l_ent_rol_id  = citrus_usr.fn_splitval(@@currstring_value,@@temp) 
                  --
                  IF @pa_chk_yn = 0
                  BEGIN --chk_yn
                  --        
