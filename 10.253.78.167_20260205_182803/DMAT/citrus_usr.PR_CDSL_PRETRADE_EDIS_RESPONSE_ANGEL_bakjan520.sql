-- Object: PROCEDURE citrus_usr.PR_CDSL_PRETRADE_EDIS_RESPONSE_ANGEL_bakjan520
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--BEGIN TRAN
--EXEC PR_CDSL_PRETRADE_EDIS_RESPONSE_ANGEL '',''
--select * from dptdc_mak where dptdc_slip_no like '14122020%' order by 1 desc
--SELECT * FROM EDIS_PRE_DPTDC_MAK
--select * from dptdc_mak with(nolock) where DPTDC_SLIP_NO='2705202051271038'
--commit
create PROCEDURE [citrus_usr].[PR_CDSL_PRETRADE_EDIS_RESPONSE_ANGEL_bakjan520]
(
...
,DPTDC_DOI
,DPTDC_CHQ_REFNO
FROM EDIS_PRE_DPTDC_MAK (Nolock) O,E_DIS_PROCESS_DATA,DP_ACCT_MSTR (Nolock) WHERE 
...
AND NOT EXISTS (
SELECT 1 FROM DPTDC_MAK (Nolock) I WHERE  I.DPTDC_ID=O.DPTDC_ID AND I.DPTDC_REQUEST_DT=O.DPTDC_REQUEST_DT 
