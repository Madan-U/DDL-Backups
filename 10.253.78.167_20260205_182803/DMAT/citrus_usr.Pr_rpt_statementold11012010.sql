-- Object: PROCEDURE citrus_usr.Pr_rpt_statementold11012010
...
create Proc [citrus_usr].[Pr_rpt_statementold11012010]                            
@pa_dptype varchar(4),                                    
@pa_excsmid int,                                    
...
set @PA_SETTM_NO_TO   = @PA_SETTM_NO_FR   
 ...
 BEGIN                              
  ...
  if @pa_group_cd <> ''              
  begin              
      insert into #tempmaincdsl(dpam_id,dpam_sba_name,dpam_acctno,trans_desc,dpm_trans_no,trans_date,isin_cd,opening_bal,qty,order_by,line_no,cdshm_trg_settm_no,tratm_cd)                         
