-- Object: PROCEDURE citrus_usr.pr_import_dp_Harmonization_V2
...
CREATE PROCeDURE [citrus_usr].[pr_import_dp_Harmonization_V2]( @pa_crn_no      VARCHAR(8000)                  
                            , @pa_exch        VARCHAR(10)                  
...
select * , acct_no boidorder,'2' id   into #tmp_line7_PADr from @line7 where Purpose_code ='212'
select * ,  acct_no boidorder,'3' id  into #tmp_line3 from @line3
select * ,  acct_no boidorder,'4' id  into #tmp_line4 from @line4

select * , acct_no boidorder ,'5' id  into #tmp_line7_NOM from @line7 where Purpose_code ='206'
select * ,  acct_no  boidorder ,'6' id  into #tmp_line5 from @line5
select pc6.* ,  acct_no  boidorder, mSTRPOAFLG  ,'7' id   into #tmp_line6 from @line6 pc6 , dps8_pc1   a  where boid = bo3_usr_txt1
select * ,  acct_no boidorder,'8' id  into #tmp_line8 from @line8
