-- Object: PROCEDURE citrus_usr.pr_breakup_bak_01082017
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

create  procedure [citrus_usr].[pr_breakup_bak_01082017](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
