-- Object: FUNCTION citrus_usr.fn_cdsl_export_line_7_extract_newversion_mod_BAK_13102016
...
CREATE  function [citrus_usr].[fn_cdsl_export_line_7_extract_newversion_mod_BAK_13102016](@pa_crn_no      VARCHAR(8000)    
...
--          ,0000--''--usr_fld4   
 ...
 AND   climmod.clic_mod_lst_upd_dt              BETWEEN CONVERT(VARCHAR,CONVERT(DATETIME, @pa_from_dt,103),106)+' 00:00:00' AND CONVERT(VARCHAR,CONVERT(DATETIME,@pa_to_dt,103),106)+' 23:59:59'     
    ...
    and isnull(climmod.clic_mod_batch_no,0) = 0  
 AND   climmod.clic_mod_action in ('N ADDRESS','NOMINEE DEL','N NAMENDTLS','N CONTACTS','N NAMECHANGE')    
...
--          ,0000--''--usr_fld4     
 ...
 AND   climmod.clic_mod_lst_upd_dt              BETWEEN CONVERT(VARCHAR,CONVERT(DATETIME, @pa_from_dt,103),106)+' 00:00:00' AND CONVERT(VARCHAR,CONVERT(DATETIME,@pa_to_dt,103),106)+' 23:59:59'     
    ...
    and isnull(climmod.clic_mod_batch_no,0) = 0  
 AND   climmod.clic_mod_action in ('G Address','G NameNDtls','G Contacts','G NAMECHANGE')    
