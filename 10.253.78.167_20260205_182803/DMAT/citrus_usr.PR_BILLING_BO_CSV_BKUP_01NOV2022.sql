-- Object: PROCEDURE citrus_usr.PR_BILLING_BO_CSV_BKUP_01NOV2022
...
CREATE  PROCEDURE [citrus_usr].[PR_BILLING_BO_CSV_BKUP_01NOV2022]  
...
SETM_START_DT=CONVERT(VARCHAR(11),GETDATE(),109) AND SETM_SETTM_ID=11
--PRINT @L_PAYINDATE
