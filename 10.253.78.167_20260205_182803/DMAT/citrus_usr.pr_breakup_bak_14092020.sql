-- Object: PROCEDURE citrus_usr.pr_breakup_bak_14092020
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

create  procedure [citrus_usr].[pr_breakup_bak_14092020](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
