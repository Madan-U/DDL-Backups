-- Object: FUNCTION citrus_usr.fn_acct_list_disp_drf_bak_05072017
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE   Function [citrus_usr].[fn_acct_list_disp_drf_bak_05072017](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int,@PA_FROMACCID varchar(16),@PA_TOACCID varchar(16))     
