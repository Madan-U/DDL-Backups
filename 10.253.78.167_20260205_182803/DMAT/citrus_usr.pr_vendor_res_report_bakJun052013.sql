-- Object: PROCEDURE citrus_usr.pr_vendor_res_report_bakJun052013
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

create procedure [citrus_usr].[pr_vendor_res_report_bakJun052013]  (@pa_from_no varchar(50)
,@pa_to_no  varchar(50)
,@pa_from_dt datetime
,@pa_to_dt datetime
...
,		case when convert(varchar(11),isnull(d.reco_datetime,''),103) = '01/01/1900' then '' else convert(varchar(19),d.reco_datetime,120) end AS "RECO DTTIME"
		...
		and d.boid = d1.boid
		where d1.boid = ACCOUNT.DPAM_SBA_NO  
--        and d.req_slip_no = d1.req_slip_no
--		and d.boid = d1.boid
        and dpam_sba_no between  @pa_from_no and  @pa_to_no
		and d1.created_dt between @pa_from_dt AND @pa_to_dt + ' 23:59:59'
