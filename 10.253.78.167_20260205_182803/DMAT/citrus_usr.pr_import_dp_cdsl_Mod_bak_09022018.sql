-- Object: PROCEDURE citrus_usr.pr_import_dp_cdsl_Mod_bak_09022018
...
CREATE  PROCeDURE [citrus_usr].[pr_import_dp_cdsl_Mod_bak_09022018]( @pa_crn_no      varchar(8000)                 
                            , @pa_exch        VARCHAR(10)                  
...
--update bitmap_ref_mstr set bitrm_values=bitrm_values + convert(varchar,@l_06cnt ) where BITRM_PARENT_CD = 'POAID_AUTO'  
                                 ...
                                 insert into  @line7(ln_no                                    
									...
									,res_sec_flag        
                                            ...
                                            --and    climmod.clic_mod_action = @pa_mod_typ
                                            and    climmod.clic_mod_action like case when upper(@pa_mod_typ) = 'ALL' then '%%' else @pa_mod_typ end
                                            AND   climmod.clic_mod_action in ('G Address','G NameNDtls','G Contacts','Guardian Suffix', 'G NameChange','G FatherNameChange' ,'G MobChange', 'G ResPhChange', 'G OffPhChange', 'G DOBChange', 'G PANChange','GUARDIAN TITLE','NG Address','NG NameNDtls','NG Contacts') 
                                            ORDER BY Purpose_code  DESC
