-- Object: PROCEDURE citrus_usr.PR_RPT_BSDA_STEP1_bak_01022024
...
CREATE   procedure [citrus_usr].[PR_RPT_BSDA_STEP1_bak_01022024]
(
--@PA_DPM_ID INT
...
begin 
   IF EXISTS (SELECT  1 FROM SYS.OBJECTS WHERE NAME ='holdingallforview')
	...
	and  isnull(smart_flag ,'N') = 'Y'  
	group by BOID,dpam_sba_name,dpam_bbo_code,brom_desc,BROM_ID,DPAM_CRN_NO,PANGIR
	having convert(numeric(18,2),sum((isnull(RATE,0)*isnull(DPHMCD_CURR_QTY-DPHMCD_DEMAT_PND_VER_QTY-DPHMCD_LOCKIN_QTY,0)))) < 200001
