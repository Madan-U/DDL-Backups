-- Object: FUNCTION citrus_usr.fn_get_high_val_bakjun22020
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

create function [citrus_usr].[fn_get_high_val_bakjun22020](@l_isin varchar(16),@l_qty numeric(18,3),@pa_validation varchar(50),@pa_acct_no varchar(16),@pa_request_date datetime)      
returns char(1)      
as      
begin      
--      
...
--    end    
  ...
  and CDSHM_TRATM_CD in ('2277')   and cdshm_tras_dt>='Apr  1 2017'    
