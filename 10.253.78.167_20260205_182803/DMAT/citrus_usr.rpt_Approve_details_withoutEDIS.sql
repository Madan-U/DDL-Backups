-- Object: PROCEDURE citrus_usr.rpt_Approve_details_withoutEDIS
...
CREATE    procedure [citrus_usr].[rpt_Approve_details_withoutEDIS]
(@pa_id  varchar(10),
 @pa_type varchar(4),
 @pa_tab varchar(20),
 @pa_from_dt datetime,
...
when dptd.dptdC_trastm_cd = 'TNT' and  dptd.dptdc_reason_cd= '7' then 'Shifting of Account within DP'
					...
					and dptd.dptdc_created_by not like '120%'
                    --AND dptd1.DPTDC_SLIP_NO like case when @pa_slip_no = '' then '%' else @pa_slip_no end
