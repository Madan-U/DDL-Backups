-- Object: PROCEDURE citrus_usr.pr_ucc_parameter_bak_18092024
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------


CREATE  PROCEDURE [citrus_usr].[pr_ucc_parameter_bak_18092024](@pa_from_dt       varchar(100)      
    ...
    --      
      ...
      FROM      
          (SELECT dpam.dpam_crn_no            dpam_crn_no      
           ...
           AND    dpam.dpam_excsm_id        = excsm.excsm_id  
           AND    dpam.dpam_deleted_ind     = 1    
           and    dpam.dpam_acct_no not like 'W%'
           and ISNULL(citrus_usr.fn_ucc_accp(dpam_id,'INSTABOID','CDSL'),'')=''
           ) x      
          , client_mstr                       clim      WITH (NOLOCK)    
          , client_ctgry_mstr                 clicm     WITH (NOLOCK)    
