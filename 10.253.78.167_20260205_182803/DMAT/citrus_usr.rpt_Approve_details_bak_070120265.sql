-- Object: PROCEDURE citrus_usr.rpt_Approve_details_bak_070120265
...
CREATE  procedure [citrus_usr].[rpt_Approve_details_bak_070120265]
(@pa_id  varchar(10),
 @pa_type varchar(4),
 @pa_tab varchar(20),
 @pa_from_dt datetime,
...
when dptd.dptdc_reason_cd= '35' then 'Transfer from Nominee/Surviving holder to the beneficiary' 
