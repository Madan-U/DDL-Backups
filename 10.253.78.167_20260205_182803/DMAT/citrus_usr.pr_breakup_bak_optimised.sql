-- Object: PROCEDURE citrus_usr.pr_breakup_bak_optimised
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

create  procedure [citrus_usr].[pr_breakup_bak_optimised](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
...
from cdsl_holding_dtls_bak_forreve  with(nolock) ,dp_acct_mstr  with(nolock) ,client_dp_brkg  with(nolock) ,BROKERAGE_MSTR   with(nolock) 
