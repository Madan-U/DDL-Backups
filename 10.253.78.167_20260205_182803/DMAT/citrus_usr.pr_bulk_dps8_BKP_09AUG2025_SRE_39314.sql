-- Object: PROCEDURE citrus_usr.pr_bulk_dps8_BKP_09AUG2025_SRE_39314
...
CREATE  proc [citrus_usr].[pr_bulk_dps8_BKP_09AUG2025_SRE_39314](@pa_dbpath varchar(8000))  
as  
begin   
...
NOMINATION_OPT_OUT	=citrus_usr.fn_splitval_by(value,	103	,'~'),
NOMINATION_opt_dt	=citrus_usr.fn_splitval_by(value,	104	,'~'),
COMM_PREFER	=citrus_usr.fn_splitval_by(value,	105	,'~'),


BOId	=citrus_usr.fn_splitval_by(value,	106	,'~'),
TransSystemDate	=citrus_usr.fn_splitval_by(value,	107	,'~')
...
BOId	= main.boid ,--citrus_usr.fn_splitval_by(value,	53	,'~'),
TransSystemDate	=main.lastmoddate --citrus_usr.fn_splitval_by(value,	54	,'~')
from dps8_source111 main,DPS8_PC6 a  , #tmp_pc6_last b where left(main.value ,2) = '06'   
and a.boid = main.BOID 
and a.NOM_Sr_No=citrus_usr.fn_splitval_by(value,	45	,'~')
and main.boid = b.boid 
and b.nomsr =citrus_usr.fn_splitval_by(value,	45	,'~')
and main.lastmoddate = b.lastmod



--select * from dps8_pc6  where boid in ('1203320198823934','1203320149918952')
