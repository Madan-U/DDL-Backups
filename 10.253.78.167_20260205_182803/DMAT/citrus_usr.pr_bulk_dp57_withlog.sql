-- Object: PROCEDURE citrus_usr.pr_bulk_dp57_withlog
...
CREATE   proc [citrus_usr].[pr_bulk_dp57_withlog]
(  
...
select * into #tempdata_demat_dtls from   #tmp_dp57_o where citrus_usr.fn_splitval_by(value,2,'~') in ('6','32')
...
WHERE  task_id = @pa_task_id
 ...
 insert into Dp57log
select GETDATE(),'into filetask','end'
