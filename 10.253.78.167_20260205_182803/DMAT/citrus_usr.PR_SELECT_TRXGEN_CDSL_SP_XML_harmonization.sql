...
+ ','+','+','+','+  + ','+ case when @PA_TRX_TAB='DESTAT*|~*' then '' else  SUBSTRING(isnull(convert(varchar,xmlField.value('(Dspchdt)[1]', 'nvarchar(max)')),''), 5, 4) + '-' + SUBSTRING(isnull(convert(varchar,xmlField.value('(Dspchdt)[1]', 'nvarchar(max)')),''), 3, 2) + '-' + SUBSTRING(isnull(convert(varchar,xmlField.value('(Dspchdt)[1]', 'nvarchar(max)')),''), 1, 2) end + ','+',' +','+  ','+case when  @PA_TRX_TAB='DESTAT*|~*' then '' else 'AC' end +','+ +','+ ','+','+isnull((SELECT top 1 ltrim(rtrim(Standard_Value)) FROM standard_value_list WHERE iso_tags ='LckInRsnCd' AND ISNULL(CDSL_Old_Values,'')<>'' and CDSL_Old_Values=isnull(convert(varchar,xmlField.value('(Lckcd)[1]', 'nvarchar(max)')),'')),'')	+',' + ',' + case when isnull(convert(varchar,xmlField.value('(Lckexpdt)[1]', 'nvarchar(max)')),'') <> '' then SUBSTRING(isnull(convert(varchar,xmlField.value('(Lckexpdt)[1]', 'nvarchar(max)')),''), 5, 4)  + '-' + SUBSTRING(isnull(convert(varchar,xmlField.value('(Lckexpdt)[1]', 'nvarchar(max)')),''), 3, 2) + '-' + SUBSTRING(isnull(convert(varchar,xmlField.value('(Lckexpdt)[1]', 'nvarchar(max)')),''), 1, 2) else '' end  + ','+convert(varchar(100),demrm_id)+','+ ','+ ','+ case when  isnull(ltrim(rtrim(convert(varchar,xmlField.value('(Lcksts)[1]', 'nvarchar(max)')))),'') = 'L' then 'LCK' else 'FRE' end  +','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+','+ ',' +','+','+','++','+','+ ',' +'' + ','+','+','+','++','+','+','+','+','+ ','+','+','+','+','+','+','+','+','+','+','+',' +',' 
