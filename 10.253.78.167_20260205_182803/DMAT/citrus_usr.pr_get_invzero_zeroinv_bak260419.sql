-- Object: PROCEDURE citrus_usr.pr_get_invzero_zeroinv_bak260419
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--exec pr_get_invzero_zeroinv 'INVTOZERO'
--exec pr_get_invzero_zeroinv 'ZEROTOINV'
create proc [citrus_usr].[pr_get_invzero_zeroinv_bak260419](@pa_tab varchar(100),@pa_dt varchar(100))
as
begin 
