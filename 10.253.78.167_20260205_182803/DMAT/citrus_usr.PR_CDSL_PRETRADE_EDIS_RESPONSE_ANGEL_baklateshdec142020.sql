-- Object: PROCEDURE citrus_usr.PR_CDSL_PRETRADE_EDIS_RESPONSE_ANGEL_baklateshdec142020
...
--ROLLBACK
create PROCEDURE [citrus_usr].[PR_CDSL_PRETRADE_EDIS_RESPONSE_ANGEL_baklateshdec142020]
(
...
AND NOT EXISTS (
SELECT 1 FROM DP_TRX_DTLS_CDSL I WHERE  I.DPTDC_ID=O.DPTDC_ID AND I.DPTDC_REQUEST_DT=O.DPTDC_REQUEST_DT 
