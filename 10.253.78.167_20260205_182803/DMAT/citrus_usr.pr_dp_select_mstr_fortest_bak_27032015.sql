-- Object: PROCEDURE citrus_usr.pr_dp_select_mstr_fortest_bak_27032015
...
create PROCEDURE  [citrus_usr].[pr_dp_select_mstr_fortest_bak_27032015]( @pa_id  VARCHAR(800)                          
...
select @l_entm_id = logn_ent_id from login_names where logn_name = @pa_login_name and logn_deleted_ind =  1                           
 ...
 BEGIN                        
  ...
  create table #tmpval(dptdc_slip_no varchar(20),Val numeric,isin varchar(15),qty numeric)
