-- Object: PROCEDURE citrus_usr.Pr_Rpt_InwardReco_16062010
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--[Pr_Rpt_InwardReco] 'CDSL',3,'FEB 19 2009','FEB 19 2009','E','N',''
create PROC [citrus_usr].[Pr_Rpt_InwardReco_16062010]                
@pa_dptype varchar(4),                
@pa_excsmid int,                
...
(                
 ...
 begin          
  select DPAM_SBA_NO,dpam_sba_name,convert(varchar(11),recd_dt,109) recddt,convert(varchar(11),exec_dt,109) execdt,slip_no,tdesc=ISNULL(t.descp,'') + ' - ' + ISNULL(ttype_cd,''),recd_mode,in_rmks,in_trans_cnt,reco_trans_cnt,trans_type                
 ...
 begin          
  ...
  insert into #inwardreco(dpam_id,recd_dt,exec_dt,slip_no,recd_mode,in_rmks,in_trans_cnt,reco_trans_cnt,trans_type)                
   ...
   if @pa_withexception = 'N'           
begin              
 select DPAM_SBA_NO,dpam_sba_name,convert(varchar(11),recd_dt,109) recddt,convert(varchar(11),exec_dt,109) execdt,slip_no,                
...
begin          
 ...
 begin                
  ...
  if @pa_withexception = 'N'          
begin          
 select DPAM_SBA_NO,dpam_sba_name,i.dpam_id,convert(varchar(11),recd_dt,109) recddt,convert(varchar(11),exec_dt,109) execdt,slip_no,tdesc=ISNULL(t.descp,'') + ' - ' + ISNULL(ttype_cd,''),recd_mode,in_rmks,in_trans_cnt,reco_trans_cnt,trans_type                
 from #inwardreco i left outer join citrus_usr.fn_getsubtransdtls('TRANS_TYPE_NSDL') t                
 on i.ttype_cd = t.cd                
 ,dp_acct_mstr d                
 where i.dpam_id = d.dpam_id                
