-- Object: PROCEDURE citrus_usr.pr_insert_dps8_bak_22092018
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------



create proc [citrus_usr].[pr_insert_dps8_bak_22092018](@pa_level numeric)
as
begin
...
,TransSystemDate
		...
		and not exists(SELECT BOID FROM DPS8_PC6 b WHERE b.BOID = a.boid and citrus_usr.fn_splitval_by(a.value,	43	,'~')=b.nom_sr_no)  -- 44 change to 43 on tp request.. 
