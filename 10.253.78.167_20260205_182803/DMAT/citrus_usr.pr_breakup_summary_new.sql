-- Object: PROCEDURE citrus_usr.pr_breakup_summary_new
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------


CREATE procedure [citrus_usr].[pr_breakup_summary_new](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
