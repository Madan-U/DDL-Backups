-- Object: PROCEDURE citrus_usr.ImportJVVouchers_bak_09102012
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--[ImportJVVouchers] 557,	4,	1,	'may 31 2008',	'may 31 2008',	'VISHAL'
create Proc [citrus_usr].[ImportJVVouchers_bak_09102012]
@pa_task_id bigint,
@pa_dpmid int,
@pa_finid int,
...
set @@ssql = 'delete from client_charges_cdsl where  CLIC_FLG = ''B'' and CLIC_TRANS_DT   = ''' + convert(varchar(11),@pa_billing_to_dt,109) + '''  and clic_dpm_id = ' + convert(varchar,@pa_dpmid)   
print @@ssql
exec(@@ssql)
...
CLIC_DELETED_IND,
CLIC_POST_TOACCT)
select null ,TMPBILL_TODATE,LDG_DPM_ID=' + convert(varchar,@pa_dpmid) + ',TMPBILL_DPAM_ID,''Recovered from trading A/C towards Curr O/S on ' + @@voucher_dt + '''
