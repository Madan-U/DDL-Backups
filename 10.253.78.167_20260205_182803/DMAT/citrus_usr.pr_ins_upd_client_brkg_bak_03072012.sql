-- Object: PROCEDURE citrus_usr.pr_ins_upd_client_brkg_bak_03072012
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--begin tran
--[pr_ins_upd_client_brkg] 359497,'','HO',359497,'1|*~|4|*~|IN300175|*~|IND047|*~|10/11/2009|*~|6|*~|A*|~*',2,'*|~*','|*~|',''
--select * from DP_aCCT_MSTR  order by 1 desc
--rollback
create PROCEDURE [citrus_usr].[pr_ins_upd_client_brkg_bak_03072012]
(			  @pa_id             varchar(8000)  
...
PRINT @l_excsm_id
       ...
       END  
        ...
        ,1  
                ...
                --  
                  print @l_dpam_id
                  print CONVERT(varchar,@l_from_dt,103)
...
if not exists(select clidb_brom_id , clidb_dpam_id from clib_mak where CONVERT(varchar,clidb_eff_from_dt,103) = CONVERT(varchar,@l_from_dt,103) AND clidb_dpam_id = @l_dpam_id  and clidb_deleted_ind in (0,4,8) )
begin 
select @l_action_type = 'A'
end 
