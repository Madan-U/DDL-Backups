-- Object: FUNCTION citrus_usr.fn_cdsl_export_line_7_extract_newversion_mod_17072015_bak
...
create  function [citrus_usr].[fn_cdsl_export_line_7_extract_newversion_mod_17072015_bak](@pa_crn_no      VARCHAR(8000)    
...
--          ,0000--''--usr_fld4   
 ...
 AND   climmod.clic_mod_lst_upd_dt              BETWEEN CONVERT(VARCHAR,CONVERT(DATETIME, @pa_from_dt,103),106)+' 00:00:00' AND CONVERT(VARCHAR,CONVERT(DATETIME,@pa_to_dt,103),106)+' 23:59:59'     
    ...
    and isnull(climmod.clic_mod_batch_no,0) = 0  
 AND   climmod.clic_mod_action in ('N ADDRESS','NOMINEE DEL')    
