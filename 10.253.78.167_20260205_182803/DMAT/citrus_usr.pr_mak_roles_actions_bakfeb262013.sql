-- Object: PROCEDURE citrus_usr.pr_mak_roles_actions_bakfeb262013
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

create PROCEDURE [citrus_usr].[pr_mak_roles_actions_bakfeb262013](@pa_id           VARCHAR(8000)  
 ...
 *********************************************************************************    
 ...
 --    
  ...
  print @@currstring_val
   ...
   if exists(select entro_rol_id from entity_roles , roles where  entro_rol_id = rol_id and rol_cd like @pa_rol_cd + '_%' and entro_deleted_ind = 1 and rol_deleted_ind = 1 )
