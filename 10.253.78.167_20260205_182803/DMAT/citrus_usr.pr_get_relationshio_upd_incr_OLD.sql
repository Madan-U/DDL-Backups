-- Object: PROCEDURE citrus_usr.pr_get_relationshio_upd_incr_OLD
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE proc [citrus_usr].[pr_get_relationshio_upd_incr_OLD]    
as    
begin     
    
update entr set entr_re = entm_id      
from entity_relationship entr , dbo.VW_CLIENT_DETAILS_OLD ,entity_mstr    
where CLTDPNO = ENTR_SBA     
