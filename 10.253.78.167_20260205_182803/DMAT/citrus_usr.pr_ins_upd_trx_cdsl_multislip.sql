-- Object: PROCEDURE citrus_usr.pr_ins_upd_trx_cdsl_multislip
...
CREATE  PROCEDURE [citrus_usr].[pr_ins_upd_trx_cdsl_multislip](@pa_id              VARCHAR(8000)    
								 ,@pa_tab             VARCHAR(20)  
