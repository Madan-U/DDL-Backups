-- Object: PROCEDURE citrus_usr.PR_ONLINE_DPTRX_BEN_bak_23052017
...
CREATE PROCEDURE [citrus_usr].[PR_ONLINE_DPTRX_BEN_bak_23052017]
(
...
BEGIN
print 'inser'
IF NOT EXISTS(SELECT 1 FROM ONLINE_DPTRX_BEN_MSTR WHERE 
(ONL_TRXFEREE_DPID=@PA_ONL_TRXFEREE_DPID OR ONL_CMBPID =@PA_ONL_CMBPID)
 AND ONL_TRXFEREE_BONAME= @PA_ONL_TRXFEREE_BONAME 
 AND ONL_TRXFEREE_BOID=@PA_ONL_TRXFEREE_BOID and onl_trx_boid = @PA_ONL_TRX_BOID
  AND ONL_DELETED_IND=1)
BEGIN
print 'yogesh'
...
--BEGIN
UPDATE ONLINE_DPTRX_BEN_MSTR SET ONL_DELETED_IND=9,ONL_LST_UPD_BY=@PA_ONL_LOGIN_NAMES,ONL_LST_UPD_DT=GETDATE() WHERE (ONL_TRXFEREE_DPID=@PA_ONL_TRXFEREE_DPID OR ONL_CMBPID =@PA_ONL_CMBPID) AND ONL_TRX_BOID =@PA_ONL_TRX_BOID AND ONL_TRXFEREE_BOID=@PA_ONL_TRXFEREE_BOID AND ONL_DELETED_IND=1
