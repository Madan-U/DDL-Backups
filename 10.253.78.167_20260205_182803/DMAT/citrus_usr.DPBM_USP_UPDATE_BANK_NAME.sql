-- Object: PROCEDURE citrus_usr.DPBM_USP_UPDATE_BANK_NAME
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE proc [citrus_usr].[DPBM_USP_UPDATE_BANK_NAME]              
...
--BEGIN TRAN            
 ...
 --where CONVERT(DATETIME,CONVERT(VARCHAR,UPLOADED_DATE,106)) = CONVERT(DATETIME,CONVERT(VARCHAR,getdate(),106))          
  ...
  where Row_Id in (Select min(Row_Id) as Row_Id from DPBM_BANK_MASTER_UPLOAD    
