-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_foralldp_arch
...
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_foralldp_arch](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                          
...
update a set DPHMCD_LOCKIN_QTY = qty from #locindata_cr , #tmp_vw_holding_base_all  a  
...
- isnull(DPHMCD_LOCKIN_QTY ,0) - ISNULL(DPHMCD_PLEDGE_QTY,'0') - ISNULL(DPHMCD_avail_lend_qty,'0') -ISNULL(DPHMCD_SAFE_KEEPING_QTY,'0') -ISNULL(DPHMCD_LEND_QTY,'0') -   
