-- Object: TABLE citrus_usr.Pend_data_to_import_accp_entp_dps8_pc3
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[Pend_data_to_import_accp_entp_dps8_pc3]
(
    [PurposeCode3] VARCHAR(100) NULL,
    ...
    [pri_isd] VARCHAR(6) NULL,
    [pri_ph_no] VARCHAR(17) NULL,
