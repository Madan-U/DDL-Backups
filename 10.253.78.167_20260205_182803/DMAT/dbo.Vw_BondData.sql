...
--select * from [172.31.16.94].DMAT.citurs_usr.holding



create view Vw_BondData
As
...
--,citrus_usr.[fn_find_relations_nm_forview](dpam_sba_no,'BR') BR   
 ...
 from citrus_usr.holdingallforview       

left outer join citrus_usr.isin_mstr on isin_cd = dphmcd_isin       
...
,citrus_usr.dp_acct_mstr--, client_ctgry_mstr , entity_type_mstr    

left outer join citrus_usr.entity_relationship   on entr_sba = dpam_sba_no  and ENTR_ACCT_NO <> '' 

  

left outer join citrus_usr.entity_mstr on (entm_id = entr_sb or entm_id = entr_br)  
