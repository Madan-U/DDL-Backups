-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_fortest
...
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_fortest](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
...
and   CDSHM_TRAS_DT  >='aug 01 2011'      
and   CDSHM_TRAS_DT   <= @pa_to_dt 
and cdshm_dpm_id = @pa_dpm_id and cdshm_isin ='INE636A01039'
group by         cdshm_dpam_id  ,cdshm_isin  ,cdshm_dpm_id  , cdshm_trans_no 

    
   select * from #finalholding where dphmcd_dpam_id = 581212 and dphmcd_isin in ('INE636A01039')
