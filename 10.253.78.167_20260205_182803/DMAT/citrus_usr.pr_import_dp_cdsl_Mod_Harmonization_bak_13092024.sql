-- Object: PROCEDURE citrus_usr.pr_import_dp_cdsl_Mod_Harmonization_bak_13092024
...
CREATE PROCeDURE [citrus_usr].[pr_import_dp_cdsl_Mod_Harmonization_bak_13092024]( @pa_crn_no      varchar(8000)                 
                            , @pa_exch        VARCHAR(10)                  
...
select * ,  acct_no boidorder into #tmp_line2 from @line2
select * , acct_no boidorder into #tmp_line7_PADr from @line7 where Purpose_code ='212'
select * , acct_no boidorder into #tmp_line7_NOM from @line7 where Purpose_code ='206'
select * ,  acct_no  boidorder into #tmp_line5 from @line5

--select * from #tmp_line5
--select * from #tmp_line7
--select * from @line7
...
and a.boidorder = ord.boidorder ) main 
order by boidorder, boidorderid 
