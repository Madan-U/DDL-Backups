-- Object: PROCEDURE citrus_usr.Pr_rpt_bill_profile_filter_CLOSEACCOUNT
...
Pr_rpt_bill_profile_filter 	'CDSL',3,'Jan 26 2009','Jun 26 2009','N','N','','','','N','Y','',1,'HO|*~|',''	

Pr_rpt_bill_profile_filter 	'NSDL',4,'Sep 11 2008','Sep 11 2008 23:59:59','N','N','10000037','','','N','Y','',1,'HO|*~|'

*/
CREATE Proc [citrus_usr].[Pr_rpt_bill_profile_filter_CLOSEACCOUNT]              
@pa_dptype varchar(4),                      
@pa_excsmid int,                      
...
prev_bill_bal numeric(18,2)
 ...
 begin  
   ...
   begin 
	  ...
	  begin   
		 ...
		 ,account_group_mapping g with(nolock)              
		 ,#ACLIST account , dp_acct_mstr  dpam
		 WHERE           dpam.dpam_id = account.dpam_id and dpam_stam_cd <> '05' and 
 ...
 begin  
  ...
  group by clic_dpam_id,dpam_sba_no,dpam_sba_name,clic_charge_name                     
   ...
   INSERT INTO #tempmaincdsl(dpam_id,dpam_sba_name,dpam_acctno,trans_desc,dpm_trans_no,trans_date,isin_cd,opening_bal,qty,order_by,line_no,charge_val) 
   SELECT distinct dpam_id , dpam_sba_name, dpam_sba_no , '','','','',0,0,4,0,0 FROM #ACLIST a
