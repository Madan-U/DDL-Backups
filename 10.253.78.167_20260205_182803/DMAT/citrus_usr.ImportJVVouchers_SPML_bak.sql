-- Object: PROCEDURE citrus_usr.ImportJVVouchers_SPML_bak
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--BEGIN TRAN
--ImportJVVouchers_SPML 1257,203412,3,'OCT  5 2009','OCT  5 2009',	'VISHAL'
--SELECT ldg_instrument_no,* FROM LEDGER3 ORDER BY 2 DESC
--ROLLBACK
create Proc [citrus_usr].[ImportJVVouchers_SPML_bak]
@pa_task_id bigint,
@pa_dpmid int,
@pa_finid int,
