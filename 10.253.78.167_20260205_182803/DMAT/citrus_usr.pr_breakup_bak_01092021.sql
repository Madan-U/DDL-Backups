-- Object: PROCEDURE citrus_usr.pr_breakup_bak_01092021
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

create  procedure [citrus_usr].[pr_breakup_bak_01092021](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
