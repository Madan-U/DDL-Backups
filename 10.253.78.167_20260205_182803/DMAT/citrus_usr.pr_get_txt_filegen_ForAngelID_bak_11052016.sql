-- Object: PROCEDURE citrus_usr.pr_get_txt_filegen_ForAngelID_bak_11052016
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--PR_GET_TXT_FILEGEN 'CLIENT','12033200','1203320000714231','1203320000714231','AUG 01 2015','AUG 31 2015'
create PROC [citrus_usr].[pr_get_txt_filegen_ForAngelID_bak_11052016](@PA_ACTION VARCHAR(100),@PA_DPID VARCHAR(100)    
,@PA_BOID VARCHAR(100)    
,@PA_ISIN VARCHAR(100)    
...
--AND ACCP_ACCPM_PROP_CD ='ECN_FLAG')
  ...
  SET @SQL11 = ''
  SELECT @SQL11  = 'SELECT IDENTITY(NUMERIC,1,1) ID ,ldg_id, DPAM_SBA_NO R_BOID,ISNULL(OS,''0'') OS , SUM(LDG_AMOUNT) R_AMOUNT,LDG_VOUCHER_DT R_VO_DT,LDG_NARRATION RE_NARRATION INTO ##BILLED_RE FROM LEDGER'+CONVERT(VARCHAR,@L_FIN_ID1)
