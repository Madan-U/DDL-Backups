-- Object: PROCEDURE citrus_usr.pr_import_dp_cdsl_Mod_bak_06052015
...
create  PROCeDURE [citrus_usr].[pr_import_dp_cdsl_Mod_bak_06052015]( @pa_crn_no      VARCHAR(8000)                  
                            , @pa_exch        VARCHAR(10)                  
      ...
      BEGIN                  
        ...
        insert into @line2( ln_no                  
                           ...
                           SELECT distinct '02'                  
                                ...
                                , '' --bo middle name
                                , '' -- bo seach name
                                , MAX(case when CLIM_GENDER in ('M','MALE') then 'MR'  when CLIM_GENDER in ('F','FEMALE') then 'MS' else 'M/S' end)  --bo title
                                , '' --bo suffix                 
                                , MAX(ISNULL(dphd_fh_fthname,''))  --father/husband name                  
