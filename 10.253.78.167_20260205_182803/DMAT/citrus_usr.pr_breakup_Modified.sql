-- Object: PROCEDURE citrus_usr.pr_breakup_Modified
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE   procedure [citrus_usr].[pr_breakup_Modified](@pa_from_dt datetime,@pa_to_dt datetime,@pa_login_name varchar(100))
as
begin 
...
insert into bbrlog
select 'TRUNCATE cdsl_holding_dtls_bak_forreve and insert start', GETDATE () 
...
insert into bbrlog
select 'TRUNCATE cdsl_holding_dtls_bak_forreve and insert end', GETDATE ()
...
select boid,cdshm_internal_trastm ,sum(convert(numeric(18,3),AMT)) bill_amt , 'N' flag , cdshm_isin into #totalcost from (
SELECT boid,@l_amount   AMT , cdshm_internal_trastm,cdshm_isin  FROM (SELECT cdshm_ben_acct_no BOID , cdshm_internal_trastm , cdshm_isin
...
union all
SELECT boid,@l_amount  act_AMT, cdshm_internal_trastm , cdshm_isin  fROM (SELECT cdshm_ben_acct_no BOID , cdshm_internal_trastm  , cdshm_isin 
FROM cdsl_holding_dtls_bak_forreve with (nolock)
where cdshm_tras_dt between @PA_from_DT and @PA_to_DT
...
UNION ALL
select CDSHM_BEN_ACCT_NO,@l_amount  act_AMT,cdshm_internal_trastm  , cdshm_isin  from cdsl_holding_dtls_bak_forreve where cdshm_tratm_cd ='2277'
...
select CDSHM_BEN_ACCT_NO  ,@l_amount  act_AMT ,cdshm_internal_trastm dsc  , cdshm_isin   from cdsl_holding_dtls_bak_forreve
...
and cdshm_isin not in ('INF732E01037 ','IN0020120062')
UNION ALL 
SELECT CDSHM_BEN_ACCT_NO ,@l_amount  act_AMT ,'NSCCL **' dsc   , cdshm_isin  FROM cdsl_holding_dtls_bak_forreve 
WHERE CDSHM_TRATM_CD ='2277'
...
UNION ALL
SELECT CDSHM_BEN_ACCT_NO ,CONVERT(NUMERIC(18,3),5.5) act_AMT  ,cdshm_internal_trastm dsc  , cdshm_isin  
...
and cdshm_isin like 'inF%'
union all
SELECT CDSHM_BEN_ACCT_NO ,CONVERT(NUMERIC(18,3),50) act_AMT  ,cdshm_internal_trastm dsc  , cdshm_isin  
FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_TRATM_CD ='2277'
AND CDSHM_CDAS_SUB_TRAS_TYPE IN ('707','3304') AND citrus_usr.fn_splitval_by(cdshm_trans_cdas_code,26,'~')= 'j'
and cdshm_isin not in ('INF732E01037' ,'IN0020120062')
...
,CEILING(ABS(CDSHM_QTY)/100.00)* CASE WHEN CDSHM_ISIN LIKE 'INC%' THEN 50 ELSE 10 END ) act_AMT  ,cdshm_internal_trastm dsc  , cdshm_isin 
FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_TRATM_CD ='2277'
AND CDSHM_CDAS_SUB_TRAS_TYPE IN ('707','3304') AND citrus_usr.fn_splitval_by(cdshm_trans_cdas_code,26,'~') <> 'j'
and cdshm_isin not in ('INF732E01037' ,'IN0020120062')
...
,cdshm_internal_trastm dsc , cdshm_isin  
FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_TRATM_CD ='2277'
AND CDSHM_CDAS_SUB_TRAS_TYPE IN ('707','3304') AND citrus_usr.fn_splitval_by(cdshm_trans_cdas_code,26,'~') = 'J'
and cdshm_isin not in ('INF732E01037','IN0020120062')
and cdshm_isin not like 'inc%'
...
--and cdshm_isin not in ('INF732E01037','IN0020120062')
UNION ALL
SELECT CDSHM_BEN_ACCT_NO, '12' act_AMT ,cdshm_internal_trastm dsc  , cdshm_isin  FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_CDAS_SUB_TRAS_TYPE in ('1002')
and cdshm_isin not in ('INF732E01037','IN0020120062')
UNION ALL
SELECT CDSHM_BEN_ACCT_NO, '12' act_AMT ,cdshm_internal_trastm dsc  , cdshm_isin  FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_CDAS_SUB_TRAS_TYPE in ('905')
and cdshm_isin not in ('INF732E01037','IN0020120062')
UNION ALL
SELECT CDSHM_BEN_ACCT_NO, '12' act_AMT ,cdshm_internal_trastm dsc  , cdshm_isin  FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_CDAS_SUB_TRAS_TYPE in ('802')
and cdshm_isin not in ('INF732E01037','IN0020120062')
UNION ALL
SELECT CDSHM_BEN_ACCT_NO, '5' act_AMT ,cdshm_internal_trastm dsc  , cdshm_isin  FROM cdsl_holding_dtls_bak_forreve a WHERE CDSHM_CDAS_SUB_TRAS_TYPE in ('829')
and cdshm_isin not in ('INF732E01037','IN0020120062')
and case
...
UNION ALL
SELECT CDSHM_BEN_ACCT_NO, '5' act_AMT ,cdshm_internal_trastm dsc  , cdshm_isin  FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_CDAS_SUB_TRAS_TYPE in ('1012')
and cdshm_isin not in ('INF732E01037','IN0020120062')
--and citrus_usr.fn_splitval_by(cdshm_trans_cdas_code ,31,'~') <> '0.000'
UNION ALL
SELECT CDSHM_BEN_ACCT_NO, '1' act_AMT ,cdshm_internal_trastm  dsc  , cdshm_isin  FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_CDAS_SUB_TRAS_TYPE in ('838')
and cdshm_isin not in ('INF732E01037','IN0020120062')

UNION ALL
SELECT CDSHM_BEN_ACCT_NO, '5' act_AMT ,cdshm_internal_trastm dsc  , cdshm_isin  FROM cdsl_holding_dtls_bak_forreve WHERE CDSHM_CDAS_SUB_TRAS_TYPE in ('1102')
and cdshm_isin not in ('INF732E01037','IN0020120062')
