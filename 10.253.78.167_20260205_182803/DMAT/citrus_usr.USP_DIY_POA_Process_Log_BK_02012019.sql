-- Object: PROCEDURE citrus_usr.USP_DIY_POA_Process_Log_BK_02012019
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------


CREATE Procedure [citrus_usr].[USP_DIY_POA_Process_Log_BK_02012019]  
(  
@date datetime  
)  
As  
...
INSERT INTO DIY_POA_Process_Log  
  ...
  FROM  
    ...
    WHERE convert(varchar(11),CreationDate,103) = CONVERT(VARCHAR(11),@date,103)  
...
(Case when EXCHANGE='BSE' then cast(right(convert(varchar(50),@date,103),2) as varchar(2))+cast((cast(right(convert(varchar(50),@date,103),2) as int)+1) as varchar(2))+cast(right(SETT_NO,3) as varchar(3)) else SETT_NO End) pa_settlm_no,  
...
@pa_rmks='',@pa_trdReasoncd='3',@pa_Paymode=null,@pa_Bankacno=null,@pa_Bankacname=null,@pa_Bankbrname=null,@pa_Transfereename=null,@pa_DOI =null,  
