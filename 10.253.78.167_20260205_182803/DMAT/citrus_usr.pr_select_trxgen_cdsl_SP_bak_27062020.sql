-- Object: PROCEDURE citrus_usr.pr_select_trxgen_cdsl_SP_bak_27062020
...
--rollback
CREATE PROCEDURE [citrus_usr].[pr_select_trxgen_cdsl_SP_bak_27062020]  
(  
...
--																	END  
						...
						BEGIN  
						print 'bmbmnbnb'
							SELECT * FROM CLOSURE_ACCT_MSTR WHERE cONVERT(DATETIME,CONVERT(VARCHAR(11),CLSR_DATE,109)) BETWEEN @PA_FROM_DT  AND @PA_TO_DT  
