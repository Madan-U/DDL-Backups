-- Object: FUNCTION citrus_usr.fn_fetch_ph_27072015_bak
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE function [citrus_usr].[fn_fetch_ph_27072015_bak](@PA_TAB VARCHAR(25),@pa_id numeric,@pa_ph_count int,@pa_ind_yn char(1))        
