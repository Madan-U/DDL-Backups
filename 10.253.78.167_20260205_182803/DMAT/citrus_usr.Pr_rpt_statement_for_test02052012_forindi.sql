-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_for_test02052012_forindi
...
CREATE Proc [citrus_usr].[Pr_rpt_statement_for_test02052012_forindi]                            
@pa_dptype varchar(4),                                    
@pa_excsmid int,                                    
...
delete a from #ACLIST a , SPECIFIED_ACCOUNT_LIST where ACCOUNT = dpam_sba_no and cm_ben ='B'


  create table #vw_fethob(v_cdshm_tras_dt datetime, v_CDSHM_DPM_ID numeric 
			, v_CDSHM_DPAM_ID numeric,v_CDSHM_ISIN varchar(20),v_cdshm_opn_bal numeric
			,v_cdshm_trans_no varchar(150))



  insert into #vw_fethob
  exec pr_get_ob_ind @@dpmid,@pa_fromdate,@pa_todate,@pa_fromaccid,@pa_toaccid,''
...
where  tratm_cd not in ('2246','2277','2280','3102','2201','2270','2220') 
...
and cdshm_tratm_cd in('2246','2277','2280','3102','2201','2270','2220') ) 
--changed by tushar sep 18 2009    
