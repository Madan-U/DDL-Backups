-- Object: FUNCTION citrus_usr.fn_cdsl_export_line_7_extract_bak_25092018
...
create function [citrus_usr].[fn_cdsl_export_line_7_extract_bak_25092018](@pa_crn_no      VARCHAR(8000)  
...
,isnull(citrus_usr.FN_TOGETCDSLCOUNTRYSTATECODE('Country',citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'NOMINEE_ADR1'),''),6 )),'') -- cntry code
,isnull(citrus_usr.FN_TOGETCDSLCOUNTRYSTATECODE('State',citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'NOMINEE_ADR1'),''),5 )),'')  -- state code
,isnull(citrus_usr.Fn_Toget_CitySeqno(citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'NOMINEE_ADR1'),''),7) ,citrus_usr.fn_splitval(ISNULL(citrus_usr.fn_addr_value(clim.clim_crn_no,'NOMINEE_ADR1'),''),4)),'' ) -- seqno
