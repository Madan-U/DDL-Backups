-- Object: PROCEDURE citrus_usr.PR_INS_UPD_DIS_CANCELLATION_POA
...
CREATE PROCEDURE [citrus_usr].[PR_INS_UPD_DIS_CANCELLATION_POA] 
(
	@PA_EXCSM_ID NUMERIC,
...
BEGIN
	...
	BEGIN
		SELECT slibm_book_name as sliim_book_name, SLIIM_SERIES_TYPE,SLIIM_DPAM_ACCT_NO
	...
	BEGIN
		...
		exec pr_get_range_for_cancel_POA @PA_SERIES_TYPE , @PA_FROM_SLIP,@PA_TO_SLIP,@PA_ACCOUNT_ID,'N' ,''
	...
	BEGIN
		...
		exec pr_get_range_for_cancel_POA @PA_SERIES_TYPE , @PA_FROM_SLIP,@PA_TO_SLIP,@PA_ACCOUNT_ID,'Y' ,@l_string
