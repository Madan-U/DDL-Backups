-- Object: TABLE citrus_usr.tmp_dp57_o_BAK_24122025
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE TABLE [citrus_usr].[tmp_dp57_o_BAK_24122025]
(
    ...
    [column_26] VARCHAR(100) NULL,
    [column_27] VARCHAR(100) NULL,
    [column_29] VARCHAR(100) NULL,
    [column_30] VARCHAR(100) NULL,
    [column_31] VARCHAR(100) NULL,
    [column_32] VARCHAR(100) NULL,
    [column_34] VARCHAR(100) NULL,
    [column_35] VARCHAR(100) NULL,
    [column_37] VARCHAR(100) NULL,
    [column_53] VARCHAR(100) NULL,
