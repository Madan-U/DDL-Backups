-- Object: PROCEDURE citrus_usr.PR_SELECT_TRXGEN_CDSL_SP_XML_EDIS_bak_14022020
...
CREATE PROCEDURE [citrus_usr].[PR_SELECT_TRXGEN_CDSL_SP_XML_EDIS_bak_14022020]  
(  
...
select T.* into #TEMPDATANEW from #TEMPDATA T,dp_trx_dtls_cdsl M where T.dptdc_id=M.dptdc_id and M.DPTDC_SLIP_NO like 'E%'
