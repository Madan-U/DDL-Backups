-- Object: VIEW citrus_usr.Synergy_Client_Master_1507
...
convert(varchar (8), RIGHT (DateOfBirth,4) +'-'+SUBSTRING (DateOfBirth , 3 ,2) +'-'+ LEFT(DateOfBirth ,2)) CM_DATEOFBIRTH,
...
convert(numeric,ClCorpId) CM_CCID,
...
' ' CM_FREEZEDT,
MKRDT=(SELECT TOP 1 DPAM_CREATED_DT FROM DP_ACCT_MSTR WHERE C.BOId=DPAM_SBA_NO) ,
