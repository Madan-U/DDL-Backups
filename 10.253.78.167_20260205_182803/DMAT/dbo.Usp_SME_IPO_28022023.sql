-- Object: PROCEDURE dbo.Usp_SME_IPO_28022023
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

      
--exec Usp_SME_IPO      
Create Proc [dbo].[Usp_SME_IPO_28022023]      
AS      
BEGIN       
 ...
 --------OFF market share -----------------------   
  ...
  --into #offmarket  
  --from [196.1.115.182].general.dbo.Tbl_DPDirectPush a inner join #notinholding b   
  --on  a.ISIN=b.isin  
...
from(  
 ...
 union all  
 select PARTY_CODE ,ISIN,0 as qty,  
              '0' as 'IS_Collateral','0' as 'EVALUATIONMETHOD','0' as 'Collateral_QUANTITY',0 as haircut,'' as 'Collateral update QUANTITY',  
              '' as 'Holding update QUANTITY',0 as cl_rate,'' as 'Withheld Holding Qty', '' as 'Withheld Collateral Qty','CNC' as Type  
