-- Object: FUNCTION citrus_usr.fn_cdsl_export_line_7_extract_newversion_mod_bak_20042023
...
CREATE  function [citrus_usr].[fn_cdsl_export_line_7_extract_newversion_mod_bak_20042023](@pa_crn_no      VARCHAR(8000)    
...
,ISNULL(CONVERT(char(8),replace(convert(varchar,convert(datetime,nom_dob),103),'/','')),'')
         ,nom_fax--, isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'NOMINEE_FAX1'),'')--fax
          ...
          ,nom_pan--isnull(DPHD_NOM_PAN_NO,'')
           ,'' -- uid
		  --,nmcrcd_reason_cd -- reason   
		  , case when (nom_fname) = (select (ltrim(rtrim(Name))) from dps8_pc6 where NOM_Sr_No = '1' and boid =Nom_DPAM_SBA_NO ) 
then '' else  nmcrcd_reason_cd end
          ,''  
          ,nom_email-- isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'NOMINEE_MAIL'),'')--fax
          ,''--usr_txt1                                 
          ,''--usr_txt2                                 
          ,0000--''--usr_fld3                                 
          ,case when clic_mod_action = 'NOMINEE DELETE' then 'D' else 
 (CASE WHEN exists (select 1 from dps8_pc6 where BOid = DPAM_SBA_NO
 and NOM_Sr_No = '1'  and (TypeOfTrans = '1'
 or TypeOfTrans = '2' or TypeOfTrans = '')) THEN 'M' ELSE 'S' END) end--''--usr_fld4                                 
          ,0000--''--usr_fld5          
...
,case when nom_phone1_ind <> '' THEN  convert(varchar(6),citrus_usr.FN_FORMATSTR(convert(varchar(6),lower(isnull(nom_phone1_ind,'')) ),6,0,'L','0'))  else '000000' END -- pri mob isd                   
    ...
    FROM   dp_acct_mstr              dpam                  
         ...
         , client_ctgry_mstr         clicm                  
           ...
           on  subcm.subcm_clicm_id    = clicm.clicm_id and   subcm.subcm_deleted_ind = 1       
		   , client_list_modified  climmod   
		   ,name_change_reason_cd namechange             
    WHERE  dpam.dpam_id            = dphd.Nom_dpam_id                      
    AND    dpam.dpam_crn_no        = clim.clim_crn_no                   
    AND    dpam.dpam_enttm_cd      = enttm.enttm_cd                  
    AND    dpam.dpam_clicm_cd      = clicm.clicm_cd  
    and      namechange.nmcrcd_sba_no =   climmod.clic_mod_dpam_sba_no                
    AND    dpam.dpam_deleted_ind   = 1                  
	...
	AND		climmod.clic_mod_action in ('NOMINEE1')
      and nmcrcd_created_dt BETWEEN CONVERT(VARCHAR,CONVERT(DATETIME, @pa_from_dt,103),106)+' 00:00:00' AND CONVERT(VARCHAR,CONVERT(DATETIME,@pa_to_dt,103),106)+' 23:59:59'   
    UNION  
    SELECT distinct '07'                  
          ,clim_crn_no                  
          ,dpam_sba_no                  
...
,ISNULL(CONVERT(char(8),replace(convert(varchar,convert(datetime,nom_dob),103),'/','')),'')
         ,nom_fax--, isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'NOMINEE_FAX1'),'')--fax
          ...
          ,case when clic_mod_action = 'NOMINEE DELETE' then 'D' else 
 (CASE WHEN exists (select 1 from dps8_pc6 where BOid = DPAM_SBA_NO
 and NOM_Sr_No = '2'  and (TypeOfTrans = '1'
 or TypeOfTrans = '2' or TypeOfTrans = '')) THEN 'M' ELSE 'S' END) end--''--usr_fld4                                 
          ,0000--''--usr_fld5          
		  		  ,case when nom_srno = '1' then '01' when  nom_srno = '2' then '02'when nom_srno = '3' then '03' end --'01'
		  , nom_relation--isnull(citrus_usr.fn_get_cd_rel( isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'1ST_NRELATN_BO',''),'')),'')
...
,ISNULL(CONVERT(char(8),replace(convert(varchar,convert(datetime,nom_dob),103),'/','')),'')
         ,nom_fax--, isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'NOMINEE_FAX1'),'')--fax
          ...
          ,case when clic_mod_action = 'NOMINEE DELETE' then 'D' else 
 (CASE WHEN exists (select 1 from dps8_pc6 where BOid = DPAM_SBA_NO
 and NOM_Sr_No = '3'  and (TypeOfTrans = '1'
 or TypeOfTrans = '2' or TypeOfTrans = '')) THEN 'M' ELSE 'S' END) end--''--usr_fld4                                 
          ,0000--''--usr_fld5          
		  		  ,case when nom_srno = '1' then '01' when  nom_srno = '2' then '02'when nom_srno = '3' then '03' end --'01'
		  , nom_relation--isnull(citrus_usr.fn_get_cd_rel( isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'1ST_NRELATN_BO',''),'')),'')
...
,ISNULL(CONVERT(char(8),replace(convert(varchar,convert(datetime,nom_dob),103),'/','')),'')
         ,nom_fax--, isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'NOMINEE_FAX1'),'')--fax
          ...
          ,0000--''--usr_fld3                                 
          ,case when clic_mod_action = 'NOMINEE DELETE' then 'D' else 
 (CASE WHEN exists (select 1 from dps8_pc8 where BOid = DPAM_SBA_NO
 and NOM_Sr_No = '4'  and (TypeOfTrans = '1'
 or TypeOfTrans = '2' or TypeOfTrans = '')) THEN 'M' ELSE 'S' END) end--''--usr_fld4                                 
          ,0000--''--usr_fld5          
...
,ISNULL(CONVERT(char(8),replace(convert(varchar,convert(datetime,nom_dob),103),'/','')),'')
         ,nom_fax--, isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'NOMINEE_FAX1'),'')--fax
          ...
          ,case when clic_mod_action = 'NOMINEE DELETE' then 'D' else 
 (CASE WHEN exists (select 1 from dps8_pc8 where BOid = DPAM_SBA_NO
 and NOM_Sr_No = '5'  and (TypeOfTrans = '1'
 or TypeOfTrans = '2' or TypeOfTrans = '')) THEN 'M' ELSE 'S' END) end--''--usr_fld4                                 
          ,0000--''--usr_fld5          
		  		  ,case when nom_srno = '4' then '01' when  nom_srno = '5' then '02'when nom_srno = '6' then '03' end --'01'
		  , nom_relation--isnull(citrus_usr.fn_get_cd_rel( isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'1ST_NRELATN_BO',''),'')),'')
...
,ISNULL(CONVERT(char(8),replace(convert(varchar,convert(datetime,nom_dob),103),'/','')),'')
         ,nom_fax--, isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'NOMINEE_FAX1'),'')--fax
          ...
          ,case when clic_mod_action = 'NOMINEE DELETE' then 'D' else 
 (CASE WHEN exists (select 1 from dps8_pc8 where BOid = DPAM_SBA_NO
 and NOM_Sr_No = '6'  and (TypeOfTrans = '1'
 or TypeOfTrans = '2' or TypeOfTrans = '')) THEN 'M' ELSE 'S' END) end--''--usr_fld4                                 
          ,0000--''--usr_fld5          
...
,ISNULL(CONVERT(char(8),replace(convert(varchar, convert(datetime,nom_dob),103),'/','')),'')
         ,nom_fax--, isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'NOMINEE_FAX1'),'')--fax
          ...
          ,nom_pan--isnull(DPHD_NOM_PAN_NO,'')  
           ,'' -- uid
--		  ,namechange.nmcrcd_reason_cd -- reason 
, case when (nom_fname) = (select (ltrim(rtrim(Name))) from dps8_pc6 where NOM_Sr_No = '1' and boid =Nom_DPAM_SBA_NO ) 
then '' else  nmcrcd_reason_cd end
          ,''  
          ,nom_email-- isnull(citrus_usr.fn_acct_conc_value(dpam.dpam_id,'NOMINEE_MAIL'),'')--fax
 ...
 (CASE WHEN exists (select 1 from dps8_pc6 where BOid = DPAM_SBA_NO
 and NOM_Sr_No = '1'  and (TypeOfTrans = '1'
 or TypeOfTrans = '2' or TypeOfTrans = '')) THEN 'M' ELSE 'S' END) end
          ,0000--''--usr_fld5          
		  		  ,case when nom_srno = '1' then '01' when  nom_srno = '2' then '02'when nom_srno = '3' then '03' end --'01'
		  , nom_relation--isnull(citrus_usr.fn_get_cd_rel( isnull(citrus_usr.fn_ucc_accp(dpam.dpam_id,'1ST_NRELATN_BO',''),'')),'')
		  , isnull(citrus_usr.fn_get_perc(nom_percentage),'')
...
,isnull(citrus_usr.FN_TOGETCDSLCOUNTRYSTATECODE('State',nom_State),'')  -- state code
--,isnull(citrus_usr.Fn_Toget_CitySeqno(nom_zip ,nom_city),'' ) -- seqno
,(Select top 1 convert(char,PM_CITYREF_NO) from PIN_MSTR where convert(varchar,PM_PIN_CODE)=nom_zip  and convert(varchar,PM_DISTRICT_NAME)=nom_city ) -- seqno
,case when nom_phone1_ind <> '' THEN  convert(varchar(6),citrus_usr.FN_FORMATSTR(convert(varchar(6),lower(isnull(nom_phone1_ind,'')) ),6,0,'L','0'))  else '000000' END -- pri mob isd                   
