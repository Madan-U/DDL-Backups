-- Object: PROCEDURE citrus_usr.pr_import_dp_Harmonization_bak_10102024
...
CREATE  PROCeDURE [citrus_usr].[pr_import_dp_Harmonization_bak_10102024]( @pa_crn_no      VARCHAR(8000)                  
                            , @pa_exch        VARCHAR(10)                  
...
select * , acct_no boidorder,'9' id  , (select top 1 Borequestdt from @line2 l2 where l2.acct_no = l7.acct_no  )  Borequestdt into #tmp_line7_AS from @line7 l7 where Purpose_code ='18'
...
union 
select boidorder from #tmp_line7_AS) a 




--select  cust_addr_cntry,* from #tmp_line2
----select * from @line7
