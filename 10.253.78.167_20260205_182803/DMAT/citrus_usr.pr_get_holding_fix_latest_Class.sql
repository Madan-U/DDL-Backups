-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_Class
...
--exec [pr_get_holding_fix_latest_Class] 3,'aug 01 2012','aug 01 2012','1201090000004621','1201090000004621',''    
--1201090000025122~INE083C01022    
    
    
    
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_Class](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
