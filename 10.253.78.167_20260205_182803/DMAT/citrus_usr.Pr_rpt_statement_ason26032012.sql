-- Object: PROCEDURE citrus_usr.Pr_rpt_statement_ason26032012
...
CREATE Proc [citrus_usr].[Pr_rpt_statement_ason26032012]                            
@pa_dptype varchar(4),                                    
@pa_excsmid int,                                    
...
where  tratm_cd not in ('2246','2277','2280','3102') 
...
and cdshm_tratm_cd in('2246','2277','2280','3102') ) 
--changed by tushar sep 18 2009    
