-- Object: PROCEDURE citrus_usr.pr_import_dp_cdsl_Mod_Harmonization_Sep162024_BNom
...
create PROCeDURE [citrus_usr].[pr_import_dp_cdsl_Mod_Harmonization_Sep162024_BNom]( @pa_crn_no      varchar(8000)                 
                            , @pa_exch        VARCHAR(10)                  
