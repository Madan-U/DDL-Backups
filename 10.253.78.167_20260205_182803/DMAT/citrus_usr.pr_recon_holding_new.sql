-- Object: PROCEDURE citrus_usr.pr_recon_holding_new
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--select * from #holdingall
--exec pr_recon_holding 485031,'may 24 2012','ALL',''
--exec pr_recon_holding 485031,'may 24 2012','MATCH',''
--exec pr_recon_holding_new 3,'jun 28 2012','MISMATCH',''
CREATE  proc [citrus_usr].[pr_recon_holding_new](@pa_excsm_id numeric
, @pa_date datetime
, @pa_flag char(15)
