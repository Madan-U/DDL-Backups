-- Object: PROCEDURE citrus_usr.Bak_pr_checkslipno_pledge_011011
...
CREATE   procedure [citrus_usr].[Bak_pr_checkslipno_pledge_011011]      
(      
...
--   print 'ssssss'
 ...
 BEGIN      
   ...
   BEGIN    
      ...
      SELECT @pa_errmsg = ISNULL(SLIIM_DPAM_ACCT_NO,'') + '|*~|0'   FROM SLIP_ISSUE_MSTR,TRANSACTION_SUB_TYPE_MSTR   
