-- Object: PROCEDURE citrus_usr.pr_insert_dps8_BakDec1816
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

Create proc [citrus_usr].[pr_insert_dps8_BakDec1816](@pa_level numeric)
as
begin
...
declare @l_counter numeric
	...
	begin 
		...
		select identity(numeric,1,1) id ,
		'insert into dps8_pc1 values('''+ replace(replace(a.value,'''',''''''),'~',''',''') +''')' insertstr into #tmpdps8_pc1 from dps8_source1 a 
	...
	begin 
		...
		select identity(numeric,1,1) id ,
		'insert into dps8_pc2 values('''+ replace(replace(a.value,'''',''''''),'~',''',''') +''')' insertstr into #tmpdps8_pc2 from dps8_source1 a 
	...
	begin 
		...
		select identity(numeric,1,1) id ,
		'insert into dps8_pc3 values('''+ replace(replace(a.value,'''',''''''),'~',''',''') +''')' insertstr into #tmpdps8_pc3 from dps8_source1 a 
...
and b.holder = citrus_usr.fn_splitval_by(value,	10	,'~')
	...
	begin 
		...
		select identity(numeric,1,1) id ,
		'insert into dps8_pc6 values('''+ replace(replace(a.value,'''',''''''),'~',''',''') +''')' insertstr into #tmpdps8_pc6 from dps8_source1 a 
	...
	begin 
		...
		select identity(numeric,1,1) id ,
		'insert into dps8_pc7 values('''+ replace(replace(a.value,'''',''''''),'~',''',''') +''')' insertstr into #tmpdps8_pc7 from dps8_source1 a 
	...
	begin 
		...
		select identity(numeric,1,1) id ,
		'insert into dps8_pc8 values('''+ replace(replace(a.value,'''',''''''),'~',''',''') +''')' insertstr into #tmpdps8_pc8 from dps8_source1 a 
	...
	begin 
		...
		select identity(numeric,1,1) id ,
		'insert into dps8_pc12 values('''+ replace(replace(a.value,'''',''''''),'~',''',''') +''')' insertstr into #tmpdps8_pc12 from dps8_source1 a 
	...
	begin 
		...
		select identity(numeric,1,1) id ,
		'insert into dps8_pc18 values('''+ replace(replace(a.value,'''',''''''),'~',''',''') +''')' insertstr into #tmpdps8_pc18 from dps8_source1 a 
