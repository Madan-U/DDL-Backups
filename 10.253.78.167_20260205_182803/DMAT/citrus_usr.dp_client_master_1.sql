-- Object: VIEW citrus_usr.dp_client_master_1
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--select  * from [dp_client_master_1] where cm_cd  ='1201090001321086'  
--select * from dps8_pc1 where boid = '1201090001321086'
CREATE view [citrus_usr].[dp_client_master_1]  
as
select   dps8_pc1.boid , case when ClosDt <> '' then right(ClosDt,4)+substring(ClosDt,3,2)+left(ClosDt,2) else '' end cm_acc_closuredate  
...
, convert(varchar,left(subcm_cd,2)) cm_productcd  
