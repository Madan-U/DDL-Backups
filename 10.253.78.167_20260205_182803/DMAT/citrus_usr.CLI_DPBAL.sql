-- Object: PROCEDURE citrus_usr.CLI_DPBAL
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

  
CREATE PROC [citrus_usr].[CLI_DPBAL] (@CLTCODE VARCHAR(10))     
AS     
...
--isnull([NEXT AMC DT],'')   
convert(datetime,'')  AS AMCDATE,isnull(Actual_amount,'0') AS DP_LEDGER,     
