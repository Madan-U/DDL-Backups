-- Object: PROCEDURE citrus_usr.pr_import_dp_bak_25092018
...
CREATE PROCeDURE [citrus_usr].[pr_import_dp_bak_25092018]( @pa_crn_no      VARCHAR(8000)                  
                            , @pa_exch        VARCHAR(10)                  
...
,  case when isnull(citrus_usr.fn_ucc_accp(dpam_id,'RGESS_FLAG',''),'00')  = 'YES'     then 'Y' else 'N' end
      ...
      select distinct l2.sign_bo                  
			...
			+convert(char(12),l2.hldr_UID)                     
			+convert(char(3),space(3))                     
