-- Object: PROCEDURE citrus_usr.pr_get_holding_fix_latest_forreco
...
--exec [pr_get_holding_fix_latest_forreco] 3,'MAR 31 2012','MAR 31 2012','0','9999999999999999',''    
--exec [pr_get_holding_fix_latest] 3,'aug 01 2012','aug 01 2012','1201090000004621','1201090000004621',''    
--1201090000025122~INE083C01022    
    
    
    
CREATE proc [citrus_usr].[pr_get_holding_fix_latest_forreco](@pa_dpm_id numeric,@pa_from_dt datetime, @pa_to_dt datetime                        
