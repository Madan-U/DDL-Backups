-- Object: PROCEDURE citrus_usr.pr_trx_cdsl_response_bak_31122012
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

create procedure [citrus_usr].[pr_trx_cdsl_response_bak_31122012]( @pa_exch          VARCHAR(20)  
 ...
 SELECT @L_DPM_ID = DPM_ID FROM DP_MSTR WHERE DEFAULT_DP = @PA_EXCSM_ID AND DPM_DELETED_IND =1  
  ...
  IF @pa_tab= 'DEMAT'
		...
		--
				...
				UPDATE BATCHNO_CDSL_MSTR SET BATCHC_STATUS = 'I'
				WHERE  BATCHC_NO = @PA_BATCHNO AND BATCHC_DPM_ID = @L_DPM_ID AND BATCHC_TRANS_TYPE = 'DESTAT'				
				/*common file format updation*/
