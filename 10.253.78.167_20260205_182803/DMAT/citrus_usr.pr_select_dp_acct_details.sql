-- Object: PROCEDURE citrus_usr.pr_select_dp_acct_details
...
CREATE PROCEDURE [citrus_usr].[pr_select_dp_acct_details](@pa_id             VARCHAR(20)
...
--       END
	 ...
	 BEGIN
		...
		WHERE ACCP_ACCPM_PROP_CD IN ('RGESS_FLAG','BSDA','SMS_FLAG','ADHAARFLAG','ADHAARSECHLDR','ADHAARTHRDHLDR','CONFIRMATION','EMAIL_ST_FLAG','CAS_FLAG','RTA_EMAIL','RBI_REF_NO','RBI_APP_DT','SLT','SEC_HLD_SUFFIX',
		'GUA_SUFFIX','NOM_SUFFIX','SEC_HLD_TITLE','GUA_TITLE','NOM_TITLE')
