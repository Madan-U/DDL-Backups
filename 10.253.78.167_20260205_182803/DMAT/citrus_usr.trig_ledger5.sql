-- Object: TRIGGER citrus_usr.trig_ledger5
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE TRIGGER [citrus_usr].[trig_ledger5]   
 ON [citrus_usr].[LEDGER5]  
 FOR INSERT,UPDATE  
 AS  
