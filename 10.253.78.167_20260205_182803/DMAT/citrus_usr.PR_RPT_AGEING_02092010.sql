-- Object: PROCEDURE citrus_usr.PR_RPT_AGEING_02092010
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--[PR_RPT_AGEING] 3
CREATE proc [citrus_usr].[PR_RPT_AGEING_02092010]
(
	@pa_fin_id	numeric,
...
, ldg_voucher_dt 
, sum(BALANCE) amount 
, datediff(dd,ldg_voucher_dt,@l_enddt) datediffe , accp_value [activation dt]
...
,diff90days numeric(18,3)
,diff180days numeric(18,3)
...
select srno,type,[client id],name,abs(diff8days),abs(diff15days),abs(diff30days),abs(diff45days),abs(diff90days),
abs(diff180days),abs(diff365days),abs([total debit amount])
from #finaldata ORDER BY NAME 
