-- Object: FUNCTION citrus_usr.fn_acct_list_bak_01082012
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

CREATE Function [citrus_usr].[fn_acct_list_bak_01082012](@pa_dpm_id int ,@pa_ent_id int,@pa_child_id int) 
...
--BEGIN
--INSERT INTO @temp  
--SELECT DPAM_ID, DPAM_CRN_NO , DPAM_SBA_NO , DPAM_SBA_NAME, ENTR_FROM_DT,ENTR_TO_DT,'P',0,DPAM_STAM_CD
