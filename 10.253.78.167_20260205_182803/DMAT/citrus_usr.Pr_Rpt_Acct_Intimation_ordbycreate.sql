-- Object: PROCEDURE citrus_usr.Pr_Rpt_Acct_Intimation_ordbycreate
...
CREATE procedure [citrus_usr].[Pr_Rpt_Acct_Intimation_ordbycreate]      
(      
  @pa_excsmid  int      
...
--      
 ...
 SELECT distinct  account.dpam_sba_name    ACCTNAME      
        ...
        ,convert(datetime,left(pc0.TransSystemDate,2)+'/'+SUBSTRING(pc0.TransSystemDate,3,2)+'/' + SUBSTRING(pc0.TransSystemDate,5,4) + ' ' + SUBSTRING(pc0.TransSystemDate,9,2) + ':' + SUBSTRING(pc0.TransSystemDate,11,2) + ':' + SUBSTRING(pc0.TransSystemDate,13,2),103) createddt
 ...
 left outer join dps8_pc6 pc6 on pc1.BOId = pc6.BOId 
      ...
      --  LEFT OUTER JOIN dp_holder_dtls DPHD ON DPAM.DPAM_ID=DPHD.DPHD_DPAM_ID AND DPHD_DELETED_IND=1      
       ...
       ,dps8_pc0 pc0
 WHERE pc0.boid = pc1.boid and pc1.boid = ACCOUNT.dpam_sba_no and isnumeric(dpam.dpam_sba_no ) =1 and isnumeric(account.dpam_sba_no) = 1 
 ...
 ORDER BY convert(datetime,left(pc0.TransSystemDate,2)+'/'+SUBSTRING(pc0.TransSystemDate,3,2)+'/' + SUBSTRING(pc0.TransSystemDate,5,4) + ' ' + SUBSTRING(pc0.TransSystemDate,9,2) + ':' + SUBSTRING(pc0.TransSystemDate,11,2) + ':' + SUBSTRING(pc0.TransSystemDate,13,2),103)
 ,ACCOUNT.dpam_sba_no
