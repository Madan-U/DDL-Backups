-- Object: PROCEDURE citrus_usr.PR_IMPORT_CLIENT_CDSL_DPB9_converter
...
CREATE PROCEDURE  [citrus_usr].[PR_IMPORT_CLIENT_CDSL_DPB9_converter]
			(
			 @pa_exch          VARCHAR(20)    
...
exec (@@SSQL)
 ...
 set @l_counter = @l_counter + 1 
 	...
 	--IF (select count (distinct clntid) from CLN_MSTR_CDSL ) > 1 
	   ...
	   insert into CLN_MSTR_CDSL_log_13092025
