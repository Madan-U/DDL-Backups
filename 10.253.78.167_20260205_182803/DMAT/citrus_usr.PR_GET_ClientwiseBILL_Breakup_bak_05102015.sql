-- Object: PROCEDURE citrus_usr.PR_GET_ClientwiseBILL_Breakup_bak_05102015
...
create  PROC [citrus_usr].[PR_GET_ClientwiseBILL_Breakup_bak_05102015](@pa_from_dt DATETIME, @pa_to_dt DATETIME    
...
--return   
--exec PR_GET_ClientwiseBILL_Breakup_auto_brwisefilter  @pa_from_dt,@pa_to_dt,@pa_login_name
--return         

exec pr_breakup @pa_from_dt,@pa_to_dt,@pa_login_name
return 
...
--and accp_clisba_id_cl in (select distinct dpam_id from #tmp_dp_acct_mstr)          
      select * from #tmp_dp_acct_mstr where dpam_sba_no ='1203320009202621'    
