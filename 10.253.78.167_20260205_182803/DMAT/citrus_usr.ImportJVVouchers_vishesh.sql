-- Object: PROCEDURE citrus_usr.ImportJVVouchers_vishesh
-- Server: 10.253.78.167 | DB: DMAT
--------------------------------------------------

--SELECT 647+27
--BEGIN TRAN
--[ImportJVVouchers] 557,	3,	2,	'AUG 31 2009',	'AUG 31 2009',	'HO'
--SELECT * FROM LEDGER2 WHERE LDG_ACCOUNT_ID='1176'
--ROLLBACK
create Proc [citrus_usr].[ImportJVVouchers_vishesh]
@pa_task_id bigint,
@pa_dpmid int,
@pa_finid int,
...
where  tmpbill_acct_no = entp_value
and    tmpbill_dpm_id = dpam_dpm_id 
and    dpam_dpm_id = @pa_dpmid
AND    DPAM_CRN_NO = ENTP_ENT_ID
